      ...
      if (Files.exists(saveFile, new LinkOption[0])) {
         try {
            ...
            try {
               ...
               map = (Map)gson.fromJson(reader, type);
         ...
         } catch (IOException | JsonSyntaxException var24) {
            LOGGER.error(USRCACHE, "Could not parse username cache file as valid json, deleting file {}", saveFile, var24);
