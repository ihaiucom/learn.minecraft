...
public enum ProtocolType {
   ...
   public Integer getPacketId(PacketDirection p_179246_1_, IPacket<?> p_179246_2_) {
      return ((ProtocolType.PacketList)this.field_229711_h_.get(p_179246_1_)).func_229720_a_(p_179246_2_.getClass());
   }

   @Nullable
   public IPacket<?> getPacket(PacketDirection p_179244_1_, int p_179244_2_) {
      return ((ProtocolType.PacketList)this.field_229711_h_.get(p_179244_1_)).func_229718_a_(p_179244_2_);
   }
   ...
   public static ProtocolType getById(int p_150760_0_) {
      return p_150760_0_ >= -1 && p_150760_0_ <= 2 ? STATES_BY_ID[p_150760_0_ - -1] : null;
   }

   public static ProtocolType getFromPacket(IPacket<?> p_150752_0_) {
      return (ProtocolType)STATES_BY_CLASS.get(p_150752_0_.getClass());
   }

   static {
      ProtocolType[] var0 = values();
      int var1 = var0.length;

      for(int var2 = 0; var2 < var1; ++var2) {
         ProtocolType lvt_3_1_ = var0[var2];
         int lvt_4_1_ = lvt_3_1_.getId();
         if (lvt_4_1_ < -1 || lvt_4_1_ > 2) {
            throw new Error("Invalid protocol ID " + Integer.toString(lvt_4_1_));
         }

         STATES_BY_ID[lvt_4_1_ - -1] = lvt_3_1_;
         lvt_3_1_.field_229711_h_.forEach((p_229713_1_, p_229713_2_) -> {
            p_229713_2_.func_229717_a_().forEach((p_229712_1_) -> {
               if (STATES_BY_CLASS.containsKey(p_229712_1_) && STATES_BY_CLASS.get(p_229712_1_) != lvt_3_1_) {
                  throw new IllegalStateException("Packet " + p_229712_1_ + " is already assigned to protocol " + STATES_BY_CLASS.get(p_229712_1_) + " - can't reassign to " + lvt_3_1_);
               } else {
                  STATES_BY_CLASS.put(p_229712_1_, lvt_3_1_);
               }
            });
         });
      }
   ...
   static class PacketRegistry {
      private final Map<PacketDirection, ProtocolType.PacketList<?>> field_229722_a_;

      private PacketRegistry() {
         this.field_229722_a_ = Maps.newEnumMap(PacketDirection.class);
      }
      ...
      // $FF: synthetic method
      PacketRegistry(Object p_i226085_1_) {
         this();
      }
   }

   static class PacketList<T extends INetHandler> {
      private final Object2IntMap<Class<? extends IPacket<T>>> field_229715_a_;
      private final List<Supplier<? extends IPacket<T>>> field_229716_b_;

      private PacketList() {
         this.field_229715_a_ = (Object2IntMap)Util.make(new Object2IntOpenHashMap(), (p_229719_0_) -> {
      ...
      public <P extends IPacket<T>> ProtocolType.PacketList<T> func_229721_a_(Class<P> p_229721_1_, Supplier<P> p_229721_2_) {
         int lvt_3_1_ = this.field_229716_b_.size();
         int lvt_4_1_ = this.field_229715_a_.put(p_229721_1_, lvt_3_1_);
         if (lvt_4_1_ != -1) {
            String lvt_5_1_ = "Packet " + p_229721_1_ + " is already registered to ID " + lvt_4_1_;
            LogManager.getLogger().fatal(lvt_5_1_);
            throw new IllegalArgumentException(lvt_5_1_);
         } else {
      ...
      public Integer func_229720_a_(Class<?> p_229720_1_) {
         int lvt_2_1_ = this.field_229715_a_.getInt(p_229720_1_);
         return lvt_2_1_ == -1 ? null : lvt_2_1_;
      }

      @Nullable
      public IPacket<?> func_229718_a_(int p_229718_1_) {
         Supplier<? extends IPacket<T>> lvt_2_1_ = (Supplier)this.field_229716_b_.get(p_229718_1_);
         return lvt_2_1_ != null ? (IPacket)lvt_2_1_.get() : null;
      }
      ...
      // $FF: synthetic method
      PacketList(Object p_i226084_1_) {
         this();
      }
   }
}
