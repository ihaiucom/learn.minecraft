...
public class PacketBuffer extends ByteBuf implements IForgePacketBuffer {
   ...
   public PacketBuffer writeVarIntArray(int[] p_186875_1_) {
      ...
      int[] var2 = p_186875_1_;
      int var3 = p_186875_1_.length;
   ...
   public PacketBuffer writeLongArray(long[] p_186865_1_) {
      ...
      long[] var2 = p_186865_1_;
      int var3 = p_186865_1_.length;
   ...
   public PacketBuffer writeBlockPos(BlockPos p_179255_1_) {
      this.writeLong(p_179255_1_.toLong());
      return this;
   }
   ...
   public PacketBuffer writeTextComponent(ITextComponent p_179256_1_) {
      return this.writeString(ITextComponent.Serializer.toJson(p_179256_1_), 262144);
   }

   public <T extends Enum<T>> T readEnumValue(Class<T> p_179257_1_) {
      return ((Enum[])p_179257_1_.getEnumConstants())[this.readVarInt()];
   }
   ...
   public PacketBuffer writeUniqueId(UUID p_179252_1_) {
   ...
   public PacketBuffer writeCompoundTag(@Nullable CompoundNBT p_150786_1_) {
      if (p_150786_1_ == null) {
         this.writeByte(0);
      } else {
         try {
            CompressedStreamTools.write(p_150786_1_, (DataOutput)(new ByteBufOutputStream(this)));
   ...
   public PacketBuffer writeItemStack(ItemStack p_150788_1_) {
      return this.writeItemStack(p_150788_1_, true);
   }
   ...
   public PacketBuffer writeItemStack(ItemStack p_writeItemStack_1_, boolean p_writeItemStack_2_) {
      if (p_writeItemStack_1_.isEmpty()) {
         ...
         if (item.isDamageable() || item.shouldSyncTag()) {
            compoundnbt = p_writeItemStack_2_ ? p_writeItemStack_1_.getShareTag() : p_writeItemStack_1_.getTag();
         }
   ...
   public String readString(int p_150789_1_) {
      int i = this.readVarInt();
      if (i > p_150789_1_ * 4) {
   ...
   public PacketBuffer writeString(String p_180714_1_) {
      return this.writeString(p_180714_1_, 32767);
   }

   public PacketBuffer writeString(String p_211400_1_, int p_211400_2_) {
   ...
   public PacketBuffer writeTime(Date p_192574_1_) {
   ...
   public BlockRayTraceResult readBlockRay() {
      ...
      Direction direction = (Direction)this.readEnumValue(Direction.class);
