...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   private static final ILootCondition.IBuilder field_218573_a;
   private static final ILootCondition.IBuilder field_218574_b;
   private static final ILootCondition.IBuilder field_218575_c;
   private static final ILootCondition.IBuilder field_218576_d;
   private static final ILootCondition.IBuilder field_218577_e;
   private static final Set<Item> field_218578_f;
   private static final float[] field_218579_g;
   private static final float[] field_218580_h;
   ...
   protected static <T> T func_218552_a(IItemProvider p_218552_0_, ILootFunctionConsumer<T> p_218552_1_) {
      return !field_218578_f.contains(p_218552_0_.asItem()) ? p_218552_1_.acceptFunction(ExplosionDecay.func_215863_b()) : p_218552_1_.cast();
   }

   protected static <T> T func_218560_a(IItemProvider p_218560_0_, ILootConditionConsumer<T> p_218560_1_) {
      return !field_218578_f.contains(p_218560_0_.asItem()) ? p_218560_1_.acceptCondition(SurvivesExplosion.builder()) : p_218560_1_.cast();
   }

   protected static LootTable.Builder func_218546_a(IItemProvider p_218546_0_) {
      return LootTable.builder().addLootPool((LootPool.Builder)func_218560_a(p_218546_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218546_0_))));
   }
   ...
   protected static LootTable.Builder func_218515_b(Block p_218515_0_, IItemProvider p_218515_1_) {
      return func_218519_a(p_218515_0_, (LootEntry.Builder)func_218560_a(p_218515_0_, ItemLootEntry.builder(p_218515_1_)));
   }

   protected static LootTable.Builder func_218463_a(IItemProvider p_218463_0_, IRandomRange p_218463_1_) {
      return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry((LootEntry.Builder)func_218552_a(p_218463_0_, ItemLootEntry.builder(p_218463_0_).acceptFunction(SetCount.func_215932_a(p_218463_1_)))));
   }

   protected static LootTable.Builder func_218530_a(Block p_218530_0_, IItemProvider p_218530_1_, IRandomRange p_218530_2_) {
      return func_218519_a(p_218530_0_, (LootEntry.Builder)func_218552_a(p_218530_0_, ItemLootEntry.builder(p_218530_1_).acceptFunction(SetCount.func_215932_a(p_218530_2_))));
   }
   ...
   protected static LootTable.Builder func_218523_c(IItemProvider p_218523_0_) {
      return LootTable.builder().addLootPool((LootPool.Builder)func_218560_a(Blocks.FLOWER_POT, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(Blocks.FLOWER_POT)))).addLootPool((LootPool.Builder)func_218560_a(p_218523_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218523_0_))));
   }

   protected static LootTable.Builder func_218513_d(Block p_218513_0_) {
      return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry((LootEntry.Builder)func_218552_a(p_218513_0_, ItemLootEntry.builder(p_218513_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.of(2)).acceptCondition(BlockStateProperty.builder(p_218513_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227193_a_(SlabBlock.TYPE, SlabType.DOUBLE)))))));
   }
   ...
   protected static <T extends Comparable<T> & IStringSerializable> LootTable.Builder func_218562_a(Block p_218562_0_, IProperty<T> p_218562_1_, T p_218562_2_) {
      return LootTable.builder().addLootPool((LootPool.Builder)func_218560_a(p_218562_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218562_0_).acceptCondition(BlockStateProperty.builder(p_218562_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227193_a_(p_218562_1_, p_218562_2_))))));
   }

   protected static LootTable.Builder func_218481_e(Block p_218481_0_) {
      return LootTable.builder().addLootPool((LootPool.Builder)func_218560_a(p_218481_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218481_0_).acceptFunction(CopyName.func_215893_a(CopyName.Source.BLOCK_ENTITY)))));
   }

   protected static LootTable.Builder func_218544_f(Block p_218544_0_) {
      return LootTable.builder().addLootPool((LootPool.Builder)func_218560_a(p_218544_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218544_0_).acceptFunction(CopyName.func_215893_a(CopyName.Source.BLOCK_ENTITY)).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Lock", "BlockEntityTag.Lock").func_216056_a("LootTable", "BlockEntityTag.LootTable").func_216056_a("LootTableSeed", "BlockEntityTag.LootTableSeed")).acceptFunction(SetContents.func_215920_b().func_216075_a(DynamicLootEntry.func_216162_a(ShulkerBoxBlock.field_220169_b))))));
   }

   protected static LootTable.Builder func_218559_g(Block p_218559_0_) {
      return LootTable.builder().addLootPool((LootPool.Builder)func_218560_a(p_218559_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218559_0_).acceptFunction(CopyName.func_215893_a(CopyName.Source.BLOCK_ENTITY)).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Patterns", "BlockEntityTag.Patterns")))));
   }
   ...
   protected static LootTable.Builder func_218540_a(Block p_218540_0_, Block p_218540_1_, float... p_218540_2_) {
      return func_218535_c(p_218540_0_, ((StandaloneLootEntry.Builder)func_218560_a(p_218540_0_, ItemLootEntry.builder(p_218540_1_))).acceptCondition(TableBonus.builder(Enchantments.FORTUNE, p_218540_2_))).addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).acceptCondition(field_218577_e).addEntry(((StandaloneLootEntry.Builder)func_218552_a(p_218540_0_, ItemLootEntry.builder(Items.STICK).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(1.0F, 2.0F))))).acceptCondition(TableBonus.builder(Enchantments.FORTUNE, 0.02F, 0.022222223F, 0.025F, 0.033333335F, 0.1F))));
   }

   protected static LootTable.Builder func_218526_b(Block p_218526_0_, Block p_218526_1_, float... p_218526_2_) {
      return func_218540_a(p_218526_0_, p_218526_1_, p_218526_2_).addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).acceptCondition(field_218577_e).addEntry(((StandaloneLootEntry.Builder)func_218560_a(p_218526_0_, ItemLootEntry.builder(Items.APPLE))).acceptCondition(TableBonus.builder(Enchantments.FORTUNE, 0.005F, 0.0055555557F, 0.00625F, 0.008333334F, 0.025F))));
   }
   ...
   protected static LootTable.Builder func_218541_a(Block p_218541_0_, Item p_218541_1_, Item p_218541_2_, ILootCondition.IBuilder p_218541_3_) {
      return (LootTable.Builder)func_218552_a(p_218541_0_, LootTable.builder().addLootPool(LootPool.builder().addEntry(((StandaloneLootEntry.Builder)ItemLootEntry.builder(p_218541_1_).acceptCondition(p_218541_3_)).func_216080_a(ItemLootEntry.builder(p_218541_2_)))).addLootPool(LootPool.builder().acceptCondition(p_218541_3_).addEntry(ItemLootEntry.builder(p_218541_2_).acceptFunction(ApplyBonus.func_215870_a(Enchantments.FORTUNE, 0.5714286F, 3)))));
   }
   ...
   protected void addTables() {
      ...
      this.registerLootTable(Blocks.STONE, (p_lambda$addTables$0_0_) -> {
         return func_218515_b(p_lambda$addTables$0_0_, Blocks.COBBLESTONE);
      });
      this.registerLootTable(Blocks.GRASS_BLOCK, (p_lambda$addTables$1_0_) -> {
         return func_218515_b(p_lambda$addTables$1_0_, Blocks.DIRT);
      });
      this.registerLootTable(Blocks.PODZOL, (p_lambda$addTables$2_0_) -> {
         return func_218515_b(p_lambda$addTables$2_0_, Blocks.DIRT);
      });
      this.registerLootTable(Blocks.MYCELIUM, (p_lambda$addTables$3_0_) -> {
         return func_218515_b(p_lambda$addTables$3_0_, Blocks.DIRT);
      });
      this.registerLootTable(Blocks.TUBE_CORAL_BLOCK, (p_lambda$addTables$4_0_) -> {
         return func_218515_b(p_lambda$addTables$4_0_, Blocks.DEAD_TUBE_CORAL_BLOCK);
      });
      this.registerLootTable(Blocks.BRAIN_CORAL_BLOCK, (p_lambda$addTables$5_0_) -> {
         return func_218515_b(p_lambda$addTables$5_0_, Blocks.DEAD_BRAIN_CORAL_BLOCK);
      });
      this.registerLootTable(Blocks.BUBBLE_CORAL_BLOCK, (p_lambda$addTables$6_0_) -> {
         return func_218515_b(p_lambda$addTables$6_0_, Blocks.DEAD_BUBBLE_CORAL_BLOCK);
      });
      this.registerLootTable(Blocks.FIRE_CORAL_BLOCK, (p_lambda$addTables$7_0_) -> {
         return func_218515_b(p_lambda$addTables$7_0_, Blocks.DEAD_FIRE_CORAL_BLOCK);
      });
      this.registerLootTable(Blocks.HORN_CORAL_BLOCK, (p_lambda$addTables$8_0_) -> {
         return func_218515_b(p_lambda$addTables$8_0_, Blocks.DEAD_HORN_CORAL_BLOCK);
      });
      this.registerLootTable(Blocks.BOOKSHELF, (p_lambda$addTables$9_0_) -> {
         return func_218530_a(p_lambda$addTables$9_0_, Items.BOOK, ConstantRange.of(3));
      });
      this.registerLootTable(Blocks.CLAY, (p_lambda$addTables$10_0_) -> {
         return func_218530_a(p_lambda$addTables$10_0_, Items.CLAY_BALL, ConstantRange.of(4));
      });
      this.registerLootTable(Blocks.ENDER_CHEST, (p_lambda$addTables$11_0_) -> {
         return func_218530_a(p_lambda$addTables$11_0_, Blocks.OBSIDIAN, ConstantRange.of(8));
      });
      this.registerLootTable(Blocks.SNOW_BLOCK, (p_lambda$addTables$12_0_) -> {
         return func_218530_a(p_lambda$addTables$12_0_, Items.SNOWBALL, ConstantRange.of(4));
      });
      ...
      this.registerLootTable(Blocks.ACACIA_DOOR, (p_lambda$addTables$13_0_) -> {
         return func_218562_a(p_lambda$addTables$13_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerLootTable(Blocks.BIRCH_DOOR, (p_lambda$addTables$14_0_) -> {
         return func_218562_a(p_lambda$addTables$14_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerLootTable(Blocks.DARK_OAK_DOOR, (p_lambda$addTables$15_0_) -> {
         return func_218562_a(p_lambda$addTables$15_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerLootTable(Blocks.IRON_DOOR, (p_lambda$addTables$16_0_) -> {
         return func_218562_a(p_lambda$addTables$16_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerLootTable(Blocks.JUNGLE_DOOR, (p_lambda$addTables$17_0_) -> {
         return func_218562_a(p_lambda$addTables$17_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerLootTable(Blocks.OAK_DOOR, (p_lambda$addTables$18_0_) -> {
         return func_218562_a(p_lambda$addTables$18_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerLootTable(Blocks.SPRUCE_DOOR, (p_lambda$addTables$19_0_) -> {
         return func_218562_a(p_lambda$addTables$19_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerLootTable(Blocks.BLACK_BED, (p_lambda$addTables$20_0_) -> {
         return func_218562_a(p_lambda$addTables$20_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.BLUE_BED, (p_lambda$addTables$21_0_) -> {
         return func_218562_a(p_lambda$addTables$21_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.BROWN_BED, (p_lambda$addTables$22_0_) -> {
         return func_218562_a(p_lambda$addTables$22_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.CYAN_BED, (p_lambda$addTables$23_0_) -> {
         return func_218562_a(p_lambda$addTables$23_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.GRAY_BED, (p_lambda$addTables$24_0_) -> {
         return func_218562_a(p_lambda$addTables$24_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.GREEN_BED, (p_lambda$addTables$25_0_) -> {
         return func_218562_a(p_lambda$addTables$25_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.LIGHT_BLUE_BED, (p_lambda$addTables$26_0_) -> {
         return func_218562_a(p_lambda$addTables$26_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.LIGHT_GRAY_BED, (p_lambda$addTables$27_0_) -> {
         return func_218562_a(p_lambda$addTables$27_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.LIME_BED, (p_lambda$addTables$28_0_) -> {
         return func_218562_a(p_lambda$addTables$28_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.MAGENTA_BED, (p_lambda$addTables$29_0_) -> {
         return func_218562_a(p_lambda$addTables$29_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.PURPLE_BED, (p_lambda$addTables$30_0_) -> {
         return func_218562_a(p_lambda$addTables$30_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.ORANGE_BED, (p_lambda$addTables$31_0_) -> {
         return func_218562_a(p_lambda$addTables$31_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.PINK_BED, (p_lambda$addTables$32_0_) -> {
         return func_218562_a(p_lambda$addTables$32_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.RED_BED, (p_lambda$addTables$33_0_) -> {
         return func_218562_a(p_lambda$addTables$33_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.WHITE_BED, (p_lambda$addTables$34_0_) -> {
         return func_218562_a(p_lambda$addTables$34_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.YELLOW_BED, (p_lambda$addTables$35_0_) -> {
         return func_218562_a(p_lambda$addTables$35_0_, BedBlock.PART, BedPart.HEAD);
      });
      this.registerLootTable(Blocks.LILAC, (p_lambda$addTables$36_0_) -> {
         return func_218562_a(p_lambda$addTables$36_0_, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerLootTable(Blocks.SUNFLOWER, (p_lambda$addTables$37_0_) -> {
         return func_218562_a(p_lambda$addTables$37_0_, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerLootTable(Blocks.PEONY, (p_lambda$addTables$38_0_) -> {
         return func_218562_a(p_lambda$addTables$38_0_, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerLootTable(Blocks.ROSE_BUSH, (p_lambda$addTables$39_0_) -> {
         return func_218562_a(p_lambda$addTables$39_0_, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER);
      });
      this.registerLootTable(Blocks.TNT, LootTable.builder().addLootPool((LootPool.Builder)func_218560_a(Blocks.TNT, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(Blocks.TNT).acceptCondition(BlockStateProperty.builder(Blocks.TNT).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227195_a_(TNTBlock.UNSTABLE, false)))))));
      this.registerLootTable(Blocks.COCOA, (p_lambda$addTables$40_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry((LootEntry.Builder)func_218552_a(p_lambda$addTables$40_0_, ItemLootEntry.builder(Items.COCOA_BEANS).acceptFunction(SetCount.func_215932_a(ConstantRange.of(3)).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$40_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(CocoaBlock.AGE, 2)))))));
      });
      this.registerLootTable(Blocks.SEA_PICKLE, (p_lambda$addTables$41_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry((LootEntry.Builder)func_218552_a(Blocks.SEA_PICKLE, ItemLootEntry.builder(p_lambda$addTables$41_0_).acceptFunction(SetCount.func_215932_a(ConstantRange.of(2)).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$41_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SeaPickleBlock.PICKLES, 2)))).acceptFunction(SetCount.func_215932_a(ConstantRange.of(3)).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$41_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SeaPickleBlock.PICKLES, 3)))).acceptFunction(SetCount.func_215932_a(ConstantRange.of(4)).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$41_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SeaPickleBlock.PICKLES, 4)))))));
      });
      this.registerLootTable(Blocks.COMPOSTER, (p_lambda$addTables$42_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().addEntry((LootEntry.Builder)func_218552_a(p_lambda$addTables$42_0_, ItemLootEntry.builder(Items.COMPOSTER)))).addLootPool(LootPool.builder().addEntry(ItemLootEntry.builder(Items.BONE_MEAL)).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$42_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(ComposterBlock.field_220298_a, 8))));
      });
      ...
      this.registerLootTable(Blocks.PLAYER_HEAD, (p_lambda$addTables$43_0_) -> {
         return LootTable.builder().addLootPool((LootPool.Builder)func_218560_a(p_lambda$addTables$43_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_lambda$addTables$43_0_).acceptFunction(CopyNbt.func_215881_a(CopyNbt.Source.BLOCK_ENTITY).func_216056_a("Owner", "SkullOwner")))));
      });
      ...
      this.registerLootTable(Blocks.BIRCH_LEAVES, (p_lambda$addTables$44_0_) -> {
         return func_218540_a(p_lambda$addTables$44_0_, Blocks.BIRCH_SAPLING, field_218579_g);
      });
      this.registerLootTable(Blocks.ACACIA_LEAVES, (p_lambda$addTables$45_0_) -> {
         return func_218540_a(p_lambda$addTables$45_0_, Blocks.ACACIA_SAPLING, field_218579_g);
      });
      this.registerLootTable(Blocks.JUNGLE_LEAVES, (p_lambda$addTables$46_0_) -> {
         return func_218540_a(p_lambda$addTables$46_0_, Blocks.JUNGLE_SAPLING, field_218580_h);
      });
      this.registerLootTable(Blocks.SPRUCE_LEAVES, (p_lambda$addTables$47_0_) -> {
         return func_218540_a(p_lambda$addTables$47_0_, Blocks.SPRUCE_SAPLING, field_218579_g);
      });
      this.registerLootTable(Blocks.OAK_LEAVES, (p_lambda$addTables$48_0_) -> {
         return func_218526_b(p_lambda$addTables$48_0_, Blocks.OAK_SAPLING, field_218579_g);
      });
      this.registerLootTable(Blocks.DARK_OAK_LEAVES, (p_lambda$addTables$49_0_) -> {
         return func_218526_b(p_lambda$addTables$49_0_, Blocks.DARK_OAK_SAPLING, field_218579_g);
      });
      ...
      this.registerLootTable(Blocks.CARROTS, (LootTable.Builder)func_218552_a(Blocks.CARROTS, LootTable.builder().addLootPool(LootPool.builder().addEntry(ItemLootEntry.builder(Items.CARROT))).addLootPool(LootPool.builder().acceptCondition(ilootcondition$ibuilder2).addEntry(ItemLootEntry.builder(Items.CARROT).acceptFunction(ApplyBonus.func_215870_a(Enchantments.FORTUNE, 0.5714286F, 3))))));
      ...
      this.registerLootTable(Blocks.POTATOES, (LootTable.Builder)func_218552_a(Blocks.POTATOES, LootTable.builder().addLootPool(LootPool.builder().addEntry(ItemLootEntry.builder(Items.POTATO))).addLootPool(LootPool.builder().acceptCondition(ilootcondition$ibuilder3).addEntry(ItemLootEntry.builder(Items.POTATO).acceptFunction(ApplyBonus.func_215870_a(Enchantments.FORTUNE, 0.5714286F, 3)))).addLootPool(LootPool.builder().acceptCondition(ilootcondition$ibuilder3).addEntry(ItemLootEntry.builder(Items.POISONOUS_POTATO).acceptCondition(RandomChance.builder(0.02F))))));
      this.registerLootTable(Blocks.SWEET_BERRY_BUSH, (p_lambda$addTables$50_0_) -> {
         return (LootTable.Builder)func_218552_a(p_lambda$addTables$50_0_, LootTable.builder().addLootPool(LootPool.builder().acceptCondition(BlockStateProperty.builder(Blocks.SWEET_BERRY_BUSH).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SweetBerryBushBlock.AGE, 3))).addEntry(ItemLootEntry.builder(Items.SWEET_BERRIES)).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(2.0F, 3.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE))).addLootPool(LootPool.builder().acceptCondition(BlockStateProperty.builder(Blocks.SWEET_BERRY_BUSH).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SweetBerryBushBlock.AGE, 2))).addEntry(ItemLootEntry.builder(Items.SWEET_BERRIES)).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(1.0F, 2.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE))));
      });
      this.registerLootTable(Blocks.BROWN_MUSHROOM_BLOCK, (p_lambda$addTables$51_0_) -> {
         return func_218491_c(p_lambda$addTables$51_0_, Blocks.BROWN_MUSHROOM);
      });
      this.registerLootTable(Blocks.RED_MUSHROOM_BLOCK, (p_lambda$addTables$52_0_) -> {
         return func_218491_c(p_lambda$addTables$52_0_, Blocks.RED_MUSHROOM);
      });
      this.registerLootTable(Blocks.COAL_ORE, (p_lambda$addTables$53_0_) -> {
         return func_218476_a(p_lambda$addTables$53_0_, Items.COAL);
      });
      this.registerLootTable(Blocks.EMERALD_ORE, (p_lambda$addTables$54_0_) -> {
         return func_218476_a(p_lambda$addTables$54_0_, Items.EMERALD);
      });
      this.registerLootTable(Blocks.NETHER_QUARTZ_ORE, (p_lambda$addTables$55_0_) -> {
         return func_218476_a(p_lambda$addTables$55_0_, Items.QUARTZ);
      });
      this.registerLootTable(Blocks.DIAMOND_ORE, (p_lambda$addTables$56_0_) -> {
         return func_218476_a(p_lambda$addTables$56_0_, Items.DIAMOND);
      });
      this.registerLootTable(Blocks.LAPIS_ORE, (p_lambda$addTables$57_0_) -> {
         return func_218519_a(p_lambda$addTables$57_0_, (LootEntry.Builder)func_218552_a(p_lambda$addTables$57_0_, ItemLootEntry.builder(Items.LAPIS_LAZULI).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(4.0F, 9.0F))).acceptFunction(ApplyBonus.func_215869_a(Enchantments.FORTUNE))));
      });
      this.registerLootTable(Blocks.COBWEB, (p_lambda$addTables$58_0_) -> {
         return func_218535_c(p_lambda$addTables$58_0_, (LootEntry.Builder)func_218560_a(p_lambda$addTables$58_0_, ItemLootEntry.builder(Items.STRING)));
      });
      this.registerLootTable(Blocks.DEAD_BUSH, (p_lambda$addTables$59_0_) -> {
         return func_218511_b(p_lambda$addTables$59_0_, (LootEntry.Builder)func_218552_a(p_lambda$addTables$59_0_, ItemLootEntry.builder(Items.STICK).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(0.0F, 2.0F)))));
      });
      ...
      this.registerLootTable(Blocks.LARGE_FERN, (p_lambda$addTables$60_0_) -> {
         return func_218511_b(Blocks.FERN, ((StandaloneLootEntry.Builder)((StandaloneLootEntry.Builder)func_218560_a(p_lambda$addTables$60_0_, ItemLootEntry.builder(Items.WHEAT_SEEDS))).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$60_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227193_a_(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER)))).acceptCondition(RandomChance.builder(0.125F)));
      });
      this.registerLootTable(Blocks.TALL_GRASS, func_218511_b(Blocks.GRASS, ((StandaloneLootEntry.Builder)((StandaloneLootEntry.Builder)func_218560_a(Blocks.TALL_GRASS, ItemLootEntry.builder(Items.WHEAT_SEEDS))).acceptCondition(BlockStateProperty.builder(Blocks.TALL_GRASS).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227193_a_(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER)))).acceptCondition(RandomChance.builder(0.125F))));
      this.registerLootTable(Blocks.MELON_STEM, (p_lambda$addTables$61_0_) -> {
         return func_218475_b(p_lambda$addTables$61_0_, Items.MELON_SEEDS);
      });
      this.registerLootTable(Blocks.ATTACHED_MELON_STEM, (p_lambda$addTables$62_0_) -> {
         return func_229435_c_(p_lambda$addTables$62_0_, Items.MELON_SEEDS);
      });
      this.registerLootTable(Blocks.PUMPKIN_STEM, (p_lambda$addTables$63_0_) -> {
         return func_218475_b(p_lambda$addTables$63_0_, Items.PUMPKIN_SEEDS);
      });
      this.registerLootTable(Blocks.ATTACHED_PUMPKIN_STEM, (p_lambda$addTables$64_0_) -> {
         return func_229435_c_(p_lambda$addTables$64_0_, Items.PUMPKIN_SEEDS);
      });
      this.registerLootTable(Blocks.CHORUS_FLOWER, (p_lambda$addTables$65_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(((StandaloneLootEntry.Builder)func_218560_a(p_lambda$addTables$65_0_, ItemLootEntry.builder(p_lambda$addTables$65_0_))).acceptCondition(EntityHasProperty.func_215998_a(LootContext.EntityTarget.THIS))));
      });
      ...
      this.registerLootTable(Blocks.GLOWSTONE, (p_lambda$addTables$66_0_) -> {
         return func_218519_a(p_lambda$addTables$66_0_, (LootEntry.Builder)func_218552_a(p_lambda$addTables$66_0_, ItemLootEntry.builder(Items.GLOWSTONE_DUST).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(2.0F, 4.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE)).acceptFunction(LimitCount.func_215911_a(IntClamper.func_215843_a(1, 4)))));
      });
      this.registerLootTable(Blocks.MELON, (p_lambda$addTables$67_0_) -> {
         return func_218519_a(p_lambda$addTables$67_0_, (LootEntry.Builder)func_218552_a(p_lambda$addTables$67_0_, ItemLootEntry.builder(Items.MELON_SLICE).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(3.0F, 7.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE)).acceptFunction(LimitCount.func_215911_a(IntClamper.func_215851_b(9)))));
      });
      this.registerLootTable(Blocks.REDSTONE_ORE, (p_lambda$addTables$68_0_) -> {
         return func_218519_a(p_lambda$addTables$68_0_, (LootEntry.Builder)func_218552_a(p_lambda$addTables$68_0_, ItemLootEntry.builder(Items.REDSTONE).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(4.0F, 5.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE))));
      });
      this.registerLootTable(Blocks.SEA_LANTERN, (p_lambda$addTables$69_0_) -> {
         return func_218519_a(p_lambda$addTables$69_0_, (LootEntry.Builder)func_218552_a(p_lambda$addTables$69_0_, ItemLootEntry.builder(Items.PRISMARINE_CRYSTALS).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(2.0F, 3.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE)).acceptFunction(LimitCount.func_215911_a(IntClamper.func_215843_a(1, 5)))));
      });
      this.registerLootTable(Blocks.NETHER_WART, (p_lambda$addTables$70_0_) -> {
         return LootTable.builder().addLootPool((LootPool.Builder)func_218552_a(p_lambda$addTables$70_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(Items.NETHER_WART).acceptFunction(SetCount.func_215932_a(RandomValueRange.func_215837_a(2.0F, 4.0F)).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$70_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(NetherWartBlock.AGE, 3)))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$70_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(NetherWartBlock.AGE, 3)))))));
      });
      this.registerLootTable(Blocks.SNOW, (p_lambda$addTables$71_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().acceptCondition(EntityHasProperty.func_215998_a(LootContext.EntityTarget.THIS)).addEntry(AlternativesLootEntry.func_216149_a(AlternativesLootEntry.func_216149_a(ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 1))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 2)))).acceptFunction(SetCount.func_215932_a(ConstantRange.of(2))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 3)))).acceptFunction(SetCount.func_215932_a(ConstantRange.of(3))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 4)))).acceptFunction(SetCount.func_215932_a(ConstantRange.of(4))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 5)))).acceptFunction(SetCount.func_215932_a(ConstantRange.of(5))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 6)))).acceptFunction(SetCount.func_215932_a(ConstantRange.of(6))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 7)))).acceptFunction(SetCount.func_215932_a(ConstantRange.of(7))), ItemLootEntry.builder(Items.SNOWBALL).acceptFunction(SetCount.func_215932_a(ConstantRange.of(8)))).acceptCondition(field_218574_b), AlternativesLootEntry.func_216149_a(ItemLootEntry.builder(Blocks.SNOW).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 1))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.func_215932_a(ConstantRange.of(2))).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 2))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.func_215932_a(ConstantRange.of(3))).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 3))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.func_215932_a(ConstantRange.of(4))).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 4))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.func_215932_a(ConstantRange.of(5))).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 5))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.func_215932_a(ConstantRange.of(6))).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 6))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.func_215932_a(ConstantRange.of(7))).acceptCondition(BlockStateProperty.builder(p_lambda$addTables$71_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 7))), ItemLootEntry.builder(Blocks.SNOW_BLOCK)))));
      });
      this.registerLootTable(Blocks.GRAVEL, (p_lambda$addTables$72_0_) -> {
         return func_218519_a(p_lambda$addTables$72_0_, (LootEntry.Builder)func_218560_a(p_lambda$addTables$72_0_, ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.FLINT).acceptCondition(TableBonus.builder(Enchantments.FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F))).func_216080_a(ItemLootEntry.builder(p_lambda$addTables$72_0_))));
      });
      this.registerLootTable(Blocks.CAMPFIRE, (p_lambda$addTables$73_0_) -> {
         return func_218519_a(p_lambda$addTables$73_0_, (LootEntry.Builder)func_218560_a(p_lambda$addTables$73_0_, ItemLootEntry.builder(Items.CHARCOAL).acceptFunction(SetCount.func_215932_a(ConstantRange.of(2)))));
      });
   ...
   public void accept(BiConsumer<ResourceLocation, LootTable.Builder> p_accept_1_) {
      ...
      Iterator var3 = this.getKnownBlocks().iterator();

      while(var3.hasNext()) {
         Block block = (Block)var3.next();
         ResourceLocation resourcelocation = block.getLootTable();
         if (resourcelocation != LootTables.EMPTY && set.add(resourcelocation)) {
            LootTable.Builder loottable$builder = (LootTable.Builder)this.field_218581_i.remove(resourcelocation);
   ...
   public void func_218547_a(Block p_218547_1_) {
      this.registerLootTable(p_218547_1_, (p_lambda$func_218547_a$74_0_) -> {
         return func_218523_c(((FlowerPotBlock)p_lambda$func_218547_a$74_0_).func_220276_d());
      });
   }
   ...
   protected void registerLootTable(Block p_218522_1_, Function<Block, LootTable.Builder> p_218522_2_) {
      this.registerLootTable(p_218522_1_, (LootTable.Builder)p_218522_2_.apply(p_218522_1_));
   }
   ...
   static {
      field_218573_a = MatchTool.builder(ItemPredicate.Builder.create().enchantment(new EnchantmentPredicate(Enchantments.SILK_TOUCH, MinMaxBounds.IntBound.atLeast(1))));
      field_218574_b = field_218573_a.inverted();
      field_218575_c = MatchTool.builder(ItemPredicate.Builder.create().item(Items.SHEARS));
      field_218576_d = field_218575_c.alternative(field_218573_a);
      field_218577_e = field_218576_d.inverted();
      field_218578_f = (Set)Stream.of(Blocks.DRAGON_EGG, Blocks.BEACON, Blocks.CONDUIT, Blocks.SKELETON_SKULL, Blocks.WITHER_SKELETON_SKULL, Blocks.PLAYER_HEAD, Blocks.ZOMBIE_HEAD, Blocks.CREEPER_HEAD, Blocks.DRAGON_HEAD, Blocks.SHULKER_BOX, Blocks.BLACK_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX, Blocks.GRAY_SHULKER_BOX, Blocks.GREEN_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX, Blocks.LIGHT_GRAY_SHULKER_BOX, Blocks.LIME_SHULKER_BOX, Blocks.MAGENTA_SHULKER_BOX, Blocks.ORANGE_SHULKER_BOX, Blocks.PINK_SHULKER_BOX, Blocks.PURPLE_SHULKER_BOX, Blocks.RED_SHULKER_BOX, Blocks.WHITE_SHULKER_BOX, Blocks.YELLOW_SHULKER_BOX).map(IItemProvider::asItem).collect(ImmutableSet.toImmutableSet());
      field_218579_g = new float[]{0.05F, 0.0625F, 0.083333336F, 0.1F};
      field_218580_h = new float[]{0.025F, 0.027777778F, 0.03125F, 0.041666668F, 0.1F};
   }
}
