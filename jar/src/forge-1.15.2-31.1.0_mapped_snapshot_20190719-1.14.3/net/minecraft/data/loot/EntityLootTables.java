...
public class EntityLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   private static final Set<EntityType<?>> field_222944_b;
   ...
   public void accept(BiConsumer<ResourceLocation, LootTable.Builder> p_accept_1_) {
      ...
      Iterator iterator = this.getKnownEntities().iterator();
      ...
      while(iterator.hasNext()) {
         ...
         if (this.isNonLiving(entitytype)) {
            ...
            LootTable.Builder loottable$builder = (LootTable.Builder)this.field_218587_b.remove(resourcelocation);
   ...
   protected boolean isNonLiving(EntityType<?> p_isNonLiving_1_) {
      return !field_222944_b.contains(p_isNonLiving_1_) && p_isNonLiving_1_.getClassification() == EntityClassification.MISC;
   }
   ...
   static {
      field_222944_b = ImmutableSet.of(EntityType.PLAYER, EntityType.ARMOR_STAND, EntityType.IRON_GOLEM, EntityType.SNOW_GOLEM, EntityType.VILLAGER);
   }
}
