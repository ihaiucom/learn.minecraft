...
public class StructureUpdater implements SNBTToNBTConverter.ITransformer {
   ...
   private static CompoundNBT func_225373_b(CompoundNBT p_225373_0_) {
      Template lvt_1_1_ = new Template();
      lvt_1_1_.read(NBTUtil.update(DataFixesManager.getDataFixer(), DefaultTypeReferences.STRUCTURE, p_225373_0_, p_225373_0_.getInt("DataVersion")));
      return lvt_1_1_.writeToNBT(new CompoundNBT());
   }
}
