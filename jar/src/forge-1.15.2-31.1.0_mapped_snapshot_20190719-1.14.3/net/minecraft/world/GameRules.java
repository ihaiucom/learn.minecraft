...
public class GameRules {
   ...
   public static final GameRules.RuleKey<GameRules.BooleanValue> REDUCED_DEBUG_INFO = register("reducedDebugInfo", GameRules.BooleanValue.create(false, (p_223589_0_, p_223589_1_) -> {
      byte lvt_2_1_ = p_223589_1_.get() ? 22 : 23;
      Iterator var3 = p_223589_0_.getPlayerList().getPlayers().iterator();

      while(var3.hasNext()) {
         ServerPlayerEntity lvt_4_1_ = (ServerPlayerEntity)var3.next();
         lvt_4_1_.connection.sendPacket(new SEntityStatusPacket(lvt_4_1_, (byte)lvt_2_1_));
      }
   ...
   public static final GameRules.RuleKey<GameRules.BooleanValue> field_226683_z_ = register("doImmediateRespawn", GameRules.BooleanValue.create(false, (p_226686_0_, p_226686_1_) -> {
      Iterator var2 = p_226686_0_.getPlayerList().getPlayers().iterator();

      while(var2.hasNext()) {
         ServerPlayerEntity lvt_3_1_ = (ServerPlayerEntity)var2.next();
         lvt_3_1_.connection.sendPacket(new SChangeGameStatePacket(11, p_226686_1_.get() ? 1.0F : 0.0F));
      }
   ...
   public static <T extends GameRules.RuleValue<T>> GameRules.RuleKey<T> register(String p_223595_0_, GameRules.RuleType<T> p_223595_1_) {
      GameRules.RuleKey<T> lvt_2_1_ = new GameRules.RuleKey(p_223595_0_);
      GameRules.RuleType<?> lvt_3_1_ = (GameRules.RuleType)GAME_RULES.put(lvt_2_1_, p_223595_1_);
      if (lvt_3_1_ != null) {
   ...
   public GameRules() {
      this.rules = (Map)GAME_RULES.entrySet().stream().collect(ImmutableMap.toImmutableMap(Entry::getKey, (p_226684_0_) -> {
         return ((GameRules.RuleType)p_226684_0_.getValue()).func_223579_a();
      }));
   }

   public <T extends GameRules.RuleValue<T>> T get(GameRules.RuleKey<T> p_223585_1_) {
      return (GameRules.RuleValue)this.rules.get(p_223585_1_);
   }

   public CompoundNBT write() {
      CompoundNBT lvt_1_1_ = new CompoundNBT();
      this.rules.forEach((p_226688_1_, p_226688_2_) -> {
         lvt_1_1_.putString(p_226688_1_.field_223578_a, p_226688_2_.func_223552_b());
      });
      return lvt_1_1_;
   }

   public void read(CompoundNBT p_82768_1_) {
      this.rules.forEach((p_226685_1_, p_226685_2_) -> {
         if (p_82768_1_.contains(p_226685_1_.field_223578_a)) {
            p_226685_2_.func_223553_a(p_82768_1_.getString(p_226685_1_.field_223578_a));
         }
   ...
   private static <T extends GameRules.RuleValue<T>> void func_223596_a(GameRules.IRuleEntryVisitor p_223596_0_, GameRules.RuleKey<?> p_223596_1_, GameRules.RuleType<?> p_223596_2_) {
      p_223596_0_.func_223481_a(p_223596_1_, p_223596_2_);
   }

   public boolean getBoolean(GameRules.RuleKey<GameRules.BooleanValue> p_223586_1_) {
      return ((GameRules.BooleanValue)this.get(p_223586_1_)).get();
   }

   public int getInt(GameRules.RuleKey<GameRules.IntegerValue> p_223592_1_) {
      return ((GameRules.IntegerValue)this.get(p_223592_1_)).get();
   }
   ...
   public static class BooleanValue extends GameRules.RuleValue<GameRules.BooleanValue> {
      ...
      // $FF: synthetic method
      protected GameRules.RuleValue func_223213_e_() {
      ...
      private static int func_223563_b(String p_223563_0_) {
         if (!p_223563_0_.isEmpty()) {
            try {
               ...
               GameRules.LOGGER.warn("Failed to parse integer {}", p_223563_0_);
            }
         }
   ...
   public abstract static class RuleValue<T extends GameRules.RuleValue<T>> {
      ...
      public void func_223554_b(CommandContext<CommandSource> p_223554_1_, String p_223554_2_) {
         ...
         this.func_223556_a(((CommandSource)p_223554_1_.getSource()).getServer());
      }
   ...
   public static class RuleType<T extends GameRules.RuleValue<T>> {
      ...
      public RequiredArgumentBuilder<CommandSource, ?> func_223581_a(String p_223581_1_) {
         return Commands.argument(p_223581_1_, (ArgumentType)this.field_223582_a.get());
      }

      public T func_223579_a() {
         return (GameRules.RuleValue)this.field_223583_b.apply(this);
      }

      // $FF: synthetic method
      RuleType(Supplier p_i51532_1_, Function p_i51532_2_, BiConsumer p_i51532_3_, Object p_i51532_4_) {
         this(p_i51532_1_, p_i51532_2_, p_i51532_3_);
      }
   }
   ...
   public interface IRuleEntryVisitor {
      <T extends GameRules.RuleValue<T>> void func_223481_a(GameRules.RuleKey<T> var1, GameRules.RuleType<T> var2);
   }
}
