...
public class ServerWorldLightManager extends WorldLightManager implements AutoCloseable {
   ...
   protected void updateChunkStatus(ChunkPos p_215581_1_) {
      this.func_215600_a(p_215581_1_.x, p_215581_1_.z, () -> {
         ...
         int lvt_2_2_;
         for(lvt_2_2_ = -1; lvt_2_2_ < 17; ++lvt_2_2_) {
            super.setData(LightType.BLOCK, SectionPos.from(p_215581_1_, lvt_2_2_), (NibbleArray)null);
            super.setData(LightType.SKY, SectionPos.from(p_215581_1_, lvt_2_2_), (NibbleArray)null);
         }

         for(lvt_2_2_ = 0; lvt_2_2_ < 16; ++lvt_2_2_) {
            super.updateSectionStatus(SectionPos.from(p_215581_1_, lvt_2_2_), true);
         }
   ...
   public void setData(LightType p_215574_1_, SectionPos p_215574_2_, @Nullable NibbleArray p_215574_3_) {
      this.func_215600_a(p_215574_2_.getSectionX(), p_215574_2_.getSectionZ(), () -> {
         return 0;
      }, ServerWorldLightManager.Phase.PRE_UPDATE, Util.namedRunnable(() -> {
         super.setData(p_215574_1_, p_215574_2_, p_215574_3_);
      }, () -> {
   ...
   public CompletableFuture<IChunk> lightChunk(IChunk p_215593_1_, boolean p_215593_2_) {
      ChunkPos lvt_3_1_ = p_215593_1_.getPos();
      p_215593_1_.setLight(false);
      this.func_215586_a(lvt_3_1_.x, lvt_3_1_.z, ServerWorldLightManager.Phase.PRE_UPDATE, Util.namedRunnable(() -> {
         ChunkSection[] lvt_4_1_ = p_215593_1_.getSections();

         for(int lvt_5_1_ = 0; lvt_5_1_ < 16; ++lvt_5_1_) {
            ChunkSection lvt_6_1_ = lvt_4_1_[lvt_5_1_];
            if (!ChunkSection.isEmpty(lvt_6_1_)) {
               super.updateSectionStatus(SectionPos.from(lvt_3_1_, lvt_5_1_), false);
            }
         }

         super.func_215571_a(lvt_3_1_, true);
         if (!p_215593_2_) {
         ...
         this.field_215607_d.func_219209_c(lvt_3_1_);
      }, () -> {
         return "lightChunk " + lvt_3_1_ + " " + p_215593_2_;
      }));
      return CompletableFuture.supplyAsync(() -> {
         p_215593_1_.setLight(true);
         super.retainData(lvt_3_1_, false);
         return p_215593_1_;
      }, (p_215597_2_) -> {
         this.func_215586_a(lvt_3_1_.x, lvt_3_1_.z, ServerWorldLightManager.Phase.POST_UPDATE, p_215597_2_);
      });
   }
   ...
   private void func_215603_b() {
      int lvt_1_1_ = Math.min(this.field_215606_c.size(), this.field_215609_f);
      ObjectListIterator<Pair<ServerWorldLightManager.Phase, Runnable>> lvt_2_1_ = this.field_215606_c.iterator();

      int lvt_3_1_;
      Pair lvt_4_2_;
      for(lvt_3_1_ = 0; lvt_2_1_.hasNext() && lvt_3_1_ < lvt_1_1_; ++lvt_3_1_) {
         lvt_4_2_ = (Pair)lvt_2_1_.next();
         if (lvt_4_2_.getFirst() == ServerWorldLightManager.Phase.PRE_UPDATE) {
            ((Runnable)lvt_4_2_.getSecond()).run();
         }
      }

      lvt_2_1_.back(lvt_3_1_);
      super.tick(Integer.MAX_VALUE, true, true);

      for(lvt_3_1_ = 0; lvt_2_1_.hasNext() && lvt_3_1_ < lvt_1_1_; ++lvt_3_1_) {
         lvt_4_2_ = (Pair)lvt_2_1_.next();
         if (lvt_4_2_.getFirst() == ServerWorldLightManager.Phase.POST_UPDATE) {
            ((Runnable)lvt_4_2_.getSecond()).run();
         }
