...
public abstract class Biomes {
   ...
   private static Biome register(int p_222369_0_, String p_222369_1_, Biome p_222369_2_) {
      Registry.register(Registry.BIOME, p_222369_0_, p_222369_1_, p_222369_2_);
   ...
   static {
      ...
      MOUNTAINS = register(3, "mountains", new MountainsBiome());
      ...
      MUSHROOM_FIELD_SHORE = register(15, "mushroom_field_shore", new MushroomFieldShoreBiome());
      ...
      WOODED_MOUNTAINS = register(34, "wooded_mountains", new WoodedMountainsBiome());
      ...
      WOODED_BADLANDS_PLATEAU = register(38, "wooded_badlands_plateau", new WoodedBadlandsPlateauBiome());
      ...
      FLOWER_FOREST = register(132, "flower_forest", new FlowerForestBiome());
      ...
      GIANT_SPRUCE_TAIGA_HILLS = register(161, "giant_spruce_taiga_hills", new GiantSpruceTaigaHillsBiome());
