...
public class ForestFlowerBlockStateProvider extends BlockStateProvider {
   private static final BlockState[] field_227401_b_;
   ...
   public BlockState func_225574_a_(Random p_225574_1_, BlockPos p_225574_2_) {
      double lvt_3_1_ = MathHelper.clamp((1.0D + Biome.INFO_NOISE.func_215464_a((double)p_225574_2_.getX() / 48.0D, (double)p_225574_2_.getZ() / 48.0D, false)) / 2.0D, 0.0D, 0.9999D);
      return field_227401_b_[(int)(lvt_3_1_ * (double)field_227401_b_.length)];
   }
