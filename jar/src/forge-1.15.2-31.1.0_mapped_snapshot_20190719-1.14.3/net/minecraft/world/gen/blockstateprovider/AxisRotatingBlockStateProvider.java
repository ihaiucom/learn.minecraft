...
public class AxisRotatingBlockStateProvider extends BlockStateProvider {
   ...
   public BlockState func_225574_a_(Random p_225574_1_, BlockPos p_225574_2_) {
      Direction.Axis lvt_3_1_ = Direction.Axis.random(p_225574_1_);
      return (BlockState)this.field_227404_b_.getDefaultState().with(RotatedPillarBlock.AXIS, lvt_3_1_);
   }

   public <T> T serialize(DynamicOps<T> p_218175_1_) {
      Builder<T, T> lvt_2_1_ = ImmutableMap.builder();
      lvt_2_1_.put(p_218175_1_.createString("type"), p_218175_1_.createString(Registry.field_229387_t_.getKey(this.field_227393_a_).toString())).put(p_218175_1_.createString("state"), BlockState.serialize(p_218175_1_, this.field_227404_b_.getDefaultState()).getValue());
