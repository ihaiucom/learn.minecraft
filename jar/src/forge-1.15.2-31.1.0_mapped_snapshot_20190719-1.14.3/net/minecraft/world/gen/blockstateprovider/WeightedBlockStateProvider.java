...
public class WeightedBlockStateProvider extends BlockStateProvider {
   ...
   public BlockState func_225574_a_(Random p_225574_1_, BlockPos p_225574_2_) {
      return (BlockState)this.field_227406_b_.func_226318_b_(p_225574_1_);
   }

   public <T> T serialize(DynamicOps<T> p_218175_1_) {
      Builder<T, T> lvt_2_1_ = ImmutableMap.builder();
      lvt_2_1_.put(p_218175_1_.createString("type"), p_218175_1_.createString(Registry.field_229387_t_.getKey(this.field_227393_a_).toString())).put(p_218175_1_.createString("entries"), this.field_227406_b_.func_226310_a_(p_218175_1_, (p_227408_1_) -> {
