...
public class SimpleBlockStateProvider extends BlockStateProvider {
   ...
   public <T> T serialize(DynamicOps<T> p_218175_1_) {
      ...
      lvt_2_1_.put(p_218175_1_.createString("type"), p_218175_1_.createString(Registry.field_229387_t_.getKey(this.field_227393_a_).toString())).put(p_218175_1_.createString("state"), BlockState.serialize(p_218175_1_, this.field_227405_b_).getValue());
