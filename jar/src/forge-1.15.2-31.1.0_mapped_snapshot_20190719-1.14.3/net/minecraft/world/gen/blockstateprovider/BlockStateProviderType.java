...
public class BlockStateProviderType<P extends BlockStateProvider> {
   ...
   private static <P extends BlockStateProvider> BlockStateProviderType<P> func_227400_a_(String p_227400_0_, Function<Dynamic<?>, P> p_227400_1_) {
      return (BlockStateProviderType)Registry.register((Registry)Registry.field_229387_t_, (String)p_227400_0_, (Object)(new BlockStateProviderType(p_227400_1_)));
   }
   ...
   public P func_227399_a_(Dynamic<?> p_227399_1_) {
      return (BlockStateProvider)this.field_227398_e_.apply(p_227399_1_);
   }
}
