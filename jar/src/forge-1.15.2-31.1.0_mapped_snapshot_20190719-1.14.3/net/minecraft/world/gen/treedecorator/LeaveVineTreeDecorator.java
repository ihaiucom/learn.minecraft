...
public class LeaveVineTreeDecorator extends TreeDecorator {
   ...
   public void func_225576_a_(IWorld p_225576_1_, Random p_225576_2_, List<BlockPos> p_225576_3_, List<BlockPos> p_225576_4_, Set<BlockPos> p_225576_5_, MutableBoundingBox p_225576_6_) {
      p_225576_4_.forEach((p_227421_5_) -> {
         ...
         if (p_225576_2_.nextInt(4) == 0) {
            lvt_6_4_ = p_227421_5_.west();
            if (AbstractTreeFeature.isAir(p_225576_1_, lvt_6_4_)) {
               this.func_227420_a_(p_225576_1_, lvt_6_4_, VineBlock.EAST, p_225576_5_, p_225576_6_);
            }
         }

         if (p_225576_2_.nextInt(4) == 0) {
            lvt_6_4_ = p_227421_5_.east();
            if (AbstractTreeFeature.isAir(p_225576_1_, lvt_6_4_)) {
               this.func_227420_a_(p_225576_1_, lvt_6_4_, VineBlock.WEST, p_225576_5_, p_225576_6_);
            }
         }

         if (p_225576_2_.nextInt(4) == 0) {
            lvt_6_4_ = p_227421_5_.north();
            if (AbstractTreeFeature.isAir(p_225576_1_, lvt_6_4_)) {
               this.func_227420_a_(p_225576_1_, lvt_6_4_, VineBlock.SOUTH, p_225576_5_, p_225576_6_);
            }
         }

         if (p_225576_2_.nextInt(4) == 0) {
            lvt_6_4_ = p_227421_5_.south();
            if (AbstractTreeFeature.isAir(p_225576_1_, lvt_6_4_)) {
               this.func_227420_a_(p_225576_1_, lvt_6_4_, VineBlock.NORTH, p_225576_5_, p_225576_6_);
            }
         }
   ...
   private void func_227420_a_(IWorldGenerationReader p_227420_1_, BlockPos p_227420_2_, BooleanProperty p_227420_3_, Set<BlockPos> p_227420_4_, MutableBoundingBox p_227420_5_) {
      ...
      for(p_227420_2_ = p_227420_2_.down(); AbstractTreeFeature.isAir(p_227420_1_, p_227420_2_) && lvt_6_1_ > 0; --lvt_6_1_) {
         this.func_227424_a_(p_227420_1_, p_227420_2_, p_227420_3_, p_227420_4_, p_227420_5_);
         p_227420_2_ = p_227420_2_.down();
      }
