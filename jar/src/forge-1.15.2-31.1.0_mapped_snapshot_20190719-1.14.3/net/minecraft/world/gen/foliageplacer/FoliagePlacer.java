...
public abstract class FoliagePlacer implements IDynamicSerializable {
   ...
   public abstract void func_225571_a_(IWorldGenerationReader var1, Random var2, TreeFeatureConfig var3, int var4, int var5, int var6, BlockPos var7, Set<BlockPos> var8);

   public abstract int func_225573_a_(Random var1, int var2, int var3, TreeFeatureConfig var4);

   protected abstract boolean func_225572_a_(Random var1, int var2, int var3, int var4, int var5, int var6);

   public abstract int func_225570_a_(int var1, int var2, int var3, int var4);
   ...
   protected void func_227384_a_(IWorldGenerationReader p_227384_1_, Random p_227384_2_, TreeFeatureConfig p_227384_3_, int p_227384_4_, BlockPos p_227384_5_, int p_227384_6_, int p_227384_7_, Set<BlockPos> p_227384_8_) {
      ...
      for(int lvt_10_1_ = -p_227384_7_; lvt_10_1_ <= p_227384_7_; ++lvt_10_1_) {
         for(int lvt_11_1_ = -p_227384_7_; lvt_11_1_ <= p_227384_7_; ++lvt_11_1_) {
            if (!this.func_225572_a_(p_227384_2_, p_227384_4_, lvt_10_1_, p_227384_6_, lvt_11_1_, p_227384_7_)) {
               lvt_9_1_.setPos(lvt_10_1_ + p_227384_5_.getX(), p_227384_6_ + p_227384_5_.getY(), lvt_11_1_ + p_227384_5_.getZ());
               this.func_227385_a_(p_227384_1_, p_227384_2_, lvt_9_1_, p_227384_3_, p_227384_8_);
            }
         }
      }
   ...
   public <T> T serialize(DynamicOps<T> p_218175_1_) {
      ...
      lvt_2_1_.put(p_218175_1_.createString("type"), p_218175_1_.createString(Registry.field_229389_v_.getKey(this.field_227383_c_).toString())).put(p_218175_1_.createString("radius"), p_218175_1_.createInt(this.field_227381_a_)).put(p_218175_1_.createString("radius_random"), p_218175_1_.createInt(this.field_227382_b_));
      return (new Dynamic(p_218175_1_, p_218175_1_.createMap(lvt_2_1_.build()))).getValue();
   }
}
