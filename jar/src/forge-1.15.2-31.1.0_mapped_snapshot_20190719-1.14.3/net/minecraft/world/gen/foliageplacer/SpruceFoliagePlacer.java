...
public class SpruceFoliagePlacer extends FoliagePlacer {
   public SpruceFoliagePlacer(int p_i225852_1_, int p_i225852_2_) {
      super(p_i225852_1_, p_i225852_2_, FoliagePlacerType.field_227387_b_);
   }
   ...
   public void func_225571_a_(IWorldGenerationReader p_225571_1_, Random p_225571_2_, TreeFeatureConfig p_225571_3_, int p_225571_4_, int p_225571_5_, int p_225571_6_, BlockPos p_225571_7_, Set<BlockPos> p_225571_8_) {
      int lvt_9_1_ = p_225571_2_.nextInt(2);
      int lvt_10_1_ = 1;
      int lvt_11_1_ = 0;

      for(int lvt_12_1_ = p_225571_4_; lvt_12_1_ >= p_225571_5_; --lvt_12_1_) {
         this.func_227384_a_(p_225571_1_, p_225571_2_, p_225571_3_, p_225571_4_, p_225571_7_, lvt_12_1_, lvt_9_1_, p_225571_8_);
         if (lvt_9_1_ >= lvt_10_1_) {
            lvt_9_1_ = lvt_11_1_;
            lvt_11_1_ = 1;
            lvt_10_1_ = Math.min(lvt_10_1_ + 1, p_225571_6_);
         } else {
            ++lvt_9_1_;
         }
      }
