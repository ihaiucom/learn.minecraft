...
public class PineFoliagePlacer extends FoliagePlacer {
   public PineFoliagePlacer(int p_i225850_1_, int p_i225850_2_) {
      super(p_i225850_1_, p_i225850_2_, FoliagePlacerType.field_227388_c_);
   }
   ...
   public void func_225571_a_(IWorldGenerationReader p_225571_1_, Random p_225571_2_, TreeFeatureConfig p_225571_3_, int p_225571_4_, int p_225571_5_, int p_225571_6_, BlockPos p_225571_7_, Set<BlockPos> p_225571_8_) {
      ...
      for(int lvt_10_1_ = p_225571_4_; lvt_10_1_ >= p_225571_5_; --lvt_10_1_) {
         this.func_227384_a_(p_225571_1_, p_225571_2_, p_225571_3_, p_225571_4_, p_225571_7_, lvt_10_1_, lvt_9_1_, p_225571_8_);
         if (lvt_9_1_ >= 1 && lvt_10_1_ == p_225571_5_ + 1) {
            --lvt_9_1_;
         } else if (lvt_9_1_ < p_225571_6_) {
            ++lvt_9_1_;
         }
      }
