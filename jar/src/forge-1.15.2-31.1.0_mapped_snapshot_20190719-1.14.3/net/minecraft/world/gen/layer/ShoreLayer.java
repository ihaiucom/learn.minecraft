...
public enum ShoreLayer implements ICastleTransformer {
   ...
   public int apply(INoiseRandom p_202748_1_, int p_202748_2_, int p_202748_3_, int p_202748_4_, int p_202748_5_, int p_202748_6_) {
      Biome lvt_7_1_ = (Biome)Registry.BIOME.getByValue(p_202748_6_);
      if (p_202748_6_ == MUSHROOM_FIELDS) {
      ...
      } else if (lvt_7_1_ != null && lvt_7_1_.getCategory() == Biome.Category.JUNGLE) {
         ...
         if (lvt_7_1_ != null && lvt_7_1_.getPrecipitation() == Biome.RainType.SNOW) {
   ...
   private static boolean isJungleCompatible(int p_151631_0_) {
      if (Registry.BIOME.getByValue(p_151631_0_) != null && ((Biome)Registry.BIOME.getByValue(p_151631_0_)).getCategory() == Biome.Category.JUNGLE) {
         return true;
      } else {
