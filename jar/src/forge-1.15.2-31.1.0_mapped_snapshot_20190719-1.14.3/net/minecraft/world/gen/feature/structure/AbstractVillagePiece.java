...
public abstract class AbstractVillagePiece extends StructurePiece {
   ...
   public AbstractVillagePiece(TemplateManager p_i51347_1_, CompoundNBT p_i51347_2_, IStructurePieceType p_i51347_3_) {
      ...
      this.field_214832_a = (JigsawPiece)IDynamicDeserializer.func_214907_a(new Dynamic(NBTDynamicOps.INSTANCE, p_i51347_2_.getCompound("pool_element")), Registry.STRUCTURE_POOL_ELEMENT, "element_type", EmptyJigsawPiece.INSTANCE);
      ...
      ListNBT lvt_4_1_ = p_i51347_2_.getList("junctions", 10);
      this.junctions.clear();
      lvt_4_1_.forEach((p_214827_1_) -> {
   ...
   protected void readAdditional(CompoundNBT p_143011_1_) {
      p_143011_1_.putInt("PosX", this.field_214833_b.getX());
      p_143011_1_.putInt("PosY", this.field_214833_b.getY());
      p_143011_1_.putInt("PosZ", this.field_214833_b.getZ());
      p_143011_1_.putInt("ground_level_delta", this.groundLevelDelta);
      p_143011_1_.put("pool_element", (INBT)this.field_214832_a.serialize(NBTDynamicOps.INSTANCE).getValue());
      p_143011_1_.putString("rotation", this.rotation.name());
      ListNBT lvt_2_1_ = new ListNBT();
      Iterator var3 = this.junctions.iterator();

      while(var3.hasNext()) {
         JigsawJunction lvt_4_1_ = (JigsawJunction)var3.next();
         lvt_2_1_.add(lvt_4_1_.serialize(NBTDynamicOps.INSTANCE).getValue());
      }

      p_143011_1_.put("junctions", lvt_2_1_);
   }
   ...
   public void offset(int p_181138_1_, int p_181138_2_, int p_181138_3_) {
      ...
      this.field_214833_b = this.field_214833_b.add(p_181138_1_, p_181138_2_, p_181138_3_);
   }
