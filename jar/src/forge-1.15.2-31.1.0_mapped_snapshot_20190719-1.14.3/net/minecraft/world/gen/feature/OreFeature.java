...
public class OreFeature extends Feature<OreFeatureConfig> {
   ...
   public boolean place(IWorld p_212245_1_, ChunkGenerator<? extends GenerationSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, OreFeatureConfig p_212245_5_) {
      ...
      for(int lvt_27_1_ = lvt_22_1_; lvt_27_1_ <= lvt_22_1_ + lvt_25_1_; ++lvt_27_1_) {
         for(int lvt_28_1_ = lvt_24_1_; lvt_28_1_ <= lvt_24_1_ + lvt_25_1_; ++lvt_28_1_) {
            if (lvt_23_1_ <= p_212245_1_.getHeight(Heightmap.Type.OCEAN_FLOOR_WG, lvt_27_1_, lvt_28_1_)) {
