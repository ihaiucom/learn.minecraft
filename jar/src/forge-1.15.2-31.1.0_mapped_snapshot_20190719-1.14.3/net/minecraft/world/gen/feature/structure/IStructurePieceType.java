...
public interface IStructurePieceType {
   ...
   StructurePiece load(TemplateManager var1, CompoundNBT var2);

   static IStructurePieceType register(IStructurePieceType p_214750_0_, String p_214750_1_) {
      return (IStructurePieceType)Registry.register((Registry)Registry.STRUCTURE_PIECE, (String)p_214750_1_.toLowerCase(Locale.ROOT), (Object)p_214750_0_);
   }
}
