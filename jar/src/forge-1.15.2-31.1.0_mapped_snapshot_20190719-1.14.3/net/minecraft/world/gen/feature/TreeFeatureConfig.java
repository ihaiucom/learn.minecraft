...
public class TreeFeatureConfig extends BaseTreeFeatureConfig {
   ...
   protected TreeFeatureConfig setSapling(IPlantable p_setSapling_1_) {
   ...
   public static <T> TreeFeatureConfig func_227338_a_(Dynamic<T> p_227338_0_) {
      ...
      FoliagePlacerType<?> foliageplacertype = (FoliagePlacerType)Registry.field_229389_v_.getOrDefault(new ResourceLocation((String)p_227338_0_.get("foliage_placer").get("type").asString().orElseThrow(RuntimeException::new)));
   ...
   public static <T> TreeFeatureConfig deserializeJungle(Dynamic<T> p_deserializeJungle_0_) {
      return func_227338_a_(p_deserializeJungle_0_).setSapling((IPlantable)Blocks.JUNGLE_SAPLING);
   }

   public static <T> TreeFeatureConfig deserializeAcacia(Dynamic<T> p_deserializeAcacia_0_) {
      return func_227338_a_(p_deserializeAcacia_0_).setSapling((IPlantable)Blocks.ACACIA_SAPLING);
   }
   ...
   public static class Builder extends BaseTreeFeatureConfig.Builder {
      ...
      public TreeFeatureConfig.Builder setSapling(IPlantable p_setSapling_1_) {
         super.setSapling(p_setSapling_1_);
         return this;
      }
