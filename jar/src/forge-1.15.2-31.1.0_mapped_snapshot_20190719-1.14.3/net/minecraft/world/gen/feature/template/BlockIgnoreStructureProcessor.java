...
public class BlockIgnoreStructureProcessor extends StructureProcessor {
   public static final BlockIgnoreStructureProcessor STRUCTURE_BLOCK;
   ...
   public BlockIgnoreStructureProcessor(List<Block> p_i51336_1_) {
      this.blocks = ImmutableList.copyOf(p_i51336_1_);
   }
   ...
   static {
      STRUCTURE_BLOCK = new BlockIgnoreStructureProcessor(ImmutableList.of(Blocks.STRUCTURE_BLOCK));
      AIR = new BlockIgnoreStructureProcessor(ImmutableList.of(Blocks.AIR));
      AIR_AND_STRUCTURE_BLOCK = new BlockIgnoreStructureProcessor(ImmutableList.of(Blocks.AIR, Blocks.STRUCTURE_BLOCK));
   }
}
