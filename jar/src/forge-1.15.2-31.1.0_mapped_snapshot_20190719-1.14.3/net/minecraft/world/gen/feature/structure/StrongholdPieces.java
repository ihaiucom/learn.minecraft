...
public class StrongholdPieces {
   ...
   public static void prepareStructurePieces() {
      ...
      StrongholdPieces.PieceWeight[] var0 = PIECE_WEIGHTS;
      int var1 = var0.length;

      for(int var2 = 0; var2 < var1; ++var2) {
         StrongholdPieces.PieceWeight lvt_3_1_ = var0[var2];
   ...
   private static StrongholdPieces.Stronghold findAndCreatePieceFactory(Class<? extends StrongholdPieces.Stronghold> p_175954_0_, List<StructurePiece> p_175954_1_, Random p_175954_2_, int p_175954_3_, int p_175954_4_, int p_175954_5_, @Nullable Direction p_175954_6_, int p_175954_7_) {
      StrongholdPieces.Stronghold lvt_8_1_ = null;
      if (p_175954_0_ == StrongholdPieces.Straight.class) {
         lvt_8_1_ = StrongholdPieces.Straight.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
      } else if (p_175954_0_ == StrongholdPieces.Prison.class) {
         lvt_8_1_ = StrongholdPieces.Prison.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
      } else if (p_175954_0_ == StrongholdPieces.LeftTurn.class) {
         lvt_8_1_ = StrongholdPieces.LeftTurn.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
      } else if (p_175954_0_ == StrongholdPieces.RightTurn.class) {
         lvt_8_1_ = StrongholdPieces.RightTurn.func_214824_a(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
      } else if (p_175954_0_ == StrongholdPieces.RoomCrossing.class) {
         lvt_8_1_ = StrongholdPieces.RoomCrossing.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
      } else if (p_175954_0_ == StrongholdPieces.StairsStraight.class) {
         lvt_8_1_ = StrongholdPieces.StairsStraight.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
      } else if (p_175954_0_ == StrongholdPieces.Stairs.class) {
         lvt_8_1_ = StrongholdPieces.Stairs.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
      } else if (p_175954_0_ == StrongholdPieces.Crossing.class) {
         lvt_8_1_ = StrongholdPieces.Crossing.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
      } else if (p_175954_0_ == StrongholdPieces.ChestCorridor.class) {
         lvt_8_1_ = StrongholdPieces.ChestCorridor.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
      } else if (p_175954_0_ == StrongholdPieces.Library.class) {
         lvt_8_1_ = StrongholdPieces.Library.createPiece(p_175954_1_, p_175954_2_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
      } else if (p_175954_0_ == StrongholdPieces.PortalRoom.class) {
         lvt_8_1_ = StrongholdPieces.PortalRoom.createPiece(p_175954_1_, p_175954_3_, p_175954_4_, p_175954_5_, p_175954_6_, p_175954_7_);
      }

      return (StrongholdPieces.Stronghold)lvt_8_1_;
   }
   ...
   private static StrongholdPieces.Stronghold generatePieceFromSmallDoor(StrongholdPieces.Stairs2 p_175955_0_, List<StructurePiece> p_175955_1_, Random p_175955_2_, int p_175955_3_, int p_175955_4_, int p_175955_5_, Direction p_175955_6_, int p_175955_7_) {
      if (!canAddStructurePieces()) {
         ...
         if (strongComponentType != null) {
            StrongholdPieces.Stronghold lvt_8_1_ = findAndCreatePieceFactory(strongComponentType, p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_, p_175955_7_);
            strongComponentType = null;
            if (lvt_8_1_ != null) {
               return lvt_8_1_;
            }
         ...
         while(lvt_8_2_ < 5) {
            ...
            while(var10.hasNext()) {
               StrongholdPieces.PieceWeight lvt_11_1_ = (StrongholdPieces.PieceWeight)var10.next();
               ...
               if (lvt_9_1_ < 0) {
                  ...
                  StrongholdPieces.Stronghold lvt_12_1_ = findAndCreatePieceFactory(lvt_11_1_.pieceClass, p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_, p_175955_7_);
                  if (lvt_12_1_ != null) {
         ...
         MutableBoundingBox lvt_9_2_ = StrongholdPieces.Corridor.findPieceBox(p_175955_1_, p_175955_2_, p_175955_3_, p_175955_4_, p_175955_5_, p_175955_6_);
         if (lvt_9_2_ != null && lvt_9_2_.minY > 1) {
            return new StrongholdPieces.Corridor(p_175955_7_, lvt_9_2_, p_175955_6_);
         } else {
            return null;
         }
      }
   ...
   public static class PortalRoom extends StrongholdPieces.Stronghold {
      ...
      public void buildComponent(StructurePiece p_74861_1_, List<StructurePiece> p_74861_2_, Random p_74861_3_) {
         if (p_74861_1_ != null) {
            ((StrongholdPieces.Stairs2)p_74861_1_).strongholdPortalRoom = this;
         }
      ...
      public static StrongholdPieces.PortalRoom createPiece(List<StructurePiece> p_175865_0_, int p_175865_1_, int p_175865_2_, int p_175865_3_, Direction p_175865_4_, int p_175865_5_) {
         ...
         return canStrongholdGoDeeper(lvt_6_1_) && StructurePiece.findIntersecting(p_175865_0_, lvt_6_1_) == null ? new StrongholdPieces.PortalRoom(p_175865_5_, lvt_6_1_, p_175865_4_) : null;
      }
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 0, 0, 0, 10, 7, 15, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.placeDoor(p_225577_1_, p_225577_3_, p_225577_4_, StrongholdPieces.Stronghold.Door.GRATES, 4, 1, 0);
         int lvt_6_1_ = 6;
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 1, lvt_6_1_, 1, 1, lvt_6_1_, 14, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 9, lvt_6_1_, 1, 9, lvt_6_1_, 14, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 2, lvt_6_1_, 1, 8, lvt_6_1_, 2, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 2, lvt_6_1_, 14, 8, lvt_6_1_, 14, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 1, 1, 1, 2, 1, 4, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 8, 1, 1, 9, 1, 4, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         ...
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 3, 1, 8, 7, 1, 12, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithBlocks(p_225577_1_, p_225577_4_, 4, 1, 9, 6, 1, 11, Blocks.LAVA.getDefaultState(), Blocks.LAVA.getDefaultState(), false);
         BlockState lvt_7_1_ = (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true);
         BlockState lvt_8_1_ = (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true);
         ...
         BlockState lvt_9_3_ = (BlockState)Blocks.STONE_BRICK_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.NORTH);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 4, 1, 5, 6, 1, 7, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 4, 2, 6, 6, 2, 7, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 4, 3, 7, 6, 3, 7, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         ...
         BlockState lvt_10_2_ = (BlockState)Blocks.END_PORTAL_FRAME.getDefaultState().with(EndPortalFrameBlock.FACING, Direction.NORTH);
         BlockState lvt_11_1_ = (BlockState)Blocks.END_PORTAL_FRAME.getDefaultState().with(EndPortalFrameBlock.FACING, Direction.SOUTH);
         BlockState lvt_12_1_ = (BlockState)Blocks.END_PORTAL_FRAME.getDefaultState().with(EndPortalFrameBlock.FACING, Direction.EAST);
         BlockState lvt_13_1_ = (BlockState)Blocks.END_PORTAL_FRAME.getDefaultState().with(EndPortalFrameBlock.FACING, Direction.WEST);
         ...
         this.setBlockState(p_225577_1_, (BlockState)lvt_10_2_.with(EndPortalFrameBlock.EYE, lvt_15_1_[0]), 4, 3, 8, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)lvt_10_2_.with(EndPortalFrameBlock.EYE, lvt_15_1_[1]), 5, 3, 8, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)lvt_10_2_.with(EndPortalFrameBlock.EYE, lvt_15_1_[2]), 6, 3, 8, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)lvt_11_1_.with(EndPortalFrameBlock.EYE, lvt_15_1_[3]), 4, 3, 12, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)lvt_11_1_.with(EndPortalFrameBlock.EYE, lvt_15_1_[4]), 5, 3, 12, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)lvt_11_1_.with(EndPortalFrameBlock.EYE, lvt_15_1_[5]), 6, 3, 12, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)lvt_12_1_.with(EndPortalFrameBlock.EYE, lvt_15_1_[6]), 3, 3, 9, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)lvt_12_1_.with(EndPortalFrameBlock.EYE, lvt_15_1_[7]), 3, 3, 10, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)lvt_12_1_.with(EndPortalFrameBlock.EYE, lvt_15_1_[8]), 3, 3, 11, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)lvt_13_1_.with(EndPortalFrameBlock.EYE, lvt_15_1_[9]), 7, 3, 9, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)lvt_13_1_.with(EndPortalFrameBlock.EYE, lvt_15_1_[10]), 7, 3, 10, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)lvt_13_1_.with(EndPortalFrameBlock.EYE, lvt_15_1_[11]), 7, 3, 11, p_225577_4_);
         if (lvt_14_1_) {
         ...
         if (!this.hasSpawner) {
            int lvt_6_1_ = this.getYWithOffset(3);
            BlockPos lvt_16_3_ = new BlockPos(this.getXWithOffset(5, 6), lvt_6_1_, this.getZWithOffset(5, 6));
   ...
   public static class Crossing extends StrongholdPieces.Stronghold {
      ...
      public void buildComponent(StructurePiece p_74861_1_, List<StructurePiece> p_74861_2_, Random p_74861_3_) {
         ...
         this.getNextComponentNormal((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, 5, 1);
         if (this.leftLow) {
            this.getNextComponentX((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, lvt_4_1_, 1);
         }

         if (this.leftHigh) {
            this.getNextComponentX((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, lvt_5_1_, 7);
         }

         if (this.rightLow) {
            this.getNextComponentZ((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, lvt_4_1_, 1);
         }

         if (this.rightHigh) {
            this.getNextComponentZ((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, lvt_5_1_, 7);
         }
      ...
      public static StrongholdPieces.Crossing createPiece(List<StructurePiece> p_175866_0_, Random p_175866_1_, int p_175866_2_, int p_175866_3_, int p_175866_4_, Direction p_175866_5_, int p_175866_6_) {
         ...
         return canStrongholdGoDeeper(lvt_7_1_) && StructurePiece.findIntersecting(p_175866_0_, lvt_7_1_) == null ? new StrongholdPieces.Crossing(p_175866_6_, p_175866_1_, lvt_7_1_, p_175866_5_) : null;
      }

      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 0, 0, 0, 9, 8, 10, true, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         ...
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 1, 2, 1, 8, 2, 6, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 4, 1, 5, 4, 4, 9, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 8, 1, 5, 8, 4, 9, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 1, 4, 7, 3, 4, 9, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 1, 3, 5, 3, 3, 6, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         ...
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 5, 1, 7, 7, 1, 8, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         ...
         this.fillWithBlocks(p_225577_1_, p_225577_4_, 5, 5, 7, 7, 5, 9, (BlockState)Blocks.SMOOTH_STONE_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE), (BlockState)Blocks.SMOOTH_STONE_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE), false);
         this.setBlockState(p_225577_1_, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.SOUTH), 6, 5, 6, p_225577_4_);
         return true;
      }
   }
   ...
   public static class Library extends StrongholdPieces.Stronghold {
      ...
      public static StrongholdPieces.Library createPiece(List<StructurePiece> p_175864_0_, Random p_175864_1_, int p_175864_2_, int p_175864_3_, int p_175864_4_, Direction p_175864_5_, int p_175864_6_) {
         ...
         return new StrongholdPieces.Library(p_175864_6_, p_175864_1_, lvt_7_1_, p_175864_5_);
      }
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 0, 0, 0, 13, lvt_6_1_ - 1, 14, true, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         ...
         for(lvt_9_1_ = 1; lvt_9_1_ <= 13; ++lvt_9_1_) {
            if ((lvt_9_1_ - 1) % 4 == 0) {
               ...
               this.setBlockState(p_225577_1_, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.EAST), 2, 3, lvt_9_1_, p_225577_4_);
               this.setBlockState(p_225577_1_, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.WEST), 11, 3, lvt_9_1_, p_225577_4_);
               if (this.isLargeRoom) {
         ...
         if (this.isLargeRoom) {
            ...
            BlockState lvt_9_3_ = (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.WEST, true)).with(FenceBlock.EAST, true);
            BlockState lvt_10_1_ = (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.SOUTH, true);
            ...
            this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.EAST, true), 3, 6, 2, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true)).with(FenceBlock.EAST, true), 3, 6, 12, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.WEST, true), 10, 6, 2, p_225577_4_);

            for(int lvt_11_1_ = 0; lvt_11_1_ <= 2; ++lvt_11_1_) {
               this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, true)).with(FenceBlock.WEST, true), 8 + lvt_11_1_, 6, 12 - lvt_11_1_, p_225577_4_);
               if (lvt_11_1_ != 2) {
                  this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, true)).with(FenceBlock.EAST, true), 8 + lvt_11_1_, 6, 11 - lvt_11_1_, p_225577_4_);
               }
            }

            BlockState lvt_11_2_ = (BlockState)Blocks.LADDER.getDefaultState().with(LadderBlock.FACING, Direction.SOUTH);
            ...
            int lvt_12_1_ = true;
            int lvt_13_1_ = true;
            BlockState lvt_14_1_ = (BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.EAST, true);
            this.setBlockState(p_225577_1_, lvt_14_1_, 6, 9, 7, p_225577_4_);
            BlockState lvt_15_1_ = (BlockState)Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.WEST, true);
            ...
            BlockState lvt_16_1_ = (BlockState)((BlockState)lvt_10_1_.with(FenceBlock.WEST, true)).with(FenceBlock.EAST, true);
            ...
            this.setBlockState(p_225577_1_, (BlockState)lvt_14_1_.with(FenceBlock.NORTH, true), 6, 7, 6, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)lvt_14_1_.with(FenceBlock.SOUTH, true), 6, 7, 8, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)lvt_15_1_.with(FenceBlock.NORTH, true), 7, 7, 6, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)lvt_15_1_.with(FenceBlock.SOUTH, true), 7, 7, 8, p_225577_4_);
   ...
   public static class Prison extends StrongholdPieces.Stronghold {
      ...
      public void buildComponent(StructurePiece p_74861_1_, List<StructurePiece> p_74861_2_, Random p_74861_3_) {
         this.getNextComponentNormal((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, 1, 1);
      }
      ...
      public static StrongholdPieces.Prison createPiece(List<StructurePiece> p_175860_0_, Random p_175860_1_, int p_175860_2_, int p_175860_3_, int p_175860_4_, Direction p_175860_5_, int p_175860_6_) {
         ...
         return canStrongholdGoDeeper(lvt_7_1_) && StructurePiece.findIntersecting(p_175860_0_, lvt_7_1_) == null ? new StrongholdPieces.Prison(p_175860_6_, p_175860_1_, lvt_7_1_, p_175860_5_) : null;
      }

      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 0, 0, 0, 8, 4, 10, true, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         ...
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 4, 1, 1, 4, 3, 1, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 4, 1, 3, 4, 3, 3, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 4, 1, 7, 4, 3, 7, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 4, 1, 9, 4, 3, 9, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);

         for(int lvt_6_1_ = 1; lvt_6_1_ <= 3; ++lvt_6_1_) {
            this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, lvt_6_1_, 4, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)((BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true)).with(PaneBlock.EAST, true), 4, lvt_6_1_, 5, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, lvt_6_1_, 6, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 5, lvt_6_1_, 5, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 6, lvt_6_1_, 5, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true)).with(PaneBlock.EAST, true), 7, lvt_6_1_, 5, p_225577_4_);
         }

         this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, 3, 2, p_225577_4_);
         this.setBlockState(p_225577_1_, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, true)).with(PaneBlock.SOUTH, true), 4, 3, 8, p_225577_4_);
         BlockState lvt_6_2_ = (BlockState)Blocks.IRON_DOOR.getDefaultState().with(DoorBlock.FACING, Direction.WEST);
         BlockState lvt_7_1_ = (BlockState)((BlockState)Blocks.IRON_DOOR.getDefaultState().with(DoorBlock.FACING, Direction.WEST)).with(DoorBlock.HALF, DoubleBlockHalf.UPPER);
   ...
   public static class RoomCrossing extends StrongholdPieces.Stronghold {
      ...
      public void buildComponent(StructurePiece p_74861_1_, List<StructurePiece> p_74861_2_, Random p_74861_3_) {
         this.getNextComponentNormal((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, 4, 1);
         this.getNextComponentX((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, 1, 4);
         this.getNextComponentZ((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, 1, 4);
      }
      ...
      public static StrongholdPieces.RoomCrossing createPiece(List<StructurePiece> p_175859_0_, Random p_175859_1_, int p_175859_2_, int p_175859_3_, int p_175859_4_, Direction p_175859_5_, int p_175859_6_) {
         ...
         return canStrongholdGoDeeper(lvt_7_1_) && StructurePiece.findIntersecting(p_175859_0_, lvt_7_1_) == null ? new StrongholdPieces.RoomCrossing(p_175859_6_, p_175859_1_, lvt_7_1_, p_175859_5_) : null;
      }

      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 0, 0, 0, 10, 6, 10, true, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.placeDoor(p_225577_1_, p_225577_3_, p_225577_4_, this.entryDoor, 4, 1, 0);
         ...
         case 0:
            ...
            this.setBlockState(p_225577_1_, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.WEST), 4, 3, 5, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.EAST), 6, 3, 5, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.SOUTH), 5, 3, 4, p_225577_4_);
            this.setBlockState(p_225577_1_, (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.NORTH), 5, 3, 6, p_225577_4_);
         ...
         case 2:
            ...
            BlockState lvt_6_6_ = (BlockState)Blocks.LADDER.getDefaultState().with(LadderBlock.FACING, Direction.WEST);
   ...
   public static class RightTurn extends StrongholdPieces.Turn {
      ...
      public void buildComponent(StructurePiece p_74861_1_, List<StructurePiece> p_74861_2_, Random p_74861_3_) {
         ...
         if (lvt_4_1_ != Direction.NORTH && lvt_4_1_ != Direction.EAST) {
            this.getNextComponentX((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, 1, 1);
         } else {
            this.getNextComponentZ((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, 1, 1);
         }
      ...
      public static StrongholdPieces.RightTurn func_214824_a(List<StructurePiece> p_214824_0_, Random p_214824_1_, int p_214824_2_, int p_214824_3_, int p_214824_4_, Direction p_214824_5_, int p_214824_6_) {
         ...
         return canStrongholdGoDeeper(lvt_7_1_) && StructurePiece.findIntersecting(p_214824_0_, lvt_7_1_) == null ? new StrongholdPieces.RightTurn(p_214824_6_, p_214824_1_, lvt_7_1_, p_214824_5_) : null;
      }

      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 0, 0, 0, 4, 4, 4, true, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.placeDoor(p_225577_1_, p_225577_3_, p_225577_4_, this.entryDoor, 1, 1, 0);
         Direction lvt_6_1_ = this.getCoordBaseMode();
   ...
   public static class LeftTurn extends StrongholdPieces.Turn {
      ...
      public static StrongholdPieces.LeftTurn createPiece(List<StructurePiece> p_175867_0_, Random p_175867_1_, int p_175867_2_, int p_175867_3_, int p_175867_4_, Direction p_175867_5_, int p_175867_6_) {
         ...
         return canStrongholdGoDeeper(lvt_7_1_) && StructurePiece.findIntersecting(p_175867_0_, lvt_7_1_) == null ? new StrongholdPieces.LeftTurn(p_175867_6_, p_175867_1_, lvt_7_1_, p_175867_5_) : null;
      }
   ...
   public static class StairsStraight extends StrongholdPieces.Stronghold {
      ...
      public static StrongholdPieces.StairsStraight createPiece(List<StructurePiece> p_175861_0_, Random p_175861_1_, int p_175861_2_, int p_175861_3_, int p_175861_4_, Direction p_175861_5_, int p_175861_6_) {
         ...
         return canStrongholdGoDeeper(lvt_7_1_) && StructurePiece.findIntersecting(p_175861_0_, lvt_7_1_) == null ? new StrongholdPieces.StairsStraight(p_175861_6_, p_175861_1_, lvt_7_1_, p_175861_5_) : null;
      }

      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 0, 0, 0, 4, 10, 7, true, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.placeDoor(p_225577_1_, p_225577_3_, p_225577_4_, this.entryDoor, 1, 7, 0);
         this.placeDoor(p_225577_1_, p_225577_3_, p_225577_4_, StrongholdPieces.Stronghold.Door.OPENING, 1, 1, 7);
         BlockState lvt_6_1_ = (BlockState)Blocks.COBBLESTONE_STAIRS.getDefaultState().with(StairsBlock.FACING, Direction.SOUTH);
   ...
   public static class ChestCorridor extends StrongholdPieces.Stronghold {
      ...
      public static StrongholdPieces.ChestCorridor createPiece(List<StructurePiece> p_175868_0_, Random p_175868_1_, int p_175868_2_, int p_175868_3_, int p_175868_4_, Direction p_175868_5_, int p_175868_6_) {
         ...
         return canStrongholdGoDeeper(lvt_7_1_) && StructurePiece.findIntersecting(p_175868_0_, lvt_7_1_) == null ? new StrongholdPieces.ChestCorridor(p_175868_6_, p_175868_1_, lvt_7_1_, p_175868_5_) : null;
      }

      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 0, 0, 0, 4, 4, 6, true, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.placeDoor(p_225577_1_, p_225577_3_, p_225577_4_, this.entryDoor, 1, 1, 0);
         this.placeDoor(p_225577_1_, p_225577_3_, p_225577_4_, StrongholdPieces.Stronghold.Door.OPENING, 1, 1, 6);
   ...
   public static class Straight extends StrongholdPieces.Stronghold {
      ...
      public void buildComponent(StructurePiece p_74861_1_, List<StructurePiece> p_74861_2_, Random p_74861_3_) {
         this.getNextComponentNormal((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, 1, 1);
         if (this.expandsX) {
            this.getNextComponentX((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, 1, 2);
         }

         if (this.expandsZ) {
            this.getNextComponentZ((StrongholdPieces.Stairs2)p_74861_1_, p_74861_2_, p_74861_3_, 1, 2);
         }
      ...
      public static StrongholdPieces.Straight createPiece(List<StructurePiece> p_175862_0_, Random p_175862_1_, int p_175862_2_, int p_175862_3_, int p_175862_4_, Direction p_175862_5_, int p_175862_6_) {
         ...
         return canStrongholdGoDeeper(lvt_7_1_) && StructurePiece.findIntersecting(p_175862_0_, lvt_7_1_) == null ? new StrongholdPieces.Straight(p_175862_6_, p_175862_1_, lvt_7_1_, p_175862_5_) : null;
      }
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         this.placeDoor(p_225577_1_, p_225577_3_, p_225577_4_, this.entryDoor, 1, 1, 0);
         this.placeDoor(p_225577_1_, p_225577_3_, p_225577_4_, StrongholdPieces.Stronghold.Door.OPENING, 1, 1, 6);
         BlockState lvt_6_1_ = (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.EAST);
         BlockState lvt_7_1_ = (BlockState)Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.WEST);
   ...
   public static class Stairs extends StrongholdPieces.Stronghold {
      ...
      public static StrongholdPieces.Stairs createPiece(List<StructurePiece> p_175863_0_, Random p_175863_1_, int p_175863_2_, int p_175863_3_, int p_175863_4_, Direction p_175863_5_, int p_175863_6_) {
         ...
         return canStrongholdGoDeeper(lvt_7_1_) && StructurePiece.findIntersecting(p_175863_0_, lvt_7_1_) == null ? new StrongholdPieces.Stairs(p_175863_6_, p_175863_1_, lvt_7_1_, p_175863_5_) : null;
      }

      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 0, 0, 0, 4, 10, 4, true, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.placeDoor(p_225577_1_, p_225577_3_, p_225577_4_, this.entryDoor, 1, 7, 0);
         this.placeDoor(p_225577_1_, p_225577_3_, p_225577_4_, StrongholdPieces.Stronghold.Door.OPENING, 1, 1, 4);
   ...
   abstract static class Stronghold extends StructurePiece {
      ...
      protected void placeDoor(IWorld p_74990_1_, Random p_74990_2_, MutableBoundingBox p_74990_3_, StrongholdPieces.Stronghold.Door p_74990_4_, int p_74990_5_, int p_74990_6_, int p_74990_7_) {
         switch(p_74990_4_) {
         case OPENING:
         ...
         case WOOD_DOOR:
            ...
            this.setBlockState(p_74990_1_, (BlockState)Blocks.OAK_DOOR.getDefaultState().with(DoorBlock.HALF, DoubleBlockHalf.UPPER), p_74990_5_ + 1, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
            break;
         case GRATES:
            ...
            this.setBlockState(p_74990_1_, (BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true), p_74990_5_, p_74990_6_, p_74990_7_, p_74990_3_);
            this.setBlockState(p_74990_1_, (BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, true), p_74990_5_, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
            this.setBlockState(p_74990_1_, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true)).with(PaneBlock.WEST, true), p_74990_5_, p_74990_6_ + 2, p_74990_7_, p_74990_3_);
            this.setBlockState(p_74990_1_, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true)).with(PaneBlock.WEST, true), p_74990_5_ + 1, p_74990_6_ + 2, p_74990_7_, p_74990_3_);
            this.setBlockState(p_74990_1_, (BlockState)((BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true)).with(PaneBlock.WEST, true), p_74990_5_ + 2, p_74990_6_ + 2, p_74990_7_, p_74990_3_);
            this.setBlockState(p_74990_1_, (BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true), p_74990_5_ + 2, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
            this.setBlockState(p_74990_1_, (BlockState)Blocks.IRON_BARS.getDefaultState().with(PaneBlock.EAST, true), p_74990_5_ + 2, p_74990_6_, p_74990_7_, p_74990_3_);
            break;
         case IRON_DOOR:
            this.setBlockState(p_74990_1_, Blocks.STONE_BRICKS.getDefaultState(), p_74990_5_, p_74990_6_, p_74990_7_, p_74990_3_);
            this.setBlockState(p_74990_1_, Blocks.STONE_BRICKS.getDefaultState(), p_74990_5_, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
            ...
            this.setBlockState(p_74990_1_, (BlockState)Blocks.IRON_DOOR.getDefaultState().with(DoorBlock.HALF, DoubleBlockHalf.UPPER), p_74990_5_ + 1, p_74990_6_ + 1, p_74990_7_, p_74990_3_);
            this.setBlockState(p_74990_1_, (BlockState)Blocks.STONE_BUTTON.getDefaultState().with(AbstractButtonBlock.HORIZONTAL_FACING, Direction.NORTH), p_74990_5_ + 2, p_74990_6_ + 1, p_74990_7_ + 1, p_74990_3_);
            this.setBlockState(p_74990_1_, (BlockState)Blocks.STONE_BUTTON.getDefaultState().with(AbstractButtonBlock.HORIZONTAL_FACING, Direction.SOUTH), p_74990_5_ + 2, p_74990_6_ + 1, p_74990_7_ - 1, p_74990_3_);
         }
      ...
      protected StructurePiece getNextComponentNormal(StrongholdPieces.Stairs2 p_74986_1_, List<StructurePiece> p_74986_2_, Random p_74986_3_, int p_74986_4_, int p_74986_5_) {
         ...
         if (lvt_6_1_ != null) {
            switch(lvt_6_1_) {
            case NORTH:
               return StrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX + p_74986_4_, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ - 1, lvt_6_1_, this.getComponentType());
            case SOUTH:
               return StrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX + p_74986_4_, this.boundingBox.minY + p_74986_5_, this.boundingBox.maxZ + 1, lvt_6_1_, this.getComponentType());
            case WEST:
               return StrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ + p_74986_4_, lvt_6_1_, this.getComponentType());
            case EAST:
               return StrongholdPieces.generateAndAddPiece(p_74986_1_, p_74986_2_, p_74986_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74986_5_, this.boundingBox.minZ + p_74986_4_, lvt_6_1_, this.getComponentType());
            }
         }
