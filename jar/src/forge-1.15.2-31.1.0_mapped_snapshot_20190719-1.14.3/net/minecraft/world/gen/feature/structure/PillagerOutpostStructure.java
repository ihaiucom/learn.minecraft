...
public class PillagerOutpostStructure extends ScatteredStructure<NoFeatureConfig> {
   private static final List<Biome.SpawnListEntry> field_214558_a;
         ...
         if (p_225558_2_.hasStructure(p_225558_6_, this)) {
            for(int lvt_10_1_ = p_225558_4_ - 10; lvt_10_1_ <= p_225558_4_ + 10; ++lvt_10_1_) {
               for(int lvt_11_1_ = p_225558_5_ - 10; lvt_11_1_ <= p_225558_5_ + 10; ++lvt_11_1_) {
                  if (Feature.VILLAGE.func_225558_a_(p_225558_1_, p_225558_2_, p_225558_3_, lvt_10_1_, lvt_11_1_, p_225558_1_.func_226836_a_(new BlockPos((lvt_10_1_ << 4) + 9, 0, (lvt_11_1_ << 4) + 9)))) {
                     return false;
                  }
               }
            }
   ...
   static {
      field_214558_a = Lists.newArrayList(new Biome.SpawnListEntry[]{new Biome.SpawnListEntry(EntityType.PILLAGER, 1, 1, 1)});
   }
   ...
   public static class Start extends MarginedStructureStart {
      ...
      public void init(ChunkGenerator<?> p_214625_1_, TemplateManager p_214625_2_, int p_214625_3_, int p_214625_4_, Biome p_214625_5_) {
         ...
         PillagerOutpostPieces.func_215139_a(p_214625_1_, p_214625_2_, lvt_6_1_, this.components, this.rand);
