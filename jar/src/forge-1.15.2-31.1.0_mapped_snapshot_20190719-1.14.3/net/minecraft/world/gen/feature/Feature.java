...
public abstract class Feature<FC extends IFeatureConfig> extends ForgeRegistryEntry<Feature<?>> {
   public static final Structure<NoFeatureConfig> PILLAGER_OUTPOST = (Structure)register("pillager_outpost", new PillagerOutpostStructure(NoFeatureConfig::deserialize));
   public static final Structure<MineshaftConfig> MINESHAFT = (Structure)register("mineshaft", new MineshaftStructure(MineshaftConfig::deserialize));
   public static final Structure<NoFeatureConfig> WOODLAND_MANSION = (Structure)register("woodland_mansion", new WoodlandMansionStructure(NoFeatureConfig::deserialize));
   public static final Structure<NoFeatureConfig> JUNGLE_TEMPLE = (Structure)register("jungle_temple", new JunglePyramidStructure(NoFeatureConfig::deserialize));
   public static final Structure<NoFeatureConfig> DESERT_PYRAMID = (Structure)register("desert_pyramid", new DesertPyramidStructure(NoFeatureConfig::deserialize));
   public static final Structure<NoFeatureConfig> IGLOO = (Structure)register("igloo", new IglooStructure(NoFeatureConfig::deserialize));
   public static final Structure<ShipwreckConfig> SHIPWRECK = (Structure)register("shipwreck", new ShipwreckStructure(ShipwreckConfig::deserialize));
   public static final SwampHutStructure SWAMP_HUT = (SwampHutStructure)register("swamp_hut", new SwampHutStructure(NoFeatureConfig::deserialize));
   public static final Structure<NoFeatureConfig> STRONGHOLD = (Structure)register("stronghold", new StrongholdStructure(NoFeatureConfig::deserialize));
   public static final Structure<NoFeatureConfig> OCEAN_MONUMENT = (Structure)register("ocean_monument", new OceanMonumentStructure(NoFeatureConfig::deserialize));
   public static final Structure<OceanRuinConfig> OCEAN_RUIN = (Structure)register("ocean_ruin", new OceanRuinStructure(OceanRuinConfig::deserialize));
   public static final Structure<NoFeatureConfig> NETHER_BRIDGE = (Structure)register("nether_bridge", new FortressStructure(NoFeatureConfig::deserialize));
   public static final Structure<NoFeatureConfig> END_CITY = (Structure)register("end_city", new EndCityStructure(NoFeatureConfig::deserialize));
   public static final Structure<BuriedTreasureConfig> BURIED_TREASURE = (Structure)register("buried_treasure", new BuriedTreasureStructure(BuriedTreasureConfig::deserialize));
   public static final Structure<VillageConfig> VILLAGE = (Structure)register("village", new VillageStructure(VillageConfig::deserialize));
   ...
   public static final FlowersFeature<BlockClusterFeatureConfig> field_227247_y_ = (FlowersFeature)register("flower", new DefaultFlowersFeature(BlockClusterFeatureConfig::func_227300_a_));
   ...
   public static final BonusChestFeature BONUS_CHEST = (BonusChestFeature)register("bonus_chest", new BonusChestFeature(NoFeatureConfig::deserialize));
   ...
   public static final BiMap<String, Structure<?>> STRUCTURES = (BiMap)Util.make(GameData.getStructureMap(), (p_lambda$static$0_0_) -> {
   });
   public static final List<Structure<?>> field_214488_aQ;
   ...
   private static <C extends IFeatureConfig, F extends Feature<C>> F register(String p_214468_0_, F p_214468_1_) {
      return (Feature)Registry.register((Registry)Registry.FEATURE, (String)p_214468_0_, (Object)p_214468_1_);
   }
   ...
   public FC createConfig(Dynamic<?> p_214470_1_) {
      return (IFeatureConfig)this.configFactory.apply(p_214470_1_);
   }
   ...
   public abstract boolean place(IWorld var1, ChunkGenerator<? extends GenerationSettings> var2, Random var3, BlockPos var4, FC var5);
   ...
   protected static boolean func_227249_a_(Block p_227249_0_) {
      return Tags.Blocks.STONE.contains(p_227249_0_);
   }

   protected static boolean func_227250_b_(Block p_227250_0_) {
      return Tags.Blocks.DIRT.contains(p_227250_0_);
   }

   static {
      field_214488_aQ = ImmutableList.of(PILLAGER_OUTPOST, VILLAGE);
   }
}
