...
public class ListJigsawPiece extends JigsawPiece {
   ...
   public ListJigsawPiece(Dynamic<?> p_i51406_1_) {
      super(p_i51406_1_);
      List<JigsawPiece> lvt_2_1_ = p_i51406_1_.get("elements").asList((p_214866_0_) -> {
         return (JigsawPiece)IDynamicDeserializer.func_214907_a(p_214866_0_, Registry.STRUCTURE_POOL_ELEMENT, "element_type", EmptyJigsawPiece.INSTANCE);
      });
      if (lvt_2_1_.isEmpty()) {
         throw new IllegalArgumentException("Elements are empty");
      } else {
         this.elements = lvt_2_1_;
      }
   }
   ...
   public List<Template.BlockInfo> func_214849_a(TemplateManager p_214849_1_, BlockPos p_214849_2_, Rotation p_214849_3_, Random p_214849_4_) {
      return ((JigsawPiece)this.elements.get(0)).func_214849_a(p_214849_1_, p_214849_2_, p_214849_3_, p_214849_4_);
   }

   public MutableBoundingBox func_214852_a(TemplateManager p_214852_1_, BlockPos p_214852_2_, Rotation p_214852_3_) {
      MutableBoundingBox lvt_4_1_ = MutableBoundingBox.getNewBoundingBox();
      Iterator var5 = this.elements.iterator();

      while(var5.hasNext()) {
         JigsawPiece lvt_6_1_ = (JigsawPiece)var5.next();
         MutableBoundingBox lvt_7_1_ = lvt_6_1_.func_214852_a(p_214852_1_, p_214852_2_, p_214852_3_);
         lvt_4_1_.expandTo(lvt_7_1_);
      }
   ...
   public boolean func_225575_a_(TemplateManager p_225575_1_, IWorld p_225575_2_, ChunkGenerator<?> p_225575_3_, BlockPos p_225575_4_, Rotation p_225575_5_, MutableBoundingBox p_225575_6_, Random p_225575_7_) {
      ...
      JigsawPiece lvt_9_1_;
      do {
         if (!var8.hasNext()) {
            return true;
         }

         lvt_9_1_ = (JigsawPiece)var8.next();
      } while(lvt_9_1_.func_225575_a_(p_225575_1_, p_225575_2_, p_225575_3_, p_225575_4_, p_225575_5_, p_225575_6_, p_225575_7_));
   ...
   public <T> Dynamic<T> serialize0(DynamicOps<T> p_214851_1_) {
      T lvt_2_1_ = p_214851_1_.createList(this.elements.stream().map((p_214865_1_) -> {
         return p_214865_1_.serialize(p_214851_1_).getValue();
      }));
      return new Dynamic(p_214851_1_, p_214851_1_.createMap(ImmutableMap.of(p_214851_1_.createString("elements"), lvt_2_1_)));
   }
