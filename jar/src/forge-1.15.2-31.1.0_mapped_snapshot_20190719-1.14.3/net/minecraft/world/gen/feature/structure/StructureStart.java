...
public abstract class StructureStart {
   ...
   public abstract void init(ChunkGenerator<?> var1, TemplateManager var2, int var3, int var4, Biome var5);
   ...
   public void func_225565_a_(IWorld p_225565_1_, ChunkGenerator<?> p_225565_2_, Random p_225565_3_, MutableBoundingBox p_225565_4_, ChunkPos p_225565_5_) {
      synchronized(this.components) {
         ...
         while(iterator.hasNext()) {
            ...
            if (structurepiece.getBoundingBox().intersectsWith(p_225565_4_) && !structurepiece.func_225577_a_(p_225565_1_, p_225565_2_, p_225565_3_, p_225565_4_, p_225565_5_)) {
               iterator.remove();
            }
         }
   ...
   protected void recalculateStructureSize() {
      ...
      while(var1.hasNext()) {
         StructurePiece structurepiece = (StructurePiece)var1.next();
         this.bounds.expandTo(structurepiece.getBoundingBox());
      }

   }

   public CompoundNBT write(int p_143021_1_, int p_143021_2_) {
      CompoundNBT compoundnbt = new CompoundNBT();
      if (!this.isValid()) {
         compoundnbt.putString("id", "INVALID");
         return compoundnbt;
      } else if (Registry.STRUCTURE_FEATURE.getKey(this.getStructure()) == null) {
   ...
   protected void func_214628_a(int p_214628_1_, Random p_214628_2_, int p_214628_3_) {
      ...
      while(var7.hasNext()) {
         StructurePiece structurepiece = (StructurePiece)var7.next();
   ...
   static {
      DUMMY = new StructureStart(Feature.MINESHAFT, 0, 0, MutableBoundingBox.getNewBoundingBox(), 0, 0L) {
