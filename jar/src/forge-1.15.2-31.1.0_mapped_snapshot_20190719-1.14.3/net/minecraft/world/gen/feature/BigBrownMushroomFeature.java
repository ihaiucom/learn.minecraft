   ...
   protected void func_225564_a_(IWorld p_225564_1_, Random p_225564_2_, BlockPos p_225564_3_, int p_225564_4_, BlockPos.Mutable p_225564_5_, BigMushroomFeatureConfig p_225564_6_) {
      ...
      for(int j = -i; j <= i; ++j) {
         for(int k = -i; k <= i; ++k) {
            ...
            if (!flag4 || !flag5) {
               p_225564_5_.setPos((Vec3i)p_225564_3_).move(j, p_225564_4_, k);
               if (p_225564_1_.getBlockState(p_225564_5_).canBeReplacedByLeaves(p_225564_1_, p_225564_5_)) {
                  ...
                  this.setBlockState(p_225564_1_, p_225564_5_, (BlockState)((BlockState)((BlockState)((BlockState)p_225564_6_.field_227272_a_.func_225574_a_(p_225564_2_, p_225564_3_).with(HugeMushroomBlock.WEST, flag6)).with(HugeMushroomBlock.EAST, flag7)).with(HugeMushroomBlock.NORTH, flag8)).with(HugeMushroomBlock.SOUTH, flag9));
               }
            }
         }
      }
