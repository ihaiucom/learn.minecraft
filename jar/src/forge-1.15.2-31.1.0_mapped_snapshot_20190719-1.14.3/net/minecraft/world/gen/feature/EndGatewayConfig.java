...
public class EndGatewayConfig implements IFeatureConfig {
   ...
   public <T> Dynamic<T> serialize(DynamicOps<T> p_214634_1_) {
      return new Dynamic(p_214634_1_, this.exit.map((p_214703_2_) -> {
   ...
   public static <T> EndGatewayConfig deserialize(Dynamic<T> p_214697_0_) {
      Optional<BlockPos> lvt_1_1_ = p_214697_0_.get("exit_x").asNumber().flatMap((p_214696_1_) -> {
      ...
      boolean lvt_2_1_ = p_214697_0_.get("exact").asBoolean(false);
      return new EndGatewayConfig(lvt_1_1_, lvt_2_1_);
   }
}
