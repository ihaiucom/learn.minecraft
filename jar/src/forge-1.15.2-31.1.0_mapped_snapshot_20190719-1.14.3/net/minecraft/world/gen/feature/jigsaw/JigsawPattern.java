...
public class JigsawPattern {
   ...
   public JigsawPattern(ResourceLocation p_i51397_1_, ResourceLocation p_i51397_2_, List<Pair<JigsawPiece, Integer>> p_i51397_3_, JigsawPattern.PlacementBehaviour p_i51397_4_) {
      ...
      Iterator var5 = p_i51397_3_.iterator();

      while(var5.hasNext()) {
         Pair<JigsawPiece, Integer> pair = (Pair)var5.next();

         for(Integer integer = 0; integer < (Integer)pair.getSecond(); integer = integer + 1) {
            this.field_214953_e.add(((JigsawPiece)pair.getFirst()).setPlacementBehaviour(p_i51397_4_));
         }
      }
   ...
   public int func_214945_a(TemplateManager p_214945_1_) {
      if (this.field_214956_h == Integer.MIN_VALUE) {
         this.field_214956_h = this.field_214953_e.stream().mapToInt((p_lambda$func_214945_a$0_1_) -> {
            return p_lambda$func_214945_a$0_1_.func_214852_a(p_214945_1_, BlockPos.ZERO, Rotation.NONE).getYSize();
         }).max().orElse(0);
      }
   ...
   public JigsawPiece func_214944_a(Random p_214944_1_) {
      return (JigsawPiece)this.field_214953_e.get(p_214944_1_.nextInt(this.field_214953_e.size()));
   }
   ...
   static {
      EMPTY = new JigsawPattern(new ResourceLocation("empty"), new ResourceLocation("empty"), ImmutableList.of(), JigsawPattern.PlacementBehaviour.RIGID);
      INVALID = new JigsawPattern(new ResourceLocation("invalid"), new ResourceLocation("invalid"), ImmutableList.of(), JigsawPattern.PlacementBehaviour.RIGID);
   }

   public static enum PlacementBehaviour implements IExtensibleEnum {
      TERRAIN_MATCHING("terrain_matching", ImmutableList.of(new GravityStructureProcessor(Heightmap.Type.WORLD_SURFACE_WG, -1))),
      RIGID("rigid", ImmutableList.of());

      private static final Map<String, JigsawPattern.PlacementBehaviour> field_214939_c = (Map)Arrays.stream(values()).collect(Collectors.toMap(JigsawPattern.PlacementBehaviour::func_214936_a, (p_lambda$static$0_0_) -> {
      ...
      public static JigsawPattern.PlacementBehaviour func_214938_a(String p_214938_0_) {
         return (JigsawPattern.PlacementBehaviour)field_214939_c.get(p_214938_0_);
      }
      ...
      public static JigsawPattern.PlacementBehaviour create(String p_create_0_, String p_create_1_, ImmutableList<StructureProcessor> p_create_2_) {
