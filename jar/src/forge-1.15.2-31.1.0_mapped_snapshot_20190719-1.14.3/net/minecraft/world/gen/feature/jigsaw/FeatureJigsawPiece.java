...
public class FeatureJigsawPiece extends JigsawPiece {
   ...
   public CompoundNBT func_214869_b() {
      ...
      lvt_1_1_.putString("target_pool", "minecraft:empty");
      lvt_1_1_.putString("attachement_type", "minecraft:bottom");
      lvt_1_1_.putString("final_state", "minecraft:air");
      return lvt_1_1_;
   }
   ...
   public List<Template.BlockInfo> func_214849_a(TemplateManager p_214849_1_, BlockPos p_214849_2_, Rotation p_214849_3_, Random p_214849_4_) {
      List<Template.BlockInfo> lvt_5_1_ = Lists.newArrayList();
      lvt_5_1_.add(new Template.BlockInfo(p_214849_2_, (BlockState)Blocks.field_226904_lY_.getDefaultState().with(JigsawBlock.FACING, Direction.DOWN), this.field_214871_b));
      return lvt_5_1_;
   }

   public MutableBoundingBox func_214852_a(TemplateManager p_214852_1_, BlockPos p_214852_2_, Rotation p_214852_3_) {
      BlockPos lvt_4_1_ = this.func_214868_a(p_214852_1_, p_214852_3_);
      return new MutableBoundingBox(p_214852_2_.getX(), p_214852_2_.getY(), p_214852_2_.getZ(), p_214852_2_.getX() + lvt_4_1_.getX(), p_214852_2_.getY() + lvt_4_1_.getY(), p_214852_2_.getZ() + lvt_4_1_.getZ());
   }
