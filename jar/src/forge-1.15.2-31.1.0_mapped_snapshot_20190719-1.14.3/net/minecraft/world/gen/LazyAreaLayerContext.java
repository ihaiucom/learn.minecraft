...
public class LazyAreaLayerContext implements IExtendedNoiseRandom<LazyArea> {
   ...
   public LazyAreaLayerContext(int p_i51285_1_, long p_i51285_2_, long p_i51285_4_) {
      this.field_215719_e = func_227471_b_(p_i51285_2_, p_i51285_4_);
      this.field_215718_b = new ImprovedNoiseGenerator(new Random(p_i51285_2_));
      this.cache = new Long2IntLinkedOpenHashMap(16, 0.25F);
      this.cache.defaultReturnValue(Integer.MIN_VALUE);
      this.maxCacheSize = p_i51285_1_;
   }
   ...
   public void setPosition(long p_202698_1_, long p_202698_3_) {
      long lvt_5_1_ = this.field_215719_e;
      lvt_5_1_ = FastRandom.func_226162_a_(lvt_5_1_, p_202698_1_);
      lvt_5_1_ = FastRandom.func_226162_a_(lvt_5_1_, p_202698_3_);
      lvt_5_1_ = FastRandom.func_226162_a_(lvt_5_1_, p_202698_1_);
      lvt_5_1_ = FastRandom.func_226162_a_(lvt_5_1_, p_202698_3_);
      this.field_215720_f = lvt_5_1_;
   }

   public int random(int p_202696_1_) {
      int lvt_2_1_ = (int)Math.floorMod(this.field_215720_f >> 24, (long)p_202696_1_);
   ...
   private static long func_227471_b_(long p_227471_0_, long p_227471_2_) {
      long lvt_4_1_ = FastRandom.func_226162_a_(p_227471_2_, p_227471_2_);
      lvt_4_1_ = FastRandom.func_226162_a_(lvt_4_1_, p_227471_2_);
      lvt_4_1_ = FastRandom.func_226162_a_(lvt_4_1_, p_227471_2_);
      long lvt_6_1_ = FastRandom.func_226162_a_(p_227471_0_, lvt_4_1_);
      lvt_6_1_ = FastRandom.func_226162_a_(lvt_6_1_, lvt_4_1_);
      lvt_6_1_ = FastRandom.func_226162_a_(lvt_6_1_, lvt_4_1_);
      return lvt_6_1_;
   }

   // $FF: synthetic method
   public IArea func_212861_a_(IPixelTransformer p_212861_1_) {
      return this.func_212861_a_(p_212861_1_);
   }
}
