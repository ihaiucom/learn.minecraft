...
public class MapBanner {
   ...
   public static MapBanner read(CompoundNBT p_204300_0_) {
      BlockPos lvt_1_1_ = NBTUtil.readBlockPos(p_204300_0_.getCompound("Pos"));
      DyeColor lvt_2_1_ = DyeColor.byTranslationKey(p_204300_0_.getString("Color"), DyeColor.WHITE);
      ITextComponent lvt_3_1_ = p_204300_0_.contains("Name") ? ITextComponent.Serializer.fromJson(p_204300_0_.getString("Name")) : null;
      return new MapBanner(lvt_1_1_, lvt_2_1_, lvt_3_1_);
   }

   @Nullable
   public static MapBanner fromWorld(IBlockReader p_204301_0_, BlockPos p_204301_1_) {
      TileEntity lvt_2_1_ = p_204301_0_.getTileEntity(p_204301_1_);
      if (lvt_2_1_ instanceof BannerTileEntity) {
         BannerTileEntity lvt_3_1_ = (BannerTileEntity)lvt_2_1_;
         DyeColor lvt_4_1_ = lvt_3_1_.getBaseColor(() -> {
            return p_204301_0_.getBlockState(p_204301_1_);
         });
         ITextComponent lvt_5_1_ = lvt_3_1_.hasCustomName() ? lvt_3_1_.getCustomName() : null;
         return new MapBanner(p_204301_1_, lvt_4_1_, lvt_5_1_);
      } else {
         return null;
      }
   }
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         MapBanner lvt_2_1_ = (MapBanner)p_equals_1_;
         return Objects.equals(this.pos, lvt_2_1_.pos) && this.color == lvt_2_1_.color && Objects.equals(this.name, lvt_2_1_.name);
      } else {
         return false;
      }
   }
   ...
   public CompoundNBT write() {
      ...
      lvt_1_1_.putString("Color", this.color.getTranslationKey());
      if (this.name != null) {
