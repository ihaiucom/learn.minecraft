...
public class ValidationTracker {
   ...
   private String func_227533_b_() {
      if (this.field_227526_h_ == null) {
         this.field_227526_h_ = (String)this.field_227520_b_.get();
      }
   ...
   public ValidationTracker func_227531_a_(String p_227531_1_, ResourceLocation p_227531_2_) {
      ImmutableSet<ResourceLocation> lvt_3_1_ = ImmutableSet.builder().addAll(this.field_227525_g_).add(p_227531_2_).build();
      return new ValidationTracker(this.field_227519_a_, () -> {
         return this.func_227533_b_() + p_227531_1_;
      }, this.field_227521_c_, this.field_227522_d_, this.field_227523_e_, this.field_227524_f_, lvt_3_1_);
   }

   public ValidationTracker func_227535_b_(String p_227535_1_, ResourceLocation p_227535_2_) {
      ImmutableSet<ResourceLocation> lvt_3_1_ = ImmutableSet.builder().addAll(this.field_227523_e_).add(p_227535_2_).build();
      return new ValidationTracker(this.field_227519_a_, () -> {
         return this.func_227533_b_() + p_227535_1_;
      }, this.field_227521_c_, this.field_227522_d_, lvt_3_1_, this.field_227524_f_, this.field_227525_g_);
   }
   ...
   public LootTable func_227539_c_(ResourceLocation p_227539_1_) {
      return (LootTable)this.field_227524_f_.apply(p_227539_1_);
   }

   @Nullable
   public ILootCondition func_227541_d_(ResourceLocation p_227541_1_) {
      return (ILootCondition)this.field_227522_d_.apply(p_227541_1_);
   }
