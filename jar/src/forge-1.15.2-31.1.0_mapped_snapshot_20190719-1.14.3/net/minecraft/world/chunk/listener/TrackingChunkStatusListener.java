...
public class TrackingChunkStatusListener implements IChunkStatusListener {
   ...
   public TrackingChunkStatusListener(int p_i50695_1_) {
      this.loggingListener = new LoggingChunkStatusListener(p_i50695_1_);
      this.diameter = p_i50695_1_ * 2 + 1;
   ...
   public void start(ChunkPos p_219509_1_) {
      if (this.field_219532_g) {
         this.loggingListener.start(p_219509_1_);
         this.center = p_219509_1_;
      }
   }
   ...
   public ChunkStatus func_219525_a(int p_219525_1_, int p_219525_2_) {
      return (ChunkStatus)this.statuses.get(ChunkPos.asLong(p_219525_1_ + this.center.x - this.field_219530_e, p_219525_2_ + this.center.z - this.field_219530_e));
   }
}
