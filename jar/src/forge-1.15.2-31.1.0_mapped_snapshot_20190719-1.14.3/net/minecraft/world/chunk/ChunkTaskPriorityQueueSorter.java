...
public class ChunkTaskPriorityQueueSorter implements AutoCloseable, ChunkHolder.IListener {
   ...
   public ChunkTaskPriorityQueueSorter(List<ITaskExecutor<?>> p_i50713_1_, Executor p_i50713_2_, int p_i50713_3_) {
      this.queues = (Map)p_i50713_1_.stream().collect(Collectors.toMap(Function.identity(), (p_219084_1_) -> {
   ...
   public static ChunkTaskPriorityQueueSorter.FunctionEntry<Runnable> func_219081_a(ChunkHolder p_219081_0_, Runnable p_219081_1_) {
      long var10001 = p_219081_0_.getPosition().asLong();
      p_219081_0_.getClass();
      return func_219069_a(p_219081_1_, var10001, p_219081_0_::func_219281_j);
   }
   ...
   public <T> ITaskExecutor<ChunkTaskPriorityQueueSorter.FunctionEntry<T>> func_219087_a(ITaskExecutor<T> p_219087_1_, boolean p_219087_2_) {
      return (ITaskExecutor)this.sorter.func_213141_a((p_219086_3_) -> {
   ...
   public void func_219066_a(ChunkPos p_219066_1_, IntSupplier p_219066_2_, int p_219066_3_, IntConsumer p_219066_4_) {
      this.sorter.enqueue(new ITaskQueue.RunnableWithPriority(0, () -> {
         int lvt_5_1_ = p_219066_2_.getAsInt();
         this.queues.values().forEach((p_219076_3_) -> {
            p_219076_3_.func_219407_a(lvt_5_1_, p_219066_1_, p_219066_3_);
         });
   ...
   private <T> void func_219074_a(ITaskExecutor<T> p_219074_1_, long p_219074_2_, Runnable p_219074_4_, boolean p_219074_5_) {
      this.sorter.enqueue(new ITaskQueue.RunnableWithPriority(1, () -> {
         ChunkTaskPriorityQueue<Function<ITaskExecutor<Unit>, T>> lvt_6_1_ = this.getQueue(p_219074_1_);
         lvt_6_1_.func_219416_a(p_219074_2_, p_219074_5_);
         if (this.field_219095_c.remove(p_219074_1_)) {
            this.func_219078_a(lvt_6_1_, p_219074_1_);
         }
   ...
   private <T> void func_219067_a(ITaskExecutor<T> p_219067_1_, Function<ITaskExecutor<Unit>, T> p_219067_2_, long p_219067_3_, IntSupplier p_219067_5_, boolean p_219067_6_) {
      this.sorter.enqueue(new ITaskQueue.RunnableWithPriority(2, () -> {
         ChunkTaskPriorityQueue<Function<ITaskExecutor<Unit>, T>> lvt_7_1_ = this.getQueue(p_219067_1_);
         int lvt_8_1_ = p_219067_5_.getAsInt();
         lvt_7_1_.func_219412_a(Optional.of(p_219067_2_), p_219067_3_, lvt_8_1_);
         if (p_219067_6_) {
            lvt_7_1_.func_219412_a(Optional.empty(), p_219067_3_, lvt_8_1_);
         }

         if (this.field_219095_c.remove(p_219067_1_)) {
            this.func_219078_a(lvt_7_1_, p_219067_1_);
         }
   ...
   private <T> void func_219078_a(ChunkTaskPriorityQueue<Function<ITaskExecutor<Unit>, T>> p_219078_1_, ITaskExecutor<T> p_219078_2_) {
      this.sorter.enqueue(new ITaskQueue.RunnableWithPriority(3, () -> {
         Stream<Either<Function<ITaskExecutor<Unit>, T>, Runnable>> lvt_3_1_ = p_219078_1_.func_219417_a();
         if (lvt_3_1_ == null) {
            this.field_219095_c.add(p_219078_2_);
         } else {
            Util.gather((List)lvt_3_1_.map((p_219092_1_) -> {
               return (CompletableFuture)p_219092_1_.map(p_219078_2_::func_213141_a, (p_219077_0_) -> {
                  p_219077_0_.run();
   ...
   private <T> ChunkTaskPriorityQueue<Function<ITaskExecutor<Unit>, T>> getQueue(ITaskExecutor<T> p_219068_1_) {
      ChunkTaskPriorityQueue<? extends Function<ITaskExecutor<Unit>, ?>> lvt_2_1_ = (ChunkTaskPriorityQueue)this.queues.get(p_219068_1_);
      if (lvt_2_1_ == null) {
   ...
   public String func_225396_a() {
      return (String)this.queues.entrySet().stream().map((p_225397_0_) -> {
         return ((ITaskExecutor)p_225397_0_.getKey()).getName() + "=[" + (String)((ChunkTaskPriorityQueue)p_225397_0_.getValue()).func_225414_b().stream().map((p_225398_0_) -> {
   ...
   public static final class RunnableEntry {
      ...
      // $FF: synthetic method
      RunnableEntry(Runnable p_i50027_1_, long p_i50027_2_, boolean p_i50027_4_, Object p_i50027_5_) {
         this(p_i50027_1_, p_i50027_2_, p_i50027_4_);
      }
   }
   ...
   public static final class FunctionEntry<T> {
      ...
      // $FF: synthetic method
      FunctionEntry(Function p_i50029_1_, long p_i50029_2_, IntSupplier p_i50029_4_, Object p_i50029_5_) {
         this(p_i50029_1_, p_i50029_2_, p_i50029_4_);
      }
   }
}
