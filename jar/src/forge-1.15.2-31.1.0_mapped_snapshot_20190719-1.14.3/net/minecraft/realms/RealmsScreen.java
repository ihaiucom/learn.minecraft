...
public abstract class RealmsScreen extends RealmsGuiEventListener implements RealmsConfirmResultListener {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      for(int lvt_4_1_ = 0; lvt_4_1_ < this.proxy.buttons().size(); ++lvt_4_1_) {
         ((AbstractRealmsButton)this.proxy.buttons().get(lvt_4_1_)).render(p_render_1_, p_render_2_, p_render_3_);
      }
   ...
   protected void tickButtons() {
      ...
      while(var1.hasNext()) {
         AbstractRealmsButton<?> lvt_2_1_ = (AbstractRealmsButton)var1.next();
         lvt_2_1_.tick();
      }
   ...
   protected boolean isKeyDown(int p_isKeyDown_1_) {
      return InputMappings.isKeyDown(Minecraft.getInstance().func_228018_at_().getHandle(), p_isKeyDown_1_);
   }
