...
public class RealmsScreenProxy extends Screen {
   ...
   public List<AbstractRealmsButton<?>> buttons() {
      List<AbstractRealmsButton<?>> lvt_1_1_ = Lists.newArrayListWithExpectedSize(this.buttons.size());
      Iterator var2 = this.buttons.iterator();

      while(var2.hasNext()) {
         Widget lvt_3_1_ = (Widget)var2.next();
         lvt_1_1_.add(((RealmsAbstractButtonProxy)lvt_3_1_).getButton());
      }
   ...
   public void buttonsClear() {
      Set<IGuiEventListener> lvt_1_1_ = Sets.newHashSet(this.buttons);
      this.children.removeIf(lvt_1_1_::contains);
      this.buttons.clear();
   }
