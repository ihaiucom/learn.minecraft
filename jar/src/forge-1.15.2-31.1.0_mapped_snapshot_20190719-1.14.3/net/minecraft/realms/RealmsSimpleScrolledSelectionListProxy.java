...
public class RealmsSimpleScrolledSelectionListProxy extends SlotGui {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      if (this.visible) {
         ...
         int lvt_4_1_ = this.getScrollbarPosition();
         int lvt_5_1_ = lvt_4_1_ + 6;
         this.capYPosition();
         Tessellator lvt_6_1_ = Tessellator.getInstance();
         BufferBuilder lvt_7_1_ = lvt_6_1_.getBuffer();
         int lvt_8_1_ = this.x0 + this.width / 2 - this.getRowWidth() / 2 + 2;
         int lvt_9_1_ = this.y0 + 4 - (int)this.yo;
         if (this.renderHeader) {
            this.renderHeader(lvt_8_1_, lvt_9_1_, lvt_6_1_);
         }

         this.renderList(lvt_8_1_, lvt_9_1_, p_render_1_, p_render_2_, p_render_3_);
         ...
         if (lvt_10_1_ > 0) {
            int lvt_11_1_ = (this.y1 - this.y0) * (this.y1 - this.y0) / this.getMaxPosition();
            lvt_11_1_ = MathHelper.clamp(lvt_11_1_, 32, this.y1 - this.y0 - 8);
            int lvt_12_1_ = (int)this.yo * (this.y1 - this.y0 - lvt_11_1_) / lvt_10_1_ + this.y0;
            if (lvt_12_1_ < this.y0) {
               lvt_12_1_ = this.y0;
            }

            lvt_7_1_.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            lvt_7_1_.func_225582_a_((double)lvt_4_1_, (double)this.y1, 0.0D).func_225583_a_(0.0F, 1.0F).func_225586_a_(0, 0, 0, 255).endVertex();
            lvt_7_1_.func_225582_a_((double)lvt_5_1_, (double)this.y1, 0.0D).func_225583_a_(1.0F, 1.0F).func_225586_a_(0, 0, 0, 255).endVertex();
            lvt_7_1_.func_225582_a_((double)lvt_5_1_, (double)this.y0, 0.0D).func_225583_a_(1.0F, 0.0F).func_225586_a_(0, 0, 0, 255).endVertex();
            lvt_7_1_.func_225582_a_((double)lvt_4_1_, (double)this.y0, 0.0D).func_225583_a_(0.0F, 0.0F).func_225586_a_(0, 0, 0, 255).endVertex();
            lvt_6_1_.draw();
            lvt_7_1_.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            lvt_7_1_.func_225582_a_((double)lvt_4_1_, (double)(lvt_12_1_ + lvt_11_1_), 0.0D).func_225583_a_(0.0F, 1.0F).func_225586_a_(128, 128, 128, 255).endVertex();
            lvt_7_1_.func_225582_a_((double)lvt_5_1_, (double)(lvt_12_1_ + lvt_11_1_), 0.0D).func_225583_a_(1.0F, 1.0F).func_225586_a_(128, 128, 128, 255).endVertex();
            lvt_7_1_.func_225582_a_((double)lvt_5_1_, (double)lvt_12_1_, 0.0D).func_225583_a_(1.0F, 0.0F).func_225586_a_(128, 128, 128, 255).endVertex();
            lvt_7_1_.func_225582_a_((double)lvt_4_1_, (double)lvt_12_1_, 0.0D).func_225583_a_(0.0F, 0.0F).func_225586_a_(128, 128, 128, 255).endVertex();
            lvt_6_1_.draw();
            lvt_7_1_.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            lvt_7_1_.func_225582_a_((double)lvt_4_1_, (double)(lvt_12_1_ + lvt_11_1_ - 1), 0.0D).func_225583_a_(0.0F, 1.0F).func_225586_a_(192, 192, 192, 255).endVertex();
            lvt_7_1_.func_225582_a_((double)(lvt_5_1_ - 1), (double)(lvt_12_1_ + lvt_11_1_ - 1), 0.0D).func_225583_a_(1.0F, 1.0F).func_225586_a_(192, 192, 192, 255).endVertex();
            lvt_7_1_.func_225582_a_((double)(lvt_5_1_ - 1), (double)lvt_12_1_, 0.0D).func_225583_a_(1.0F, 0.0F).func_225586_a_(192, 192, 192, 255).endVertex();
            lvt_7_1_.func_225582_a_((double)lvt_4_1_, (double)lvt_12_1_, 0.0D).func_225583_a_(0.0F, 0.0F).func_225586_a_(192, 192, 192, 255).endVertex();
            lvt_6_1_.draw();
         }
