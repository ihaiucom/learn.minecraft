...
public abstract class RealmsButton extends AbstractRealmsButton<RealmsButtonProxy> {
   ...
   public RealmsButton(int p_i1177_1_, int p_i1177_2_, int p_i1177_3_, String p_i1177_4_) {
      this(p_i1177_1_, p_i1177_2_, p_i1177_3_, 200, 20, p_i1177_4_);
   }

   public RealmsButton(int p_i1178_1_, int p_i1178_2_, int p_i1178_3_, int p_i1178_4_, int p_i1178_5_, String p_i1178_6_) {
      this.id = p_i1178_1_;
      this.proxy = new RealmsButtonProxy(this, p_i1178_2_, p_i1178_3_, p_i1178_6_, p_i1178_4_, p_i1178_5_, (p_229953_1_) -> {
         this.onPress();
      });
   }
