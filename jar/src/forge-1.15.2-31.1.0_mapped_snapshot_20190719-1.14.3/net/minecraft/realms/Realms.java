...
public class Realms {
   ...
   public static String sessionId() {
      Session lvt_0_1_ = Minecraft.getInstance().getSession();
      return lvt_0_1_ == null ? null : lvt_0_1_.getSessionID();
   }

   public static String userName() {
      Session lvt_0_1_ = Minecraft.getInstance().getSession();
      return lvt_0_1_ == null ? null : lvt_0_1_.getUsername();
   }
   ...
   public static void deletePlayerTag(File p_deletePlayerTag_0_) {
      if (p_deletePlayerTag_0_.exists()) {
         try {
            CompoundNBT lvt_1_1_ = CompressedStreamTools.readCompressed(new FileInputStream(p_deletePlayerTag_0_));
            CompoundNBT lvt_2_1_ = lvt_1_1_.getCompound("Data");
            lvt_2_1_.remove("Player");
            CompressedStreamTools.writeCompressed(lvt_1_1_, new FileOutputStream(p_deletePlayerTag_0_));
   ...
   public static void bind(String p_bind_0_) {
      ...
      Minecraft.getInstance().getTextureManager().bindTexture(lvt_1_1_);
   }

   public static void narrateNow(String p_narrateNow_0_) {
      NarratorChatListener lvt_1_1_ = NarratorChatListener.INSTANCE;
      lvt_1_1_.clear();
      lvt_1_1_.say(ChatType.SYSTEM, new StringTextComponent(fixNarrationNewlines(p_narrateNow_0_)));
   }
   ...
   public static void narrateNow(String... p_narrateNow_0_) {
      narrateNow((Iterable)Arrays.asList(p_narrateNow_0_));
   }
