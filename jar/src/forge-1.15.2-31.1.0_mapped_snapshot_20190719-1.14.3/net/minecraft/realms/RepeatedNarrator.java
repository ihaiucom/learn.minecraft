...
public class RepeatedNarrator {
   ...
   public RepeatedNarrator(Duration p_i49961_1_) {
      ...
      float lvt_2_1_ = (float)p_i49961_1_.toMillis() / 1000.0F;
      this.permitsPerSecond = 1.0F / lvt_2_1_;
   }

   public void narrate(String p_narrate_1_) {
      RepeatedNarrator.Parameter lvt_2_1_ = (RepeatedNarrator.Parameter)this.params.updateAndGet((p_229956_2_) -> {
      ...
      if (lvt_2_1_.field_214463_b.tryAcquire(1)) {
         NarratorChatListener lvt_3_1_ = NarratorChatListener.INSTANCE;
         lvt_3_1_.say(ChatType.SYSTEM, new StringTextComponent(p_narrate_1_));
      }
