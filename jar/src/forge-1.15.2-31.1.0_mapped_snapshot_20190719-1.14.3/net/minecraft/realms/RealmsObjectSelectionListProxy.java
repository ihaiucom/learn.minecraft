...
public class RealmsObjectSelectionListProxy<E extends ExtendedList.AbstractListEntry<E>> extends ExtendedList<E> {
   ...
   protected void setSelectedItem(int p_setSelectedItem_1_) {
      if (p_setSelectedItem_1_ == -1) {
         super.setSelected((AbstractList.AbstractListEntry)null);
      } else if (super.getItemCount() != 0) {
         E lvt_2_1_ = (ExtendedList.AbstractListEntry)super.getEntry(p_setSelectedItem_1_);
         super.setSelected(lvt_2_1_);
      }
   ...
   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      return this.realmsObjectSelectionList.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_) ? true : access$001(this, p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_);
   }
   ...
   public E remove(int p_remove_1_) {
      return (ExtendedList.AbstractListEntry)super.remove(p_remove_1_);
   }
   ...
   // $FF: synthetic method
   static boolean access$001(RealmsObjectSelectionListProxy p_access$001_0_, double p_access$001_1_, double p_access$001_3_, int p_access$001_5_) {
      return p_access$001_0_.mouseClicked(p_access$001_1_, p_access$001_3_, p_access$001_5_);
   }
}
