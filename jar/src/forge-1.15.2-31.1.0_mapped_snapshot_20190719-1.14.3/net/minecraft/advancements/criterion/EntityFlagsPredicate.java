...
public class EntityFlagsPredicate {
   ...
   public static EntityFlagsPredicate deserialize(@Nullable JsonElement p_217975_0_) {
      if (p_217975_0_ != null && !p_217975_0_.isJsonNull()) {
         JsonObject lvt_1_1_ = JSONUtils.getJsonObject(p_217975_0_, "entity flags");
         Boolean lvt_2_1_ = getBoolean(lvt_1_1_, "is_on_fire");
         Boolean lvt_3_1_ = getBoolean(lvt_1_1_, "is_sneaking");
         Boolean lvt_4_1_ = getBoolean(lvt_1_1_, "is_sprinting");
         Boolean lvt_5_1_ = getBoolean(lvt_1_1_, "is_swimming");
         Boolean lvt_6_1_ = getBoolean(lvt_1_1_, "is_baby");
         return new EntityFlagsPredicate(lvt_2_1_, lvt_3_1_, lvt_4_1_, lvt_5_1_, lvt_6_1_);
      } else {
         return ALWAYS_TRUE;
      }
   }
   ...
   public JsonElement serialize() {
      if (this == ALWAYS_TRUE) {
         ...
         this.putBoolean(lvt_1_1_, "is_on_fire", this.onFire);
         this.putBoolean(lvt_1_1_, "is_sneaking", this.field_226569_c_);
         this.putBoolean(lvt_1_1_, "is_sprinting", this.sprinting);
         this.putBoolean(lvt_1_1_, "is_swimming", this.swimming);
         this.putBoolean(lvt_1_1_, "is_baby", this.baby);
         return lvt_1_1_;
      }
   }
