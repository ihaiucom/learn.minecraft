...
public class PalettedContainer<T> implements IResizeCallback<T> {
   ...
   private final IResizeCallback<T> field_205522_c = (p_lambda$new$0_0_, p_lambda$new$0_1_) -> {
      return 0;
   };
   ...
   public void lock() {
      if (this.lock.isLocked() && !this.lock.isHeldByCurrentThread()) {
         String s = (String)Thread.getAllStackTraces().keySet().stream().filter(Objects::nonNull).map((p_lambda$lock$1_0_) -> {
            return p_lambda$lock$1_0_.getName() + ": \n\tat " + (String)Arrays.stream(p_lambda$lock$1_0_.getStackTrace()).map(Object::toString).collect(Collectors.joining("\n\tat "));
         }).collect(Collectors.joining("\n"));
         CrashReport crashreport = new CrashReport("Writing into PalettedContainer from multiple threads", new IllegalStateException());
         CrashReportCategory crashreportcategory = crashreport.makeCategory("Thread dumps");
         crashreportcategory.addDetail("Thread dumps", (Object)s);
   ...
   private void setBits(int p_186012_1_) {
      this.setBits(p_186012_1_, false);
   }
   ...
   public int onResize(int p_onResize_1_, T p_onResize_2_) {
      ...
      i = this.palette.idFor(p_onResize_2_);
      this.unlock();
      return i;
   }
   ...
   public T func_222641_a(int p_222641_1_, int p_222641_2_, int p_222641_3_, T p_222641_4_) {
      this.lock();
      T t = this.func_222643_a(getIndex(p_222641_1_, p_222641_2_, p_222641_3_), p_222641_4_);
      this.unlock();
      return t;
   }

   public T func_222639_b(int p_222639_1_, int p_222639_2_, int p_222639_3_, T p_222639_4_) {
      return this.func_222643_a(getIndex(p_222639_1_, p_222639_2_, p_222639_3_), p_222639_4_);
   }
   ...
   protected T get(int p_186015_1_) {
      T t = this.palette.get(this.storage.getAt(p_186015_1_));
      return t == null ? this.defaultState : t;
   }
   ...
   public void read(PacketBuffer p_186010_1_) {
      ...
      if (this.palette == this.field_205521_b && this.bits != regSize) {
         this.onResize(regSize, this.defaultState);
      }
   ...
   public void writeChunkPalette(CompoundNBT p_196963_1_, String p_196963_2_, String p_196963_3_) {
      this.lock();
      ...
      p_196963_1_.putLongArray(p_196963_3_, bitarray.getBackingLongArray());
      this.unlock();
   }
   ...
   public void func_225497_a(PalettedContainer.ICountConsumer<T> p_225497_1_) {
      ...
      this.storage.func_225421_a((p_lambda$func_225497_a$2_1_) -> {
         int2intmap.put(p_lambda$func_225497_a$2_1_, int2intmap.get(p_lambda$func_225497_a$2_1_) + 1);
      });
      int2intmap.int2IntEntrySet().forEach((p_lambda$func_225497_a$3_2_) -> {
         p_225497_1_.accept(this.palette.get(p_lambda$func_225497_a$3_2_.getIntKey()), p_lambda$func_225497_a$3_2_.getIntValue());
      });
   }
