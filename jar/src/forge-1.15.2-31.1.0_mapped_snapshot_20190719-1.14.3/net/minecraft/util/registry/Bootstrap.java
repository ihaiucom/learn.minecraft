...
public class Bootstrap {
   ...
   private static <T> void func_218819_a(Registry<T> p_218819_0_, Function<T, String> p_218819_1_, Set<String> p_218819_2_) {
      ...
      p_218819_0_.iterator().forEachRemaining((p_lambda$func_218819_a$0_3_) -> {
         String s = (String)p_218819_1_.apply(p_lambda$func_218819_a$0_3_);
   ...
   public static Set<String> func_218816_b() {
      ...
      func_218819_a(Registry.CUSTOM_STAT, (p_lambda$func_218816_b$1_0_) -> {
         return "stat." + p_lambda$func_218816_b$1_0_.toString().replace(':', '.');
      }, set);
      return set;
   }
   ...
   public static void func_218821_c() {
      if (!alreadyRegistered) {
         ...
         if (SharedConstants.developmentMode) {
            func_218816_b().forEach((p_lambda$func_218821_c$2_0_) -> {
               LOGGER.error("Missing translations: " + p_lambda$func_218821_c$2_0_);
            });
         }
