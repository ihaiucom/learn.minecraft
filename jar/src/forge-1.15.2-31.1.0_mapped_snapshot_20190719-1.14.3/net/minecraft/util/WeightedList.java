...
public class WeightedList<U> {
   protected final List<WeightedList<U>.Entry<? extends U>> field_220658_a;
   ...
   public <T> WeightedList(Dynamic<T> p_i225709_1_, Function<Dynamic<T>, U> p_i225709_2_) {
      ...
      p_i225709_1_.asStream().forEach((p_226316_2_) -> {
         p_226316_2_.get("data").map((p_226317_3_) -> {
            U lvt_4_1_ = p_i225709_2_.apply(p_226317_3_);
            int lvt_5_1_ = p_226316_2_.get("weight").asInt(1);
            return this.func_226313_a_(lvt_4_1_, lvt_5_1_);
         });
      });
   }
   ...
   public <T> T func_226310_a_(DynamicOps<T> p_226310_1_, Function<U, Dynamic<T>> p_226310_2_) {
      return p_226310_1_.createList(this.func_226319_c_().map((p_226311_2_) -> {
         return p_226310_1_.createMap(ImmutableMap.builder().put(p_226310_1_.createString("data"), ((Dynamic)p_226310_2_.apply(p_226311_2_.func_220647_b())).getValue()).put(p_226310_1_.createString("weight"), p_226310_1_.createInt(p_226311_2_.func_226322_b_())).build());
      }));
   }
   ...
   public WeightedList<U> func_226314_a_(Random p_226314_1_) {
      ...
      this.field_220658_a.sort(Comparator.comparingDouble((p_226312_0_) -> {
         return ((WeightedList.Entry)p_226312_0_).func_220649_a();
      }));
      return this;
   }
   ...
   public class Entry<T> {
      ...
      // $FF: synthetic method
      Entry(Object p_i50546_2_, int p_i50546_3_, Object p_i50546_4_) {
         this(p_i50546_2_, p_i50546_3_);
      }
   }
}
