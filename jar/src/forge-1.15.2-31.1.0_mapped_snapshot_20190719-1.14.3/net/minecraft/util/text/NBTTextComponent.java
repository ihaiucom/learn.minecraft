...
public abstract class NBTTextComponent extends TextComponent implements ITargetedTextComponent {
   ...
   public ITextComponent createNames(@Nullable CommandSource p_197668_1_, @Nullable net.minecraft.entity.Entity p_197668_2_, int p_197668_3_) throws CommandSyntaxException {
      if (p_197668_1_ != null && this.field_218680_d != null) {
         Stream<String> lvt_4_1_ = this.func_218673_a(p_197668_1_).flatMap((p_218675_1_) -> {
            try {
         ...
         return (ITextComponent)(this.field_218678_b ? (ITextComponent)lvt_4_1_.flatMap((p_223137_3_) -> {
            try {
               ITextComponent lvt_4_1_ = ITextComponent.Serializer.fromJson(p_223137_3_);
               return Stream.of(TextComponentUtils.updateForEntity(p_197668_1_, lvt_4_1_, p_197668_2_, p_197668_3_));
            } catch (Exception var5) {
               field_218681_e.warn("Failed to parse component: " + p_223137_3_, var5);
               return Stream.of();
            }
         }).reduce((p_218671_0_, p_218671_1_) -> {
            return p_218671_0_.appendText(", ").appendSibling(p_218671_1_);
         }).orElse(new StringTextComponent("")) : new StringTextComponent(Joiner.on(", ").join(lvt_4_1_.iterator())));
      } else {
   ...
   public static class Storage extends NBTTextComponent {
      ...
      protected Stream<CompoundNBT> func_218673_a(CommandSource p_218673_1_) {
         CompoundNBT lvt_2_1_ = p_218673_1_.getServer().func_229735_aN_().func_227488_a_(this.field_229725_e_);
         return Stream.of(lvt_2_1_);
      }
      ...
      public boolean equals(Object p_equals_1_) {
         if (this == p_equals_1_) {
            ...
            NBTTextComponent.Storage lvt_2_1_ = (NBTTextComponent.Storage)p_equals_1_;
            return Objects.equals(this.field_229725_e_, lvt_2_1_.field_229725_e_) && Objects.equals(this.field_218679_c, lvt_2_1_.field_218679_c) && super.equals(p_equals_1_);
         }
      }
   ...
   public static class Block extends NBTTextComponent {
      ...
      protected Stream<CompoundNBT> func_218673_a(CommandSource p_218673_1_) {
         if (this.field_218685_f != null) {
            ServerWorld lvt_2_1_ = p_218673_1_.getWorld();
            BlockPos lvt_3_1_ = this.field_218685_f.getBlockPos(p_218673_1_);
            if (lvt_2_1_.isBlockPresent(lvt_3_1_)) {
               TileEntity lvt_4_1_ = lvt_2_1_.getTileEntity(lvt_3_1_);
               if (lvt_4_1_ != null) {
                  return Stream.of(lvt_4_1_.write(new CompoundNBT()));
               }
            }
         }
      ...
      public boolean equals(Object p_equals_1_) {
         if (this == p_equals_1_) {
            ...
            NBTTextComponent.Block lvt_2_1_ = (NBTTextComponent.Block)p_equals_1_;
            return Objects.equals(this.field_218684_e, lvt_2_1_.field_218684_e) && Objects.equals(this.field_218679_c, lvt_2_1_.field_218679_c) && super.equals(p_equals_1_);
         }
      }
   ...
   public static class Entity extends NBTTextComponent {
      ...
      private static EntitySelector func_218686_b(String p_218686_0_) {
         try {
            EntitySelectorParser lvt_1_1_ = new EntitySelectorParser(new StringReader(p_218686_0_));
            return lvt_1_1_.parse();
         } catch (CommandSyntaxException var2) {
            return null;
         }
      }
      ...
      protected Stream<CompoundNBT> func_218673_a(CommandSource p_218673_1_) throws CommandSyntaxException {
         if (this.field_218689_f != null) {
            List<? extends net.minecraft.entity.Entity> lvt_2_1_ = this.field_218689_f.select(p_218673_1_);
            return lvt_2_1_.stream().map(NBTPredicate::writeToNBTWithSelectedItem);
         } else {
            return Stream.empty();
         }
      }
      ...
      public boolean equals(Object p_equals_1_) {
         if (this == p_equals_1_) {
            ...
            NBTTextComponent.Entity lvt_2_1_ = (NBTTextComponent.Entity)p_equals_1_;
            return Objects.equals(this.field_218688_e, lvt_2_1_.field_218688_e) && Objects.equals(this.field_218679_c, lvt_2_1_.field_218679_c) && super.equals(p_equals_1_);
         }
      }
