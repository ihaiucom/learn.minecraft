...
public class PotionItems extends DataFix {
   private static final String[] POTION_IDS = (String[])DataFixUtils.make(new String[128], (p_209316_0_) -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemPotionFix", lvt_1_1_, (p_206351_2_) -> {
         Optional<Pair<String, String>> lvt_3_1_x = p_206351_2_.getOptional(lvt_2_1_);
         if (lvt_3_1_x.isPresent() && Objects.equals(((Pair)lvt_3_1_x.get()).getSecond(), "minecraft:potion")) {
            Dynamic<?> lvt_4_1_ = (Dynamic)p_206351_2_.get(DSL.remainderFinder());
            Optional<? extends Typed<?>> lvt_5_1_ = p_206351_2_.getOptionalTyped(lvt_3_1_);
            short lvt_6_1_ = lvt_4_1_.get("Damage").asShort((short)0);
            if (lvt_5_1_.isPresent()) {
               Typed<?> lvt_7_1_ = p_206351_2_;
               Dynamic<?> lvt_8_1_ = (Dynamic)((Typed)lvt_5_1_.get()).get(DSL.remainderFinder());
               Optional<String> lvt_9_1_ = lvt_8_1_.get("Potion").asString();
               if (!lvt_9_1_.isPresent()) {
                  String lvt_10_1_ = POTION_IDS[lvt_6_1_ & 127];
                  Typed<?> lvt_11_1_ = ((Typed)lvt_5_1_.get()).set(DSL.remainderFinder(), lvt_8_1_.set("Potion", lvt_8_1_.createString(lvt_10_1_ == null ? "minecraft:water" : lvt_10_1_)));
                  lvt_7_1_ = p_206351_2_.set(lvt_3_1_, lvt_11_1_);
                  if ((lvt_6_1_ & 16384) == 16384) {
                     lvt_7_1_ = lvt_7_1_.set(lvt_2_1_, Pair.of(TypeReferences.ITEM_NAME.typeName(), "minecraft:splash_potion"));
                  }
               }

               if (lvt_6_1_ != 0) {
                  lvt_4_1_ = lvt_4_1_.set("Damage", lvt_4_1_.createShort((short)0));
               }

               return lvt_7_1_.set(DSL.remainderFinder(), lvt_4_1_);
            }
         }
