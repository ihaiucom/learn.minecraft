...
public class EntityId extends DataFix {
   private static final Map<String, String> OLD_TO_NEW_ID_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_209312_0_) -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> lvt_3_1_ = this.getInputSchema().getType(TypeReferences.ITEM_STACK);
      Type<?> lvt_4_1_ = this.getOutputSchema().getType(TypeReferences.ITEM_STACK);
      return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", lvt_3_1_, lvt_4_1_), this.fixTypeEverywhere("EntityIdFix", lvt_1_1_, lvt_2_1_, (p_209744_0_) -> {
         return (p_206326_0_) -> {
            return p_206326_0_.mapFirst((p_206327_0_) -> {
               return (String)OLD_TO_NEW_ID_MAP.getOrDefault(p_206327_0_, p_206327_0_);
            });
         };
      }));
   }
