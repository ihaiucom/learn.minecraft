...
public class LWJGL3KeyOptions extends DataFix {
   private static final Int2ObjectMap<String> field_199186_a = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (p_206279_0_) -> {
   ...
   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("OptionsKeyLwjgl3Fix", this.getInputSchema().getType(TypeReferences.OPTIONS), (p_207423_0_) -> {
         return p_207423_0_.update(DSL.remainderFinder(), (p_207424_0_) -> {
            return (Dynamic)p_207424_0_.getMapValues().map((p_209663_1_) -> {
               return p_207424_0_.createMap((Map)p_209663_1_.entrySet().stream().map((p_209661_0_) -> {
                  if (((Dynamic)p_209661_0_.getKey()).asString("").startsWith("key_")) {
                     int lvt_1_1_ = Integer.parseInt(((Dynamic)p_209661_0_.getValue()).asString(""));
                     if (lvt_1_1_ < 0) {
                        int lvt_2_1_ = lvt_1_1_ + 100;
                        String lvt_3_4_;
                        if (lvt_2_1_ == 0) {
                           lvt_3_4_ = "key.mouse.left";
                        } else if (lvt_2_1_ == 1) {
                           lvt_3_4_ = "key.mouse.right";
                        } else if (lvt_2_1_ == 2) {
                           lvt_3_4_ = "key.mouse.middle";
                        } else {
                           lvt_3_4_ = "key.mouse." + (lvt_2_1_ + 1);
                        }

                        return Pair.of(p_209661_0_.getKey(), ((Dynamic)p_209661_0_.getValue()).createString(lvt_3_4_));
                     } else {
                        String lvt_2_2_ = (String)field_199186_a.getOrDefault(lvt_1_1_, "key.unknown");
                        return Pair.of(p_209661_0_.getKey(), ((Dynamic)p_209661_0_.getValue()).createString(lvt_2_2_));
                     }
                  } else {
