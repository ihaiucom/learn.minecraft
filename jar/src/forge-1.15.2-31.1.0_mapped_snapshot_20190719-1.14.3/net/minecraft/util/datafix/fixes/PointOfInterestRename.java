...
public abstract class PointOfInterestRename extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      if (!Objects.equals(lvt_1_1_, this.getInputSchema().getType(TypeReferences.POI_CHUNK))) {
         ...
         return this.fixTypeEverywhere("POI rename", lvt_1_1_, (p_226203_1_) -> {
            return (p_226206_1_) -> {
         ...
         return p_226209_1_.updateMapValues((p_226204_1_) -> {
            return p_226204_1_.mapSecond((p_226210_1_) -> {
               return p_226210_1_.update("Records", (p_226211_1_) -> {
                  return (Dynamic)DataFixUtils.orElse(this.func_226205_b_(p_226211_1_), p_226211_1_);
               });
            });
         });
      });
      ...
      return p_226205_1_.asStreamOpt().map((p_226202_2_) -> {
         return p_226205_1_.createList(p_226202_2_.map((p_226207_1_) -> {
            return p_226207_1_.update("type", (p_226208_1_) -> {
               Optional var10000 = p_226208_1_.asString().map(this::func_225501_a_);
               p_226208_1_.getClass();
               return (Dynamic)DataFixUtils.orElse(var10000.map(p_226208_1_::createString), p_226208_1_);
            });
         }));
      });
   }
