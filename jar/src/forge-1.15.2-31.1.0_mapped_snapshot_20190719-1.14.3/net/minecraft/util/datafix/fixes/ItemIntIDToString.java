...
public class ItemIntIDToString extends DataFix {
   private static final Int2ObjectMap<String> ID_MAP = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (p_207470_0_) -> {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> lvt_1_1_ = DSL.or(DSL.intType(), DSL.named(TypeReferences.ITEM_NAME.typeName(), DSL.namespacedString()));
      Type<Pair<String, String>> lvt_2_1_ = DSL.named(TypeReferences.ITEM_NAME.typeName(), DSL.namespacedString());
      OpticFinder<Either<Integer, Pair<String, String>>> lvt_3_1_ = DSL.fieldFinder("id", lvt_1_1_);
      return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(TypeReferences.ITEM_STACK), this.getOutputSchema().getType(TypeReferences.ITEM_STACK), (p_206349_2_) -> {
         return p_206349_2_.update(lvt_3_1_, lvt_2_1_, (p_206350_0_) -> {
            return (Pair)p_206350_0_.map((p_207473_0_) -> {
