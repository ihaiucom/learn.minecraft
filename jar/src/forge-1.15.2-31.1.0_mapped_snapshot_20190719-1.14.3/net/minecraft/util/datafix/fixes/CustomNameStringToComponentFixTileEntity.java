   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("BlockEntityCustomNameToComponentFix", this.getInputSchema().getType(TypeReferences.BLOCK_ENTITY), (p_207790_1_) -> {
         return p_207790_1_.update(DSL.remainderFinder(), (p_207789_2_) -> {
            Optional<String> lvt_3_1_ = p_207790_1_.getOptional(lvt_1_1_);
            return lvt_3_1_.isPresent() && Objects.equals(lvt_3_1_.get(), "minecraft:command_block") ? p_207789_2_ : CustomNameStringToComponentEntity.fixTagCustomName(p_207789_2_);
         });
      });
   }
}
