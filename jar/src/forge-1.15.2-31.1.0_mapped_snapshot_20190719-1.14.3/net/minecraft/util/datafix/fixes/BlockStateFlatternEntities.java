...
public class BlockStateFlatternEntities extends DataFix {
   private static final Map<String, Integer> MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_209311_0_) -> {
   ...
   public static int getBlockId(String p_199171_0_) {
      Integer lvt_1_1_ = (Integer)MAP.get(p_199171_0_);
   ...
   public TypeRewriteRule makeRule() {
      ...
      Function<Typed<?>, Typed<?>> lvt_3_1_ = (p_211443_1_) -> {
         return this.updateBlockToBlockState(p_211443_1_, "DisplayTile", "DisplayData", "DisplayState");
      };
      Function<Typed<?>, Typed<?>> lvt_4_1_ = (p_211429_1_) -> {
         return this.updateBlockToBlockState(p_211429_1_, "inTile", "inData", "inBlockState");
      };
      Type<Pair<Either<Pair<String, Either<Integer, String>>, Unit>, Dynamic<?>>> lvt_5_1_ = DSL.and(DSL.optional(DSL.field("inTile", DSL.named(TypeReferences.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), DSL.namespacedString())))), DSL.remainderType());
      Function<Typed<?>, Typed<?>> lvt_6_1_ = (p_211439_1_) -> {
         return p_211439_1_.update(lvt_5_1_.finder(), DSL.remainderType(), Pair::getSecond);
      };
      return this.fixTypeEverywhereTyped("EntityBlockStateFix", lvt_1_1_.getType(TypeReferences.ENTITY), lvt_2_1_.getType(TypeReferences.ENTITY), (p_211438_4_) -> {
         ...
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:arrow", lvt_4_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:spectral_arrow", lvt_4_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:egg", lvt_6_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:ender_pearl", lvt_6_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:fireball", lvt_6_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:potion", lvt_6_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:small_fireball", lvt_6_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:snowball", lvt_6_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:wither_skull", lvt_6_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:xp_bottle", lvt_6_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:commandblock_minecart", lvt_3_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:minecart", lvt_3_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:chest_minecart", lvt_3_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:furnace_minecart", lvt_3_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:tnt_minecart", lvt_3_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:hopper_minecart", lvt_3_1_);
         p_211438_4_ = this.updateEntity(p_211438_4_, "minecraft:spawner_minecart", lvt_3_1_);
         return p_211438_4_;
      });
   }

   private Typed<?> updateFallingBlock(Typed<?> p_211442_1_) {
      Type<Either<Pair<String, Either<Integer, String>>, Unit>> lvt_2_1_ = DSL.optional(DSL.field("Block", DSL.named(TypeReferences.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), DSL.namespacedString()))));
      Type<Either<Pair<String, Dynamic<?>>, Unit>> lvt_3_1_ = DSL.optional(DSL.field("BlockState", DSL.named(TypeReferences.BLOCK_STATE.typeName(), DSL.remainderType())));
      Dynamic<?> lvt_4_1_ = (Dynamic)p_211442_1_.get(DSL.remainderFinder());
      return p_211442_1_.update(lvt_2_1_.finder(), lvt_3_1_, (p_211437_1_) -> {
         int lvt_2_1_ = (Integer)p_211437_1_.map((p_211440_0_) -> {
            return (Integer)((Either)p_211440_0_.getSecond()).map((p_211436_0_) -> {
               return p_211436_0_;
            }, BlockStateFlatternEntities::getBlockId);
         }, (p_211441_1_) -> {
            Optional<Number> lvt_2_1_ = lvt_4_1_.get("TileID").asNumber();
            return (Integer)lvt_2_1_.map(Number::intValue).orElseGet(() -> {
               return lvt_4_1_.get("Tile").asByte((byte)0) & 255;
            });
         });
         int lvt_3_1_ = lvt_4_1_.get("Data").asInt(0) & 15;
         return Either.left(Pair.of(TypeReferences.BLOCK_STATE.typeName(), BlockStateFlatteningMap.getFixedNBTForID(lvt_2_1_ << 4 | lvt_3_1_)));
      }).set(DSL.remainderFinder(), lvt_4_1_.remove("Data").remove("TileID").remove("Tile"));
   }

   private Typed<?> updateBlockToBlockState(Typed<?> p_211434_1_, String p_211434_2_, String p_211434_3_, String p_211434_4_) {
      Type<Pair<String, Either<Integer, String>>> lvt_5_1_ = DSL.field(p_211434_2_, DSL.named(TypeReferences.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), DSL.namespacedString())));
      Type<Pair<String, Dynamic<?>>> lvt_6_1_ = DSL.field(p_211434_4_, DSL.named(TypeReferences.BLOCK_STATE.typeName(), DSL.remainderType()));
      Dynamic<?> lvt_7_1_ = (Dynamic)p_211434_1_.getOrCreate(DSL.remainderFinder());
      return p_211434_1_.update(lvt_5_1_.finder(), lvt_6_1_, (p_211432_2_) -> {
         int lvt_3_1_ = (Integer)((Either)p_211432_2_.getSecond()).map((p_211435_0_) -> {
            return p_211435_0_;
         }, BlockStateFlatternEntities::getBlockId);
         int lvt_4_1_ = lvt_7_1_.get(p_211434_3_).asInt(0) & 15;
         return Pair.of(TypeReferences.BLOCK_STATE.typeName(), BlockStateFlatteningMap.getFixedNBTForID(lvt_3_1_ << 4 | lvt_4_1_));
      }).set(DSL.remainderFinder(), lvt_7_1_.remove(p_211434_3_));
   }

   private Typed<?> updateEntity(Typed<?> p_211431_1_, String p_211431_2_, Function<Typed<?>, Typed<?>> p_211431_3_) {
      Type<?> lvt_4_1_ = this.getInputSchema().getChoiceType(TypeReferences.ENTITY, p_211431_2_);
      Type<?> lvt_5_1_ = this.getOutputSchema().getChoiceType(TypeReferences.ENTITY, p_211431_2_);
      return p_211431_1_.updateTyped(DSL.namedChoice(p_211431_2_, lvt_4_1_), lvt_5_1_, p_211431_3_);
   }
}
