...
public class ChunkPaletteFormat extends DataFix {
   ...
   private static final Map<String, Dynamic<?>> FLOWER_POT_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_209306_0_) -> {
   ...
   private static final Map<String, Dynamic<?>> SKULL_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_209308_0_) -> {
   ...
   private static final Map<String, Dynamic<?>> DOOR_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_209298_0_) -> {
   ...
   private static final Map<String, Dynamic<?>> NOTE_BLOCK_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_209302_0_) -> {
      for(int lvt_1_1_ = 0; lvt_1_1_ < 26; ++lvt_1_1_) {
         p_209302_0_.put("true" + lvt_1_1_, BlockStateFlatteningMap.makeDynamic("{Name:'minecraft:note_block',Properties:{powered:'true',note:'" + lvt_1_1_ + "'}}"));
         p_209302_0_.put("false" + lvt_1_1_, BlockStateFlatteningMap.makeDynamic("{Name:'minecraft:note_block',Properties:{powered:'false',note:'" + lvt_1_1_ + "'}}"));
      }

   });
   private static final Int2ObjectMap<String> DYE_COLOR_MAP = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (p_209296_0_) -> {
   ...
   private static final Map<String, Dynamic<?>> BED_BLOCK_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_209304_0_) -> {
      ObjectIterator var1 = DYE_COLOR_MAP.int2ObjectEntrySet().iterator();

      while(var1.hasNext()) {
         Entry<String> lvt_2_1_ = (Entry)var1.next();
         if (!Objects.equals(lvt_2_1_.getValue(), "red")) {
            addBeds(p_209304_0_, lvt_2_1_.getIntKey(), (String)lvt_2_1_.getValue());
         }
      }

   });
   private static final Map<String, Dynamic<?>> BANNER_BLOCK_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_209299_0_) -> {
      ObjectIterator var1 = DYE_COLOR_MAP.int2ObjectEntrySet().iterator();

      while(var1.hasNext()) {
         Entry<String> lvt_2_1_ = (Entry)var1.next();
         if (!Objects.equals(lvt_2_1_.getValue(), "white")) {
            addBanners(p_209299_0_, 15 - lvt_2_1_.getIntKey(), (String)lvt_2_1_.getValue());
         }
      }
   ...
   private static void mapSkull(Map<String, Dynamic<?>> p_209300_0_, int p_209300_1_, String p_209300_2_, String p_209300_3_) {
      ...
      for(int lvt_4_1_ = 0; lvt_4_1_ < 16; ++lvt_4_1_) {
         p_209300_0_.put(p_209300_1_ + "" + lvt_4_1_, BlockStateFlatteningMap.makeDynamic("{Name:'minecraft:" + p_209300_2_ + "_" + p_209300_3_ + "',Properties:{rotation:'" + lvt_4_1_ + "'}}"));
      }
   ...
   private static void addBanners(Map<String, Dynamic<?>> p_209297_0_, int p_209297_1_, String p_209297_2_) {
      for(int lvt_3_1_ = 0; lvt_3_1_ < 16; ++lvt_3_1_) {
         p_209297_0_.put("" + lvt_3_1_ + "_" + p_209297_1_, BlockStateFlatteningMap.makeDynamic("{Name:'minecraft:" + p_209297_2_ + "_banner',Properties:{rotation:'" + lvt_3_1_ + "'}}"));
      }
   ...
   public static int idFor(IntIdentityHashBiMap<Dynamic<?>> p_209724_0_, Dynamic<?> p_209724_1_) {
      int lvt_2_1_ = p_209724_0_.getId(p_209724_1_);
      if (lvt_2_1_ == -1) {
         lvt_2_1_ = p_209724_0_.add(p_209724_1_);
      }
   ...
   private Dynamic<?> fix(Dynamic<?> p_209712_1_) {
      Optional<? extends Dynamic<?>> lvt_2_1_ = p_209712_1_.get("Level").get();
      return lvt_2_1_.isPresent() && ((Dynamic)lvt_2_1_.get()).get("Sections").asStreamOpt().isPresent() ? p_209712_1_.set("Level", (new ChunkPaletteFormat.UpgradeChunk((Dynamic)lvt_2_1_.get())).write()) : p_209712_1_;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.writeFixAndRead("ChunkPalettedStorageFix", lvt_1_1_, lvt_2_1_, this::fix);
   }
   ...
   static {
      ...
      VIRTUAL.set(139);
      VIRTUAL.set(199);
      AIR = BlockStateFlatteningMap.getFixedNBTForID(0);
   }
   ...
   static class NibbleArray {
      ...
      public int get(int p_210932_1_, int p_210932_2_, int p_210932_3_) {
         int lvt_4_1_ = this.getPosition(p_210932_2_ << 8 | p_210932_3_ << 4 | p_210932_1_);
         return this.isFirst(p_210932_2_ << 8 | p_210932_3_ << 4 | p_210932_1_) ? this.data[lvt_4_1_] & 15 : this.data[lvt_4_1_] >> 4 & 15;
      }
   ...
   static final class UpgradeChunk {
      ...
      public UpgradeChunk(Dynamic<?> p_i49574_1_) {
         this.level = p_i49574_1_;
         this.x = p_i49574_1_.get("xPos").asInt(0) << 4;
         this.z = p_i49574_1_.get("zPos").asInt(0) << 4;
         p_i49574_1_.get("TileEntities").asStreamOpt().ifPresent((p_210061_1_) -> {
            p_210061_1_.forEach((p_210063_1_) -> {
               int lvt_2_1_ = p_210063_1_.get("x").asInt(0) - this.x & 15;
               int lvt_3_1_ = p_210063_1_.get("y").asInt(0);
               int lvt_4_1_ = p_210063_1_.get("z").asInt(0) - this.z & 15;
               int lvt_5_1_ = lvt_3_1_ << 8 | lvt_4_1_ << 4 | lvt_2_1_;
               if (this.tileEntities.put(lvt_5_1_, p_210063_1_) != null) {
                  ChunkPaletteFormat.LOGGER.warn("In chunk: {}x{} found a duplicate block entity at position: [{}, {}, {}]", this.x, this.z, lvt_2_1_, lvt_3_1_, lvt_4_1_);
               }

            });
         });
         boolean lvt_2_1_ = p_i49574_1_.get("convertedFromAlphaFormat").asBoolean(false);
         p_i49574_1_.get("Sections").asStreamOpt().ifPresent((p_210062_1_) -> {
            p_210062_1_.forEach((p_210065_1_) -> {
               ChunkPaletteFormat.Section lvt_2_1_ = new ChunkPaletteFormat.Section(p_210065_1_);
               this.sides = lvt_2_1_.upgrade(this.sides);
               this.sections[lvt_2_1_.y] = lvt_2_1_;
            });
         });
         ChunkPaletteFormat.Section[] var3 = this.sections;
         int var4 = var3.length;

         label261:
         for(int var5 = 0; var5 < var4; ++var5) {
            ChunkPaletteFormat.Section lvt_6_1_ = var3[var5];
            if (lvt_6_1_ != null) {
               ObjectIterator var7 = lvt_6_1_.toFix.entrySet().iterator();
               ...
               while(true) {
                  ...
                  while(true) {
                     ...
                     java.util.Map.Entry<Integer, IntList> lvt_8_1_ = (java.util.Map.Entry)var7.next();
                     int lvt_9_1_ = lvt_6_1_.y << 12;
                     ...
                     String lvt_13_9_;
                     String lvt_14_5_;
                     switch((Integer)lvt_8_1_.getKey()) {
                     case 2:
                        var10 = ((IntList)lvt_8_1_.getValue()).iterator();
                        ...
                        while(true) {
                           do {
                              do {
                                 ...
                                 lvt_11_11_ = (Integer)var10.next();
                                 lvt_11_11_ |= lvt_9_1_;
                                 lvt_12_9_ = this.getBlock(lvt_11_11_);
                              } while(!"minecraft:grass_block".equals(ChunkPaletteFormat.getName(lvt_12_9_)));

                              lvt_13_9_ = ChunkPaletteFormat.getName(this.getBlock(relative(lvt_11_11_, ChunkPaletteFormat.Direction.UP)));
                           } while(!"minecraft:snow".equals(lvt_13_9_) && !"minecraft:snow_layer".equals(lvt_13_9_));

                           this.setBlock(lvt_11_11_, ChunkPaletteFormat.SNOWY_GRASS);
                        }
                     case 3:
                        var10 = ((IntList)lvt_8_1_.getValue()).iterator();
                        ...
                        while(true) {
                           do {
                              do {
                                 ...
                                 lvt_11_11_ |= lvt_9_1_;
                                 lvt_12_9_ = this.getBlock(lvt_11_11_);
                              } while(!"minecraft:podzol".equals(ChunkPaletteFormat.getName(lvt_12_9_)));

                              lvt_13_9_ = ChunkPaletteFormat.getName(this.getBlock(relative(lvt_11_11_, ChunkPaletteFormat.Direction.UP)));
                           } while(!"minecraft:snow".equals(lvt_13_9_) && !"minecraft:snow_layer".equals(lvt_13_9_));

                           this.setBlock(lvt_11_11_, ChunkPaletteFormat.SNOWY_PODZOL);
                        }
                     case 25:
                        var10 = ((IntList)lvt_8_1_.getValue()).iterator();
                        ...
                        while(true) {
                           ...
                           lvt_11_11_ = (Integer)var10.next();
                           lvt_11_11_ |= lvt_9_1_;
                           lvt_12_9_ = this.removeTileEntity(lvt_11_11_);
                           if (lvt_12_9_ != null) {
                              lvt_13_9_ = Boolean.toString(lvt_12_9_.get("powered").asBoolean(false)) + (byte)Math.min(Math.max(lvt_12_9_.get("note").asInt(0), 0), 24);
                              this.setBlock(lvt_11_11_, (Dynamic)ChunkPaletteFormat.NOTE_BLOCK_MAP.getOrDefault(lvt_13_9_, ChunkPaletteFormat.NOTE_BLOCK_MAP.get("false0")));
                           }
                        }
                     case 26:
                        var10 = ((IntList)lvt_8_1_.getValue()).iterator();
                        ...
                        while(true) {
                           ...
                           lvt_11_11_ = (Integer)var10.next();
                           lvt_11_11_ |= lvt_9_1_;
                           lvt_12_9_ = this.getTileEntity(lvt_11_11_);
                           lvt_13_10_ = this.getBlock(lvt_11_11_);
                           if (lvt_12_9_ != null) {
                              lvt_14_4_ = lvt_12_9_.get("color").asInt(0);
                              if (lvt_14_4_ != 14 && lvt_14_4_ >= 0 && lvt_14_4_ < 16) {
                                 lvt_15_1_ = ChunkPaletteFormat.getProperty(lvt_13_10_, "facing") + ChunkPaletteFormat.getProperty(lvt_13_10_, "occupied") + ChunkPaletteFormat.getProperty(lvt_13_10_, "part") + lvt_14_4_;
                                 if (ChunkPaletteFormat.BED_BLOCK_MAP.containsKey(lvt_15_1_)) {
                                    this.setBlock(lvt_11_11_, (Dynamic)ChunkPaletteFormat.BED_BLOCK_MAP.get(lvt_15_1_));
                                 }
                              }
                           }
                        }
                     ...
                     case 197:
                        ...
                        while(true) {
                           ...
                           lvt_11_11_ |= lvt_9_1_;
                           lvt_12_9_ = this.getBlock(lvt_11_11_);
                           if (ChunkPaletteFormat.getName(lvt_12_9_).endsWith("_door")) {
                              lvt_13_10_ = this.getBlock(lvt_11_11_);
                              if ("lower".equals(ChunkPaletteFormat.getProperty(lvt_13_10_, "half"))) {
                                 lvt_14_4_ = relative(lvt_11_11_, ChunkPaletteFormat.Direction.UP);
                                 Dynamic<?> lvt_15_5_ = this.getBlock(lvt_14_4_);
                                 String lvt_16_1_ = ChunkPaletteFormat.getName(lvt_13_10_);
                                 if (lvt_16_1_.equals(ChunkPaletteFormat.getName(lvt_15_5_))) {
                                    String lvt_17_1_ = ChunkPaletteFormat.getProperty(lvt_13_10_, "facing");
                                    String lvt_18_1_ = ChunkPaletteFormat.getProperty(lvt_13_10_, "open");
                                    String lvt_19_1_ = lvt_2_1_ ? "left" : ChunkPaletteFormat.getProperty(lvt_15_5_, "hinge");
                                    String lvt_20_1_ = lvt_2_1_ ? "false" : ChunkPaletteFormat.getProperty(lvt_15_5_, "powered");
                                    this.setBlock(lvt_11_11_, (Dynamic)ChunkPaletteFormat.DOOR_MAP.get(lvt_16_1_ + lvt_17_1_ + "lower" + lvt_19_1_ + lvt_18_1_ + lvt_20_1_));
                                    this.setBlock(lvt_14_4_, (Dynamic)ChunkPaletteFormat.DOOR_MAP.get(lvt_16_1_ + lvt_17_1_ + "upper" + lvt_19_1_ + lvt_18_1_ + lvt_20_1_));
                                 }
                              }
                           }
                        }
                        ...
                        while(true) {
                           do {
                              do {
                                 ...
                                 lvt_11_11_ |= lvt_9_1_;
                                 lvt_12_9_ = this.getBlock(lvt_11_11_);
                              } while(!"minecraft:carved_pumpkin".equals(ChunkPaletteFormat.getName(lvt_12_9_)));

                              lvt_13_9_ = ChunkPaletteFormat.getName(this.getBlock(relative(lvt_11_11_, ChunkPaletteFormat.Direction.DOWN)));
                           } while(!"minecraft:grass_block".equals(lvt_13_9_) && !"minecraft:dirt".equals(lvt_13_9_));

                           this.setBlock(lvt_11_11_, ChunkPaletteFormat.PUMPKIN);
                        }
                     case 110:
                        var10 = ((IntList)lvt_8_1_.getValue()).iterator();
                        ...
                        while(true) {
                           do {
                              do {
                                 ...
                                 lvt_11_11_ |= lvt_9_1_;
                                 lvt_12_9_ = this.getBlock(lvt_11_11_);
                              } while(!"minecraft:mycelium".equals(ChunkPaletteFormat.getName(lvt_12_9_)));

                              lvt_13_9_ = ChunkPaletteFormat.getName(this.getBlock(relative(lvt_11_11_, ChunkPaletteFormat.Direction.UP)));
                           } while(!"minecraft:snow".equals(lvt_13_9_) && !"minecraft:snow_layer".equals(lvt_13_9_));

                           this.setBlock(lvt_11_11_, ChunkPaletteFormat.SNOWY_MYCELIUM);
                        }
                     case 140:
                        var10 = ((IntList)lvt_8_1_.getValue()).iterator();
                        ...
                        while(true) {
                           ...
                           lvt_12_9_ = this.removeTileEntity(lvt_11_11_);
                           if (lvt_12_9_ != null) {
                              lvt_13_9_ = lvt_12_9_.get("Item").asString("") + lvt_12_9_.get("Data").asInt(0);
                              this.setBlock(lvt_11_11_, (Dynamic)ChunkPaletteFormat.FLOWER_POT_MAP.getOrDefault(lvt_13_9_, ChunkPaletteFormat.FLOWER_POT_MAP.get("minecraft:air0")));
                           }
                        }
                     case 144:
                        var10 = ((IntList)lvt_8_1_.getValue()).iterator();
                        ...
                        while(true) {
                           do {
                              ...
                              lvt_11_11_ |= lvt_9_1_;
                              lvt_12_9_ = this.getTileEntity(lvt_11_11_);
                           } while(lvt_12_9_ == null);

                           lvt_13_9_ = String.valueOf(lvt_12_9_.get("SkullType").asInt(0));
                           lvt_14_5_ = ChunkPaletteFormat.getProperty(this.getBlock(lvt_11_11_), "facing");
                           if (!"up".equals(lvt_14_5_) && !"down".equals(lvt_14_5_)) {
                              lvt_15_1_ = lvt_13_9_ + lvt_14_5_;
                           } else {
                              lvt_15_1_ = lvt_13_9_ + String.valueOf(lvt_12_9_.get("Rot").asInt(0));
                           }

                           lvt_12_9_.remove("SkullType");
                           lvt_12_9_.remove("facing");
                           lvt_12_9_.remove("Rot");
                           this.setBlock(lvt_11_11_, (Dynamic)ChunkPaletteFormat.SKULL_MAP.getOrDefault(lvt_15_1_, ChunkPaletteFormat.SKULL_MAP.get("0north")));
                        }
                     case 175:
                        var10 = ((IntList)lvt_8_1_.getValue()).iterator();
                        ...
                        while(true) {
                           ...
                           lvt_11_11_ |= lvt_9_1_;
                           lvt_12_9_ = this.getBlock(lvt_11_11_);
                           if ("upper".equals(ChunkPaletteFormat.getProperty(lvt_12_9_, "half"))) {
                              lvt_13_10_ = this.getBlock(relative(lvt_11_11_, ChunkPaletteFormat.Direction.DOWN));
                              lvt_14_5_ = ChunkPaletteFormat.getName(lvt_13_10_);
                              if ("minecraft:sunflower".equals(lvt_14_5_)) {
                                 this.setBlock(lvt_11_11_, ChunkPaletteFormat.UPPER_SUNFLOWER);
                              } else if ("minecraft:lilac".equals(lvt_14_5_)) {
                                 this.setBlock(lvt_11_11_, ChunkPaletteFormat.UPPER_LILAC);
                              } else if ("minecraft:tall_grass".equals(lvt_14_5_)) {
                                 this.setBlock(lvt_11_11_, ChunkPaletteFormat.UPPER_TALL_GRASS);
                              } else if ("minecraft:large_fern".equals(lvt_14_5_)) {
                                 this.setBlock(lvt_11_11_, ChunkPaletteFormat.UPPER_LARGE_FERN);
                              } else if ("minecraft:rose_bush".equals(lvt_14_5_)) {
                                 this.setBlock(lvt_11_11_, ChunkPaletteFormat.UPPER_ROSE_BUSH);
                              } else if ("minecraft:peony".equals(lvt_14_5_)) {
                                 this.setBlock(lvt_11_11_, ChunkPaletteFormat.UPPER_PEONY);
                              }
                           }
                        }
                     case 176:
                     case 177:
                        ...
                        while(var10.hasNext()) {
                           ...
                           lvt_13_10_ = this.getBlock(lvt_11_11_);
                           if (lvt_12_9_ != null) {
                              lvt_14_4_ = lvt_12_9_.get("Base").asInt(0);
                              if (lvt_14_4_ != 15 && lvt_14_4_ >= 0 && lvt_14_4_ < 16) {
                                 lvt_15_1_ = ChunkPaletteFormat.getProperty(lvt_13_10_, (Integer)lvt_8_1_.getKey() == 176 ? "rotation" : "facing") + "_" + lvt_14_4_;
                                 if (ChunkPaletteFormat.BANNER_BLOCK_MAP.containsKey(lvt_15_1_)) {
                                    this.setBlock(lvt_11_11_, (Dynamic)ChunkPaletteFormat.BANNER_BLOCK_MAP.get(lvt_15_1_));
                                 }
                              }
                           }
                        }
      ...
      public static int relative(int p_199223_0_, ChunkPaletteFormat.Direction p_199223_1_) {
         ...
         case X:
            int lvt_2_1_ = (p_199223_0_ & 15) + p_199223_1_.getAxisDirection().getStep();
            return lvt_2_1_ >= 0 && lvt_2_1_ <= 15 ? p_199223_0_ & -16 | lvt_2_1_ : -1;
         case Y:
            int lvt_3_1_ = (p_199223_0_ >> 8) + p_199223_1_.getAxisDirection().getStep();
            return lvt_3_1_ >= 0 && lvt_3_1_ <= 255 ? p_199223_0_ & 255 | lvt_3_1_ << 8 : -1;
         case Z:
            int lvt_4_1_ = (p_199223_0_ >> 4 & 15) + p_199223_1_.getAxisDirection().getStep();
            return lvt_4_1_ >= 0 && lvt_4_1_ <= 15 ? p_199223_0_ & -241 | lvt_4_1_ << 4 : -1;
         default:
            return -1;
         }
      }
      ...
      private void setBlock(int p_210060_1_, Dynamic<?> p_210060_2_) {
         if (p_210060_1_ >= 0 && p_210060_1_ <= 65535) {
            ChunkPaletteFormat.Section lvt_3_1_ = this.getSection(p_210060_1_);
            if (lvt_3_1_ != null) {
               lvt_3_1_.setBlock(p_210060_1_ & 4095, p_210060_2_);
            }
         }
      }
      ...
      private ChunkPaletteFormat.Section getSection(int p_199221_1_) {
         int lvt_2_1_ = p_199221_1_ >> 12;
         return lvt_2_1_ < this.sections.length ? this.sections[lvt_2_1_] : null;
      }

      public Dynamic<?> getBlock(int p_210064_1_) {
         if (p_210064_1_ >= 0 && p_210064_1_ <= 65535) {
            ChunkPaletteFormat.Section lvt_2_1_ = this.getSection(p_210064_1_);
            return lvt_2_1_ == null ? ChunkPaletteFormat.AIR : lvt_2_1_.getBlock(p_210064_1_ & 4095);
         } else {
      ...
      public Dynamic<?> write() {
         Dynamic<?> lvt_1_1_ = this.level;
         if (this.tileEntities.isEmpty()) {
            lvt_1_1_ = lvt_1_1_.remove("TileEntities");
         } else {
            lvt_1_1_ = lvt_1_1_.set("TileEntities", lvt_1_1_.createList(this.tileEntities.values().stream()));
         }

         Dynamic<?> lvt_2_1_ = lvt_1_1_.emptyMap();
         Dynamic<?> lvt_3_1_ = lvt_1_1_.emptyList();
         ChunkPaletteFormat.Section[] var4 = this.sections;
         int var5 = var4.length;

         for(int var6 = 0; var6 < var5; ++var6) {
            ChunkPaletteFormat.Section lvt_7_1_ = var4[var6];
            if (lvt_7_1_ != null) {
               lvt_3_1_ = lvt_3_1_.merge(lvt_7_1_.write());
               lvt_2_1_ = lvt_2_1_.set(String.valueOf(lvt_7_1_.y), lvt_2_1_.createIntList(Arrays.stream(lvt_7_1_.update.toIntArray())));
            }
         }

         Dynamic<?> lvt_4_1_ = lvt_1_1_.emptyMap();
         lvt_4_1_ = lvt_4_1_.set("Sides", lvt_4_1_.createByte((byte)this.sides));
         lvt_4_1_ = lvt_4_1_.set("Indices", lvt_2_1_);
         return lvt_1_1_.set("UpgradeData", lvt_4_1_).set("Sections", lvt_3_1_);
      }
   }
   ...
   static class Section {
      ...
      public Section(Dynamic<?> p_i49575_1_) {
         this.listTag = p_i49575_1_.emptyList();
         this.section = p_i49575_1_;
         this.y = p_i49575_1_.get("Y").asInt(0);
         this.hasData = p_i49575_1_.get("Blocks").get().isPresent();
      }

      public Dynamic<?> getBlock(int p_210056_1_) {
         if (p_210056_1_ >= 0 && p_210056_1_ <= 4095) {
            Dynamic<?> lvt_2_1_ = (Dynamic)this.palette.getByValue(this.buffer[p_210056_1_]);
            return lvt_2_1_ == null ? ChunkPaletteFormat.AIR : lvt_2_1_;
         } else {
            return ChunkPaletteFormat.AIR;
         }
      }
      ...
      public int upgrade(int p_199207_1_) {
         if (!this.hasData) {
            ...
            ByteBuffer lvt_2_1_ = (ByteBuffer)this.section.get("Blocks").asByteBufferOpt().get();
            ChunkPaletteFormat.NibbleArray lvt_3_1_ = (ChunkPaletteFormat.NibbleArray)this.section.get("Data").asByteBufferOpt().map((p_210055_0_) -> {
               return new ChunkPaletteFormat.NibbleArray(DataFixUtils.toArray(p_210055_0_));
            }).orElseGet(ChunkPaletteFormat.NibbleArray::new);
            ChunkPaletteFormat.NibbleArray lvt_4_1_ = (ChunkPaletteFormat.NibbleArray)this.section.get("Add").asByteBufferOpt().map((p_210052_0_) -> {
            ...
            for(int lvt_5_1_ = 0; lvt_5_1_ < 4096; ++lvt_5_1_) {
               int lvt_6_1_ = lvt_5_1_ & 15;
               int lvt_7_1_ = lvt_5_1_ >> 8 & 15;
               int lvt_8_1_ = lvt_5_1_ >> 4 & 15;
               int lvt_9_1_ = lvt_4_1_.get(lvt_6_1_, lvt_7_1_, lvt_8_1_) << 12 | (lvt_2_1_.get(lvt_5_1_) & 255) << 4 | lvt_3_1_.get(lvt_6_1_, lvt_7_1_, lvt_8_1_);
               if (ChunkPaletteFormat.FIX.get(lvt_9_1_ >> 4)) {
                  this.addFix(lvt_9_1_ >> 4, lvt_5_1_);
               }

               if (ChunkPaletteFormat.VIRTUAL.get(lvt_9_1_ >> 4)) {
                  int lvt_10_1_ = ChunkPaletteFormat.getSideMask(lvt_6_1_ == 0, lvt_6_1_ == 15, lvt_8_1_ == 0, lvt_8_1_ == 15);
                  if (lvt_10_1_ == 0) {
                     this.update.add(lvt_5_1_);
                  } else {
                     p_199207_1_ |= lvt_10_1_;
                  }
               }

               this.setBlock(lvt_5_1_, BlockStateFlatteningMap.getFixedNBTForID(lvt_9_1_));
            }
      ...
      private void addFix(int p_199205_1_, int p_199205_2_) {
         IntList lvt_3_1_ = (IntList)this.toFix.get(p_199205_1_);
         if (lvt_3_1_ == null) {
            lvt_3_1_ = new IntArrayList();
            this.toFix.put(p_199205_1_, lvt_3_1_);
         }

         ((IntList)lvt_3_1_).add(p_199205_2_);
      }

      public Dynamic<?> write() {
         Dynamic<?> lvt_1_1_ = this.section;
         if (!this.hasData) {
            return lvt_1_1_;
         } else {
            lvt_1_1_ = lvt_1_1_.set("Palette", this.listTag);
            int lvt_2_1_ = Math.max(4, DataFixUtils.ceillog2(this.seen.size()));
            BitArray lvt_3_1_ = new BitArray(lvt_2_1_, 4096);

            for(int lvt_4_1_ = 0; lvt_4_1_ < this.buffer.length; ++lvt_4_1_) {
               lvt_3_1_.setAt(lvt_4_1_, this.buffer[lvt_4_1_]);
            }

            lvt_1_1_ = lvt_1_1_.set("BlockStates", lvt_1_1_.createLongList(Arrays.stream(lvt_3_1_.getBackingLongArray())));
            lvt_1_1_ = lvt_1_1_.remove("Blocks");
            lvt_1_1_ = lvt_1_1_.remove("Data");
            lvt_1_1_ = lvt_1_1_.remove("Add");
            return lvt_1_1_;
         }
      }
   }
