...
public class TileEntityId extends DataFix {
   private static final Map<String, String> OLD_TO_NEW_ID_MAP = (Map)DataFixUtils.make(Maps.newHashMap(), (p_209293_0_) -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> lvt_2_1_ = this.getOutputSchema().getType(TypeReferences.ITEM_STACK);
      TaggedChoiceType<String> lvt_3_1_ = this.getInputSchema().findChoiceType(TypeReferences.BLOCK_ENTITY);
      TaggedChoiceType<String> lvt_4_1_ = this.getOutputSchema().findChoiceType(TypeReferences.BLOCK_ENTITY);
      return TypeRewriteRule.seq(this.convertUnchecked("item stack block entity name hook converter", lvt_1_1_, lvt_2_1_), this.fixTypeEverywhere("BlockEntityIdFix", lvt_3_1_, lvt_4_1_, (p_209700_0_) -> {
         return (p_206301_0_) -> {
            return p_206301_0_.mapFirst((p_206302_0_) -> {
               return (String)OLD_TO_NEW_ID_MAP.getOrDefault(p_206302_0_, p_206302_0_);
            });
         };
      }));
   }
