...
public class ItemSpawnEggSplit extends DataFix {
   private static final Map<String, String> field_199421_a = (Map)DataFixUtils.make(Maps.newHashMap(), (p_209279_0_) -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      OpticFinder<String> lvt_3_1_ = DSL.fieldFinder("id", DSL.namespacedString());
      OpticFinder<?> lvt_4_1_ = lvt_1_1_.findField("tag");
      OpticFinder<?> lvt_5_1_ = lvt_4_1_.type().findField("EntityTag");
      return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix", lvt_1_1_, (p_206361_4_) -> {
         Optional<Pair<String, String>> lvt_5_1_x = p_206361_4_.getOptional(lvt_2_1_);
         if (lvt_5_1_x.isPresent() && Objects.equals(((Pair)lvt_5_1_x.get()).getSecond(), "minecraft:spawn_egg")) {
            Typed<?> lvt_6_1_ = p_206361_4_.getOrCreateTyped(lvt_4_1_);
            Typed<?> lvt_7_1_ = lvt_6_1_.getOrCreateTyped(lvt_5_1_);
            Optional<String> lvt_8_1_ = lvt_7_1_.getOptional(lvt_3_1_);
            if (lvt_8_1_.isPresent()) {
               return p_206361_4_.set(lvt_2_1_, Pair.of(TypeReferences.ITEM_NAME.typeName(), field_199421_a.getOrDefault(lvt_8_1_.get(), "minecraft:pig_spawn_egg")));
            }
         }
