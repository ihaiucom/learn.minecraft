...
public class ChunkStructuresTemplateRenameFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      OpticFinder<?> lvt_2_1_ = lvt_1_1_.findField("Children");
      return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", lvt_1_1_, (p_207911_2_) -> {
         return p_207911_2_.updateTyped(lvt_2_1_, (p_207908_2_) -> {
            return p_207908_2_.update(DSL.remainderFinder(), (p_207909_2_) -> {
               return this.fixTag((Dynamic)p_207911_2_.get(DSL.remainderFinder()), p_207909_2_);
            });
         });
      });
   }
   ...
   private Dynamic<?> fixTag(Dynamic<?> p_209729_1_, Dynamic<?> p_209729_2_) {
      String lvt_3_1_ = p_209729_1_.get("id").asString("");
      if (field_207912_a.containsKey(lvt_3_1_)) {
         Pair<String, ImmutableMap<String, String>> lvt_4_1_ = (Pair)field_207912_a.get(lvt_3_1_);
         if (((String)lvt_4_1_.getFirst()).equals(p_209729_2_.get("id").asString(""))) {
            String lvt_5_1_ = p_209729_2_.get("Template").asString("");
            p_209729_2_ = p_209729_2_.set("Template", p_209729_2_.createString((String)((ImmutableMap)lvt_4_1_.getSecond()).getOrDefault(lvt_5_1_, lvt_5_1_)));
         }
      }
