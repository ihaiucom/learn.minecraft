...
public class BiomeRenames extends DataFix {
   ...
   public BiomeRenames(Schema p_i49688_1_, boolean p_i49688_2_) {
      super(p_i49688_1_, p_i49688_2_);
   }

   protected TypeRewriteRule makeRule() {
      Type<Pair<String, String>> lvt_1_1_ = DSL.named(TypeReferences.BIOME.typeName(), DSL.namespacedString());
      if (!Objects.equals(lvt_1_1_, this.getInputSchema().getType(TypeReferences.BIOME))) {
         throw new IllegalStateException("Biome type is not what was expected.");
      } else {
         return this.fixTypeEverywhere("Biomes fix", lvt_1_1_, (p_210916_0_) -> {
            return (p_210917_0_) -> {
               return p_210917_0_.mapSecond((p_210918_0_) -> {
                  return (String)field_210919_a.getOrDefault(p_210918_0_, p_210918_0_);
               });
            };
         });
      }
