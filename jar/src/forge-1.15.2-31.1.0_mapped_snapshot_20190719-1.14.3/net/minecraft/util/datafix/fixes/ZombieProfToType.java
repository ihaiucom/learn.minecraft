   ...
   public Dynamic<?> fixTag(Dynamic<?> p_209656_1_) {
      if (p_209656_1_.get("IsVillager").asBoolean(false)) {
         if (!p_209656_1_.get("ZombieType").get().isPresent()) {
            int lvt_2_1_ = this.getVillagerProfession(p_209656_1_.get("VillagerProfession").asInt(-1));
            if (lvt_2_1_ == -1) {
               lvt_2_1_ = this.getVillagerProfession(RANDOM.nextInt(6));
            }

            p_209656_1_ = p_209656_1_.set("ZombieType", p_209656_1_.createInt(lvt_2_1_));
         }
