...
public class ItemStackEnchantmentFix extends DataFix {
   private static final Int2ObjectMap<String> field_208047_a = (Int2ObjectMap)DataFixUtils.make(new Int2ObjectOpenHashMap(), (p_208043_0_) -> {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemStackEnchantmentFix", lvt_1_1_, (p_208045_2_) -> {
         return p_208045_2_.updateTyped(lvt_2_1_, (p_208046_1_) -> {
   ...
   private Dynamic<?> fixTag(Dynamic<?> p_209627_1_) {
      Optional var10000 = p_209627_1_.get("ench").asStreamOpt().map((p_209626_0_) -> {
         return p_209626_0_.map((p_209628_0_) -> {
            return p_209628_0_.set("id", p_209628_0_.createString((String)field_208047_a.getOrDefault(p_209628_0_.get("id").asInt(0), "null")));
         });
      });
      p_209627_1_.getClass();
      Optional<Dynamic<?>> lvt_2_1_ = var10000.map(p_209627_1_::createList);
      if (lvt_2_1_.isPresent()) {
         p_209627_1_ = p_209627_1_.remove("ench").set("Enchantments", (Dynamic)lvt_2_1_.get());
      }

      return p_209627_1_.update("StoredEnchantments", (p_209625_0_) -> {
         Optional var10000 = p_209625_0_.asStreamOpt().map((p_209623_0_) -> {
            return p_209623_0_.map((p_209624_0_) -> {
               return p_209624_0_.set("id", p_209624_0_.createString((String)field_208047_a.getOrDefault(p_209624_0_.get("id").asInt(0), "null")));
            });
         });
         p_209625_0_.getClass();
         return (Dynamic)DataFixUtils.orElse(var10000.map(p_209625_0_::createList), p_209625_0_);
      });
   }
}
