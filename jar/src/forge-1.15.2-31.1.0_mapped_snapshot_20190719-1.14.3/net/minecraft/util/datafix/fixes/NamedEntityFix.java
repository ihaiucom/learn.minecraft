...
public abstract class NamedEntityFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      OpticFinder<?> lvt_1_1_ = DSL.namedChoice(this.entityName, this.getInputSchema().getChoiceType(this.type, this.entityName));
      return this.fixTypeEverywhereTyped(this.name, this.getInputSchema().getType(this.type), this.getOutputSchema().getType(this.type), (p_206371_2_) -> {
         return p_206371_2_.updateTyped(lvt_1_1_, this.getOutputSchema().getChoiceType(this.type, this.entityName), this::fix);
      });
   }
