...
public class StructureReferenceFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("Structure Reference Fix", lvt_1_1_, (p_226213_0_) -> {
   ...
   private static <T> Dynamic<T> func_226212_a_(Dynamic<T> p_226212_0_) {
      return p_226212_0_.update("references", (p_226215_0_) -> {
         return p_226215_0_.createInt((Integer)p_226215_0_.asNumber().map(Number::intValue).filter((p_226214_0_) -> {
