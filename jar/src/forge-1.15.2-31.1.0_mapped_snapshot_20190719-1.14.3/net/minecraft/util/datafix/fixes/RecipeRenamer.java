...
public class RecipeRenamer extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<Pair<String, String>> lvt_1_1_ = DSL.named(TypeReferences.RECIPE.typeName(), DSL.namespacedString());
      if (!Objects.equals(lvt_1_1_, this.getInputSchema().getType(TypeReferences.RECIPE))) {
         throw new IllegalStateException("Recipe type is not what was expected.");
      } else {
         return this.fixTypeEverywhere(this.field_230073_a_, lvt_1_1_, (p_230075_1_) -> {
            return (p_230076_1_) -> {
