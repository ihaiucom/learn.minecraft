...
public class V1929 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema p_registerEntities_1_) {
      ...
      p_registerEntities_1_.register(lvt_2_1_, "minecraft:wandering_trader", (p_219890_1_) -> {
      ...
      p_registerEntities_1_.register(lvt_2_1_, "minecraft:trader_llama", (p_219891_1_) -> {
