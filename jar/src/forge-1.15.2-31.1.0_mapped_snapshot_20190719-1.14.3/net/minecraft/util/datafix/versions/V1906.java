...
public class V1906 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_registerBlockEntities_1_) {
      ...
      func_219880_a(p_registerBlockEntities_1_, lvt_2_1_, "minecraft:barrel");
      func_219880_a(p_registerBlockEntities_1_, lvt_2_1_, "minecraft:smoker");
      func_219880_a(p_registerBlockEntities_1_, lvt_2_1_, "minecraft:blast_furnace");
      p_registerBlockEntities_1_.register(lvt_2_1_, "minecraft:lectern", (p_219882_1_) -> {
         return DSL.optionalFields("Book", TypeReferences.ITEM_STACK.in(p_registerBlockEntities_1_));
      });
      p_registerBlockEntities_1_.registerSimple(lvt_2_1_, "minecraft:bell");
      return lvt_2_1_;
   }
