...
public class V0704 extends Schema {
   protected static final Map<String, String> field_206647_b = (Map)DataFixUtils.make(Maps.newHashMap(), (p_209318_0_) -> {
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema p_registerBlockEntities_1_) {
      ...
      p_registerBlockEntities_1_.register(lvt_2_1_, "minecraft:jukebox", (p_206641_1_) -> {
      ...
      p_registerBlockEntities_1_.register(lvt_2_1_, "minecraft:mob_spawner", (p_206646_1_) -> {
         return TypeReferences.UNTAGGED_SPAWNER.in(p_registerBlockEntities_1_);
      });
      p_registerBlockEntities_1_.registerSimple(lvt_2_1_, "minecraft:noteblock");
      p_registerBlockEntities_1_.registerSimple(lvt_2_1_, "minecraft:piston");
      ...
      p_registerBlockEntities_1_.register(lvt_2_1_, "minecraft:flower_pot", (p_206640_1_) -> {
