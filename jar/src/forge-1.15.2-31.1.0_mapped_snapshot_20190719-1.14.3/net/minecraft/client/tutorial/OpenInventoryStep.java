...
public class OpenInventoryStep implements ITutorialStep {
   private static final ITextComponent TITLE = new TranslationTextComponent("tutorial.open_inventory.title", new Object[0]);
   private static final ITextComponent DESCRIPTION = new TranslationTextComponent("tutorial.open_inventory.description", new Object[]{Tutorial.createKeybindComponent("inventory")});
