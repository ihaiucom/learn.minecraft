...
public class MovementStep implements ITutorialStep {
   private static final ITextComponent MOVE_TITLE = new TranslationTextComponent("tutorial.move.title", new Object[]{Tutorial.createKeybindComponent("forward"), Tutorial.createKeybindComponent("left"), Tutorial.createKeybindComponent("back"), Tutorial.createKeybindComponent("right")});
   private static final ITextComponent MOVE_DESCRIPTION = new TranslationTextComponent("tutorial.move.description", new Object[]{Tutorial.createKeybindComponent("jump")});
   private static final ITextComponent LOOK_TITLE = new TranslationTextComponent("tutorial.look.title", new Object[0]);
   private static final ITextComponent LOOK_DESCRIPTION = new TranslationTextComponent("tutorial.look.description", new Object[0]);
