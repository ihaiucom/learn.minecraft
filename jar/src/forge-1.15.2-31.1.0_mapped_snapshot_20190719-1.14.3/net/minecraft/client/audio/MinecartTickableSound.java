...
public class MinecartTickableSound extends TickableSound {
   ...
   public MinecartTickableSound(AbstractMinecartEntity p_i48614_1_) {
      ...
      this.repeatDelay = 0;
      this.volume = 0.0F;
      this.x = (float)p_i48614_1_.func_226277_ct_();
      this.y = (float)p_i48614_1_.func_226278_cu_();
      this.z = (float)p_i48614_1_.func_226281_cx_();
   }
   ...
   public void tick() {
      if (this.minecart.removed) {
         ...
         if ((double)lvt_1_1_ >= 0.01D) {
            ...
            this.volume = MathHelper.lerp(MathHelper.clamp(lvt_1_1_, 0.0F, 0.5F), 0.0F, 0.7F);
         } else {
            this.distance = 0.0F;
            this.volume = 0.0F;
         }
