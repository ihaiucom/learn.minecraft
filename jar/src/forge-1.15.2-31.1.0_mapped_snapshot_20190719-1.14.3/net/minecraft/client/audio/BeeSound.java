...
public abstract class BeeSound extends TickableSound {
   ...
   public void tick() {
      boolean lvt_1_1_ = this.func_225643_p_();
      if (lvt_1_1_ && !this.donePlaying) {
      ...
      if (!this.field_229357_o_.removed && !this.field_229358_p_) {
         ...
         float lvt_2_1_ = MathHelper.sqrt(Entity.func_213296_b(this.field_229357_o_.getMotion()));
         if ((double)lvt_2_1_ >= 0.01D) {
            this.pitch = MathHelper.lerp(MathHelper.clamp(lvt_2_1_, this.func_229359_s_(), this.func_229360_t_()), this.func_229359_s_(), this.func_229360_t_());
