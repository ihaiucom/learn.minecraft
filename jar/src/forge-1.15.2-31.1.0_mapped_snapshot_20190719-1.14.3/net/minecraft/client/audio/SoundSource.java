...
public class SoundSource {
   ...
   static SoundSource func_216426_a() {
      int[] lvt_0_1_ = new int[1];
      AL10.alGenSources(lvt_0_1_);
      return ALUtils.func_216483_a("Allocate new source") ? null : new SoundSource(lvt_0_1_[0]);
   }
   ...
   public void func_216433_a(IAudioStream p_216433_1_) {
      ...
      AudioFormat lvt_2_1_ = p_216433_1_.func_216454_a();
      this.field_216443_d = func_216417_a(lvt_2_1_, 1);
   ...
   private void func_216421_a(int p_216421_1_) {
      if (this.field_216444_e != null) {
         try {
            for(int lvt_2_1_ = 0; lvt_2_1_ < p_216421_1_; ++lvt_2_1_) {
               ByteBuffer lvt_3_1_ = this.field_216444_e.func_216455_a(this.field_216443_d);
               if (lvt_3_1_ != null) {
                  (new AudioStreamBuffer(lvt_3_1_, this.field_216444_e.func_216454_a())).func_216472_c().ifPresent((p_216424_1_) -> {
   ...
   public void func_216434_i() {
      if (this.field_216444_e != null) {
         int lvt_1_1_ = this.func_216427_k();
         this.func_216421_a(lvt_1_1_);
      }

   }

   private int func_216427_k() {
      int lvt_1_1_ = AL10.alGetSourcei(this.field_216441_b, 4118);
      if (lvt_1_1_ > 0) {
         int[] lvt_2_1_ = new int[lvt_1_1_];
         AL10.alSourceUnqueueBuffers(this.field_216441_b, lvt_2_1_);
         ALUtils.func_216483_a("Unqueue buffers");
         AL10.alDeleteBuffers(lvt_2_1_);
