...
public class AudioStreamBuffer {
   ...
   OptionalInt func_216473_a() {
      if (!this.field_216477_c) {
         ...
         int lvt_1_1_ = ALUtils.func_216479_a(this.field_216476_b);
         int[] lvt_2_1_ = new int[1];
         AL10.alGenBuffers(lvt_2_1_);
         if (ALUtils.func_216483_a("Creating buffer")) {
            return OptionalInt.empty();
         }

         AL10.alBufferData(lvt_2_1_[0], lvt_1_1_, this.field_216475_a, (int)this.field_216476_b.getSampleRate());
         if (ALUtils.func_216483_a("Assigning buffer data")) {
            return OptionalInt.empty();
         }

         this.field_216478_d = lvt_2_1_[0];
   ...
   public OptionalInt func_216472_c() {
      OptionalInt lvt_1_1_ = this.func_216473_a();
      this.field_216477_c = false;
      return lvt_1_1_;
   }
}
