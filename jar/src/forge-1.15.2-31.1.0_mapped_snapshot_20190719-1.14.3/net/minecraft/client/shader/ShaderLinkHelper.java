...
public class ShaderLinkHelper {
   ...
   public static int createProgram() throws IOException {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      int lvt_0_1_ = GlStateManager.func_227743_n_();
      if (lvt_0_1_ <= 0) {
         throw new IOException("Could not create shader program (returned program ID " + lvt_0_1_ + ")");
      } else {
         return lvt_0_1_;
      }
   }
   ...
   public static void linkProgram(IShaderManager p_148075_0_) throws IOException {
      ...
      int lvt_1_1_ = GlStateManager.func_227691_c_(p_148075_0_.getProgram(), 35714);
      if (lvt_1_1_ == 0) {
