...
public abstract class AbstractOption {
   public static final SliderPercentageOption BIOME_BLEND_RADIUS = new SliderPercentageOption("options.biomeBlendRadius", 0.0D, 7.0D, 1.0F, (p_216607_0_) -> {
      ...
      p_216660_0_.biomeBlendRadius = MathHelper.clamp((int)p_216660_1_, 0, 7);
      Minecraft.getInstance().worldRenderer.loadRenderers();
   }, (p_216595_0_, p_216595_1_) -> {
      double lvt_2_1_ = p_216595_1_.get(p_216595_0_);
      String lvt_4_1_ = p_216595_1_.getDisplayString();
      int lvt_5_1_ = (int)lvt_2_1_ * 2 + 1;
      return lvt_4_1_ + I18n.format("options.biomeBlendRadius." + lvt_5_1_);
   });
   public static final SliderPercentageOption CHAT_HEIGHT_FOCUSED = new SliderPercentageOption("options.chat.height.focused", 0.0D, 1.0D, 0.0F, (p_216587_0_) -> {
      ...
      double lvt_2_1_ = p_216642_1_.func_216726_a(p_216642_1_.get(p_216642_0_));
      return p_216642_1_.getDisplayString() + NewChatGui.calculateChatboxHeight(lvt_2_1_) + "px";
   });
   public static final SliderPercentageOption CHAT_HEIGHT_UNFOCUSED = new SliderPercentageOption("options.chat.height.unfocused", 0.0D, 1.0D, 0.0F, (p_216611_0_) -> {
      ...
      double lvt_2_1_ = p_216604_1_.func_216726_a(p_216604_1_.get(p_216604_0_));
      return p_216604_1_.getDisplayString() + NewChatGui.calculateChatboxHeight(lvt_2_1_) + "px";
   });
   public static final SliderPercentageOption CHAT_OPACITY = new SliderPercentageOption("options.chat.opacity", 0.0D, 1.0D, 0.0F, (p_216649_0_) -> {
      ...
      double lvt_2_1_ = p_216592_1_.func_216726_a(p_216592_1_.get(p_216592_0_));
      return p_216592_1_.getDisplayString() + (int)(lvt_2_1_ * 90.0D + 10.0D) + "%";
   });
   public static final SliderPercentageOption CHAT_SCALE = new SliderPercentageOption("options.chat.scale", 0.0D, 1.0D, 0.0F, (p_216591_0_) -> {
      ...
      double lvt_2_1_ = p_216637_1_.func_216726_a(p_216637_1_.get(p_216637_0_));
      String lvt_4_1_ = p_216637_1_.getDisplayString();
      return lvt_2_1_ == 0.0D ? lvt_4_1_ + I18n.format("options.off") : lvt_4_1_ + (int)(lvt_2_1_ * 100.0D) + "%";
   });
   public static final SliderPercentageOption CHAT_WIDTH = new SliderPercentageOption("options.chat.width", 0.0D, 1.0D, 0.0F, (p_216601_0_) -> {
      ...
      double lvt_2_1_ = p_216673_1_.func_216726_a(p_216673_1_.get(p_216673_0_));
      return p_216673_1_.getDisplayString() + NewChatGui.calculateChatboxWidth(lvt_2_1_) + "px";
   });
   public static final SliderPercentageOption FOV = new SliderPercentageOption("options.fov", 30.0D, 110.0D, 1.0F, (p_216655_0_) -> {
      ...
      double lvt_2_1_ = p_216590_1_.get(p_216590_0_);
      String lvt_4_1_ = p_216590_1_.getDisplayString();
      if (lvt_2_1_ == 70.0D) {
         return lvt_4_1_ + I18n.format("options.fov.min");
      } else {
         return lvt_2_1_ == p_216590_1_.getMaxValue() ? lvt_4_1_ + I18n.format("options.fov.max") : lvt_4_1_ + (int)lvt_2_1_;
      }
   });
   public static final SliderPercentageOption FRAMERATE_LIMIT = new SliderPercentageOption("options.framerateLimit", 10.0D, 260.0D, 10.0F, (p_216672_0_) -> {
      ...
      p_216608_0_.framerateLimit = (int)p_216608_1_;
      Minecraft.getInstance().func_228018_at_().setFramerateLimit(p_216608_0_.framerateLimit);
   }, (p_216645_0_, p_216645_1_) -> {
      double lvt_2_1_ = p_216645_1_.get(p_216645_0_);
      String lvt_4_1_ = p_216645_1_.getDisplayString();
      return lvt_2_1_ == p_216645_1_.getMaxValue() ? lvt_4_1_ + I18n.format("options.framerateLimit.max") : lvt_4_1_ + I18n.format("options.framerate", (int)lvt_2_1_);
   });
   public static final SliderPercentageOption GAMMA = new SliderPercentageOption("options.gamma", 0.0D, 1.0D, 0.0F, (p_216636_0_) -> {
      ...
      double lvt_2_1_ = p_216594_1_.func_216726_a(p_216594_1_.get(p_216594_0_));
      String lvt_4_1_ = p_216594_1_.getDisplayString();
      if (lvt_2_1_ == 0.0D) {
         return lvt_4_1_ + I18n.format("options.gamma.min");
      } else {
         return lvt_2_1_ == 1.0D ? lvt_4_1_ + I18n.format("options.gamma.max") : lvt_4_1_ + "+" + (int)(lvt_2_1_ * 100.0D) + "%";
      }
   });
   public static final SliderPercentageOption MIPMAP_LEVELS = new SliderPercentageOption("options.mipmapLevels", 0.0D, 4.0D, 1.0F, (p_216667_0_) -> {
      ...
      p_216585_0_.mipmapLevels = (int)p_216585_1_;
   }, (p_216629_0_, p_216629_1_) -> {
      double lvt_2_1_ = p_216629_1_.get(p_216629_0_);
      String lvt_4_1_ = p_216629_1_.getDisplayString();
      return lvt_2_1_ == 0.0D ? lvt_4_1_ + I18n.format("options.off") : lvt_4_1_ + (int)lvt_2_1_;
   });
   public static final SliderPercentageOption MOUSE_WHEEL_SENSITIVITY = new SliderMultiplierOption("options.mouseWheelSensitivity", 0.01D, 10.0D, 0.01F, (p_216581_0_) -> {
      ...
      double lvt_2_1_ = p_216675_1_.func_216726_a(p_216675_1_.get(p_216675_0_));
      return p_216675_1_.getDisplayString() + String.format("%.2f", p_216675_1_.func_216725_b(lvt_2_1_));
   });
   public static final BooleanOption field_225302_l = new BooleanOption("options.rawMouseInput", (p_225287_0_) -> {
      ...
      MainWindow lvt_2_1_ = Minecraft.getInstance().func_228018_at_();
      if (lvt_2_1_ != null) {
         lvt_2_1_.func_224798_d(p_225259_1_);
      }
   ...
   public static final SliderPercentageOption RENDER_DISTANCE = new SliderPercentageOption("options.renderDistance", 2.0D, 16.0D, 1.0F, (p_216658_0_) -> {
      ...
      p_216579_0_.renderDistanceChunks = (int)p_216579_1_;
      Minecraft.getInstance().worldRenderer.setDisplayListEntitiesDirty();
   }, (p_216664_0_, p_216664_1_) -> {
      double lvt_2_1_ = p_216664_1_.get(p_216664_0_);
      return p_216664_1_.getDisplayString() + I18n.format("options.chunks", (int)lvt_2_1_);
   });
   public static final SliderPercentageOption SENSITIVITY = new SliderPercentageOption("options.sensitivity", 0.0D, 1.0D, 0.0F, (p_216654_0_) -> {
      ...
      double lvt_2_1_ = p_216641_1_.func_216726_a(p_216641_1_.get(p_216641_0_));
      String lvt_4_1_ = p_216641_1_.getDisplayString();
      if (lvt_2_1_ == 0.0D) {
         return lvt_4_1_ + I18n.format("options.sensitivity.min");
      } else {
         return lvt_2_1_ == 1.0D ? lvt_4_1_ + I18n.format("options.sensitivity.max") : lvt_4_1_ + (int)(lvt_2_1_ * 200.0D) + "%";
      }
   });
   ...
   public static final BooleanOption FORCE_UNICODE_FONT = new BooleanOption("options.forceUnicodeFont", (p_216657_0_) -> {
      ...
      if (lvt_2_1_.getFontResourceManager() != null) {
         lvt_2_1_.getFontResourceManager().func_216883_a(p_216631_0_.forceUnicodeFont, Util.getServerExecutor(), lvt_2_1_);
      }
   ...
   public static final BooleanOption FULLSCREEN = new BooleanOption("options.fullscreen", (p_228040_0_) -> {
      ...
      Minecraft lvt_2_1_ = Minecraft.getInstance();
      if (lvt_2_1_.func_228018_at_() != null && lvt_2_1_.func_228018_at_().isFullscreen() != p_228042_0_.fullscreen) {
         lvt_2_1_.func_228018_at_().toggleFullscreen();
         p_228042_0_.fullscreen = lvt_2_1_.func_228018_at_().isFullscreen();
      }
   ...
   public AbstractOption(String p_i51158_1_) {
      this.translationKey = p_i51158_1_;
   }
