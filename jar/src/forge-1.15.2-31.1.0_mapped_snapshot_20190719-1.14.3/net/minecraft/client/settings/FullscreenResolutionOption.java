   ...
   private FullscreenResolutionOption(MainWindow p_i51745_1_, @Nullable Monitor p_i51745_2_) {
      super("options.fullscreen.resolution", -1.0D, p_i51745_2_ != null ? (double)(p_i51745_2_.getVideoModeCount() - 1) : -1.0D, 1.0F, (p_225306_2_) -> {
         if (p_i51745_2_ == null) {
            ...
            Optional<VideoMode> lvt_3_1_ = p_i51745_1_.getVideoMode();
            return (Double)lvt_3_1_.map((p_225304_1_) -> {
         ...
         if (p_i51745_2_ == null) {
            ...
            double lvt_3_1_ = p_225305_2_.get(p_225305_1_);
            String lvt_5_1_ = p_225305_2_.getDisplayString();
            return lvt_3_1_ == -1.0D ? lvt_5_1_ + I18n.format("options.fullscreen.current") : p_i51745_2_.getVideoModeFromIndex((int)lvt_3_1_).toString();
         }
      });
   }
}
