...
public enum AmbientOcclusionStatus {
   ...
   private static final AmbientOcclusionStatus[] field_216573_d = (AmbientOcclusionStatus[])Arrays.stream(values()).sorted(Comparator.comparingInt(AmbientOcclusionStatus::func_216572_a)).toArray((p_216571_0_) -> {
