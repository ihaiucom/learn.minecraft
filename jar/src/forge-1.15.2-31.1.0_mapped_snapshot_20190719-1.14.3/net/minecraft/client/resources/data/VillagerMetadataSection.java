...
public class VillagerMetadataSection {
   ...
   public static enum HatType {
      ...
      private static final Map<String, VillagerMetadataSection.HatType> field_217824_d = (Map)Arrays.stream(values()).collect(Collectors.toMap(VillagerMetadataSection.HatType::func_217823_a, (p_217822_0_) -> {
         return p_217822_0_;
      }));
      ...
      public static VillagerMetadataSection.HatType func_217821_a(String p_217821_0_) {
         return (VillagerMetadataSection.HatType)field_217824_d.getOrDefault(p_217821_0_, NONE);
      }
   }
}
