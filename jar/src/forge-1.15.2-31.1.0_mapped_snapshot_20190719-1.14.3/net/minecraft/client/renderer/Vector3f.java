...
public final class Vector3f {
   ...
   public void clamp(float p_195901_1_, float p_195901_2_) {
      this.field_229184_g_ = MathHelper.clamp(this.field_229184_g_, p_195901_1_, p_195901_2_);
      this.field_229185_h_ = MathHelper.clamp(this.field_229185_h_, p_195901_1_, p_195901_2_);
      this.field_229186_i_ = MathHelper.clamp(this.field_229186_i_, p_195901_1_, p_195901_2_);
   }
   ...
   public Vector3f(float[] p_i230102_1_) {
      this.set(p_i230102_1_);
   }

   public void set(float[] p_set_1_) {
      this.field_229184_g_ = p_set_1_[0];
      this.field_229185_h_ = p_set_1_[1];
      this.field_229186_i_ = p_set_1_[2];
   }

   public void setX(float p_setX_1_) {
      this.field_229184_g_ = p_setX_1_;
   }

   public void setY(float p_setY_1_) {
      this.field_229185_h_ = p_setY_1_;
   }

   public void setZ(float p_setZ_1_) {
      this.field_229186_i_ = p_setZ_1_;
   }
}
