...
public class PointOfInterestDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   public void func_217706_a(BlockPos p_217706_1_, int p_217706_2_) {
      PointOfInterestDebugRenderer.POIInfo lvt_3_1_ = (PointOfInterestDebugRenderer.POIInfo)this.field_217713_c.get(p_217706_1_);
      if (lvt_3_1_ == null) {
         LOGGER.warn("Strange, setFreeTicketCount was called for an unknown POI: " + p_217706_1_);
      } else {
         lvt_3_1_.field_217757_c = p_217706_2_;
      }
   }
   ...
   private void func_229035_a_(double p_229035_1_, double p_229035_3_, double p_229035_5_) {
      BlockPos lvt_7_1_ = new BlockPos(p_229035_1_, p_229035_3_, p_229035_5_);
      this.field_217714_d.forEach((p_222924_1_) -> {
         if (lvt_7_1_.withinDistance(p_222924_1_.getCenter(), 60.0D)) {
      ...
      Iterator var8 = this.field_217713_c.keySet().iterator();

      while(var8.hasNext()) {
         BlockPos lvt_9_1_ = (BlockPos)var8.next();
         if (lvt_7_1_.withinDistance(lvt_9_1_, 30.0D)) {
            func_217699_b(lvt_9_1_);
         }
      }

      this.field_217713_c.values().forEach((p_222916_2_) -> {
         if (lvt_7_1_.withinDistance(p_222916_2_.field_217755_a, 30.0D)) {
            this.func_217705_b(p_222916_2_);
         }

      });
      this.func_222915_d().forEach((p_222925_2_, p_222925_3_) -> {
         if (lvt_7_1_.withinDistance(p_222925_2_, 30.0D)) {
   ...
   private static void func_217702_c(SectionPos p_217702_0_) {
      float lvt_1_1_ = 1.0F;
      BlockPos lvt_2_1_ = p_217702_0_.getCenter();
      BlockPos lvt_3_1_ = lvt_2_1_.add(-1.0D, -1.0D, -1.0D);
      BlockPos lvt_4_1_ = lvt_2_1_.add(1.0D, 1.0D, 1.0D);
      DebugRenderer.func_217735_a(lvt_3_1_, lvt_4_1_, 0.2F, 1.0F, 0.2F, 0.15F);
   }
   ...
   private void func_217705_b(PointOfInterestDebugRenderer.POIInfo p_217705_1_) {
      ...
      if (this.func_217696_c(p_217705_1_).size() < 4) {
         func_217695_a("" + this.func_217696_c(p_217705_1_), p_217705_1_, lvt_2_1_, -256);
      } else {
         func_217695_a("" + this.func_217696_c(p_217705_1_).size() + " ticket holders", p_217705_1_, lvt_2_1_, -256);
      }

      int lvt_2_1_ = lvt_2_1_ + 1;
      func_217695_a("Free tickets: " + p_217705_1_.field_217757_c, p_217705_1_, lvt_2_1_, -256);
      ++lvt_2_1_;
      func_217695_a(p_217705_1_.field_217756_b, p_217705_1_, lvt_2_1_, -1);
   }
   ...
   private void func_229038_b_(PointOfInterestDebugRenderer.BrainInfo p_229038_1_, double p_229038_2_, double p_229038_4_, double p_229038_6_) {
      boolean lvt_8_1_ = this.func_217703_c(p_229038_1_);
      int lvt_9_1_ = 0;
      func_217693_a(p_229038_1_.field_217750_d, lvt_9_1_, p_229038_1_.field_217749_c, -1, 0.03F);
      int lvt_9_1_ = lvt_9_1_ + 1;
      if (lvt_8_1_) {
         func_217693_a(p_229038_1_.field_217750_d, lvt_9_1_, p_229038_1_.field_222928_d + " " + p_229038_1_.field_222929_e + "xp", -1, 0.02F);
         ++lvt_9_1_;
      }

      if (lvt_8_1_ && !p_229038_1_.field_223455_g.equals("")) {
         func_217693_a(p_229038_1_.field_217750_d, lvt_9_1_, p_229038_1_.field_223455_g, -98404, 0.02F);
         ++lvt_9_1_;
      }
      ...
      String lvt_11_4_;
      if (lvt_8_1_) {
         for(var10 = p_229038_1_.field_217752_f.iterator(); var10.hasNext(); ++lvt_9_1_) {
            lvt_11_4_ = (String)var10.next();
            func_217693_a(p_229038_1_.field_217750_d, lvt_9_1_, lvt_11_4_, -16711681, 0.02F);
         }
      }

      if (lvt_8_1_) {
         for(var10 = p_229038_1_.field_217751_e.iterator(); var10.hasNext(); ++lvt_9_1_) {
            lvt_11_4_ = (String)var10.next();
            func_217693_a(p_229038_1_.field_217750_d, lvt_9_1_, lvt_11_4_, -16711936, 0.02F);
         }
      }

      if (p_229038_1_.field_223456_i) {
         func_217693_a(p_229038_1_.field_217750_d, lvt_9_1_, "Wants Golem", -23296, 0.02F);
         ++lvt_9_1_;
      }

      if (lvt_8_1_) {
         for(var10 = p_229038_1_.field_223457_m.iterator(); var10.hasNext(); ++lvt_9_1_) {
            lvt_11_4_ = (String)var10.next();
            if (lvt_11_4_.startsWith(p_229038_1_.field_217749_c)) {
               func_217693_a(p_229038_1_.field_217750_d, lvt_9_1_, lvt_11_4_, -1, 0.02F);
            } else {
               func_217693_a(p_229038_1_.field_217750_d, lvt_9_1_, lvt_11_4_, -23296, 0.02F);
            }
         }
      }

      if (lvt_8_1_) {
         for(var10 = Lists.reverse(p_229038_1_.field_217753_g).iterator(); var10.hasNext(); ++lvt_9_1_) {
            lvt_11_4_ = (String)var10.next();
            func_217693_a(p_229038_1_.field_217750_d, lvt_9_1_, lvt_11_4_, -3355444, 0.02F);
         }
      }
   ...
   private static void func_217695_a(String p_217695_0_, PointOfInterestDebugRenderer.POIInfo p_217695_1_, int p_217695_2_, int p_217695_3_) {
      BlockPos lvt_4_1_ = p_217695_1_.field_217755_a;
      func_222923_a(p_217695_0_, lvt_4_1_, p_217695_2_, p_217695_3_);
   }
   ...
   private static void func_222923_a(String p_222923_0_, BlockPos p_222923_1_, int p_222923_2_, int p_222923_3_) {
      ...
      double lvt_8_1_ = (double)p_222923_1_.getX() + 0.5D;
      double lvt_10_1_ = (double)p_222923_1_.getY() + 1.3D + (double)p_222923_2_ * 0.2D;
      double lvt_12_1_ = (double)p_222923_1_.getZ() + 0.5D;
      DebugRenderer.func_217734_a(p_222923_0_, lvt_8_1_, lvt_10_1_, lvt_12_1_, p_222923_3_, 0.02F, true, 0.0F, true);
   }
   ...
   private static void func_217693_a(IPosition p_217693_0_, int p_217693_1_, String p_217693_2_, int p_217693_3_, float p_217693_4_) {
      ...
      BlockPos lvt_9_1_ = new BlockPos(p_217693_0_);
      double lvt_10_1_ = (double)lvt_9_1_.getX() + 0.5D;
      double lvt_12_1_ = p_217693_0_.getY() + 2.4D + (double)p_217693_1_ * 0.25D;
      double lvt_14_1_ = (double)lvt_9_1_.getZ() + 0.5D;
      float lvt_16_1_ = 0.5F;
      DebugRenderer.func_217734_a(p_217693_2_, lvt_10_1_, lvt_12_1_, lvt_14_1_, p_217693_3_, p_217693_4_, false, 0.5F, true);
   }

   private Set<String> func_217696_c(PointOfInterestDebugRenderer.POIInfo p_217696_1_) {
      return (Set)this.func_217697_c(p_217696_1_.field_217755_a).stream().map(RandomObjectDescriptor::func_229748_a_).collect(Collectors.toSet());
   }
   ...
   private boolean func_217694_d(PointOfInterestDebugRenderer.BrainInfo p_217694_1_) {
      PlayerEntity lvt_2_1_ = this.client.player;
      BlockPos lvt_3_1_ = new BlockPos(lvt_2_1_.func_226277_ct_(), p_217694_1_.field_217750_d.getY(), lvt_2_1_.func_226281_cx_());
      BlockPos lvt_4_1_ = new BlockPos(p_217694_1_.field_217750_d);
      return lvt_3_1_.withinDistance(lvt_4_1_, 30.0D);
   }

   private Collection<UUID> func_217697_c(BlockPos p_217697_1_) {
      return (Collection)this.field_217715_e.values().stream().filter((p_217690_1_) -> {
   ...
   private Map<BlockPos, List<String>> func_222915_d() {
      ...
      Iterator var2 = this.field_217715_e.values().iterator();

      while(var2.hasNext()) {
         PointOfInterestDebugRenderer.BrainInfo lvt_3_1_ = (PointOfInterestDebugRenderer.BrainInfo)var2.next();
         Iterator var4 = lvt_3_1_.field_217754_h.iterator();

         while(var4.hasNext()) {
            BlockPos lvt_5_1_ = (BlockPos)var4.next();
            if (!this.field_217713_c.containsKey(lvt_5_1_)) {
               List<String> lvt_6_1_ = (List)lvt_1_1_.get(lvt_5_1_);
               if (lvt_6_1_ == null) {
                  lvt_6_1_ = Lists.newArrayList();
                  lvt_1_1_.put(lvt_5_1_, lvt_6_1_);
               }

               ((List)lvt_6_1_).add(lvt_3_1_.field_217749_c);
            }
         }
      }
   ...
   public static class BrainInfo {
      ...
      private boolean func_217744_a(BlockPos p_217744_1_) {
         Stream var10000 = this.field_217754_h.stream();
         p_217744_1_.getClass();
         return var10000.anyMatch(p_217744_1_::equals);
      }
