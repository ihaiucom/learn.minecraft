...
public class GameTestDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   public void func_225619_a_(MatrixStack p_225619_1_, IRenderTypeBuffer p_225619_2_, double p_225619_3_, double p_225619_5_, double p_225619_7_) {
      ...
      this.field_229020_a_.entrySet().removeIf((p_229021_2_) -> {
         return lvt_9_1_ > ((GameTestDebugRenderer.Marker)p_229021_2_.getValue()).field_229026_c_;
      });
   ...
   private void func_229023_a_(BlockPos p_229023_1_, GameTestDebugRenderer.Marker p_229023_2_) {
      ...
      if (!p_229023_2_.field_229025_b_.isEmpty()) {
         double lvt_3_1_ = (double)p_229023_1_.getX() + 0.5D;
         double lvt_5_1_ = (double)p_229023_1_.getY() + 1.2D;
         double lvt_7_1_ = (double)p_229023_1_.getZ() + 0.5D;
         DebugRenderer.func_217734_a(p_229023_2_.field_229025_b_, lvt_3_1_, lvt_5_1_, lvt_7_1_, -1, 0.01F, true, 0.0F, true);
      }
