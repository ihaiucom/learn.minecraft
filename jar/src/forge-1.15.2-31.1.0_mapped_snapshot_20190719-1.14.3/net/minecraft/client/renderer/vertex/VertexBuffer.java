...
public class VertexBuffer implements AutoCloseable {
   ...
   private void func_227880_c_(BufferBuilder p_227880_1_) {
      Pair<BufferBuilder.DrawState, ByteBuffer> lvt_2_1_ = p_227880_1_.func_227832_f_();
      if (this.glBufferId != -1) {
         ByteBuffer lvt_3_1_ = (ByteBuffer)lvt_2_1_.getSecond();
         this.count = lvt_3_1_.remaining() / this.vertexFormat.getSize();
         this.bindBuffer();
         RenderSystem.glBufferData(34962, lvt_3_1_, 35044);
         unbindBuffer();
      }
   }
