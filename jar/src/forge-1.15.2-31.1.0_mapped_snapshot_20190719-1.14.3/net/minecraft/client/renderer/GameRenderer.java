...
public class GameRenderer implements AutoCloseable, IResourceManagerReloadListener {
   ...
   public GameRenderer(Minecraft p_i225966_1_, IResourceManager p_i225966_2_, RenderTypeBuffers p_i225966_3_) {
      ...
      this.activeRender = new ActiveRenderInfo();
   ...
   public void updateShaderGroupSize(int p_147704_1_, int p_147704_2_) {
      ...
      this.mc.worldRenderer.createBindEntityOutlineFbs(p_147704_1_, p_147704_2_);
   }
   ...
   public void getMouseOver(float p_78473_1_) {
      ...
      if (entity != null && this.mc.world != null) {
         ...
         this.mc.objectMouseOver = entity.func_213324_a(d0, p_78473_1_, false);
         ...
         EntityRayTraceResult entityraytraceresult = ProjectileHelper.func_221273_a(entity, vec3d, vec3d2, axisalignedbb, (p_lambda$getMouseOver$0_0_) -> {
   ...
   private double getFOVModifier(ActiveRenderInfo p_215311_1_, float p_215311_2_, boolean p_215311_3_) {
      if (this.debugView) {
         ...
         if (p_215311_3_) {
            ...
            d0 *= (double)MathHelper.lerp(p_215311_2_, this.fovModifierHandPrev, this.fovModifierHand);
         }
         ...
         return ForgeHooksClient.getFOVModifier(this, p_215311_1_, (double)p_215311_2_, d0);
      }
   }
   ...
   private void func_228380_a_(MatrixStack p_228380_1_, float p_228380_2_) {
      if (this.mc.getRenderViewEntity() instanceof LivingEntity) {
         ...
         if (livingentity.getHealth() <= 0.0F) {
            f2 = Math.min((float)livingentity.deathTime + p_228380_2_, 20.0F);
            p_228380_1_.func_227863_a_(Vector3f.field_229183_f_.func_229187_a_(40.0F - 8000.0F / (f2 + 200.0F)));
         }
   ...
   private void func_228383_b_(MatrixStack p_228383_1_, float p_228383_2_) {
      if (this.mc.getRenderViewEntity() instanceof PlayerEntity) {
         ...
         p_228383_1_.func_227861_a_((double)(MathHelper.sin(f1 * 3.1415927F) * f2 * 0.5F), (double)(-Math.abs(MathHelper.cos(f1 * 3.1415927F) * f2)), 0.0D);
         p_228383_1_.func_227863_a_(Vector3f.field_229183_f_.func_229187_a_(MathHelper.sin(f1 * 3.1415927F) * f2 * 3.0F));
         p_228383_1_.func_227863_a_(Vector3f.field_229179_b_.func_229187_a_(Math.abs(MathHelper.cos(f1 * 3.1415927F - 0.2F) * f2) * 5.0F));
      }
   ...
   public static float getNightVisionBrightness(LivingEntity p_180438_0_, float p_180438_1_) {
      int i = p_180438_0_.getActivePotionEffect(Effects.NIGHT_VISION).getDuration();
      return i > 200 ? 1.0F : 0.7F + MathHelper.sin(((float)i - p_180438_1_) * 3.1415927F * 0.2F) * 0.3F;
   }

   public void updateCameraAndRender(float p_195458_1_, long p_195458_2_, boolean p_195458_4_) {
      ...
      } else if (Util.milliTime() - this.prevFrameTime > 500L) {
      ...
      if (!this.mc.skipRenderWorld) {
         ...
         if (p_195458_4_ && this.mc.world != null) {
            this.mc.getProfiler().startSection("level");
            this.func_228378_a_(p_195458_1_, p_195458_2_, matrixstack);
            ...
            if (this.shaderGroup != null && this.useShader) {
               ...
               RenderSystem.loadIdentity();
               this.shaderGroup.render(p_195458_1_);
         ...
         if (p_195458_4_ && this.mc.world != null) {
            ...
            if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null) {
               ...
               this.renderItemActivation(this.mc.func_228018_at_().getScaledWidth(), this.mc.func_228018_at_().getScaledHeight(), p_195458_1_);
               this.mc.ingameGUI.renderGameOverlay(p_195458_1_);
               RenderSystem.clear(256, Minecraft.IS_RUNNING_ON_MAC);
            }
         ...
         if (this.mc.loadingGui != null) {
            try {
               ...
               crashreport1 = CrashReport.makeCrashReport(var13, "Rendering overlay");
               crashreportcategory1 = crashreport1.makeCategory("Overlay render details");
               crashreportcategory1.addDetail("Overlay name", () -> {
            ...
            try {
               ForgeHooksClient.drawScreen(this.mc.currentScreen, i, j, this.mc.getTickLength());
            } catch (Throwable var12) {
               crashreport1 = CrashReport.makeCrashReport(var12, "Rendering screen");
               crashreportcategory1 = crashreport1.makeCategory("Screen render details");
   ...
   public void func_228378_a_(float p_228378_1_, long p_228378_2_, MatrixStack p_228378_4_) {
      ...
      EntityViewRenderEvent.CameraSetup cameraSetup = ForgeHooksClient.onCameraSetup(this, activerenderinfo, p_228378_1_);
      ...
      ForgeHooksClient.dispatchRenderLast(this.mc.worldRenderer, p_228378_4_, (float)p_228378_2_);
   ...
   private void renderItemActivation(int p_190563_1_, int p_190563_2_, float p_190563_3_) {
      if (this.itemActivationItem != null && this.itemActivationTicks > 0) {
         ...
         matrixstack.func_227861_a_((double)((float)(p_190563_1_ / 2) + f5 * MathHelper.abs(MathHelper.sin(f4 * 2.0F))), (double)((float)(p_190563_2_ / 2) + f6 * MathHelper.abs(MathHelper.sin(f4 * 2.0F))), -50.0D);
   ...
   public float getBossColorModifier(float p_205002_1_) {
      return MathHelper.lerp(p_205002_1_, this.bossColorModifierPrev, this.bossColorModifier);
   }
