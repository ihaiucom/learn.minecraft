...
public class RegionRenderCacheBuilder {
   private final Map<RenderType, BufferBuilder> builders = (Map)RenderType.func_228661_n_().stream().collect(Collectors.toMap((p_228369_0_) -> {
      return p_228369_0_;
   }, (p_228368_0_) -> {
   ...
   public BufferBuilder func_228366_a_(RenderType p_228366_1_) {
      return (BufferBuilder)this.builders.get(p_228366_1_);
   }
