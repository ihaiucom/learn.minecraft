...
public class RenderTypeBuffers {
   ...
   private final SortedMap<RenderType, BufferBuilder> field_228480_b_ = (SortedMap)Util.make(new Object2ObjectLinkedOpenHashMap(), (p_228485_1_) -> {
   ...
   private final IRenderTypeBuffer.Impl field_228481_c_;
   private final IRenderTypeBuffer.Impl field_228482_d_;
   private final OutlineLayerBuffer field_228483_e_;

   public RenderTypeBuffers() {
      this.field_228481_c_ = IRenderTypeBuffer.func_228456_a_(this.field_228480_b_, new BufferBuilder(256));
      this.field_228482_d_ = IRenderTypeBuffer.func_228455_a_(new BufferBuilder(256));
      this.field_228483_e_ = new OutlineLayerBuffer(this.field_228481_c_);
   }
