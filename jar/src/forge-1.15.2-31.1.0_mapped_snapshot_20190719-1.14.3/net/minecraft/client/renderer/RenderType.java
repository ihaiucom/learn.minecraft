...
public abstract class RenderType extends RenderState {
   private static final RenderType field_228615_R_;
   private static final RenderType field_228616_S_;
   private static final RenderType field_228617_T_;
   private static final RenderType field_228618_U_;
   private static final RenderType field_228619_V_;
   private static final RenderType field_228620_W_;
   private static final RenderType field_228621_X_;
   private static final RenderType field_228622_Y_;
   private static final RenderType field_228623_Z_;
   private static final RenderType field_228624_aa_;
   public static final RenderType.Type field_228614_Q_;
   ...
   public static RenderType func_228634_a_(ResourceLocation p_228634_0_) {
      RenderType.State lvt_1_1_ = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_228634_0_, false, false)).func_228726_a_(field_228510_b_).func_228716_a_(field_228532_x_).func_228719_a_(field_228528_t_).func_228722_a_(field_228530_v_).func_228728_a_(true);
      return func_228633_a_("entity_solid", DefaultVertexFormats.field_227849_i_, 7, 256, true, false, lvt_1_1_);
   }

   public static RenderType func_228638_b_(ResourceLocation p_228638_0_) {
      RenderType.State lvt_1_1_ = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_228638_0_, false, false)).func_228726_a_(field_228510_b_).func_228716_a_(field_228532_x_).func_228713_a_(field_228517_i_).func_228719_a_(field_228528_t_).func_228722_a_(field_228530_v_).func_228728_a_(true);
      return func_228633_a_("entity_cutout", DefaultVertexFormats.field_227849_i_, 7, 256, true, false, lvt_1_1_);
   }

   public static RenderType func_230167_a_(ResourceLocation p_230167_0_, boolean p_230167_1_) {
      RenderType.State lvt_2_1_ = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_230167_0_, false, false)).func_228726_a_(field_228510_b_).func_228716_a_(field_228532_x_).func_228713_a_(field_228517_i_).func_228714_a_(field_228491_A_).func_228719_a_(field_228528_t_).func_228722_a_(field_228530_v_).func_228728_a_(p_230167_1_);
      return func_228633_a_("entity_cutout_no_cull", DefaultVertexFormats.field_227849_i_, 7, 256, true, false, lvt_2_1_);
   }
   ...
   public static RenderType func_228642_d_(ResourceLocation p_228642_0_) {
      RenderType.State lvt_1_1_ = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_228642_0_, false, false)).func_228726_a_(field_228515_g_).func_228716_a_(field_228532_x_).func_228713_a_(field_228517_i_).func_228719_a_(field_228528_t_).func_228722_a_(field_228530_v_).func_228728_a_(true);
      return func_228633_a_("entity_translucent_cull", DefaultVertexFormats.field_227849_i_, 7, 256, true, true, lvt_1_1_);
   }
   ...
   public static RenderType func_230168_b_(ResourceLocation p_230168_0_, boolean p_230168_1_) {
      ...
      return func_228633_a_("entity_translucent", DefaultVertexFormats.field_227849_i_, 7, 256, true, true, lvt_2_1_);
   }
   ...
   public static RenderType func_228646_f_(ResourceLocation p_228646_0_) {
      RenderType.State lvt_1_1_ = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_228646_0_, false, false)).func_228713_a_(field_228518_j_).func_228716_a_(field_228532_x_).func_228723_a_(field_228520_l_).func_228714_a_(field_228491_A_).func_228719_a_(field_228528_t_).func_228728_a_(true);
      return func_228632_a_("entity_smooth_cutout", DefaultVertexFormats.field_227849_i_, 7, 256, lvt_1_1_);
   }

   public static RenderType func_228637_a_(ResourceLocation p_228637_0_, boolean p_228637_1_) {
      RenderType.State lvt_2_1_ = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_228637_0_, false, false)).func_228726_a_(p_228637_1_ ? field_228515_g_ : field_228510_b_).func_228727_a_(p_228637_1_ ? field_228496_F_ : field_228495_E_).func_228717_a_(field_228501_K_).func_228728_a_(false);
      return func_228633_a_("beacon_beam", DefaultVertexFormats.BLOCK, 7, 256, false, true, lvt_2_1_);
   }
   ...
   public static RenderType func_228648_g_(ResourceLocation p_228648_0_) {
      ...
      return func_228632_a_("entity_decal", DefaultVertexFormats.field_227849_i_, 7, 256, lvt_1_1_);
   }
   ...
   public static RenderType func_228650_h_(ResourceLocation p_228650_0_) {
      ...
      return func_228633_a_("entity_no_outline", DefaultVertexFormats.field_227849_i_, 7, 256, false, true, lvt_1_1_);
   }

   public static RenderType func_228635_a_(ResourceLocation p_228635_0_, float p_228635_1_) {
      RenderType.State lvt_2_1_ = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_228635_0_, false, false)).func_228713_a_(new RenderState.AlphaState(p_228635_1_)).func_228714_a_(field_228491_A_).func_228728_a_(true);
      return func_228632_a_("entity_alpha", DefaultVertexFormats.field_227849_i_, 7, 256, lvt_2_1_);
   }
   ...
   public static RenderType func_228652_i_(ResourceLocation p_228652_0_) {
      ...
      return func_228633_a_("eyes", DefaultVertexFormats.field_227849_i_, 7, 256, false, true, RenderType.State.func_228694_a_().func_228724_a_(lvt_1_1_).func_228726_a_(field_228511_c_).func_228727_a_(field_228496_F_).func_228717_a_(field_228503_M_).func_228728_a_(false));
   }
   ...
   public static RenderType func_228656_k_(ResourceLocation p_228656_0_) {
      RenderState.TextureState lvt_1_1_ = new RenderState.TextureState(p_228656_0_, false, false);
      return func_228633_a_("crumbling", DefaultVertexFormats.BLOCK, 7, 256, false, true, RenderType.State.func_228694_a_().func_228724_a_(lvt_1_1_).func_228713_a_(field_228517_i_).func_228726_a_(field_228514_f_).func_228727_a_(field_228496_F_).func_228718_a_(field_228499_I_).func_228728_a_(false));
   }
   ...
   public static RenderType func_228630_a_(int p_228630_0_) {
      RenderState.TransparencyState lvt_1_2_;
      RenderState.TextureState lvt_2_2_;
      if (p_228630_0_ <= 1) {
         lvt_1_2_ = field_228515_g_;
         lvt_2_2_ = new RenderState.TextureState(EndPortalTileEntityRenderer.END_SKY_TEXTURE, false, false);
      } else {
         lvt_1_2_ = field_228511_c_;
         lvt_2_2_ = new RenderState.TextureState(EndPortalTileEntityRenderer.END_PORTAL_TEXTURE, false, false);
      }

      return func_228633_a_("end_portal", DefaultVertexFormats.POSITION_COLOR, 7, 256, false, true, RenderType.State.func_228694_a_().func_228726_a_(lvt_1_2_).func_228724_a_(lvt_2_2_).func_228725_a_(new RenderState.PortalTexturingState(p_228630_0_)).func_228717_a_(field_228503_M_).func_228728_a_(false));
   }
   ...
   static {
      field_228615_R_ = func_228633_a_("solid", DefaultVertexFormats.BLOCK, 7, 2097152, true, false, RenderType.State.func_228694_a_().func_228723_a_(field_228520_l_).func_228719_a_(field_228528_t_).func_228724_a_(field_228521_m_).func_228728_a_(true));
      field_228616_S_ = func_228633_a_("cutout_mipped", DefaultVertexFormats.BLOCK, 7, 131072, true, false, RenderType.State.func_228694_a_().func_228723_a_(field_228520_l_).func_228719_a_(field_228528_t_).func_228724_a_(field_228521_m_).func_228713_a_(field_228518_j_).func_228728_a_(true));
      field_228617_T_ = func_228633_a_("cutout", DefaultVertexFormats.BLOCK, 7, 131072, true, false, RenderType.State.func_228694_a_().func_228723_a_(field_228520_l_).func_228719_a_(field_228528_t_).func_228724_a_(field_228522_n_).func_228713_a_(field_228518_j_).func_228728_a_(true));
      field_228618_U_ = func_228633_a_("translucent", DefaultVertexFormats.BLOCK, 7, 262144, true, true, func_228666_t_());
      field_228619_V_ = func_228633_a_("translucent_no_crumbling", DefaultVertexFormats.BLOCK, 7, 262144, false, true, func_228666_t_());
      field_228620_W_ = func_228632_a_("leash", DefaultVertexFormats.field_227850_m_, 7, 256, RenderType.State.func_228694_a_().func_228724_a_(field_228523_o_).func_228714_a_(field_228491_A_).func_228719_a_(field_228528_t_).func_228728_a_(false));
      field_228621_X_ = func_228632_a_("water_mask", DefaultVertexFormats.POSITION, 7, 256, RenderType.State.func_228694_a_().func_228724_a_(field_228523_o_).func_228727_a_(field_228497_G_).func_228728_a_(false));
      field_228622_Y_ = func_228632_a_("glint", DefaultVertexFormats.POSITION_TEX, 7, 256, RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(ItemRenderer.RES_ITEM_GLINT, true, false)).func_228727_a_(field_228496_F_).func_228714_a_(field_228491_A_).func_228715_a_(field_228493_C_).func_228726_a_(field_228513_e_).func_228725_a_(field_228526_r_).func_228728_a_(false));
      field_228623_Z_ = func_228632_a_("entity_glint", DefaultVertexFormats.POSITION_TEX, 7, 256, RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(ItemRenderer.RES_ITEM_GLINT, true, false)).func_228727_a_(field_228496_F_).func_228714_a_(field_228491_A_).func_228715_a_(field_228493_C_).func_228726_a_(field_228513_e_).func_228725_a_(field_228527_s_).func_228728_a_(false));
      field_228624_aa_ = func_228633_a_("lightning", DefaultVertexFormats.POSITION_COLOR, 7, 256, false, true, RenderType.State.func_228694_a_().func_228727_a_(field_228496_F_).func_228726_a_(field_228512_d_).func_228723_a_(field_228520_l_).func_228728_a_(false));
      field_228614_Q_ = func_228632_a_("lines", DefaultVertexFormats.POSITION_COLOR, 1, 256, RenderType.State.func_228694_a_().func_228720_a_(new RenderState.LineState(OptionalDouble.empty())).func_228718_a_(field_228500_J_).func_228726_a_(field_228515_g_).func_228727_a_(field_228496_F_).func_228728_a_(false));
   }

   @OnlyIn(Dist.CLIENT)
   static final class Type extends RenderType {
      private static final ObjectOpenCustomHashSet<RenderType.Type> field_228667_R_;
      ...
      private Type(String p_i225993_1_, VertexFormat p_i225993_2_, int p_i225993_3_, int p_i225993_4_, boolean p_i225993_5_, boolean p_i225993_6_, RenderType.State p_i225993_7_) {
         ...
         this.field_228669_T_ = Objects.hash(new Object[]{super.hashCode(), p_i225993_7_});
      }
      ...
      private static RenderType.Type func_228676_c_(String p_228676_0_, VertexFormat p_228676_1_, int p_228676_2_, int p_228676_3_, boolean p_228676_4_, boolean p_228676_5_, RenderType.State p_228676_6_) {
         return (RenderType.Type)field_228667_R_.addOrGet(new RenderType.Type(p_228676_0_, p_228676_1_, p_228676_2_, p_228676_3_, p_228676_4_, p_228676_5_, p_228676_6_));
      }
      ...
      static {
         field_228667_R_ = new ObjectOpenCustomHashSet(RenderType.Type.EqualityStrategy.INSTANCE);
      }
      ...
      static enum EqualityStrategy implements Strategy<RenderType.Type> {
         ...
         // $FF: synthetic method
         public boolean equals(@Nullable Object p_equals_1_, @Nullable Object p_equals_2_) {
            return this.equals((RenderType.Type)p_equals_1_, (RenderType.Type)p_equals_2_);
         }

         // $FF: synthetic method
         public int hashCode(@Nullable Object p_hashCode_1_) {
            return this.hashCode((RenderType.Type)p_hashCode_1_);
         }
      }
   }
   ...
   public static final class State {
      ...
      private State(RenderState.TextureState p_i230053_1_, RenderState.TransparencyState p_i230053_2_, RenderState.DiffuseLightingState p_i230053_3_, RenderState.ShadeModelState p_i230053_4_, RenderState.AlphaState p_i230053_5_, RenderState.DepthTestState p_i230053_6_, RenderState.CullState p_i230053_7_, RenderState.LightmapState p_i230053_8_, RenderState.OverlayState p_i230053_9_, RenderState.FogState p_i230053_10_, RenderState.LayerState p_i230053_11_, RenderState.TargetState p_i230053_12_, RenderState.TexturingState p_i230053_13_, RenderState.WriteMaskState p_i230053_14_, RenderState.LineState p_i230053_15_, RenderType.OutlineState p_i230053_16_) {
         ...
         this.field_228693_q_ = ImmutableList.of(this.field_228677_a_, this.field_228678_b_, this.field_228679_c_, this.field_228680_d_, this.field_228681_e_, this.field_228682_f_, this.field_228683_g_, this.field_228684_h_, this.field_228685_i_, this.field_228686_j_, this.field_228687_k_, this.field_228688_l_, new RenderState[]{this.field_228689_m_, this.field_228690_n_, this.field_228691_o_});
      }
      ...
      public boolean equals(Object p_equals_1_) {
         if (this == p_equals_1_) {
            ...
            RenderType.State lvt_2_1_ = (RenderType.State)p_equals_1_;
            return this.field_230171_p_ == lvt_2_1_.field_230171_p_ && this.field_228693_q_.equals(lvt_2_1_.field_228693_q_);
         } else {
            return false;
         }
      }
      ...
      // $FF: synthetic method
      State(RenderState.TextureState p_i230054_1_, RenderState.TransparencyState p_i230054_2_, RenderState.DiffuseLightingState p_i230054_3_, RenderState.ShadeModelState p_i230054_4_, RenderState.AlphaState p_i230054_5_, RenderState.DepthTestState p_i230054_6_, RenderState.CullState p_i230054_7_, RenderState.LightmapState p_i230054_8_, RenderState.OverlayState p_i230054_9_, RenderState.FogState p_i230054_10_, RenderState.LayerState p_i230054_11_, RenderState.TargetState p_i230054_12_, RenderState.TexturingState p_i230054_13_, RenderState.WriteMaskState p_i230054_14_, RenderState.LineState p_i230054_15_, RenderType.OutlineState p_i230054_16_, Object p_i230054_17_) {
         this(p_i230054_1_, p_i230054_2_, p_i230054_3_, p_i230054_4_, p_i230054_5_, p_i230054_6_, p_i230054_7_, p_i230054_8_, p_i230054_9_, p_i230054_10_, p_i230054_11_, p_i230054_12_, p_i230054_13_, p_i230054_14_, p_i230054_15_, p_i230054_16_);
      }

      @OnlyIn(Dist.CLIENT)
      public static class Builder {
         private RenderState.TextureState field_228698_a_;
         private RenderState.TransparencyState field_228699_b_;
         private RenderState.DiffuseLightingState field_228700_c_;
         private RenderState.ShadeModelState field_228701_d_;
         private RenderState.AlphaState field_228702_e_;
         private RenderState.DepthTestState field_228703_f_;
         private RenderState.CullState field_228704_g_;
         private RenderState.LightmapState field_228705_h_;
         private RenderState.OverlayState field_228706_i_;
         private RenderState.FogState field_228707_j_;
         private RenderState.LayerState field_228708_k_;
         private RenderState.TargetState field_228709_l_;
         private RenderState.TexturingState field_228710_m_;
         private RenderState.WriteMaskState field_228711_n_;
         private RenderState.LineState field_228712_o_;

         private Builder() {
            this.field_228698_a_ = RenderState.field_228523_o_;
            this.field_228699_b_ = RenderState.field_228510_b_;
            this.field_228700_c_ = RenderState.field_228533_y_;
            this.field_228701_d_ = RenderState.field_228519_k_;
            this.field_228702_e_ = RenderState.field_228516_h_;
            this.field_228703_f_ = RenderState.field_228494_D_;
            this.field_228704_g_ = RenderState.field_228534_z_;
            this.field_228705_h_ = RenderState.field_228529_u_;
            this.field_228706_i_ = RenderState.field_228531_w_;
            this.field_228707_j_ = RenderState.field_228502_L_;
            this.field_228708_k_ = RenderState.field_228498_H_;
            this.field_228709_l_ = RenderState.field_228504_N_;
            this.field_228710_m_ = RenderState.field_228524_p_;
            this.field_228711_n_ = RenderState.field_228495_E_;
            this.field_228712_o_ = RenderState.field_228506_P_;
         }
