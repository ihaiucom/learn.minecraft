...
public class SpriteMap implements AutoCloseable {
   ...
   public SpriteMap(Collection<AtlasTexture> p_i226042_1_) {
      this.field_229150_a_ = (Map)p_i226042_1_.stream().collect(Collectors.toMap(AtlasTexture::func_229223_g_, Function.identity()));
   }

   public AtlasTexture func_229152_a_(ResourceLocation p_229152_1_) {
      return (AtlasTexture)this.field_229150_a_.get(p_229152_1_);
   }

   public TextureAtlasSprite func_229151_a_(Material p_229151_1_) {
      return ((AtlasTexture)this.field_229150_a_.get(p_229151_1_.func_229310_a_())).getSprite(p_229151_1_.func_229313_b_());
   }
