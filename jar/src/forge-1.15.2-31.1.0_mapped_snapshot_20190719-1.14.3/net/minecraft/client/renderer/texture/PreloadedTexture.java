...
public class PreloadedTexture extends SimpleTexture {
   ...
   protected SimpleTexture.TextureData func_215246_b(IResourceManager p_215246_1_) {
      if (this.field_215252_g != null) {
         SimpleTexture.TextureData lvt_2_1_ = (SimpleTexture.TextureData)this.field_215252_g.join();
   ...
   public CompletableFuture<Void> func_215248_a() {
      return this.field_215252_g == null ? CompletableFuture.completedFuture((Object)null) : this.field_215252_g.thenApply((p_215247_0_) -> {
         return null;
      });
   }
