...
public class BlockModelRenderer {
   ...
   public boolean func_228802_a_(ILightReader p_228802_1_, IBakedModel p_228802_2_, BlockState p_228802_3_, BlockPos p_228802_4_, MatrixStack p_228802_5_, IVertexBuilder p_228802_6_, boolean p_228802_7_, Random p_228802_8_, long p_228802_9_, int p_228802_11_) {
      return this.renderModel(p_228802_1_, p_228802_2_, p_228802_3_, p_228802_4_, p_228802_5_, p_228802_6_, p_228802_7_, p_228802_8_, p_228802_9_, p_228802_11_, EmptyModelData.INSTANCE);
   }

   public boolean renderModel(ILightReader p_renderModel_1_, IBakedModel p_renderModel_2_, BlockState p_renderModel_3_, BlockPos p_renderModel_4_, MatrixStack p_renderModel_5_, IVertexBuilder p_renderModel_6_, boolean p_renderModel_7_, Random p_renderModel_8_, long p_renderModel_9_, int p_renderModel_11_, IModelData p_renderModel_12_) {
      boolean flag = Minecraft.isAmbientOcclusionEnabled() && p_renderModel_3_.getLightValue(p_renderModel_1_, p_renderModel_4_) == 0 && p_renderModel_2_.isAmbientOcclusion();
      Vec3d vec3d = p_renderModel_3_.getOffset(p_renderModel_1_, p_renderModel_4_);
      p_renderModel_5_.func_227861_a_(vec3d.x, vec3d.y, vec3d.z);
      p_renderModel_12_ = p_renderModel_2_.getModelData(p_renderModel_1_, p_renderModel_4_, p_renderModel_3_, p_renderModel_12_);

      try {
         return flag ? this.renderModelSmooth(p_renderModel_1_, p_renderModel_2_, p_renderModel_3_, p_renderModel_4_, p_renderModel_5_, p_renderModel_6_, p_renderModel_7_, p_renderModel_8_, p_renderModel_9_, p_renderModel_11_, p_renderModel_12_) : this.renderModelFlat(p_renderModel_1_, p_renderModel_2_, p_renderModel_3_, p_renderModel_4_, p_renderModel_5_, p_renderModel_6_, p_renderModel_7_, p_renderModel_8_, p_renderModel_9_, p_renderModel_11_, p_renderModel_12_);
      } catch (Throwable var18) {
         CrashReport crashreport = CrashReport.makeCrashReport(var18, "Tesselating block model");
         CrashReportCategory crashreportcategory = crashreport.makeCategory("Block model being tesselated");
         CrashReportCategory.addBlockInfo(crashreportcategory, p_renderModel_4_, p_renderModel_3_);
         crashreportcategory.addDetail("Using AO", (Object)flag);
   ...
   public boolean renderModelSmooth(ILightReader p_renderModelSmooth_1_, IBakedModel p_renderModelSmooth_2_, BlockState p_renderModelSmooth_3_, BlockPos p_renderModelSmooth_4_, MatrixStack p_renderModelSmooth_5_, IVertexBuilder p_renderModelSmooth_6_, boolean p_renderModelSmooth_7_, Random p_renderModelSmooth_8_, long p_renderModelSmooth_9_, int p_renderModelSmooth_11_, IModelData p_renderModelSmooth_12_) {
      ...
      for(int var19 = 0; var19 < var18; ++var19) {
         Direction direction = var17[var19];
         p_renderModelSmooth_8_.setSeed(p_renderModelSmooth_9_);
         List<BakedQuad> list = p_renderModelSmooth_2_.getQuads(p_renderModelSmooth_3_, direction, p_renderModelSmooth_8_, p_renderModelSmooth_12_);
         if (!list.isEmpty() && (!p_renderModelSmooth_7_ || Block.shouldSideBeRendered(p_renderModelSmooth_3_, p_renderModelSmooth_1_, p_renderModelSmooth_4_, direction))) {
            this.func_228799_a_(p_renderModelSmooth_1_, p_renderModelSmooth_3_, p_renderModelSmooth_4_, p_renderModelSmooth_5_, p_renderModelSmooth_6_, list, afloat, bitset, blockmodelrenderer$ambientocclusionface, p_renderModelSmooth_11_);
            flag = true;
         }
      }

      p_renderModelSmooth_8_.setSeed(p_renderModelSmooth_9_);
      List<BakedQuad> list1 = p_renderModelSmooth_2_.getQuads(p_renderModelSmooth_3_, (Direction)null, p_renderModelSmooth_8_, p_renderModelSmooth_12_);
      if (!list1.isEmpty()) {
         this.func_228799_a_(p_renderModelSmooth_1_, p_renderModelSmooth_3_, p_renderModelSmooth_4_, p_renderModelSmooth_5_, p_renderModelSmooth_6_, list1, afloat, bitset, blockmodelrenderer$ambientocclusionface, p_renderModelSmooth_11_);
         flag = true;
      }
   ...
   public boolean func_228806_c_(ILightReader p_228806_1_, IBakedModel p_228806_2_, BlockState p_228806_3_, BlockPos p_228806_4_, MatrixStack p_228806_5_, IVertexBuilder p_228806_6_, boolean p_228806_7_, Random p_228806_8_, long p_228806_9_, int p_228806_11_) {
      return this.renderModelFlat(p_228806_1_, p_228806_2_, p_228806_3_, p_228806_4_, p_228806_5_, p_228806_6_, p_228806_7_, p_228806_8_, p_228806_9_, p_228806_11_, EmptyModelData.INSTANCE);
   }

   public boolean renderModelFlat(ILightReader p_renderModelFlat_1_, IBakedModel p_renderModelFlat_2_, BlockState p_renderModelFlat_3_, BlockPos p_renderModelFlat_4_, MatrixStack p_renderModelFlat_5_, IVertexBuilder p_renderModelFlat_6_, boolean p_renderModelFlat_7_, Random p_renderModelFlat_8_, long p_renderModelFlat_9_, int p_renderModelFlat_11_, IModelData p_renderModelFlat_12_) {
      boolean flag = false;
      BitSet bitset = new BitSet(3);
      ...
      for(int var17 = 0; var17 < var16; ++var17) {
         ...
         List<BakedQuad> list = p_renderModelFlat_2_.getQuads(p_renderModelFlat_3_, direction, p_renderModelFlat_8_, p_renderModelFlat_12_);
         if (!list.isEmpty() && (!p_renderModelFlat_7_ || Block.shouldSideBeRendered(p_renderModelFlat_3_, p_renderModelFlat_1_, p_renderModelFlat_4_, direction))) {
            int i = WorldRenderer.func_228420_a_(p_renderModelFlat_1_, p_renderModelFlat_3_, p_renderModelFlat_4_.offset(direction));
            this.func_228798_a_(p_renderModelFlat_1_, p_renderModelFlat_3_, p_renderModelFlat_4_, i, p_renderModelFlat_11_, false, p_renderModelFlat_5_, p_renderModelFlat_6_, list, bitset);
            flag = true;
         }
      }

      p_renderModelFlat_8_.setSeed(p_renderModelFlat_9_);
      List<BakedQuad> list1 = p_renderModelFlat_2_.getQuads(p_renderModelFlat_3_, (Direction)null, p_renderModelFlat_8_, p_renderModelFlat_12_);
      if (!list1.isEmpty()) {
         this.func_228798_a_(p_renderModelFlat_1_, p_renderModelFlat_3_, p_renderModelFlat_4_, -1, p_renderModelFlat_11_, true, p_renderModelFlat_5_, p_renderModelFlat_6_, list1, bitset);
         flag = true;
      }
   ...
   private void func_228799_a_(ILightReader p_228799_1_, BlockState p_228799_2_, BlockPos p_228799_3_, MatrixStack p_228799_4_, IVertexBuilder p_228799_5_, List<BakedQuad> p_228799_6_, float[] p_228799_7_, BitSet p_228799_8_, BlockModelRenderer.AmbientOcclusionFace p_228799_9_, int p_228799_10_) {
      Iterator var11 = p_228799_6_.iterator();
   ...
   private void func_228800_a_(ILightReader p_228800_1_, BlockState p_228800_2_, BlockPos p_228800_3_, IVertexBuilder p_228800_4_, MatrixStack.Entry p_228800_5_, BakedQuad p_228800_6_, float p_228800_7_, float p_228800_8_, float p_228800_9_, float p_228800_10_, int p_228800_11_, int p_228800_12_, int p_228800_13_, int p_228800_14_, int p_228800_15_) {
      ...
      if (p_228800_6_.shouldApplyDiffuseLighting()) {
         float l = LightUtil.diffuseLight(p_228800_6_.getFace());
         f *= l;
         f1 *= l;
         f2 *= l;
      }
   ...
   private void func_228801_a_(ILightReader p_228801_1_, BlockState p_228801_2_, BlockPos p_228801_3_, int[] p_228801_4_, Direction p_228801_5_, @Nullable float[] p_228801_6_, BitSet p_228801_7_) {
      ...
      float f10;
      for(j = 0; j < 4; ++j) {
         f10 = Float.intBitsToFloat(p_228801_4_[j * 8]);
         float f7 = Float.intBitsToFloat(p_228801_4_[j * 8 + 1]);
         float f8 = Float.intBitsToFloat(p_228801_4_[j * 8 + 2]);
         f = Math.min(f, f10);
         f1 = Math.min(f1, f7);
         f2 = Math.min(f2, f8);
         f3 = Math.max(f3, f10);
   ...
   private void func_228798_a_(ILightReader p_228798_1_, BlockState p_228798_2_, BlockPos p_228798_3_, int p_228798_4_, int p_228798_5_, boolean p_228798_6_, MatrixStack p_228798_7_, IVertexBuilder p_228798_8_, List<BakedQuad> p_228798_9_, BitSet p_228798_10_) {
      BakedQuad bakedquad;
      for(Iterator var11 = p_228798_9_.iterator(); var11.hasNext(); this.func_228800_a_(p_228798_1_, p_228798_2_, p_228798_3_, p_228798_8_, p_228798_7_.func_227866_c_(), bakedquad, 1.0F, 1.0F, 1.0F, 1.0F, p_228798_4_, p_228798_4_, p_228798_4_, p_228798_4_, p_228798_5_)) {
   ...
   public void func_228804_a_(MatrixStack.Entry p_228804_1_, IVertexBuilder p_228804_2_, @Nullable BlockState p_228804_3_, IBakedModel p_228804_4_, float p_228804_5_, float p_228804_6_, float p_228804_7_, int p_228804_8_, int p_228804_9_) {
      this.renderModel(p_228804_1_, p_228804_2_, p_228804_3_, p_228804_4_, p_228804_5_, p_228804_6_, p_228804_7_, p_228804_8_, p_228804_9_, EmptyModelData.INSTANCE);
   }
   ...
   public void renderModel(MatrixStack.Entry p_renderModel_1_, IVertexBuilder p_renderModel_2_, @Nullable BlockState p_renderModel_3_, IBakedModel p_renderModel_4_, float p_renderModel_5_, float p_renderModel_6_, float p_renderModel_7_, int p_renderModel_8_, int p_renderModel_9_, IModelData p_renderModel_10_) {
      ...
      for(int var16 = 0; var16 < var15; ++var16) {
         ...
         random.setSeed(42L);
         func_228803_a_(p_renderModel_1_, p_renderModel_2_, p_renderModel_5_, p_renderModel_6_, p_renderModel_7_, p_renderModel_4_.getQuads(p_renderModel_3_, direction, random), p_renderModel_8_, p_renderModel_9_);
      }

      random.setSeed(42L);
      func_228803_a_(p_renderModel_1_, p_renderModel_2_, p_renderModel_5_, p_renderModel_6_, p_renderModel_7_, p_renderModel_4_.getQuads(p_renderModel_3_, (Direction)null, random), p_renderModel_8_, p_renderModel_9_);
   }
   ...
   private static void func_228803_a_(MatrixStack.Entry p_228803_0_, IVertexBuilder p_228803_1_, float p_228803_2_, float p_228803_3_, float p_228803_4_, List<BakedQuad> p_228803_5_, int p_228803_6_, int p_228803_7_) {
      ...
      float f1;
      float f2;
      for(Iterator var8 = p_228803_5_.iterator(); var8.hasNext(); p_228803_1_.func_227889_a_(p_228803_0_, bakedquad, f, f1, f2, p_228803_6_, p_228803_7_)) {
   ...
   public static void enableCache() {
      ((BlockModelRenderer.Cache)CACHE_COMBINED_LIGHT.get()).func_222895_a();
   }

   public static void disableCache() {
      ((BlockModelRenderer.Cache)CACHE_COMBINED_LIGHT.get()).func_222897_b();
   }
   ...
   static enum VertexTranslations {
      ...
      private static final BlockModelRenderer.VertexTranslations[] VALUES = (BlockModelRenderer.VertexTranslations[])Util.make(new BlockModelRenderer.VertexTranslations[6], (p_lambda$static$0_0_) -> {
   ...
   public static enum NeighborInfo {
      ...
      private static final BlockModelRenderer.NeighborInfo[] VALUES = (BlockModelRenderer.NeighborInfo[])Util.make(new BlockModelRenderer.NeighborInfo[6], (p_lambda$static$0_0_) -> {
         p_lambda$static$0_0_[Direction.DOWN.getIndex()] = DOWN;
         p_lambda$static$0_0_[Direction.UP.getIndex()] = UP;
         p_lambda$static$0_0_[Direction.NORTH.getIndex()] = NORTH;
         p_lambda$static$0_0_[Direction.SOUTH.getIndex()] = SOUTH;
      ...
      public static BlockModelRenderer.NeighborInfo getNeighbourInfo(Direction p_178273_0_) {
   ...
   static class Cache {
      ...
      private Cache() {
         this.field_222899_b = (Long2IntLinkedOpenHashMap)Util.make(() -> {
         ...
         this.field_222900_c = (Long2FloatLinkedOpenHashMap)Util.make(() -> {
      ...
      public int func_228810_a_(BlockState p_228810_1_, ILightReader p_228810_2_, BlockPos p_228810_3_) {
         ...
         if (this.field_222898_a) {
            k = this.field_222899_b.get(i);
            if (k != Integer.MAX_VALUE) {
               return k;
            }
         }

         k = WorldRenderer.func_228420_a_(p_228810_2_, p_228810_1_, p_228810_3_);
         if (this.field_222898_a) {
      ...
      public float func_228811_b_(BlockState p_228811_1_, ILightReader p_228811_2_, BlockPos p_228811_3_) {
         ...
         float f1;
         if (this.field_222898_a) {
            f1 = this.field_222900_c.get(i);
            if (!Float.isNaN(f1)) {
               return f1;
            }
         }

         f1 = p_228811_1_.func_215703_d(p_228811_2_, p_228811_3_);
         if (this.field_222898_a) {
   ...
   class AmbientOcclusionFace {
      ...
      public void func_228807_a_(ILightReader p_228807_1_, BlockState p_228807_2_, BlockPos p_228807_3_, Direction p_228807_4_, float[] p_228807_5_, BitSet p_228807_6_) {
         ...
         BlockModelRenderer.Cache blockmodelrenderer$cache = (BlockModelRenderer.Cache)BlockModelRenderer.CACHE_COMBINED_LIGHT.get();
         blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[0]);
         ...
         blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[1]);
         ...
         blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[2]);
         ...
         blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[3]);
         ...
         blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[0]).move(p_228807_4_);
         boolean flag = p_228807_1_.getBlockState(blockpos$mutable).getOpacity(p_228807_1_, blockpos$mutable) == 0;
         blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[1]).move(p_228807_4_);
         boolean flag1 = p_228807_1_.getBlockState(blockpos$mutable).getOpacity(p_228807_1_, blockpos$mutable) == 0;
         blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[2]).move(p_228807_4_);
         boolean flag2 = p_228807_1_.getBlockState(blockpos$mutable).getOpacity(p_228807_1_, blockpos$mutable) == 0;
         blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[3]).move(p_228807_4_);
         ...
         if (!flag2 && !flag) {
            ...
            blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[0]).move(blockmodelrenderer$neighborinfo.corners[2]);
         ...
         if (!flag3 && !flag) {
            ...
            blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[0]).move(blockmodelrenderer$neighborinfo.corners[3]);
         ...
         if (!flag2 && !flag1) {
            ...
            blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[1]).move(blockmodelrenderer$neighborinfo.corners[2]);
         ...
         if (!flag3 && !flag1) {
            ...
            blockpos$mutable.setPos((Vec3i)blockpos).move(blockmodelrenderer$neighborinfo.corners[1]).move(blockmodelrenderer$neighborinfo.corners[3]);
         ...
         blockpos$mutable.setPos((Vec3i)p_228807_3_).move(p_228807_4_);
         ...
         if (p_228807_6_.get(1) && blockmodelrenderer$neighborinfo.doNonCubicWeight) {
            ...
            this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.vert0] = f9 * f13 + f10 * f14 + f11 * f15 + f12 * f16;
            this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.vert1] = f9 * f17 + f10 * f18 + f11 * f19 + f12 * f20;
            this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.vert2] = f9 * f21 + f10 * f22 + f11 * f23 + f12 * f24;
            this.vertexColorMultiplier[blockmodelrenderer$vertextranslations.vert3] = f9 * f25 + f10 * f26 + f11 * f27 + f12 * f28;
