...
@OnlyIn(Dist.CLIENT)
public final class TransformationMatrix implements IForgeTransformationMatrix {
   ...
   private static final TransformationMatrix field_227982_g_ = (TransformationMatrix)Util.make(() -> {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.field_227976_a_});
   }
