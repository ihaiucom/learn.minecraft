...
public class FirstPersonRenderer {
   ...
   private void func_228403_a_(MatrixStack p_228403_1_, IRenderTypeBuffer p_228403_2_, int p_228403_3_, HandSide p_228403_4_) {
      ...
      p_228403_1_.func_227861_a_((double)(f * 0.3F), -1.100000023841858D, 0.44999998807907104D);
   ...
   private void func_228402_a_(MatrixStack p_228402_1_, IRenderTypeBuffer p_228402_2_, int p_228402_3_, float p_228402_4_, HandSide p_228402_5_, float p_228402_6_, ItemStack p_228402_7_) {
      ...
      float f5 = -0.3F * MathHelper.sin(p_228402_6_ * 3.1415927F);
   ...
   private void func_228400_a_(MatrixStack p_228400_1_, IRenderTypeBuffer p_228400_2_, int p_228400_3_, float p_228400_4_, float p_228400_5_, float p_228400_6_) {
      ...
      float f1 = -0.2F * MathHelper.sin(p_228400_6_ * 3.1415927F);
      ...
      p_228400_1_.func_227861_a_(0.0D, (double)(0.04F + p_228400_5_ * -1.2F + f3 * -0.5F), -0.7200000286102295D);
   ...
   private void func_228401_a_(MatrixStack p_228401_1_, IRenderTypeBuffer p_228401_2_, int p_228401_3_, float p_228401_4_, float p_228401_5_, HandSide p_228401_6_) {
      ...
      float f4 = -0.4F * MathHelper.sin(p_228401_5_ * 3.1415927F);
      ...
      float f5 = MathHelper.sin(p_228401_5_ * p_228401_5_ * 3.1415927F);
      ...
      p_228401_1_.func_227861_a_((double)(f * -1.0F), 3.5999999046325684D, 3.5D);
   ...
   private void func_228398_a_(MatrixStack p_228398_1_, float p_228398_2_, HandSide p_228398_3_, ItemStack p_228398_4_) {
      ...
      if (f1 < 0.8F) {
         ...
         p_228398_1_.func_227861_a_(0.0D, (double)f3, 0.0D);
      }
   ...
   private void func_228399_a_(MatrixStack p_228399_1_, HandSide p_228399_2_, float p_228399_3_) {
      ...
      float f = MathHelper.sin(p_228399_3_ * p_228399_3_ * 3.1415927F);
      p_228399_1_.func_227863_a_(Vector3f.field_229181_d_.func_229187_a_((float)i * (45.0F + f * -20.0F)));
      float f1 = MathHelper.sin(MathHelper.sqrt(p_228399_3_) * 3.1415927F);
   ...
   private void func_228406_b_(MatrixStack p_228406_1_, HandSide p_228406_2_, float p_228406_3_) {
      ...
      p_228406_1_.func_227861_a_((double)((float)i * 0.56F), (double)(-0.52F + p_228406_3_ * -0.6F), -0.7200000286102295D);
   }
   ...
   public void func_228396_a_(float p_228396_1_, MatrixStack p_228396_2_, IRenderTypeBuffer.Impl p_228396_3_, ClientPlayerEntity p_228396_4_, int p_228396_5_) {
      ...
      Hand hand = (Hand)MoreObjects.firstNonNull(p_228396_4_.swingingHand, Hand.MAIN_HAND);
      ...
      if (p_228396_4_.isHandActive()) {
         itemstack2 = p_228396_4_.getActiveItemStack();
         ...
         itemstack2 = p_228396_4_.getHeldItemMainhand();
      ...
      if (flag) {
         ...
         f7 = 1.0F - MathHelper.lerp(p_228396_1_, this.prevEquippedProgressMainHand, this.equippedProgressMainHand);
         if (!ForgeHooksClient.renderSpecificFirstPersonHand(Hand.MAIN_HAND, p_228396_2_, p_228396_3_, p_228396_5_, p_228396_1_, f1, f3, f6, this.itemStackMainHand)) {
            this.func_228405_a_(p_228396_4_, p_228396_1_, f1, Hand.MAIN_HAND, f6, this.itemStackMainHand, f7, p_228396_2_, p_228396_3_, p_228396_5_);
         }
      }

      if (flag1) {
         f6 = hand == Hand.OFF_HAND ? f : 0.0F;
         f7 = 1.0F - MathHelper.lerp(p_228396_1_, this.prevEquippedProgressOffHand, this.equippedProgressOffHand);
         if (!ForgeHooksClient.renderSpecificFirstPersonHand(Hand.OFF_HAND, p_228396_2_, p_228396_3_, p_228396_5_, p_228396_1_, f1, f4, f6, this.itemStackOffHand)) {
   ...
   private void func_228405_a_(AbstractClientPlayerEntity p_228405_1_, float p_228405_2_, float p_228405_3_, Hand p_228405_4_, float p_228405_5_, ItemStack p_228405_6_, float p_228405_7_, MatrixStack p_228405_8_, IRenderTypeBuffer p_228405_9_, int p_228405_10_) {
      ...
      if (p_228405_6_.isEmpty()) {
         ...
         float f14;
         float f17;
         if (p_228405_6_.getItem() instanceof CrossbowItem) {
            flag3 = CrossbowItem.isCharged(p_228405_6_);
            ...
            if (p_228405_1_.isHandActive() && p_228405_1_.getItemInUseCount() > 0 && p_228405_1_.getActiveHand() == p_228405_4_) {
               ...
               p_228405_8_.func_227861_a_((double)((float)i * -0.4785682F), -0.0943870022892952D, 0.05731530860066414D);
               ...
               f12 = (float)p_228405_6_.getUseDuration() - ((float)this.mc.player.getItemInUseCount() - p_228405_2_ + 1.0F);
               f7 = f12 / (float)CrossbowItem.getChargeTime(p_228405_6_);
               if (f7 > 1.0F) {
                  f7 = 1.0F;
               }

               if (f7 > 0.1F) {
                  f11 = MathHelper.sin((f12 - 0.1F) * 1.3F);
                  f14 = f7 - 0.1F;
                  f17 = f11 * f14;
               ...
               f12 = -0.4F * MathHelper.sin(MathHelper.sqrt(p_228405_5_) * 3.1415927F);
               f7 = 0.2F * MathHelper.sin(MathHelper.sqrt(p_228405_5_) * 6.2831855F);
               f11 = -0.2F * MathHelper.sin(p_228405_5_ * 3.1415927F);
               p_228405_8_.func_227861_a_((double)((float)i * f12), (double)f7, (double)f11);
               this.func_228406_b_(p_228405_8_, handside, p_228405_7_);
            ...
            if (p_228405_1_.isHandActive() && p_228405_1_.getItemInUseCount() > 0 && p_228405_1_.getActiveHand() == p_228405_4_) {
               ...
               case BOW:
                  ...
                  f8 = (float)p_228405_6_.getUseDuration() - ((float)this.mc.player.getItemInUseCount() - p_228405_2_ + 1.0F);
                  f12 = f8 / 20.0F;
                  ...
                  if (f12 > 0.1F) {
                     f7 = MathHelper.sin((f8 - 0.1F) * 1.3F);
                     f11 = f12 - 0.1F;
                     f14 = f7 * f11;
               ...
               case SPEAR:
                  ...
                  p_228405_8_.func_227863_a_(Vector3f.field_229181_d_.func_229187_a_((float)k * 35.3F));
                  p_228405_8_.func_227863_a_(Vector3f.field_229183_f_.func_229187_a_((float)k * -9.785F));
                  f7 = (float)p_228405_6_.getUseDuration() - ((float)this.mc.player.getItemInUseCount() - p_228405_2_ + 1.0F);
                  f11 = f7 / 10.0F;
                  if (f11 > 1.0F) {
                     f11 = 1.0F;
                  }
                  ...
                  if (f11 > 0.1F) {
                     f14 = MathHelper.sin((f7 - 0.1F) * 1.3F);
                     f17 = f11 - 0.1F;
                     float f19 = f14 * f17;
               ...
               float f5 = -0.4F * MathHelper.sin(MathHelper.sqrt(p_228405_5_) * 3.1415927F);
               f8 = 0.2F * MathHelper.sin(MathHelper.sqrt(p_228405_5_) * 6.2831855F);
               f12 = -0.2F * MathHelper.sin(p_228405_5_ * 3.1415927F);
               int l = flag3 ? 1 : -1;
               p_228405_8_.func_227861_a_((double)((float)l * f5), (double)f8, (double)f12);
               this.func_228406_b_(p_228405_8_, handside, p_228405_7_);
               this.func_228399_a_(p_228405_8_, handside, p_228405_5_);
            }
   ...
   public void tick() {
      ...
      if (clientplayerentity.isRowingBoat()) {
         ...
         boolean requipM = ForgeHooksClient.shouldCauseReequipAnimation(this.itemStackMainHand, itemstack, clientplayerentity.inventory.currentItem);
   ...
   public void resetEquippedProgress(Hand p_187460_1_) {
