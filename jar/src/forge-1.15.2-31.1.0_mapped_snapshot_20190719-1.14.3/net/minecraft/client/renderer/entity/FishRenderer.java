...
public class FishRenderer extends EntityRenderer<FishingBobberEntity> {
   ...
   public void func_225623_a_(FishingBobberEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      if (playerentity != null) {
         ...
         if ((this.renderManager.options == null || this.renderManager.options.thirdPersonView <= 0) && playerentity == Minecraft.getInstance().player) {
            ...
            d9 /= 100.0D;
            Vec3d vec3d = new Vec3d((double)i * -0.36D * d9, -0.045D * d9, 0.4D);
            vec3d = vec3d.rotatePitch(-MathHelper.lerp(p_225623_3_, playerentity.prevRotationPitch, playerentity.rotationPitch) * 0.017453292F);
            vec3d = vec3d.rotateYaw(-MathHelper.lerp(p_225623_3_, playerentity.prevRotationYaw, playerentity.rotationYaw) * 0.017453292F);
         ...
         d9 = MathHelper.lerp((double)p_225623_3_, p_225623_1_.prevPosX, p_225623_1_.func_226277_ct_());
   ...
   public ResourceLocation getEntityTexture(FishingBobberEntity p_110775_1_) {
      return BOBBER;
   }

   static {
      field_229103_e_ = RenderType.func_228638_b_(BOBBER);
   }
}
