...
public class LlamaDecorLayer extends LayerRenderer<LlamaEntity, LlamaModel<LlamaEntity>> {
   ...
   public void func_225628_a_(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, LlamaEntity p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
      DyeColor lvt_11_1_ = p_225628_4_.getColor();
      ResourceLocation lvt_12_3_;
      if (lvt_11_1_ != null) {
         lvt_12_3_ = LLAMA_DECOR_TEXTURES[lvt_11_1_.getId()];
      } else {
         if (!p_225628_4_.func_213800_eB()) {
            return;
         }

         lvt_12_3_ = field_215342_b;
      }

      ((LlamaModel)this.getEntityModel()).setModelAttributes(this.model);
      this.model.func_225597_a_((AbstractChestedHorseEntity)p_225628_4_, p_225628_5_, p_225628_6_, p_225628_8_, p_225628_9_, p_225628_10_);
      IVertexBuilder lvt_13_1_ = p_225628_2_.getBuffer(RenderType.func_228640_c_(lvt_12_3_));
      this.model.func_225598_a_(p_225628_1_, lvt_13_1_, p_225628_3_, OverlayTexture.field_229196_a_, 1.0F, 1.0F, 1.0F, 1.0F);
   }
}
