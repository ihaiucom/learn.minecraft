...
public class TridentModel extends Model {
   ...
   public TridentModel() {
      ...
      ModelRenderer lvt_1_1_ = new ModelRenderer(32, 32, 4, 0);
      lvt_1_1_.func_228300_a_(-1.5F, 0.0F, -0.5F, 3.0F, 2.0F, 1.0F);
      this.modelRenderer.addChild(lvt_1_1_);
      ModelRenderer lvt_2_1_ = new ModelRenderer(32, 32, 4, 3);
      lvt_2_1_.func_228300_a_(-2.5F, -3.0F, -0.5F, 1.0F, 4.0F, 1.0F);
      this.modelRenderer.addChild(lvt_2_1_);
      ModelRenderer lvt_3_1_ = new ModelRenderer(32, 32, 0, 0);
      lvt_3_1_.func_228301_a_(-0.5F, -4.0F, -0.5F, 1.0F, 4.0F, 1.0F, 0.0F);
      this.modelRenderer.addChild(lvt_3_1_);
      ModelRenderer lvt_4_1_ = new ModelRenderer(32, 32, 4, 3);
      lvt_4_1_.mirror = true;
      lvt_4_1_.func_228300_a_(1.5F, -3.0F, -0.5F, 1.0F, 4.0F, 1.0F);
      this.modelRenderer.addChild(lvt_4_1_);
   }
