...
public class OcelotModel<T extends Entity> extends AgeableModel<T> {
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      this.ocelotHead.rotateAngleX = p_225597_6_ * 0.017453292F;
      this.ocelotHead.rotateAngleY = p_225597_5_ * 0.017453292F;
      if (this.state != 3) {
         ...
         if (this.state == 2) {
            ...
            this.ocelotFrontLeftLeg.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F + 3.1415927F + 0.3F) * p_225597_3_;
            this.ocelotFrontRightLeg.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F + 3.1415927F) * p_225597_3_;
            this.ocelotTail2.rotateAngleX = 1.7278761F + 0.31415927F * MathHelper.cos(p_225597_2_) * p_225597_3_;
         } else {
            this.ocelotBackLeftLeg.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F) * p_225597_3_;
            this.ocelotBackRightLeg.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F + 3.1415927F) * p_225597_3_;
            this.ocelotFrontLeftLeg.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F + 3.1415927F) * p_225597_3_;
            this.ocelotFrontRightLeg.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F) * p_225597_3_;
            if (this.state == 1) {
               this.ocelotTail2.rotateAngleX = 1.7278761F + 0.7853982F * MathHelper.cos(p_225597_2_) * p_225597_3_;
            } else {
