...
public class EntityRendererManager {
   ...
   public void validateRendererExistence() {
      ...
      do {
         ...
         entitytype = (EntityType)var1.next();
   ...
   public <T extends Entity> EntityRenderer<? super T> getRenderer(T p_78713_1_) {
      if (p_78713_1_ instanceof AbstractClientPlayerEntity) {
         String s = ((AbstractClientPlayerEntity)p_78713_1_).getSkinType();
         PlayerRenderer playerrenderer = (PlayerRenderer)this.skinMap.get(s);
         return playerrenderer != null ? playerrenderer : this.playerRenderer;
      } else {
         return (EntityRenderer)this.renderers.get(p_78713_1_.getType());
      }
   }
   ...
   public <E extends Entity> void func_229084_a_(E p_229084_1_, double p_229084_2_, double p_229084_4_, double p_229084_6_, float p_229084_8_, float p_229084_9_, MatrixStack p_229084_10_, IRenderTypeBuffer p_229084_11_, int p_229084_12_) {
      EntityRenderer entityrenderer = this.getRenderer(p_229084_1_);
      ...
      try {
         ...
         CrashReport crashreport = CrashReport.makeCrashReport(var24, "Rendering entity in world");
         CrashReportCategory crashreportcategory = crashreport.makeCategory("Entity being rendered");
         p_229084_1_.fillCrashReport(crashreportcategory);
         CrashReportCategory crashreportcategory1 = crashreport.makeCategory("Renderer details");
         crashreportcategory1.addDetail("Assigned renderer", (Object)entityrenderer);
         crashreportcategory1.addDetail("Location", (Object)CrashReportCategory.getCoordinateInfo(p_229084_2_, p_229084_4_, p_229084_6_));
         crashreportcategory1.addDetail("Rotation", (Object)p_229084_8_);
         crashreportcategory1.addDetail("Delta", (Object)p_229084_9_);
   ...
   private void func_229093_a_(MatrixStack p_229093_1_, IVertexBuilder p_229093_2_, Entity p_229093_3_, float p_229093_4_) {
      ...
      if (p_229093_3_ instanceof EnderDragonEntity) {
         ...
         EnderDragonPartEntity[] var12 = ((EnderDragonEntity)p_229093_3_).func_213404_dT();
         int var13 = var12.length;

         for(int var14 = 0; var14 < var13; ++var14) {
            EnderDragonPartEntity enderdragonpartentity = var12[var14];
   ...
   private static void func_229096_a_(MatrixStack p_229096_0_, IRenderTypeBuffer p_229096_1_, Entity p_229096_2_, float p_229096_3_, float p_229096_4_, IWorldReader p_229096_5_, float p_229096_6_) {
      ...
      Iterator var22 = BlockPos.getAllInBoxMutable(new BlockPos(i, k, i1), new BlockPos(j, l, j1)).iterator();
   ...
   private static void func_229092_a_(MatrixStack.Entry p_229092_0_, IVertexBuilder p_229092_1_, IWorldReader p_229092_2_, BlockPos p_229092_3_, double p_229092_4_, double p_229092_6_, double p_229092_8_, float p_229092_10_, float p_229092_11_) {
      ...
      if (blockstate.getRenderType() != BlockRenderType.INVISIBLE && p_229092_2_.getLight(p_229092_3_) > 3 && blockstate.func_224756_o(p_229092_2_, blockpos)) {
   ...
   public double getDistanceToCamera(double p_78714_1_, double p_78714_3_, double p_78714_5_) {
      return this.info.getProjectedView().squareDistanceTo(p_78714_1_, p_78714_3_, p_78714_5_);
   }
