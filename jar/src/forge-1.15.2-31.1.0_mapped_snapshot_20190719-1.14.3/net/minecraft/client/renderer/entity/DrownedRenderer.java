...
public class DrownedRenderer extends AbstractZombieRenderer<DrownedEntity, DrownedModel<DrownedEntity>> {
   ...
   protected void func_225621_a_(DrownedEntity p_225621_1_, MatrixStack p_225621_2_, float p_225621_3_, float p_225621_4_, float p_225621_5_) {
      super.func_225621_a_((ZombieEntity)p_225621_1_, p_225621_2_, p_225621_3_, p_225621_4_, p_225621_5_);
      float lvt_6_1_ = p_225621_1_.getSwimAnimation(p_225621_5_);
      if (lvt_6_1_ > 0.0F) {
         p_225621_2_.func_227863_a_(Vector3f.field_229179_b_.func_229187_a_(MathHelper.lerp(lvt_6_1_, p_225621_1_.rotationPitch, -10.0F - p_225621_1_.rotationPitch)));
      }
