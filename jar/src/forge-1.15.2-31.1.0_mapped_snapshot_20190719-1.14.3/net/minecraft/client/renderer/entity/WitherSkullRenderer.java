...
public class WitherSkullRenderer extends EntityRenderer<WitherSkullEntity> {
   ...
   public void func_225623_a_(WitherSkullEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      IVertexBuilder lvt_9_1_ = p_225623_5_.getBuffer(this.skeletonHeadModel.func_228282_a_(this.getEntityTexture(p_225623_1_)));
      this.skeletonHeadModel.func_225603_a_(0.0F, lvt_7_1_, lvt_8_1_);
      this.skeletonHeadModel.func_225598_a_(p_225623_4_, lvt_9_1_, p_225623_6_, OverlayTexture.field_229196_a_, 1.0F, 1.0F, 1.0F, 1.0F);
      p_225623_4_.func_227865_b_();
      super.func_225623_a_(p_225623_1_, p_225623_2_, p_225623_3_, p_225623_4_, p_225623_5_, p_225623_6_);
   }

   public ResourceLocation getEntityTexture(WitherSkullEntity p_110775_1_) {
