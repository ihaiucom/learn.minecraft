...
public class PlayerRenderer extends LivingRenderer<AbstractClientPlayerEntity, PlayerModel<AbstractClientPlayerEntity>> {
   ...
   private void setModelVisibilities(AbstractClientPlayerEntity p_177137_1_) {
      PlayerModel<AbstractClientPlayerEntity> playermodel = (PlayerModel)this.getEntityModel();
      if (p_177137_1_.isSpectator()) {
         ...
         playermodel.bipedHeadwear.showModel = p_177137_1_.isWearing(PlayerModelPart.HAT);
         playermodel.bipedBodyWear.showModel = p_177137_1_.isWearing(PlayerModelPart.JACKET);
         playermodel.bipedLeftLegwear.showModel = p_177137_1_.isWearing(PlayerModelPart.LEFT_PANTS_LEG);
         playermodel.bipedRightLegwear.showModel = p_177137_1_.isWearing(PlayerModelPart.RIGHT_PANTS_LEG);
         playermodel.bipedLeftArmwear.showModel = p_177137_1_.isWearing(PlayerModelPart.LEFT_SLEEVE);
         playermodel.bipedRightArmwear.showModel = p_177137_1_.isWearing(PlayerModelPart.RIGHT_SLEEVE);
         playermodel.field_228270_o_ = p_177137_1_.isCrouching();
         ...
         if (p_177137_1_.getPrimaryHand() == HandSide.RIGHT) {
   ...
   public ResourceLocation getEntityTexture(AbstractClientPlayerEntity p_110775_1_) {
   ...
   protected void func_225629_a_(AbstractClientPlayerEntity p_225629_1_, String p_225629_2_, MatrixStack p_225629_3_, IRenderTypeBuffer p_225629_4_, int p_225629_5_) {
      ...
      if (d0 < 100.0D) {
         ...
         if (scoreobjective != null) {
            ...
            p_225629_3_.func_227861_a_(0.0D, 0.25874999165534973D, 0.0D);
         }
      }
   ...
   public void func_229144_a_(MatrixStack p_229144_1_, IRenderTypeBuffer p_229144_2_, int p_229144_3_, AbstractClientPlayerEntity p_229144_4_) {
      this.func_229145_a_(p_229144_1_, p_229144_2_, p_229144_3_, p_229144_4_, ((PlayerModel)this.entityModel).bipedRightArm, ((PlayerModel)this.entityModel).bipedRightArmwear);
   }
   ...
   public void func_229146_b_(MatrixStack p_229146_1_, IRenderTypeBuffer p_229146_2_, int p_229146_3_, AbstractClientPlayerEntity p_229146_4_) {
      this.func_229145_a_(p_229146_1_, p_229146_2_, p_229146_3_, p_229146_4_, ((PlayerModel)this.entityModel).bipedLeftArm, ((PlayerModel)this.entityModel).bipedLeftArmwear);
   }
   ...
   private void func_229145_a_(MatrixStack p_229145_1_, IRenderTypeBuffer p_229145_2_, int p_229145_3_, AbstractClientPlayerEntity p_229145_4_, ModelRenderer p_229145_5_, ModelRenderer p_229145_6_) {
      ...
      playermodel.func_225597_a_((LivingEntity)p_229145_4_, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F);
   ...
   protected void func_225621_a_(AbstractClientPlayerEntity p_225621_1_, MatrixStack p_225621_2_, float p_225621_3_, float p_225621_4_, float p_225621_5_) {
      ...
      if (p_225621_1_.isElytraFlying()) {
         ...
         f3 = (float)p_225621_1_.getTicksElytraFlying() + p_225621_5_;
         ...
         super.func_225621_a_(p_225621_1_, p_225621_2_, p_225621_3_, p_225621_4_, p_225621_5_);
         f3 = p_225621_1_.isInWater() ? -90.0F - p_225621_1_.rotationPitch : -90.0F;
         ...
         if (p_225621_1_.func_213314_bj()) {
            p_225621_2_.func_227861_a_(0.0D, -1.0D, 0.30000001192092896D);
         }
      } else {
         super.func_225621_a_(p_225621_1_, p_225621_2_, p_225621_3_, p_225621_4_, p_225621_5_);
      }
