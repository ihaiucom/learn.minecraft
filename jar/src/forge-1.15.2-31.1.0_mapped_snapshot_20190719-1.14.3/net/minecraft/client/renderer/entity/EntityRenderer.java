...
public abstract class EntityRenderer<T extends Entity> {
   ...
   public void func_225623_a_(T p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      RenderNameplateEvent renderNameplateEvent = new RenderNameplateEvent(p_225623_1_, p_225623_1_.getDisplayName().getFormattedText(), p_225623_4_, p_225623_5_);
      MinecraftForge.EVENT_BUS.post(renderNameplateEvent);
      if (renderNameplateEvent.getResult() != Result.DENY && (renderNameplateEvent.getResult() == Result.ALLOW || this.canRenderName(p_225623_1_))) {
