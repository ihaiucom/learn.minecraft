...
public class TropicalFishBModel<T extends Entity> extends AbstractTropicalFishModel<T> {
   ...
   public TropicalFishBModel(float p_i48891_1_) {
      ...
      this.body.func_228301_a_(-1.0F, -3.0F, -3.0F, 2.0F, 6.0F, 6.0F, p_i48891_1_);
      this.body.setRotationPoint(0.0F, 19.0F, 0.0F);
      this.tail = new ModelRenderer(this, 21, 16);
      this.tail.func_228301_a_(0.0F, -3.0F, 0.0F, 0.0F, 6.0F, 5.0F, p_i48891_1_);
      this.tail.setRotationPoint(0.0F, 19.0F, 3.0F);
      this.finRight = new ModelRenderer(this, 2, 16);
      this.finRight.func_228301_a_(-2.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, p_i48891_1_);
      ...
      this.finLeft.func_228301_a_(0.0F, 0.0F, 0.0F, 2.0F, 2.0F, 0.0F, p_i48891_1_);
      ...
      this.finTop.func_228301_a_(0.0F, -4.0F, 0.0F, 0.0F, 4.0F, 6.0F, p_i48891_1_);
      this.finTop.setRotationPoint(0.0F, 16.0F, -3.0F);
      this.finBottom = new ModelRenderer(this, 20, 21);
      this.finBottom.func_228301_a_(0.0F, 0.0F, 0.0F, 0.0F, 4.0F, 6.0F, p_i48891_1_);
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      this.tail.rotateAngleY = -lvt_7_1_ * 0.45F * MathHelper.sin(0.6F * p_225597_4_);
   }
}
