...
public class PhantomRenderer extends MobRenderer<PhantomEntity, PhantomModel<PhantomEntity>> {
   ...
   public ResourceLocation getEntityTexture(PhantomEntity p_110775_1_) {
      return PHANTOM_LOCATION;
   }

   protected void func_225620_a_(PhantomEntity p_225620_1_, MatrixStack p_225620_2_, float p_225620_3_) {
      int lvt_4_1_ = p_225620_1_.getPhantomSize();
      float lvt_5_1_ = 1.0F + 0.15F * (float)lvt_4_1_;
      p_225620_2_.func_227862_a_(lvt_5_1_, lvt_5_1_, lvt_5_1_);
