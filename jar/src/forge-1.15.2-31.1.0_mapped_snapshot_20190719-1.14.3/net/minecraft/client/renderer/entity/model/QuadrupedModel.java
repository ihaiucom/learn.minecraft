...
public class QuadrupedModel<T extends Entity> extends AgeableModel<T> {
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      this.headModel.rotateAngleX = p_225597_6_ * 0.017453292F;
      this.headModel.rotateAngleY = p_225597_5_ * 0.017453292F;
      this.field_78148_b.rotateAngleX = 1.5707964F;
      this.field_78149_c.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F) * 1.4F * p_225597_3_;
      this.field_78146_d.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F + 3.1415927F) * 1.4F * p_225597_3_;
      this.field_78147_e.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F + 3.1415927F) * 1.4F * p_225597_3_;
