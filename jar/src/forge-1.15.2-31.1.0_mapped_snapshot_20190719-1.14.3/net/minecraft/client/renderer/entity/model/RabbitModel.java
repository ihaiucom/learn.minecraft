...
public class RabbitModel<T extends RabbitEntity> extends EntityModel<T> {
   ...
   public void func_225598_a_(MatrixStack p_225598_1_, IVertexBuilder p_225598_2_, int p_225598_3_, int p_225598_4_, float p_225598_5_, float p_225598_6_, float p_225598_7_, float p_225598_8_) {
      if (this.isChild) {
         ...
         ImmutableList.of(this.rabbitLeftFoot, this.rabbitRightFoot, this.rabbitLeftThigh, this.rabbitRightThigh, this.rabbitBody, this.rabbitLeftArm, this.rabbitRightArm, this.rabbitHead, this.rabbitRightEar, this.rabbitLeftEar, this.rabbitTail, this.rabbitNose, new ModelRenderer[0]).forEach((p_228290_8_) -> {
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      this.rabbitNose.rotateAngleX = p_225597_6_ * 0.017453292F;
      this.rabbitHead.rotateAngleX = p_225597_6_ * 0.017453292F;
      this.rabbitRightEar.rotateAngleX = p_225597_6_ * 0.017453292F;
      this.rabbitLeftEar.rotateAngleX = p_225597_6_ * 0.017453292F;
      this.rabbitNose.rotateAngleY = p_225597_5_ * 0.017453292F;
      this.rabbitHead.rotateAngleY = p_225597_5_ * 0.017453292F;
      this.rabbitRightEar.rotateAngleY = this.rabbitNose.rotateAngleY - 0.2617994F;
      this.rabbitLeftEar.rotateAngleY = this.rabbitNose.rotateAngleY + 0.2617994F;
      this.jumpRotation = MathHelper.sin(p_225597_1_.getJumpCompletion(lvt_7_1_) * 3.1415927F);
   ...
   public void setLivingAnimations(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      ...
      this.jumpRotation = MathHelper.sin(p_212843_1_.getJumpCompletion(p_212843_4_) * 3.1415927F);
   }
}
