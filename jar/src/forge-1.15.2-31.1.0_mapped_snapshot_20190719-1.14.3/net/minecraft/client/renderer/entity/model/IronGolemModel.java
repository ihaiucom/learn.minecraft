...
public class IronGolemModel<T extends IronGolemEntity> extends SegmentedModel<T> {
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      this.field_78178_a.rotateAngleY = p_225597_5_ * 0.017453292F;
      this.field_78178_a.rotateAngleX = p_225597_6_ * 0.017453292F;
   ...
   public void setLivingAnimations(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      int lvt_5_1_ = p_212843_1_.getAttackTimer();
      if (lvt_5_1_ > 0) {
         this.field_78177_c.rotateAngleX = -2.0F + 1.5F * this.triangleWave((float)lvt_5_1_ - p_212843_4_, 10.0F);
         this.field_78174_d.rotateAngleX = -2.0F + 1.5F * this.triangleWave((float)lvt_5_1_ - p_212843_4_, 10.0F);
      } else {
         int lvt_6_1_ = p_212843_1_.getHoldRoseTick();
         if (lvt_6_1_ > 0) {
            this.field_78177_c.rotateAngleX = -0.8F + 0.025F * this.triangleWave((float)lvt_6_1_, 70.0F);
