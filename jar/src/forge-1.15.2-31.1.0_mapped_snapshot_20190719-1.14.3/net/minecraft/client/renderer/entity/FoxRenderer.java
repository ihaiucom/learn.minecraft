...
public class FoxRenderer extends MobRenderer<FoxEntity, FoxModel<FoxEntity>> {
   ...
   protected void func_225621_a_(FoxEntity p_225621_1_, MatrixStack p_225621_2_, float p_225621_3_, float p_225621_4_, float p_225621_5_) {
      ...
      if (p_225621_1_.func_213480_dY() || p_225621_1_.func_213472_dX()) {
         float lvt_6_1_ = -MathHelper.lerp(p_225621_5_, p_225621_1_.prevRotationPitch, p_225621_1_.rotationPitch);
         p_225621_2_.func_227863_a_(Vector3f.field_229179_b_.func_229187_a_(lvt_6_1_));
      }

   }

   public ResourceLocation getEntityTexture(FoxEntity p_110775_1_) {
      if (p_110775_1_.getVariantType() == FoxEntity.Type.RED) {
         return p_110775_1_.isSleeping() ? field_217768_j : field_217767_a;
      } else {
         return p_110775_1_.isSleeping() ? field_217770_l : field_217769_k;
      }
   }
}
