...
public class WitchModel<T extends Entity> extends VillagerModel<T> {
   ...
   public WitchModel(float p_i46361_1_) {
      ...
      this.villagerHead.setTextureOffset(0, 0).func_228301_a_(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, p_i46361_1_);
      ...
      lvt_2_1_.setTextureOffset(0, 76).func_228300_a_(0.0F, 0.0F, 0.0F, 7.0F, 4.0F, 7.0F);
      lvt_2_1_.rotateAngleX = -0.05235988F;
      lvt_2_1_.rotateAngleZ = 0.02617994F;
      this.field_217151_b.addChild(lvt_2_1_);
      ModelRenderer lvt_3_1_ = (new ModelRenderer(this)).setTextureSize(64, 128);
      lvt_3_1_.setRotationPoint(1.75F, -4.0F, 2.0F);
      lvt_3_1_.setTextureOffset(0, 87).func_228300_a_(0.0F, 0.0F, 0.0F, 4.0F, 4.0F, 4.0F);
      ...
      lvt_4_1_.setTextureOffset(0, 95).func_228301_a_(0.0F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, 0.25F);
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      float lvt_7_1_ = 0.01F * (float)(p_225597_1_.getEntityId() % 10);
      this.villagerNose.rotateAngleX = MathHelper.sin((float)p_225597_1_.ticksExisted * lvt_7_1_) * 4.5F * 0.017453292F;
      this.villagerNose.rotateAngleY = 0.0F;
      this.villagerNose.rotateAngleZ = MathHelper.cos((float)p_225597_1_.ticksExisted * lvt_7_1_) * 2.5F * 0.017453292F;
      if (this.holdingItem) {
