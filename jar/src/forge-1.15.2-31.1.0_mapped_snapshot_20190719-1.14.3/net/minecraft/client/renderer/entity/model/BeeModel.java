...
public class BeeModel<T extends BeeEntity> extends AgeableModel<T> {
   ...
   public void setLivingAnimations(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      ...
      this.field_228241_n_ = p_212843_1_.func_226455_v_(p_212843_4_);
      this.field_228238_k_.showModel = !p_212843_1_.func_226412_eE_();
   }
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      boolean lvt_7_1_ = p_225597_1_.onGround && p_225597_1_.getMotion().lengthSquared() < 1.0E-7D;
      float lvt_8_2_;
      if (lvt_7_1_) {
         this.field_228233_f_.rotateAngleY = -0.2618F;
         this.field_228233_f_.rotateAngleZ = 0.0F;
         ...
         this.field_228233_f_.rotateAngleZ = MathHelper.cos(lvt_8_2_) * 3.1415927F * 0.15F;
         ...
         this.field_228235_h_.rotateAngleX = 0.7853982F;
         this.field_228236_i_.rotateAngleX = 0.7853982F;
         this.field_228237_j_.rotateAngleX = 0.7853982F;
         this.field_228231_a_.rotateAngleX = 0.0F;
      ...
      if (!p_225597_1_.func_226427_ez_()) {
         ...
         if (!lvt_7_1_) {
            ...
            this.field_228231_a_.rotateAngleX = 0.1F + lvt_8_2_ * 3.1415927F * 0.025F;
            this.field_228239_l_.rotateAngleX = lvt_8_2_ * 3.1415927F * 0.03F;
            this.field_228240_m_.rotateAngleX = lvt_8_2_ * 3.1415927F * 0.03F;
            this.field_228235_h_.rotateAngleX = -lvt_8_2_ * 3.1415927F * 0.1F + 0.3926991F;
            this.field_228237_j_.rotateAngleX = -lvt_8_2_ * 3.1415927F * 0.05F + 0.7853982F;
