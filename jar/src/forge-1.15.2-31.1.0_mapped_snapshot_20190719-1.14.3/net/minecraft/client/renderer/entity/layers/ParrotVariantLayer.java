...
public class ParrotVariantLayer<T extends PlayerEntity> extends LayerRenderer<T, PlayerModel<T>> {
   ...
   private void func_229136_a_(MatrixStack p_229136_1_, IRenderTypeBuffer p_229136_2_, int p_229136_3_, T p_229136_4_, float p_229136_5_, float p_229136_6_, float p_229136_7_, float p_229136_8_, boolean p_229136_9_) {
      CompoundNBT lvt_10_1_ = p_229136_9_ ? p_229136_4_.getLeftShoulderEntity() : p_229136_4_.getRightShoulderEntity();
      EntityType.byKey(lvt_10_1_.getString("id")).filter((p_215344_0_) -> {
         return p_215344_0_ == EntityType.PARROT;
      }).ifPresent((p_229137_11_) -> {
         p_229136_1_.func_227860_a_();
         p_229136_1_.func_227861_a_(p_229136_9_ ? 0.4000000059604645D : -0.4000000059604645D, p_229136_4_.isCrouching() ? -1.2999999523162842D : -1.5D, 0.0D);
         IVertexBuilder lvt_12_1_ = p_229136_2_.getBuffer(this.field_215346_a.func_228282_a_(ParrotRenderer.PARROT_TEXTURES[lvt_10_1_.getInt("Variant")]));
         this.field_215346_a.func_228284_a_(p_229136_1_, lvt_12_1_, p_229136_3_, OverlayTexture.field_229196_a_, p_229136_5_, p_229136_6_, p_229136_7_, p_229136_8_, p_229136_4_.ticksExisted);
