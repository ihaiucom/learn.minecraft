...
public class PufferFishMediumModel<T extends Entity> extends SegmentedModel<T> {
   ...
   public PufferFishMediumModel() {
      ...
      this.field_203733_d.rotateAngleX = 0.7853982F;
      ...
      this.field_203734_e.rotateAngleX = -0.7853982F;
      ...
      this.field_203735_f.rotateAngleY = -0.7853982F;
      ...
      this.field_203736_g.rotateAngleY = 0.7853982F;
      ...
      this.field_203737_h.rotateAngleY = -0.7853982F;
      ...
      this.field_203738_i.rotateAngleY = 0.7853982F;
      ...
      this.field_203739_j.rotateAngleX = 0.7853982F;
      ...
      this.field_203740_k.rotateAngleX = -0.7853982F;
   }
