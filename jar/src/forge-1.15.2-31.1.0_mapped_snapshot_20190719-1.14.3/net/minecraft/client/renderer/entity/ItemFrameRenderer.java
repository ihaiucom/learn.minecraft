...
public class ItemFrameRenderer extends EntityRenderer<ItemFrameEntity> {
   ...
   public void func_225623_a_(ItemFrameEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      if (!itemstack.isEmpty()) {
         ...
         if (!MinecraftForge.EVENT_BUS.post(new RenderItemInFrameEvent(p_225623_1_, this, p_225623_4_, p_225623_5_, p_225623_6_))) {
            if (mapdata != null) {
   ...
   public ResourceLocation getEntityTexture(ItemFrameEntity p_110775_1_) {
      return AtlasTexture.LOCATION_BLOCKS_TEXTURE;
   }

   protected boolean canRenderName(ItemFrameEntity p_177070_1_) {
