...
public class LlamaModel<T extends AbstractChestedHorseEntity> extends EntityModel<T> {
   ...
   public LlamaModel(float p_i47226_1_) {
      ...
      ModelRenderer var10000 = this.field_228275_f_;
      var10000.rotationPointZ += 0.0F;
      var10000 = this.field_228276_g_;
      var10000.rotationPointZ += 0.0F;
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      this.field_228273_a_.rotateAngleX = p_225597_6_ * 0.017453292F;
      this.field_228273_a_.rotateAngleY = p_225597_5_ * 0.017453292F;
      this.field_228274_b_.rotateAngleX = 1.5707964F;
      this.field_228275_f_.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F) * 1.4F * p_225597_3_;
      this.field_228276_g_.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F + 3.1415927F) * 1.4F * p_225597_3_;
      this.field_228277_h_.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F + 3.1415927F) * 1.4F * p_225597_3_;
      this.field_228278_i_.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F) * 1.4F * p_225597_3_;
      boolean lvt_7_1_ = !p_225597_1_.isChild() && p_225597_1_.hasChest();
      this.chest1.showModel = lvt_7_1_;
      this.chest2.showModel = lvt_7_1_;
   }
   ...
   public void func_225598_a_(MatrixStack p_225598_1_, IVertexBuilder p_225598_2_, int p_225598_3_, int p_225598_4_, float p_225598_5_, float p_225598_6_, float p_225598_7_, float p_225598_8_) {
      if (this.isChild) {
         ...
         float lvt_10_1_ = 0.7F;
         p_225598_1_.func_227862_a_(0.71428573F, 0.64935064F, 0.7936508F);
         p_225598_1_.func_227861_a_(0.0D, 1.3125D, 0.2199999988079071D);
