...
public class ArrowLayer<T extends LivingEntity, M extends PlayerModel<T>> extends StuckInBodyLayer<T, M> {
   ...
   public ArrowLayer(LivingRenderer<T, M> p_i46124_1_) {
      super(p_i46124_1_);
      this.field_215336_a = p_i46124_1_.getRenderManager();
   }
   ...
   protected void func_225632_a_(MatrixStack p_225632_1_, IRenderTypeBuffer p_225632_2_, int p_225632_3_, Entity p_225632_4_, float p_225632_5_, float p_225632_6_, float p_225632_7_, float p_225632_8_) {
      ...
      this.field_229130_b_ = new ArrowEntity(p_225632_4_.world, p_225632_4_.func_226277_ct_(), p_225632_4_.func_226278_cu_(), p_225632_4_.func_226281_cx_());
      this.field_229130_b_.rotationYaw = (float)(Math.atan2((double)p_225632_5_, (double)p_225632_7_) * 57.2957763671875D);
      this.field_229130_b_.rotationPitch = (float)(Math.atan2((double)p_225632_6_, (double)lvt_9_1_) * 57.2957763671875D);
