...
public class TurtleModel<T extends TurtleEntity> extends QuadrupedModel<T> {
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      this.field_78146_d.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F * 0.6F + 3.1415927F) * 0.5F * p_225597_3_;
      this.field_78147_e.rotateAngleZ = MathHelper.cos(p_225597_2_ * 0.6662F * 0.6F + 3.1415927F) * 0.5F * p_225597_3_;
      ...
      this.field_203078_i.rotateAngleX = 1.5707964F;
      if (!p_225597_1_.isInWater() && p_225597_1_.onGround) {
         float lvt_7_1_ = p_225597_1_.isDigging() ? 4.0F : 1.0F;
         float lvt_8_1_ = p_225597_1_.isDigging() ? 2.0F : 1.0F;
         float lvt_9_1_ = 5.0F;
         this.field_78147_e.rotateAngleY = MathHelper.cos(lvt_7_1_ * p_225597_2_ * 5.0F + 3.1415927F) * 8.0F * p_225597_3_ * lvt_8_1_;
         this.field_78147_e.rotateAngleZ = 0.0F;
         this.field_78144_f.rotateAngleY = MathHelper.cos(lvt_7_1_ * p_225597_2_ * 5.0F) * 8.0F * p_225597_3_ * lvt_8_1_;
         this.field_78144_f.rotateAngleZ = 0.0F;
         this.field_78149_c.rotateAngleY = MathHelper.cos(p_225597_2_ * 5.0F + 3.1415927F) * 3.0F * p_225597_3_;
   ...
   public void func_225598_a_(MatrixStack p_225598_1_, IVertexBuilder p_225598_2_, int p_225598_3_, int p_225598_4_, float p_225598_5_, float p_225598_6_, float p_225598_7_, float p_225598_8_) {
      boolean lvt_9_1_ = this.field_203078_i.showModel;
      if (lvt_9_1_) {
         p_225598_1_.func_227860_a_();
         p_225598_1_.func_227861_a_(0.0D, -0.07999999821186066D, 0.0D);
      }
