...
public class SpinAttackEffectLayer<T extends LivingEntity> extends LayerRenderer<T, PlayerModel<T>> {
   ...
   public void func_225628_a_(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, T p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
      if (p_225628_4_.isSpinAttacking()) {
         IVertexBuilder lvt_11_1_ = p_225628_2_.getBuffer(RenderType.func_228640_c_(field_204836_a));

         for(int lvt_12_1_ = 0; lvt_12_1_ < 3; ++lvt_12_1_) {
            p_225628_1_.func_227860_a_();
            float lvt_13_1_ = p_225628_8_ * (float)(-(45 + lvt_12_1_ * 5));
            p_225628_1_.func_227863_a_(Vector3f.field_229181_d_.func_229187_a_(lvt_13_1_));
            float lvt_14_1_ = 0.75F * (float)lvt_12_1_;
            p_225628_1_.func_227862_a_(lvt_14_1_, lvt_14_1_, lvt_14_1_);
            p_225628_1_.func_227861_a_(0.0D, (double)(-0.2F + 0.6F * (float)lvt_12_1_), 0.0D);
            this.field_229143_b_.func_228308_a_(p_225628_1_, lvt_11_1_, p_225628_3_, OverlayTexture.field_229196_a_);
