...
public class DolphinCarriedItemLayer extends LayerRenderer<DolphinEntity, DolphinModel<DolphinEntity>> {
   ...
   public void func_225628_a_(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, DolphinEntity p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
      ...
      float lvt_14_1_ = MathHelper.abs(p_225628_4_.rotationPitch) / 60.0F;
      if (p_225628_4_.rotationPitch < 0.0F) {
         p_225628_1_.func_227861_a_(0.0D, (double)(1.0F - lvt_14_1_ * 0.5F), (double)(-1.0F + lvt_14_1_ * 0.5F));
      } else {
         p_225628_1_.func_227861_a_(0.0D, (double)(1.0F + lvt_14_1_ * 0.8F), (double)(-1.0F + lvt_14_1_ * 0.2F));
      }

      ItemStack lvt_15_1_ = lvt_11_1_ ? p_225628_4_.getHeldItemMainhand() : p_225628_4_.getHeldItemOffhand();
      Minecraft.getInstance().getFirstPersonRenderer().func_228397_a_(p_225628_4_, lvt_15_1_, ItemCameraTransforms.TransformType.GROUND, false, p_225628_1_, p_225628_2_, p_225628_3_);
