...
public class VillagerModel<T extends Entity> extends SegmentedModel<T> implements IHasHead, IHeadToggle {
   ...
   public VillagerModel(float p_i51059_1_, int p_i51059_2_, int p_i51059_3_) {
      ...
      this.field_217152_f.rotateAngleX = -1.5707964F;
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      if (p_225597_1_ instanceof AbstractVillagerEntity) {
         lvt_7_1_ = ((AbstractVillagerEntity)p_225597_1_).getShakeHeadTicks() > 0;
      }

      this.villagerHead.rotateAngleY = p_225597_5_ * 0.017453292F;
      this.villagerHead.rotateAngleX = p_225597_6_ * 0.017453292F;
      if (lvt_7_1_) {
      ...
      this.leftVillagerLeg.rotateAngleX = MathHelper.cos(p_225597_2_ * 0.6662F + 3.1415927F) * 1.4F * p_225597_3_ * 0.5F;
