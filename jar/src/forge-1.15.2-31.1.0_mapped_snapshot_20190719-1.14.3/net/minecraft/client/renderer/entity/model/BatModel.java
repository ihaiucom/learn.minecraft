...
public class BatModel extends SegmentedModel<BatEntity> {
   ...
   public BatModel() {
      ...
      lvt_1_1_.func_228300_a_(-4.0F, -6.0F, -2.0F, 3.0F, 4.0F, 1.0F);
      this.batHead.addChild(lvt_1_1_);
      ModelRenderer lvt_2_1_ = new ModelRenderer(this, 24, 0);
      lvt_2_1_.mirror = true;
      lvt_2_1_.func_228300_a_(1.0F, -6.0F, -2.0F, 3.0F, 4.0F, 1.0F);
   ...
   public void func_225597_a_(BatEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      if (p_225597_1_.getIsBatHanging()) {
         this.batHead.rotateAngleX = p_225597_6_ * 0.017453292F;
         this.batHead.rotateAngleY = 3.1415927F - p_225597_5_ * 0.017453292F;
         ...
         this.batHead.rotateAngleX = p_225597_6_ * 0.017453292F;
         this.batHead.rotateAngleY = p_225597_5_ * 0.017453292F;
         this.batHead.rotateAngleZ = 0.0F;
         this.batHead.setRotationPoint(0.0F, 0.0F, 0.0F);
         this.batRightWing.setRotationPoint(0.0F, 0.0F, 0.0F);
         this.batLeftWing.setRotationPoint(0.0F, 0.0F, 0.0F);
         this.batBody.rotateAngleX = 0.7853982F + MathHelper.cos(p_225597_4_ * 0.1F) * 0.15F;
         this.batBody.rotateAngleY = 0.0F;
         this.batRightWing.rotateAngleY = MathHelper.cos(p_225597_4_ * 1.3F) * 3.1415927F * 0.25F;
         this.batLeftWing.rotateAngleY = -this.batRightWing.rotateAngleY;
