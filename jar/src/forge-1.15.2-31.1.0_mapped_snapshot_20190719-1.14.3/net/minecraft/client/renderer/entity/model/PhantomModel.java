...
public class PhantomModel<T extends Entity> extends SegmentedModel<T> {
   ...
   public PhantomModel() {
      ...
      lvt_1_1_.func_228300_a_(-4.0F, -2.0F, -5.0F, 7.0F, 3.0F, 5.0F);
      lvt_1_1_.setRotationPoint(0.0F, 1.0F, -7.0F);
      lvt_1_1_.rotateAngleX = 0.2F;
      this.field_203070_a.addChild(lvt_1_1_);
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      float lvt_7_1_ = ((float)(p_225597_1_.getEntityId() * 3) + p_225597_4_) * 0.13F;
      float lvt_8_1_ = 16.0F;
      this.field_203071_b.rotateAngleZ = MathHelper.cos(lvt_7_1_) * 16.0F * 0.017453292F;
      this.field_203072_c.rotateAngleZ = MathHelper.cos(lvt_7_1_) * 16.0F * 0.017453292F;
      ...
      this.field_204233_g.rotateAngleX = -(5.0F + MathHelper.cos(lvt_7_1_ * 2.0F) * 5.0F) * 0.017453292F;
      this.field_204234_h.rotateAngleX = -(5.0F + MathHelper.cos(lvt_7_1_ * 2.0F) * 5.0F) * 0.017453292F;
   }
}
