...
public class DrownedModel<T extends ZombieEntity> extends ZombieModel<T> {
   ...
   public void setLivingAnimations(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      ...
      ItemStack lvt_5_1_ = p_212843_1_.getHeldItem(Hand.MAIN_HAND);
      if (lvt_5_1_.getItem() == Items.TRIDENT && p_212843_1_.isAggressive()) {
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      if (this.swimAnimation > 0.0F) {
         ...
         var10000.rotateAngleX -= this.swimAnimation * 0.55F * MathHelper.sin(0.1F * p_225597_4_);
