...
public class MooshroomRenderer extends MobRenderer<MooshroomEntity, CowModel<MooshroomEntity>> {
   private static final Map<MooshroomEntity.Type, ResourceLocation> field_217774_a = (Map)Util.make(Maps.newHashMap(), (p_217773_0_) -> {
   ...
   public ResourceLocation getEntityTexture(MooshroomEntity p_110775_1_) {
      return (ResourceLocation)field_217774_a.get(p_110775_1_.getMooshroomType());
   }
}
