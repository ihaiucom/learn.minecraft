...
public class CampfireTileEntityRenderer extends TileEntityRenderer<CampfireTileEntity> {
   ...
   public void func_225616_a_(CampfireTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
      Direction lvt_7_1_ = (Direction)p_225616_1_.getBlockState().get(CampfireBlock.FACING);
      NonNullList<ItemStack> lvt_8_1_ = p_225616_1_.getInventory();

      for(int lvt_9_1_ = 0; lvt_9_1_ < lvt_8_1_.size(); ++lvt_9_1_) {
         ItemStack lvt_10_1_ = (ItemStack)lvt_8_1_.get(lvt_9_1_);
         if (lvt_10_1_ != ItemStack.EMPTY) {
            p_225616_3_.func_227860_a_();
            p_225616_3_.func_227861_a_(0.5D, 0.44921875D, 0.5D);
            Direction lvt_11_1_ = Direction.byHorizontalIndex((lvt_9_1_ + lvt_7_1_.getHorizontalIndex()) % 4);
            float lvt_12_1_ = -lvt_11_1_.getHorizontalAngle();
            p_225616_3_.func_227863_a_(Vector3f.field_229181_d_.func_229187_a_(lvt_12_1_));
            ...
            Minecraft.getInstance().getItemRenderer().func_229110_a_(lvt_10_1_, ItemCameraTransforms.TransformType.FIXED, p_225616_5_, p_225616_6_, p_225616_3_, p_225616_4_);
