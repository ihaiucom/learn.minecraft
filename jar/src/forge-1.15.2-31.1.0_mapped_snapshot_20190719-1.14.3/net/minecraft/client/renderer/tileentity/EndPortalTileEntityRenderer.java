...
public class EndPortalTileEntityRenderer<T extends EndPortalTileEntity> extends TileEntityRenderer<T> {
   ...
   private static final List<RenderType> field_228881_e_ = (List)IntStream.range(0, 16).mapToObj((p_228882_0_) -> {
   ...
   public void func_225616_a_(T p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
      ...
      double lvt_7_1_ = p_225616_1_.getPos().distanceSq(this.field_228858_b_.renderInfo.getProjectedView(), true);
      ...
      this.func_228883_a_(p_225616_1_, lvt_10_1_, 0.15F, lvt_11_1_, p_225616_4_.getBuffer((RenderType)field_228881_e_.get(0)));

      for(int lvt_12_1_ = 1; lvt_12_1_ < lvt_9_1_; ++lvt_12_1_) {
         this.func_228883_a_(p_225616_1_, lvt_10_1_, 2.0F / (float)(18 - lvt_12_1_), lvt_11_1_, p_225616_4_.getBuffer((RenderType)field_228881_e_.get(lvt_12_1_)));
      }
