...
public class PistonTileEntityRenderer extends TileEntityRenderer<PistonTileEntity> {
      ...
      if (world != null) {
         ...
         if (!blockstate.isAir() && p_225616_1_.getProgress(p_225616_2_) < 1.0F) {
            ...
            if (blockstate.getBlock() == Blocks.PISTON_HEAD && p_225616_1_.getProgress(p_225616_2_) <= 4.0F) {
               ...
               blockstate1 = (BlockState)blockstate1.with(PistonHeadBlock.SHORT, p_225616_1_.getProgress(p_225616_2_) >= 0.5F);
   ...
   private void func_228876_a_(BlockPos p_228876_1_, BlockState p_228876_2_, MatrixStack p_228876_3_, IRenderTypeBuffer p_228876_4_, World p_228876_5_, boolean p_228876_6_, int p_228876_7_) {
      RenderType.func_228661_n_().stream().filter((p_lambda$func_228876_a_$0_1_) -> {
         return RenderTypeLookup.canRenderInLayer(p_228876_2_, p_lambda$func_228876_a_$0_1_);
      }).forEach((p_lambda$func_228876_a_$1_8_) -> {
         ForgeHooksClient.setRenderLayer(p_lambda$func_228876_a_$1_8_);
         IVertexBuilder ivertexbuilder = p_228876_4_.getBuffer(p_lambda$func_228876_a_$1_8_);
