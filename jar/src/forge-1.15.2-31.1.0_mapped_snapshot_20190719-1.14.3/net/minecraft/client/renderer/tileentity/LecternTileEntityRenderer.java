...
public class LecternTileEntityRenderer extends TileEntityRenderer<LecternTileEntity> {
   ...
   public void func_225616_a_(LecternTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
      ...
      if ((Boolean)lvt_7_1_.get(LecternBlock.HAS_BOOK)) {
         p_225616_3_.func_227860_a_();
         p_225616_3_.func_227861_a_(0.5D, 1.0625D, 0.5D);
         float lvt_8_1_ = ((Direction)lvt_7_1_.get(LecternBlock.FACING)).rotateY().getHorizontalAngle();
         p_225616_3_.func_227863_a_(Vector3f.field_229181_d_.func_229187_a_(-lvt_8_1_));
         ...
         IVertexBuilder lvt_9_1_ = EnchantmentTableTileEntityRenderer.TEXTURE_BOOK.func_229311_a_(p_225616_4_, RenderType::func_228634_a_);
         this.field_217656_d.func_228249_b_(p_225616_3_, lvt_9_1_, p_225616_5_, p_225616_6_, 1.0F, 1.0F, 1.0F, 1.0F);
