...
public class GlDebugTextUtils {
   ...
   private static final Map<Integer, String> GL_CONSTANT_NAMES;
   ...
   private static void logDebugMessage(int p_209244_0_, int p_209244_1_, int p_209244_2_, int p_209244_3_, int p_209244_4_, long p_209244_5_, long p_209244_7_) {
      LOGGER.info("OpenGL debug message, id={}, source={}, type={}, severity={}, message={}", p_209244_2_, getSource(p_209244_0_), getType(p_209244_1_), getSeverity(p_209244_3_), GLDebugMessageCallback.getMessage(p_209244_4_, p_209244_5_));
   }

   private static void registerGlConstantName(int p_209243_0_, String p_209243_1_) {
      GL_CONSTANT_NAMES.merge(p_209243_0_, p_209243_1_, (p_209249_0_, p_209249_1_) -> {
         return p_209249_0_ + "/" + p_209249_1_;
      });
   }

   public static void setDebugVerbosity(int p_209247_0_, boolean p_209247_1_) {
      RenderSystem.assertThread(RenderSystem::isInInitPhase);
      if (p_209247_0_ > 0) {
         GLCapabilities lvt_2_1_ = GL.getCapabilities();
         int lvt_3_2_;
         boolean lvt_4_2_;
         if (lvt_2_1_.GL_KHR_debug) {
            GL11.glEnable(37600);
            if (p_209247_1_) {
               GL11.glEnable(33346);
            }

            for(lvt_3_2_ = 0; lvt_3_2_ < field_209257_h.size(); ++lvt_3_2_) {
               lvt_4_2_ = lvt_3_2_ < p_209247_0_;
               KHRDebug.glDebugMessageControl(4352, 4352, (Integer)field_209257_h.get(lvt_3_2_), (int[])null, lvt_4_2_);
            }

            KHRDebug.glDebugMessageCallback((GLDebugMessageCallbackI)GLX.make(GLDebugMessageCallback.create(GlDebugTextUtils::logDebugMessage), LWJGLMemoryUntracker::untrack), 0L);
         } else if (lvt_2_1_.GL_ARB_debug_output) {
            if (p_209247_1_) {
               GL11.glEnable(33346);
            }

            for(lvt_3_2_ = 0; lvt_3_2_ < field_209258_i.size(); ++lvt_3_2_) {
               lvt_4_2_ = lvt_3_2_ < p_209247_0_;
               ARBDebugOutput.glDebugMessageControlARB(4352, 4352, (Integer)field_209258_i.get(lvt_3_2_), (int[])null, lvt_4_2_);
            }

            ARBDebugOutput.glDebugMessageCallbackARB((GLDebugMessageARBCallbackI)GLX.make(GLDebugMessageARBCallback.create(GlDebugTextUtils::logDebugMessage), LWJGLMemoryUntracker::untrack), 0L);
         }
   ...
   static {
      ...
      GL_CONSTANT_NAMES = Maps.newHashMap();
