...
public final class Matrix3f {
   ...
   private static Pair<Float, Float> func_226112_a_(float p_226112_0_, float p_226112_1_) {
      ...
      f4 = MathHelper.func_226165_i_(f2 * f2 + f1 * f1);
      f2 *= f4;
      f1 *= f4;
   ...
   private static Quaternion func_226120_c_(Matrix3f p_226120_0_) {
      ...
      if (p_226120_0_.field_226098_b_ * p_226120_0_.field_226098_b_ + p_226120_0_.field_226100_d_ * p_226120_0_.field_226100_d_ > 1.0E-6F) {
         pair2 = func_226113_a_(p_226120_0_.field_226097_a_, 0.5F * (p_226120_0_.field_226098_b_ + p_226120_0_.field_226100_d_), p_226120_0_.field_226101_e_);
         f6 = (Float)pair2.getFirst();
         f8 = (Float)pair2.getSecond();
         quaternion3 = new Quaternion(0.0F, 0.0F, f6, f8);
         f10 = f8 * f8 - f6 * f6;
         f12 = -2.0F * f6 * f8;
         f14 = f8 * f8 + f6 * f6;
         quaternion.multiply(quaternion3);
         matrix3f.func_226119_c_();
         matrix3f.field_226097_a_ = f10;
         matrix3f.field_226101_e_ = f10;
         matrix3f.field_226100_d_ = -f12;
         matrix3f.field_226098_b_ = f12;
         matrix3f.field_226105_i_ = f14;
      ...
      if (p_226120_0_.field_226099_c_ * p_226120_0_.field_226099_c_ + p_226120_0_.field_226103_g_ * p_226120_0_.field_226103_g_ > 1.0E-6F) {
         pair2 = func_226113_a_(p_226120_0_.field_226097_a_, 0.5F * (p_226120_0_.field_226099_c_ + p_226120_0_.field_226103_g_), p_226120_0_.field_226105_i_);
         float f5 = -(Float)pair2.getFirst();
         f8 = (Float)pair2.getSecond();
         quaternion3 = new Quaternion(0.0F, f5, 0.0F, f8);
         f10 = f8 * f8 - f5 * f5;
         f12 = -2.0F * f5 * f8;
         f14 = f8 * f8 + f5 * f5;
         quaternion.multiply(quaternion3);
         ...
         matrix3f.field_226103_g_ = f12;
         matrix3f.field_226099_c_ = -f12;
         matrix3f.field_226101_e_ = f14;
         p_226120_0_.func_226118_b_(matrix3f);
         matrix3f.func_226110_a_();
         matrix3f.func_226118_b_(p_226120_0_);
         p_226120_0_.func_226114_a_(matrix3f);
      ...
      if (p_226120_0_.field_226102_f_ * p_226120_0_.field_226102_f_ + p_226120_0_.field_226104_h_ * p_226120_0_.field_226104_h_ > 1.0E-6F) {
         pair2 = func_226113_a_(p_226120_0_.field_226101_e_, 0.5F * (p_226120_0_.field_226102_f_ + p_226120_0_.field_226104_h_), p_226120_0_.field_226105_i_);
         f6 = (Float)pair2.getFirst();
         f8 = (Float)pair2.getSecond();
         quaternion3 = new Quaternion(f6, 0.0F, 0.0F, f8);
         f10 = f8 * f8 - f6 * f6;
         f12 = -2.0F * f6 * f8;
         f14 = f8 * f8 + f6 * f6;
         quaternion.multiply(quaternion3);
   ...
   public void multiplyBackward(Matrix3f p_multiplyBackward_1_) {
      Matrix3f copy = p_multiplyBackward_1_.func_226121_d_();
