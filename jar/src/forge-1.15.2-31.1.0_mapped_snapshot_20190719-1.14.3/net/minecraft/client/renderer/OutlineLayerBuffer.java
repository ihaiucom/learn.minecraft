...
public class OutlineLayerBuffer implements IRenderTypeBuffer {
   ...
   public IVertexBuilder getBuffer(RenderType p_getBuffer_1_) {
      IVertexBuilder lvt_2_2_;
      if (p_getBuffer_1_.func_230041_s_()) {
         lvt_2_2_ = this.field_228466_b_.getBuffer(p_getBuffer_1_);
         return new OutlineLayerBuffer.ColoredOutline(lvt_2_2_, this.field_228467_c_, this.field_228468_d_, this.field_228469_e_, this.field_228470_f_);
      } else {
         lvt_2_2_ = this.field_228465_a_.getBuffer(p_getBuffer_1_);
         Optional<RenderType> lvt_3_1_ = p_getBuffer_1_.func_225612_r_();
         if (lvt_3_1_.isPresent()) {
            IVertexBuilder lvt_4_1_ = this.field_228466_b_.getBuffer((RenderType)lvt_3_1_.get());
            OutlineLayerBuffer.ColoredOutline lvt_5_1_ = new OutlineLayerBuffer.ColoredOutline(lvt_4_1_, this.field_228467_c_, this.field_228468_d_, this.field_228469_e_, this.field_228470_f_);
            return VertexBuilderUtils.func_227915_a_(lvt_5_1_, lvt_2_2_);
         } else {
            return lvt_2_2_;
         }
      }
   ...
   static class ColoredOutline extends DefaultColorVertexBuilder {
      ...
      // $FF: synthetic method
      ColoredOutline(IVertexBuilder p_i225972_1_, int p_i225972_2_, int p_i225972_3_, int p_i225972_4_, int p_i225972_5_, Object p_i225972_6_) {
         this(p_i225972_1_, p_i225972_2_, p_i225972_3_, p_i225972_4_, p_i225972_5_);
      }
   }
}
