...
public class FaceBakery {
   ...
   private int getFaceShadeColor(Direction p_178413_1_) {
      float f = this.getFaceBrightness(p_178413_1_);
      int i = MathHelper.clamp((int)(f * 255.0F), 0, 255);
      return -16777216 | i << 16 | i << 8 | i;
   }

   private float getFaceBrightness(Direction p_178412_1_) {
      switch(p_178412_1_) {
      case DOWN:
         return 0.5F;
      case UP:
   ...
   private float[] getPositionsDiv16(Vector3f p_199337_1_, Vector3f p_199337_2_) {
      float[] afloat = new float[Direction.values().length];
      afloat[FaceDirection.Constants.WEST_INDEX] = p_199337_1_.getX() / 16.0F;
      afloat[FaceDirection.Constants.DOWN_INDEX] = p_199337_1_.getY() / 16.0F;
      afloat[FaceDirection.Constants.NORTH_INDEX] = p_199337_1_.getZ() / 16.0F;
      afloat[FaceDirection.Constants.EAST_INDEX] = p_199337_2_.getX() / 16.0F;
      afloat[FaceDirection.Constants.UP_INDEX] = p_199337_2_.getY() / 16.0F;
      afloat[FaceDirection.Constants.SOUTH_INDEX] = p_199337_2_.getZ() / 16.0F;
      return afloat;
   }
   ...
   private void func_228826_a_(int[] p_228826_1_, int p_228826_2_, Vector3f p_228826_3_, int p_228826_4_, TextureAtlasSprite p_228826_5_, BlockFaceUV p_228826_6_) {
      ...
      p_228826_1_[i + 4] = Float.floatToRawIntBits(p_228826_5_.getInterpolatedU((double)p_228826_6_.getVertexU(p_228826_2_) * 0.999D + (double)p_228826_6_.getVertexU((p_228826_2_ + 2) % 4) * 0.001D));
      p_228826_1_[i + 4 + 1] = Float.floatToRawIntBits(p_228826_5_.getInterpolatedV((double)p_228826_6_.getVertexV(p_228826_2_) * 0.999D + (double)p_228826_6_.getVertexV((p_228826_2_ + 2) % 4) * 0.001D));
   }

   private void rotatePart(Vector3f p_199336_1_, @Nullable BlockPartRotation p_199336_2_) {
      if (p_199336_2_ != null) {
         Vector3f vector3f;
         Vector3f vector3f1;
         ...
         this.func_228823_a_(p_199336_1_, p_199336_2_.origin.func_229195_e_(), new Matrix4f(quaternion), vector3f1);
      }
   ...
   public static Direction getFacingFromVertexData(int[] p_178410_0_) {
      ...
      for(int var11 = 0; var11 < var10; ++var11) {
         Direction direction1 = var9[var11];
   ...
   private void applyFacing(int[] p_178408_1_, Direction p_178408_2_) {
      ...
      for(i1 = 0; i1 < 4; ++i1) {
         ...
         f2 = afloat[facedirection$vertexinformation.xIndex];
