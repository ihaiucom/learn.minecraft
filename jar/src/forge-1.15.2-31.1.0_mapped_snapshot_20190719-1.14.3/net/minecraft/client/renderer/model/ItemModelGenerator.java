...
public class ItemModelGenerator {
   ...
   public BlockModel makeItemModel(Function<Material, TextureAtlasSprite> p_209579_1_, BlockModel p_209579_2_) {
      ...
      for(int i = 0; i < LAYERS.size(); ++i) {
         ...
         TextureAtlasSprite textureatlassprite = (TextureAtlasSprite)p_209579_1_.apply(material);
         list.addAll(this.getBlockParts(i, s, textureatlassprite));
      }

      map.put("particle", p_209579_2_.isTexturePresent("particle") ? Either.left(p_209579_2_.func_228816_c_("particle")) : (Either)map.get("layer0"));
