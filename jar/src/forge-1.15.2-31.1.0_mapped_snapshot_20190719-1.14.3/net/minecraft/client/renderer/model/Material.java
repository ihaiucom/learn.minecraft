...
public class Material {
   ...
   public TextureAtlasSprite func_229314_c_() {
      return (TextureAtlasSprite)Minecraft.getInstance().func_228015_a_(this.func_229310_a_()).apply(this.func_229313_b_());
   }

   public RenderType func_229312_a_(Function<ResourceLocation, RenderType> p_229312_1_) {
      if (this.field_229309_c_ == null) {
         this.field_229309_c_ = (RenderType)p_229312_1_.apply(this.field_229307_a_);
      }
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         Material lvt_2_1_ = (Material)p_equals_1_;
         return this.field_229307_a_.equals(lvt_2_1_.field_229307_a_) && this.field_229308_b_.equals(lvt_2_1_.field_229308_b_);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.field_229307_a_, this.field_229308_b_});
   }
