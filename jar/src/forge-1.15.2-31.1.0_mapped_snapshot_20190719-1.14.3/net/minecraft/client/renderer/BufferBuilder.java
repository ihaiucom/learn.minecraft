...
public class BufferBuilder extends DefaultColorVertexBuilder implements IVertexConsumer {
   ...
   private void growBuffer(int p_181670_1_) {
      if (this.field_227824_l_ + p_181670_1_ > this.byteBuffer.capacity()) {
         int i = this.byteBuffer.capacity();
         int j = i + func_216566_c(p_181670_1_);
   ...
   public void sortVertexData(float p_181674_1_, float p_181674_2_, float p_181674_3_) {
      ...
      for(int j = 0; j < i; ++j) {
         afloat[j] = getDistanceSq(floatbuffer, p_181674_1_, p_181674_2_, p_181674_3_, this.vertexFormat.getIntegerSize(), this.field_227823_k_ / 4 + j * this.vertexFormat.getSize());
      }
   ...
   public void setVertexState(BufferBuilder.State p_178993_1_) {
      p_178993_1_.field_227841_a_.clear();
      int i = p_178993_1_.field_227841_a_.capacity();
      this.growBuffer(i);
      this.byteBuffer.limit(this.byteBuffer.capacity());
      this.byteBuffer.position(this.field_227823_k_);
      this.byteBuffer.put(p_178993_1_.field_227841_a_);
      this.byteBuffer.clear();
      VertexFormat vertexformat = p_178993_1_.stateVertexFormat;
   ...
   public void begin(int p_181668_1_, VertexFormat p_181668_2_) {
      if (this.isDrawing) {
         ...
         this.func_227828_a_(p_181668_2_);
         this.vertexFormatElement = (VertexFormatElement)p_181668_2_.func_227894_c_().get(0);
   ...
   public void nextVertexFormatIndex() {
      ...
      VertexFormatElement vertexformatelement = (VertexFormatElement)immutablelist.get(this.vertexFormatIndex);
   ...
   public Pair<BufferBuilder.DrawState, ByteBuffer> func_227832_f_() {
      BufferBuilder.DrawState bufferbuilder$drawstate = (BufferBuilder.DrawState)this.field_227821_i_.get(this.field_227822_j_++);
   ...
   public static class State {
      ...
      // $FF: synthetic method
      State(ByteBuffer p_i225908_1_, VertexFormat p_i225908_2_, Object p_i225908_3_) {
         this(p_i225908_1_, p_i225908_2_);
      }
   }
   ...
   public static final class DrawState {
      ...
      // $FF: synthetic method
      DrawState(VertexFormat p_i225906_1_, int p_i225906_2_, int p_i225906_3_, Object p_i225906_4_) {
         this(p_i225906_1_, p_i225906_2_, p_i225906_3_);
      }
   }
}
