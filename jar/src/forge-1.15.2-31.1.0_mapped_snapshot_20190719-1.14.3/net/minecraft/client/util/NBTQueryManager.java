...
public class NBTQueryManager {
   ...
   public void queryEntity(int p_211549_1_, Consumer<CompoundNBT> p_211549_2_) {
      int lvt_3_1_ = this.setHandler(p_211549_2_);
      this.connection.sendPacket(new CQueryEntityNBTPacket(lvt_3_1_, p_211549_1_));
   }

   public void queryTileEntity(BlockPos p_211547_1_, Consumer<CompoundNBT> p_211547_2_) {
      int lvt_3_1_ = this.setHandler(p_211547_2_);
      this.connection.sendPacket(new CQueryTileEntityNBTPacket(lvt_3_1_, p_211547_1_));
   }
}
