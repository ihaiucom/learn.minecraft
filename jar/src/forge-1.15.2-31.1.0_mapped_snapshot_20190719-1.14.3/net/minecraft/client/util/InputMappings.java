...
public class InputMappings {
   ...
   public static InputMappings.Input getInputByName(String p_197955_0_) {
      if (InputMappings.Input.REGISTRY.containsKey(p_197955_0_)) {
         return (InputMappings.Input)InputMappings.Input.REGISTRY.get(p_197955_0_);
      } else {
         InputMappings.Type[] var1 = InputMappings.Type.values();
         int var2 = var1.length;

         for(int var3 = 0; var3 < var2; ++var3) {
            InputMappings.Type lvt_4_1_ = var1[var3];
            if (p_197955_0_.startsWith(lvt_4_1_.name)) {
               String lvt_5_1_ = p_197955_0_.substring(lvt_4_1_.name.length() + 1);
               return lvt_4_1_.getOrMakeInput(Integer.parseInt(lvt_5_1_));
            }
         }
   ...
   static {
      ...
      MethodType lvt_1_1_ = MethodType.methodType(Boolean.TYPE);
      MethodHandle lvt_2_1_ = null;
      int lvt_3_1_ = 0;

      try {
         lvt_2_1_ = lvt_0_1_.findStatic(GLFW.class, "glfwRawMouseMotionSupported", lvt_1_1_);
         MethodHandle lvt_4_1_ = lvt_0_1_.findStaticGetter(GLFW.class, "GLFW_RAW_MOUSE_MOTION", Integer.TYPE);
         lvt_3_1_ = lvt_4_1_.invokeExact();
      } catch (NoSuchFieldException | NoSuchMethodException var5) {
      } catch (Throwable var6) {
         throw new RuntimeException(var6);
      }

      field_224792_b = lvt_2_1_;
      field_224793_c = lvt_3_1_;
   ...
   public static final class Input {
      ...
      public boolean equals(Object p_equals_1_) {
         if (this == p_equals_1_) {
            ...
            InputMappings.Input lvt_2_1_ = (InputMappings.Input)p_equals_1_;
            return this.keyCode == lvt_2_1_.keyCode && this.type == lvt_2_1_.type;
         } else {
            return false;
         }
      }
      ...
      // $FF: synthetic method
      Input(String p_i48058_1_, InputMappings.Type p_i48058_2_, int p_i48058_3_, Object p_i48058_4_) {
         this(p_i48058_1_, p_i48058_2_, p_i48058_3_);
      }
   }
   ...
   public static enum Type {
      ...
      private static void registerInput(InputMappings.Type p_197943_0_, String p_197943_1_, int p_197943_2_) {
         InputMappings.Input lvt_3_1_ = new InputMappings.Input(p_197943_1_, p_197943_0_, p_197943_2_);
         p_197943_0_.inputs.put(p_197943_2_, lvt_3_1_);
      }
      ...
      public InputMappings.Input getOrMakeInput(int p_197944_1_) {
         if (this.inputs.containsKey(p_197944_1_)) {
            return (InputMappings.Input)this.inputs.get(p_197944_1_);
         } else {
            String lvt_2_3_;
            if (this == MOUSE) {
               if (p_197944_1_ <= 2) {
                  lvt_2_3_ = "." + field_197950_d[p_197944_1_];
               } else {
                  lvt_2_3_ = "." + (p_197944_1_ + 1);
               }
            } else {
               lvt_2_3_ = "." + p_197944_1_;
            }

            InputMappings.Input lvt_3_1_ = new InputMappings.Input(this.name + lvt_2_3_, this, p_197944_1_);
            this.inputs.put(p_197944_1_, lvt_3_1_);
            return lvt_3_1_;
         }
      }
