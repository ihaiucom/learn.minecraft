...
public class PosAndRotation {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         PosAndRotation lvt_2_1_ = (PosAndRotation)p_equals_1_;
         return Float.compare(lvt_2_1_.field_224787_b, this.field_224787_b) == 0 && Float.compare(lvt_2_1_.field_224788_c, this.field_224788_c) == 0 && Objects.equals(this.field_224786_a, lvt_2_1_.field_224786_a);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.field_224786_a, this.field_224787_b, this.field_224788_c});
   }
