...
public class WorldSelectionScreen extends Screen {
   ...
   public WorldSelectionScreen(Screen p_i46592_1_) {
      super(new TranslationTextComponent("selectWorld.title", new Object[0]));
   ...
   protected void init() {
      ...
      this.selectButton = (Button)this.addButton(new Button(this.width / 2 - 154, this.height - 52, 150, 20, I18n.format("selectWorld.select"), (p_214325_1_) -> {
      ...
      this.renameButton = (Button)this.addButton(new Button(this.width / 2 - 154, this.height - 28, 72, 20, I18n.format("selectWorld.edit"), (p_214323_1_) -> {
         this.selectionList.func_214376_a().ifPresent(WorldSelectionList.Entry::func_214444_c);
      }));
      this.deleteButton = (Button)this.addButton(new Button(this.width / 2 - 76, this.height - 28, 72, 20, I18n.format("selectWorld.delete"), (p_214330_1_) -> {
         this.selectionList.func_214376_a().ifPresent(WorldSelectionList.Entry::func_214442_b);
      }));
      this.copyButton = (Button)this.addButton(new Button(this.width / 2 + 4, this.height - 28, 72, 20, I18n.format("selectWorld.recreate"), (p_214328_1_) -> {
