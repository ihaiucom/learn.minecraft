...
public class ServerSelectionList extends ExtendedList<ServerSelectionList.Entry> {
   ...
   private static final ThreadPoolExecutor field_214358_b;
   ...
   public void setSelected(ServerSelectionList.Entry p_setSelected_1_) {
      ...
      if (this.getSelected() instanceof ServerSelectionList.NormalEntry) {
         NarratorChatListener.INSTANCE.func_216864_a((new TranslationTextComponent("narrator.select", new Object[]{((ServerSelectionList.NormalEntry)this.getSelected()).server.serverName})).getString());
      }

   }

   public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
      ServerSelectionList.Entry serverselectionlist$entry = (ServerSelectionList.Entry)this.getSelected();
   ...
   protected void moveSelection(int p_moveSelection_1_) {
      ...
      ServerSelectionList.Entry serverselectionlist$entry = (ServerSelectionList.Entry)this.children().get(j);
   ...
   static {
      field_214358_b = new ScheduledThreadPoolExecutor(5, (new ThreadFactoryBuilder()).setNameFormat("Server Pinger #%d").setDaemon(true).setUncaughtExceptionHandler(new DefaultUncaughtExceptionHandler(LOGGER)).build());
      field_214359_c = new ResourceLocation("textures/misc/unknown_server.png");
      field_214360_d = new ResourceLocation("textures/gui/server_selection.png");
   }
   ...
   public class NormalEntry extends ServerSelectionList.Entry {
      ...
      public void render(int p_render_1_, int p_render_2_, int p_render_3_, int p_render_4_, int p_render_5_, int p_render_6_, int p_render_7_, boolean p_render_8_, float p_render_9_) {
         ...
         for(int i = 0; i < Math.min(list.size(), 2); ++i) {
            this.mc.fontRenderer.drawString((String)list.get(i), (float)(p_render_3_ + 32 + 3), (float)(p_render_2_ + 12 + 9 * i), 8421504);
         }
         ...
         ClientHooks.drawForgePingInfo(this.owner, this.server, p_render_3_, p_render_2_, p_render_4_, i1, j1);
      ...
      private void prepareServerIcon() {
         ...
         if (s == null) {
            ...
            try {
               ...
               ServerSelectionList.LOGGER.error("Invalid icon for server {} ({})", this.server.serverName, this.server.serverIP, var3);
      ...
      private void func_228196_a_(int p_228196_1_, int p_228196_2_) {
         ...
         ServerSelectionList.Entry serverselectionlist$entry = (ServerSelectionList.Entry)this.owner.serverListSelector.children().get(p_228196_2_);
