...
public abstract class AbstractCommandBlockScreen extends Screen {
   ...
   protected void init() {
      ...
      this.doneButton = (Button)this.addButton(new Button(this.width / 2 - 4 - 150, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.done"), (p_214187_1_) -> {
         this.func_195234_k();
      }));
      this.cancelButton = (Button)this.addButton(new Button(this.width / 2 + 4, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.cancel"), (p_214186_1_) -> {
         this.onClose();
      }));
      this.trackOutputButton = (Button)this.addButton(new Button(this.width / 2 + 150 - 20, this.func_195236_i(), 20, 20, "O", (p_214184_1_) -> {
         CommandBlockLogic lvt_2_1_ = this.getLogic();
   ...
   public void resize(Minecraft p_resize_1_, int p_resize_2_, int p_resize_3_) {
      String lvt_4_1_ = this.commandTextField.getText();
      this.init(p_resize_1_, p_resize_2_, p_resize_3_);
      this.commandTextField.setText(lvt_4_1_);
      this.field_228184_g_.func_228111_a_();
   }
   ...
   protected void func_195234_k() {
      CommandBlockLogic lvt_1_1_ = this.getLogic();
      this.func_195235_a(lvt_1_1_);
      if (!lvt_1_1_.shouldTrackOutput()) {
         lvt_1_1_.setLastOutput((ITextComponent)null);
      }
   ...
   public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
      if (this.field_228184_g_.func_228115_a_(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_)) {
         return true;
   ...
   public boolean mouseScrolled(double p_mouseScrolled_1_, double p_mouseScrolled_3_, double p_mouseScrolled_5_) {
      return this.field_228184_g_.func_228112_a_(p_mouseScrolled_5_) ? true : super.mouseScrolled(p_mouseScrolled_1_, p_mouseScrolled_3_, p_mouseScrolled_5_);
   }

   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      return this.field_228184_g_.func_228113_a_(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_) ? true : super.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_);
   }
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      if (!this.resultTextField.getText().isEmpty()) {
         this.font.getClass();
         int lvt_4_1_ = lvt_4_1_ + (5 * 9 + 1 + this.func_195236_i() - 135);
         this.drawString(this.font, I18n.format("advMode.previousOutput"), this.width / 2 - 150, lvt_4_1_ + 4, 10526880);
         this.resultTextField.render(p_render_1_, p_render_2_, p_render_3_);
      }

      super.render(p_render_1_, p_render_2_, p_render_3_);
      this.field_228184_g_.func_228114_a_(p_render_1_, p_render_2_);
   }
}
