...
public class AddServerScreen extends Screen {
   ...
   private final Predicate<String> addressFilter = (p_210141_0_) -> {
      if (StringUtils.isNullOrEmpty(p_210141_0_)) {
         ...
         String[] lvt_1_1_ = p_210141_0_.split(":");
         if (lvt_1_1_.length == 0) {
            return true;
         } else {
            try {
               String lvt_2_1_ = IDN.toASCII(lvt_1_1_[0]);
               return true;
   ...
   protected void init() {
      ...
      this.field_152176_i = (Button)this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 72, 200, 20, I18n.format("addServer.resourcePack") + ": " + this.serverData.getResourceMode().getMotd().getFormattedText(), (p_213031_1_) -> {
      ...
      this.field_195179_a = (Button)this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 96 + 18, 200, 20, I18n.format("addServer.add"), (p_213030_1_) -> {
         this.func_195172_h();
      }));
   ...
   public void resize(Minecraft p_resize_1_, int p_resize_2_, int p_resize_3_) {
      String lvt_4_1_ = this.field_146308_f.getText();
      String lvt_5_1_ = this.field_146309_g.getText();
      this.init(p_resize_1_, p_resize_2_, p_resize_3_);
      this.field_146308_f.setText(lvt_4_1_);
      this.field_146309_g.setText(lvt_5_1_);
   }
   ...
   private void func_228180_b_() {
      String lvt_1_1_ = this.field_146308_f.getText();
      boolean lvt_2_1_ = !lvt_1_1_.isEmpty() && lvt_1_1_.split(":").length > 0 && lvt_1_1_.indexOf(32) == -1;
      this.field_195179_a.active = lvt_2_1_ && !this.field_146309_g.getText().isEmpty();
   }
