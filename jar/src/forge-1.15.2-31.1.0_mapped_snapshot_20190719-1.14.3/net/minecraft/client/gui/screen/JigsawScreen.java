...
public class JigsawScreen extends Screen {
   ...
   protected void init() {
      ...
      this.field_214263_e = (Button)this.addButton(new Button(this.width / 2 - 4 - 150, 210, 150, 20, I18n.format("gui.done"), (p_214255_1_) -> {
         this.func_214256_b();
      }));
   ...
   public void resize(Minecraft p_resize_1_, int p_resize_2_, int p_resize_3_) {
      String lvt_4_1_ = this.field_214260_b.getText();
      String lvt_5_1_ = this.field_214261_c.getText();
      String lvt_6_1_ = this.field_214262_d.getText();
      this.init(p_resize_1_, p_resize_2_, p_resize_3_);
      this.field_214260_b.setText(lvt_4_1_);
      this.field_214261_c.setText(lvt_5_1_);
      this.field_214262_d.setText(lvt_6_1_);
   }
