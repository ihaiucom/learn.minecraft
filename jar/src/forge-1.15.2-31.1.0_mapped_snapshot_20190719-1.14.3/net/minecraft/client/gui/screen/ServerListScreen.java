...
public class ServerListScreen extends Screen {
   ...
   protected void init() {
      ...
      this.field_195170_a = (Button)this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 96 + 12, 200, 20, I18n.format("selectServer.select"), (p_213026_1_) -> {
         this.func_195167_h();
      }));
   ...
   public void resize(Minecraft p_resize_1_, int p_resize_2_, int p_resize_3_) {
      String lvt_4_1_ = this.ipEdit.getText();
      this.init(p_resize_1_, p_resize_2_, p_resize_3_);
      this.ipEdit.setText(lvt_4_1_);
   }
   ...
   private void func_195168_i() {
      String lvt_1_1_ = this.ipEdit.getText();
      this.field_195170_a.active = !lvt_1_1_.isEmpty() && lvt_1_1_.split(":").length > 0 && lvt_1_1_.indexOf(32) == -1;
   }
