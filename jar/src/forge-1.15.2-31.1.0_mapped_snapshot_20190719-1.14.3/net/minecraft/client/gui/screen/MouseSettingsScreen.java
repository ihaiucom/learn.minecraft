...
public class MouseSettingsScreen extends SettingsScreen {
   ...
   public MouseSettingsScreen(Screen p_i225929_1_, GameSettings p_i225929_2_) {
      super(p_i225929_1_, p_i225929_2_, new TranslationTextComponent("options.mouse_settings.title", new Object[0]));
   }
   ...
   protected void init() {
      ...
      if (InputMappings.func_224790_a()) {
         this.field_213045_b.func_214335_a((AbstractOption[])Stream.concat(Arrays.stream(OPTIONS), Stream.of(AbstractOption.field_225302_l)).toArray((p_223702_0_) -> {
   ...
   static {
      OPTIONS = new AbstractOption[]{AbstractOption.SENSITIVITY, AbstractOption.INVERT_MOUSE, AbstractOption.MOUSE_WHEEL_SENSITIVITY, AbstractOption.DISCRETE_MOUSE_SCROLL, AbstractOption.TOUCHSCREEN};
   }
}
