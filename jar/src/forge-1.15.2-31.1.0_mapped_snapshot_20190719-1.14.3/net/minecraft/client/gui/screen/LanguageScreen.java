...
public class LanguageScreen extends SettingsScreen {
   ...
   public LanguageScreen(Screen p_i1043_1_, GameSettings p_i1043_2_, LanguageManager p_i1043_3_) {
      super(p_i1043_1_, p_i1043_2_, new TranslationTextComponent("options.language", new Object[0]));
   ...
   protected void init() {
      ...
      this.field_211832_i = (OptionButton)this.addButton(new OptionButton(this.width / 2 - 155, this.height - 38, 150, 20, AbstractOption.FORCE_UNICODE_FONT, AbstractOption.FORCE_UNICODE_FONT.func_216743_c(this.field_228183_b_), (p_lambda$init$0_1_) -> {
         AbstractOption.FORCE_UNICODE_FONT.func_216740_a(this.field_228183_b_);
         this.field_228183_b_.saveOptions();
         p_lambda$init$0_1_.setMessage(AbstractOption.FORCE_UNICODE_FONT.func_216743_c(this.field_228183_b_));
         this.minecraft.updateWindowSize();
      }));
      this.confirmSettingsBtn = (Button)this.addButton(new Button(this.width / 2 - 155 + 160, this.height - 38, 150, 20, I18n.format("gui.done"), (p_lambda$init$1_1_) -> {
         LanguageScreen.List.LanguageEntry languagescreen$list$languageentry = (LanguageScreen.List.LanguageEntry)this.list.getSelected();
         if (languagescreen$list$languageentry != null && !languagescreen$list$languageentry.field_214398_b.getCode().equals(this.languageManager.getCurrentLanguage().getCode())) {
            ...
            this.field_228183_b_.language = languagescreen$list$languageentry.field_214398_b.getCode();
            ...
            this.field_211832_i.setMessage(AbstractOption.FORCE_UNICODE_FONT.func_216743_c(this.field_228183_b_));
            this.field_228183_b_.saveOptions();
         }
   ...
   class List extends ExtendedList<LanguageScreen.List.LanguageEntry> {
      public List(Minecraft p_i45519_2_) {
         ...
         Iterator var3 = LanguageScreen.this.languageManager.getLanguages().iterator();
      ...
      public void setSelected(@Nullable LanguageScreen.List.LanguageEntry p_setSelected_1_) {
         ...
         if (p_setSelected_1_ != null) {
            NarratorChatListener.INSTANCE.func_216864_a((new TranslationTextComponent("narrator.select", new Object[]{p_setSelected_1_.field_214398_b})).getString());
         }
