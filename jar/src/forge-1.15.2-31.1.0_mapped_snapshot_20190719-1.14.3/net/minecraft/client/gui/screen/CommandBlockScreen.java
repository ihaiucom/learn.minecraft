...
public class CommandBlockScreen extends AbstractCommandBlockScreen {
   ...
   protected void init() {
      super.init();
      this.modeBtn = (Button)this.addButton(new Button(this.width / 2 - 50 - 100 - 4, 165, 100, 20, I18n.format("advMode.mode.sequence"), (p_214191_1_) -> {
         this.nextMode();
         this.updateMode();
      }));
      this.conditionalBtn = (Button)this.addButton(new Button(this.width / 2 - 50, 165, 100, 20, I18n.format("advMode.mode.unconditional"), (p_214190_1_) -> {
         this.conditional = !this.conditional;
         this.updateConditional();
      }));
      this.autoExecBtn = (Button)this.addButton(new Button(this.width / 2 + 50 + 4, 165, 100, 20, I18n.format("advMode.mode.redstoneTriggered"), (p_214189_1_) -> {
   ...
   public void updateGui() {
      CommandBlockLogic lvt_1_1_ = this.commandBlock.getCommandBlockLogic();
      this.commandTextField.setText(lvt_1_1_.getCommand());
      this.field_195238_s = lvt_1_1_.shouldTrackOutput();
