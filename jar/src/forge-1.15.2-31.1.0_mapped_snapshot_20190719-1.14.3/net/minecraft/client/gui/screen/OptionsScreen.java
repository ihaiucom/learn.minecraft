...
public class OptionsScreen extends Screen {
   private static final AbstractOption[] SCREEN_OPTIONS;
   ...
   protected void init() {
      int lvt_1_1_ = 0;
      AbstractOption[] var2 = SCREEN_OPTIONS;
      int var3 = var2.length;

      for(int var4 = 0; var4 < var3; ++var4) {
         AbstractOption lvt_5_1_ = var2[var4];
         int lvt_6_1_ = this.width / 2 - 155 + lvt_1_1_ % 2 * 160;
         int lvt_7_1_ = this.height / 6 - 12 + 24 * (lvt_1_1_ >> 1);
         this.addButton(lvt_5_1_.createWidget(this.minecraft.gameSettings, lvt_6_1_, lvt_7_1_, 150));
         ++lvt_1_1_;
      }

      if (this.minecraft.world != null) {
         this.field_213062_f = this.minecraft.world.getDifficulty();
         this.difficultyButton = (Button)this.addButton(new Button(this.width / 2 - 155 + lvt_1_1_ % 2 * 160, this.height / 6 - 12 + 24 * (lvt_1_1_ >> 1), 150, 20, this.getDifficultyText(this.field_213062_f), (p_213051_1_) -> {
         ...
         if (this.minecraft.isSingleplayer() && !this.minecraft.world.getWorldInfo().isHardcore()) {
            ...
            this.lockButton = (LockIconButton)this.addButton(new LockIconButton(this.difficultyButton.x + this.difficultyButton.getWidth(), this.difficultyButton.y, (p_213054_1_) -> {
               this.minecraft.displayGuiScreen(new ConfirmScreen(this::func_213050_a, new TranslationTextComponent("difficulty.lock.title", new Object[0]), new TranslationTextComponent("difficulty.lock.question", new Object[]{new TranslationTextComponent("options.difficulty." + this.minecraft.world.getWorldInfo().getDifficulty().getTranslationKey(), new Object[0])})));
            }));
         ...
         this.addButton(new OptionButton(this.width / 2 - 155 + lvt_1_1_ % 2 * 160, this.height / 6 - 12 + 24 * (lvt_1_1_ >> 1), 150, 20, AbstractOption.REALMS_NOTIFICATIONS, AbstractOption.REALMS_NOTIFICATIONS.func_216743_c(this.settings), (p_213057_1_) -> {
   ...
   public String getDifficultyText(Difficulty p_175355_1_) {
      return (new TranslationTextComponent("options.difficulty", new Object[0])).appendText(": ").appendSibling(p_175355_1_.getDisplayName()).getFormattedText();
   }
   ...
   static {
      SCREEN_OPTIONS = new AbstractOption[]{AbstractOption.FOV};
   }
}
