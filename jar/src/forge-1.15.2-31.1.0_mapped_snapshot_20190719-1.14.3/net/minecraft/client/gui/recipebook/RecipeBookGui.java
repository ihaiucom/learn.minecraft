...
public class RecipeBookGui extends AbstractGui implements IRenderable, IGuiEventListener, IRecipeUpdateListener, IRecipePlacer<Ingredient> {
   ...
   public void func_201518_a(boolean p_201518_1_) {
      ...
      this.searchBar = new TextFieldWidget(this.mc.fontRenderer, i + 25, j + 14, 80, 14, I18n.format("itemGroup.search"));
      ...
      Iterator var5 = this.field_201522_g.getRecipeBookCategories().iterator();

      while(var5.hasNext()) {
         RecipeBookCategories recipebookcategories = (RecipeBookCategories)var5.next();
         this.recipeTabs.add(new RecipeTabToggleWidget(recipebookcategories));
      }

      if (this.currentTab != null) {
         this.currentTab = (RecipeTabToggleWidget)this.recipeTabs.stream().filter((p_lambda$func_201518_a$0_1_) -> {
            return p_lambda$func_201518_a$0_1_.func_201503_d().equals(this.currentTab.func_201503_d());
         }).findFirst().orElse((RecipeTabToggleWidget)null);
      }

      if (this.currentTab == null) {
         this.currentTab = (RecipeTabToggleWidget)this.recipeTabs.get(0);
      }
   ...
   private void updateCollections(boolean p_193003_1_) {
      ...
      list.forEach((p_lambda$updateCollections$1_1_) -> {
         p_lambda$updateCollections$1_1_.canCraft(this.stackedContents, this.field_201522_g.getWidth(), this.field_201522_g.getHeight(), this.recipeBook);
      });
      List<RecipeList> list1 = Lists.newArrayList(list);
      list1.removeIf((p_lambda$updateCollections$2_0_) -> {
         return !p_lambda$updateCollections$2_0_.isNotEmpty();
      });
      list1.removeIf((p_lambda$updateCollections$3_0_) -> {
         return !p_lambda$updateCollections$3_0_.containsValidRecipes();
      });
      ...
      if (!s.isEmpty()) {
         ...
         list1.removeIf((p_lambda$updateCollections$4_1_) -> {
            return !objectset.contains(p_lambda$updateCollections$4_1_);
         });
      }

      if (this.recipeBook.isFilteringCraftable(this.field_201522_g)) {
         list1.removeIf((p_lambda$updateCollections$5_0_) -> {
            return !p_lambda$updateCollections$5_0_.containsCraftableRecipes();
         });
      }
   ...
   private void updateTabs() {
      ...
      while(true) {
         while(var5.hasNext()) {
            RecipeTabToggleWidget recipetabtogglewidget = (RecipeTabToggleWidget)var5.next();
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      if (this.isVisible()) {
         ...
         while(var6.hasNext()) {
            RecipeTabToggleWidget recipetabtogglewidget = (RecipeTabToggleWidget)var6.next();
   ...
   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      if (this.isVisible() && !this.mc.player.isSpectator()) {
         if (this.recipeBookPage.func_198955_a(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_, (this.width - 147) / 2 - this.xOffset, (this.height - 166) / 2, 147, 166)) {
            ...
            RecipeTabToggleWidget recipetabtogglewidget;
            do {
               if (!var6.hasNext()) {
                  return false;
               }

               recipetabtogglewidget = (RecipeTabToggleWidget)var6.next();
            } while(!recipetabtogglewidget.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_));
   ...
   private void pirateRecipe(String p_193716_1_) {
   ...
   public void setupGhostRecipe(IRecipe<?> p_193951_1_, List<Slot> p_193951_2_) {
      ...
      this.ghostRecipe.addIngredient(Ingredient.fromStacks(itemstack), ((Slot)p_193951_2_.get(0)).xPos, ((Slot)p_193951_2_.get(0)).yPos);
   ...
   public void setSlotContents(Iterator<Ingredient> p_201500_1_, int p_201500_2_, int p_201500_3_, int p_201500_4_, int p_201500_5_) {
      Ingredient ingredient = (Ingredient)p_201500_1_.next();
      if (!ingredient.hasNoMatchingItems()) {
         Slot slot = (Slot)this.field_201522_g.inventorySlots.get(p_201500_2_);
