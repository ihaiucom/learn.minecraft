...
public class MapItemRenderer implements AutoCloseable {
   ...
   private MapItemRenderer.Instance getMapRendererInstance(MapData p_148248_1_) {
      MapItemRenderer.Instance mapitemrenderer$instance = (MapItemRenderer.Instance)this.loadedMaps.get(p_148248_1_.getName());
   ...
   static {
      field_228085_d_ = RenderType.func_228658_l_(TEXTURE_MAP_ICONS);
   }
   ...
   class Instance implements AutoCloseable {
      ...
      private Instance(MapData p_i45007_2_) {
         ...
         ResourceLocation resourcelocation = MapItemRenderer.this.textureManager.getDynamicTextureLocation("map/" + p_i45007_2_.getName(), this.mapTexture);
      ...
      private void func_228089_a_(MatrixStack p_228089_1_, IRenderTypeBuffer p_228089_2_, boolean p_228089_3_, int p_228089_4_) {
         ...
         int k = 0;
         Iterator var11 = this.mapData.mapDecorations.values().iterator();
         ...
         while(true) {
            ...
            } while(p_228089_3_ && !mapdecoration.renderOnFrame());

            if (mapdecoration.render(k)) {
               ++k;
            } else {
               p_228089_1_.func_227860_a_();
               p_228089_1_.func_227861_a_((double)(0.0F + (float)mapdecoration.getX() / 2.0F + 64.0F), (double)(0.0F + (float)mapdecoration.getY() / 2.0F + 64.0F), -0.019999999552965164D);
               ...
               if (mapdecoration.getCustomName() != null) {
                  ...
                  p_228089_1_.func_227860_a_();
                  p_228089_1_.func_227861_a_((double)(0.0F + (float)mapdecoration.getX() / 2.0F + 64.0F - f6 * f7 / 2.0F), (double)(0.0F + (float)mapdecoration.getY() / 2.0F + 64.0F + 4.0F), -0.02500000037252903D);
                  p_228089_1_.func_227862_a_(f7, f7, 1.0F);
                  p_228089_1_.func_227861_a_(0.0D, 0.0D, -0.10000000149011612D);
