...
public class IngameGui extends AbstractGui {
   ...
   public IngameGui(Minecraft p_i46325_1_) {
      ...
      this.overlayDebug = new DebugOverlayGui(p_i46325_1_);
      this.spectatorGui = new SpectatorGui(p_i46325_1_);
      this.persistantChatGUI = new NewChatGui(p_i46325_1_);
      this.overlayPlayerList = new PlayerTabOverlayGui(p_i46325_1_, this);
      this.overlayBoss = new BossOverlayGui(p_i46325_1_);
      this.overlaySubtitle = new SubtitleOverlayGui(p_i46325_1_);
      ...
      ((List)this.chatListeners.get(ChatType.CHAT)).add(new NormalChatListener(p_i46325_1_));
      ((List)this.chatListeners.get(ChatType.CHAT)).add(ichatlistener);
      ((List)this.chatListeners.get(ChatType.SYSTEM)).add(new NormalChatListener(p_i46325_1_));
      ((List)this.chatListeners.get(ChatType.SYSTEM)).add(ichatlistener);
      ((List)this.chatListeners.get(ChatType.GAME_INFO)).add(new OverlayChatListener(p_i46325_1_));
   ...
   public void renderGameOverlay(float p_175180_1_) {
      ...
      if (!this.mc.player.isPotionActive(Effects.NAUSEA)) {
         f4 = MathHelper.lerp(p_175180_1_, this.mc.player.prevTimeInPortal, this.mc.player.timeInPortal);
         if (f4 > 0.0F) {
            this.renderPortal(f4);
         }
      }

      if (this.mc.playerController.getCurrentGameType() == GameType.SPECTATOR) {
         this.spectatorGui.renderTooltip(p_175180_1_);
      ...
      if (this.mc.player.getSleepTimer() > 0) {
         ...
         f4 = (float)this.mc.player.getSleepTimer();
         float f1 = f4 / 100.0F;
         if (f1 > 1.0F) {
            f1 = 1.0F - (f4 - 100.0F) / 10.0F;
         }

         l1 = (int)(220.0F * f1) << 24 | 1052704;
         fill(0, 0, this.scaledWidth, this.scaledHeight, l1);
         RenderSystem.enableAlphaTest();
         RenderSystem.enableDepthTest();
         this.mc.getProfiler().endSection();
         RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      ...
      if (!this.mc.gameSettings.hideGUI) {
         ...
         if (this.overlayMessageTime > 0) {
            ...
            f4 = (float)this.overlayMessageTime - p_175180_1_;
            j1 = (int)(f4 * 255.0F / 20.0F);
            if (j1 > 255) {
               j1 = 255;
            }
            ...
            if (j1 > 8) {
               ...
               if (this.animateOverlayMessageColor) {
                  l1 = MathHelper.hsvToRGB(f4 / 50.0F, 0.7F, 0.6F) & 16777215;
               }

               i2 = j1 << 24 & -16777216;
               this.func_212909_a(fontrenderer, -4, fontrenderer.getStringWidth(this.overlayMessage));
               fontrenderer.drawString(this.overlayMessage, (float)(-fontrenderer.getStringWidth(this.overlayMessage) / 2), -4.0F, l1 | i2);
               RenderSystem.disableBlend();
         ...
         if (this.titlesTimer > 0) {
            ...
            f4 = (float)this.titlesTimer - p_175180_1_;
            j1 = 255;
            ...
            if (j1 > 8) {
               ...
               l1 = j1 << 24 & -16777216;
               i2 = fontrenderer.getStringWidth(this.displayedTitle);
         ...
         if (scoreplayerteam != null) {
            i2 = scoreplayerteam.getColor().getColorIndex();
            if (i2 >= 0) {
               scoreobjective = scoreboard.getObjectiveInDisplaySlot(3 + i2);
            }
         }
   ...
   protected void renderAttackIndicator() {
      ...
      if (gamesettings.thirdPersonView == 0 && (this.mc.playerController.getCurrentGameType() != GameType.SPECTATOR || this.func_212913_a(this.mc.objectMouseOver))) {
               ...
               if (effectinstance.isShowIcon()) {
                  ...
                  if (effectinstance.isAmbient()) {
                     ...
                     if (effectinstance.getDuration() <= 200) {
                        ...
                        f = MathHelper.clamp((float)effectinstance.getDuration() / 10.0F / 5.0F * 0.5F, 0.0F, 0.5F) + MathHelper.cos((float)effectinstance.getDuration() * 3.1415927F / 5.0F) * MathHelper.clamp((float)i1 / 10.0F * 0.25F, 0.0F, 0.25F);
                     }
                  }
                  ...
                  list.add(() -> {
                     ...
                     blit(k + 3, l + 3, this.getBlitOffset(), 18, 18, textureatlassprite);
                  });
                  effectinstance.renderHUDEffect(this, k, l, (float)this.getBlitOffset(), f);
               }
            }
         }
   ...
   protected void renderHotbar(float p_194806_1_) {
      ...
      if (playerentity != null) {
         ...
         for(i2 = 0; i2 < 9; ++i2) {
            j2 = i - 90 + i2 * 20 + 2;
            k2 = this.scaledHeight - 16 - 3;
            this.renderHotbarItem(j2, k2, p_194806_1_, playerentity, (ItemStack)playerentity.inventory.mainInventory.get(i2));
         }

         if (!itemstack.isEmpty()) {
            i2 = this.scaledHeight - 16 - 3;
            if (handside == HandSide.LEFT) {
               this.renderHotbarItem(i - 91 - 26, i2, p_194806_1_, playerentity, itemstack);
            } else {
               this.renderHotbarItem(i + 91 + 10, i2, p_194806_1_, playerentity, itemstack);
            }
         }
   ...
   public void renderExpBar(int p_194804_1_) {
      ...
      if (i > 0) {
         int j = true;
         i1 = (int)(this.mc.player.experience * 183.0F);
         j1 = this.scaledHeight - 32 + 3;
         this.blit(p_194804_1_, j1, 0, 64, 182, 5);
         if (i1 > 0) {
            this.blit(p_194804_1_, j1, 0, 69, i1, 5);
         }
      }
      ...
      if (this.mc.player.experienceLevel > 0) {
         ...
         i1 = (this.scaledWidth - this.getFontRenderer().getStringWidth(s)) / 2;
         j1 = this.scaledHeight - 31 - 4;
   ...
   protected void renderScoreboard(ScoreObjective p_194802_1_) {
      ...
      List<Score> list = (List)collection.stream().filter((p_lambda$renderScoreboard$1_0_) -> {
      ...
      String s1;
      for(Iterator var8 = ((Collection)collection).iterator(); var8.hasNext(); j = Math.max(j, this.getFontRenderer().getStringWidth(s1))) {
         Score score = (Score)var8.next();
         ScorePlayerTeam scoreplayerteam = scoreboard.getPlayersTeam(score.getPlayerName());
         s1 = ScorePlayerTeam.formatMemberName(scoreplayerteam, new StringTextComponent(score.getPlayerName())).getFormattedText() + ": " + TextFormatting.RED + score.getScorePoints();
      }

      int l1 = ((Collection)collection).size() * 9;
      ...
      Iterator var15 = ((Collection)collection).iterator();

      while(var15.hasNext()) {
         Score score1 = (Score)var15.next();
         ++k;
         ...
         if (k == ((Collection)collection).size()) {
      ...
      if (playerentity != null) {
         ...
         for(l5 = 0; l5 < 10; ++l5) {
            if (j3 > 0) {
               i6 = i1 + l5 * 8;
               if (l5 * 2 + 1 < j3) {
                  this.blit(i6, k2, 34, 9, 9, 9);
               }

               if (l5 * 2 + 1 == j3) {
                  this.blit(i6, k2, 25, 9, 9, 9);
               }

               if (l5 * 2 + 1 > j3) {
                  this.blit(i6, k2, 16, 9, 9, 9);
               }
            }
         }
         ...
         int l4;
         int i5;
         for(l5 = MathHelper.ceil((f + (float)l1) / 2.0F) - 1; l5 >= 0; --l5) {
            i6 = 16;
            ...
            i7 = MathHelper.ceil((float)(l5 + 1) / 10.0F) - 1;
            l4 = i1 + l5 % 10 * 8;
            i5 = k1 - i7 * j2;
            if (i <= 4) {
         ...
         i6 = this.func_212306_a(livingentity);
         int k6;
         int k8;
         if (i6 == 0) {
            ...
            for(k6 = 0; k6 < 10; ++k6) {
               ...
               if (k6 * 2 + 1 < l) {
                  this.blit(k8, i7, l4 + 36, 27, 9, 9);
               }

               if (k6 * 2 + 1 == l) {
                  this.blit(k8, i7, l4 + 45, 27, 9, 9);
               }
            }
         ...
         k6 = playerentity.getAir();
         i7 = playerentity.getMaxAir();
         if (playerentity.areEyesInFluid(FluidTags.WATER) || k6 < i7) {
            l4 = this.func_212302_c(i6) - 1;
            l2 -= l4 * 10;
            i5 = MathHelper.ceil((double)(k6 - 2) * 10.0D / (double)i7);
            k8 = MathHelper.ceil((double)k6 * 10.0D / (double)i7) - i5;

            for(int k5 = 0; k5 < i5 + k8; ++k5) {
               if (k5 < i5) {
   ...
   private void renderVehicleHealth() {
      ...
      if (livingentity != null) {
         ...
         if (i != 0) {
            ...
            for(boolean var8 = false; i > 0; j1 += 20) {
   ...
   private void renderHotbarItem(int p_184044_1_, int p_184044_2_, float p_184044_3_, PlayerEntity p_184044_4_, ItemStack p_184044_5_) {
   ...
   public void addChatMessage(ChatType p_191742_1_, ITextComponent p_191742_2_) {
      Iterator var3 = ((List)this.chatListeners.get(p_191742_1_)).iterator();
