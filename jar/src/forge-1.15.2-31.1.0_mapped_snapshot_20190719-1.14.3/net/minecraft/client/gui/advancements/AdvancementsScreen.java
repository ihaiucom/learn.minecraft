...
public class AdvancementsScreen extends Screen implements ClientAdvancementManager.IListener {
   ...
   protected void init() {
      ...
      if (this.selectedTab == null && !this.tabs.isEmpty()) {
         this.clientAdvancementManager.setSelectedTab(((AdvancementTabGui)this.tabs.values().iterator().next()).getAdvancement(), true);
      } else {
      ...
      if (this.tabs.size() > AdvancementTabType.MAX_TABS) {
         ...
         this.addButton(new Button(guiLeft, guiTop - 50, 20, 20, "<", (p_lambda$init$0_0_) -> {
            tabPage = Math.max(tabPage - 1, 0);
         }));
         this.addButton(new Button(guiLeft + 252 - 20, guiTop - 50, 20, 20, ">", (p_lambda$init$1_0_) -> {
   ...
   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      if (p_mouseClicked_5_ == 0) {
         ...
         while(var8.hasNext()) {
            AdvancementTabGui advancementtabgui = (AdvancementTabGui)var8.next();
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      if (maxPages != 0) {
         ...
         this.font.drawStringWithShadow(page, (float)(i + 126 - width / 2), (float)(j - 44), -1);
      }
   ...
   private void renderInside(int p_191936_1_, int p_191936_2_, int p_191936_3_, int p_191936_4_) {
      ...
      if (advancementtabgui == null) {
         ...
         this.font.drawString(s, (float)(p_191936_3_ + 9 + 117 - i / 2), (float)(p_191936_4_ + 18 + 56 - 4), -1);
   ...
   public void renderWindow(int p_191934_1_, int p_191934_2_) {
      ...
      if (this.tabs.size() > 1) {
         ...
         AdvancementTabGui advancementtabgui1;
         while(var3.hasNext()) {
            advancementtabgui1 = (AdvancementTabGui)var3.next();
            if (advancementtabgui1.getPage() == tabPage) {
               advancementtabgui1.drawTab(p_191934_1_, p_191934_2_, advancementtabgui1 == this.selectedTab);
            }
         }
   ...
   private void renderToolTips(int p_191937_1_, int p_191937_2_, int p_191937_3_, int p_191937_4_) {
      ...
      if (this.tabs.size() > 1) {
         ...
         while(var5.hasNext()) {
            AdvancementTabGui advancementtabgui = (AdvancementTabGui)var5.next();
   ...
   public void onUpdateAdvancementProgress(Advancement p_191933_1_, AdvancementProgress p_191933_2_) {
      AdvancementEntryGui advancemententrygui = this.getAdvancementGui(p_191933_1_);
      if (advancemententrygui != null) {
         advancemententrygui.setAdvancementProgress(p_191933_2_);
      }

   }

   public void setSelectedTab(@Nullable Advancement p_193982_1_) {
      this.selectedTab = (AdvancementTabGui)this.tabs.get(p_193982_1_);
   }
   ...
   private AdvancementTabGui getTab(Advancement p_191935_1_) {
      ...
      return (AdvancementTabGui)this.tabs.get(p_191935_1_);
   }
}
