...
public class AdvancementTabGui extends AbstractGui {
   ...
   public AdvancementTabGui(Minecraft p_i230091_1_, AdvancementsScreen p_i230091_2_, AdvancementTabType p_i230091_3_, int p_i230091_4_, int p_i230091_5_, Advancement p_i230091_6_, DisplayInfo p_i230091_7_) {
      this(p_i230091_1_, p_i230091_2_, p_i230091_3_, p_i230091_4_, p_i230091_6_, p_i230091_7_);
      this.page = p_i230091_5_;
   }
   ...
   public void drawToolTips(int p_192991_1_, int p_192991_2_, int p_192991_3_, int p_192991_4_) {
      ...
      if (p_192991_1_ > 0 && p_192991_1_ < 234 && p_192991_2_ > 0 && p_192991_2_ < 113) {
         Iterator var8 = this.guis.values().iterator();

         while(var8.hasNext()) {
            AdvancementEntryGui advancemententrygui = (AdvancementEntryGui)var8.next();
   ...
   private void addGuiAdvancement(AdvancementEntryGui p_193937_1_, Advancement p_193937_2_) {
      ...
      while(var7.hasNext()) {
         AdvancementEntryGui advancemententrygui = (AdvancementEntryGui)var7.next();
   ...
   public AdvancementEntryGui getAdvancementGui(Advancement p_191794_1_) {
      return (AdvancementEntryGui)this.guis.get(p_191794_1_);
   }
