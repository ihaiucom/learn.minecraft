...
enum AdvancementTabType {
   ...
   public static final int MAX_TABS = Arrays.stream(values()).mapToInt((p_lambda$static$0_0_) -> {
      return p_lambda$static$0_0_.max;
   }).sum();
   ...
   public void draw(AbstractGui p_192651_1_, int p_192651_2_, int p_192651_3_, boolean p_192651_4_, int p_192651_5_) {
      int i = this.textureX;
      if (p_192651_5_ > 0) {
         i += this.width;
      }
   ...
   public void drawIcon(int p_192652_1_, int p_192652_2_, int p_192652_3_, ItemRenderer p_192652_4_, ItemStack p_192652_5_) {
      ...
      p_192652_4_.renderItemAndEffectIntoGUI((LivingEntity)null, p_192652_5_, i, j);
   }
