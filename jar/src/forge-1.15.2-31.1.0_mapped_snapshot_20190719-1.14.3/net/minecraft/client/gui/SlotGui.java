...
public abstract class SlotGui extends FocusableGui implements IRenderable {
   ...
   public SlotGui(Minecraft p_i1052_1_, int p_i1052_2_, int p_i1052_3_, int p_i1052_4_, int p_i1052_5_, int p_i1052_6_) {
      this.minecraft = p_i1052_1_;
      this.width = p_i1052_2_;
      this.height = p_i1052_3_;
      this.y0 = p_i1052_4_;
      this.y1 = p_i1052_5_;
      this.itemHeight = p_i1052_6_;
      this.x0 = 0;
      this.x1 = p_i1052_2_;
   }
      ...
      if (this.isVisible() && this.isMouseInList(p_mouseClicked_1_, p_mouseClicked_3_)) {
         ...
         if (i == -1 && p_mouseClicked_5_ == 0) {
            ...
            if (this.children().size() > i) {
               this.setFocused((IGuiEventListener)this.children().get(i));
            }
   ...
   protected void renderList(int p_renderList_1_, int p_renderList_2_, int p_renderList_3_, int p_renderList_4_, float p_renderList_5_) {
      ...
      for(int j = 0; j < i; ++j) {
         ...
         if (this.renderSelection && this.isSelectedItem(j)) {
            ...
            bufferbuilder.func_225582_a_((double)i1, (double)(k + l + 2), 0.0D).endVertex();
            bufferbuilder.func_225582_a_((double)j1, (double)(k + l + 2), 0.0D).endVertex();
            bufferbuilder.func_225582_a_((double)j1, (double)(k - 2), 0.0D).endVertex();
            bufferbuilder.func_225582_a_((double)i1, (double)(k - 2), 0.0D).endVertex();
            tessellator.draw();
            RenderSystem.color4f(0.0F, 0.0F, 0.0F, 1.0F);
            bufferbuilder.begin(7, DefaultVertexFormats.POSITION);
            bufferbuilder.func_225582_a_((double)(i1 + 1), (double)(k + l + 1), 0.0D).endVertex();
            bufferbuilder.func_225582_a_((double)(j1 - 1), (double)(k + l + 1), 0.0D).endVertex();
            bufferbuilder.func_225582_a_((double)(j1 - 1), (double)(k - 1), 0.0D).endVertex();
            bufferbuilder.func_225582_a_((double)(i1 + 1), (double)(k - 1), 0.0D).endVertex();
            tessellator.draw();
            RenderSystem.enableTexture();
         }
   ...
   protected void renderHoleBackground(int p_renderHoleBackground_1_, int p_renderHoleBackground_2_, int p_renderHoleBackground_3_, int p_renderHoleBackground_4_) {
      ...
      float f = 32.0F;
      bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
      bufferbuilder.func_225582_a_((double)this.x0, (double)p_renderHoleBackground_2_, 0.0D).func_225583_a_(0.0F, (float)p_renderHoleBackground_2_ / 32.0F).func_225586_a_(64, 64, 64, p_renderHoleBackground_4_).endVertex();
      bufferbuilder.func_225582_a_((double)(this.x0 + this.width), (double)p_renderHoleBackground_2_, 0.0D).func_225583_a_((float)this.width / 32.0F, (float)p_renderHoleBackground_2_ / 32.0F).func_225586_a_(64, 64, 64, p_renderHoleBackground_4_).endVertex();
      bufferbuilder.func_225582_a_((double)(this.x0 + this.width), (double)p_renderHoleBackground_1_, 0.0D).func_225583_a_((float)this.width / 32.0F, (float)p_renderHoleBackground_1_ / 32.0F).func_225586_a_(64, 64, 64, p_renderHoleBackground_3_).endVertex();
      bufferbuilder.func_225582_a_((double)this.x0, (double)p_renderHoleBackground_1_, 0.0D).func_225583_a_(0.0F, (float)p_renderHoleBackground_1_ / 32.0F).func_225586_a_(64, 64, 64, p_renderHoleBackground_3_).endVertex();
      tessellator.draw();
   }
   ...
   protected void drawContainerBackground(Tessellator p_drawContainerBackground_1_) {
      BufferBuilder buffer = p_drawContainerBackground_1_.getBuffer();
      this.minecraft.getTextureManager().bindTexture(AbstractGui.BACKGROUND_LOCATION);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      float scale = 32.0F;
      buffer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
      buffer.func_225582_a_((double)this.x0, (double)this.y1, 0.0D).func_225583_a_((float)this.x0 / scale, (float)(this.y1 + (int)this.yo) / scale).func_225586_a_(32, 32, 32, 255).endVertex();
      buffer.func_225582_a_((double)this.x1, (double)this.y1, 0.0D).func_225583_a_((float)this.x1 / scale, (float)(this.y1 + (int)this.yo) / scale).func_225586_a_(32, 32, 32, 255).endVertex();
      buffer.func_225582_a_((double)this.x1, (double)this.y0, 0.0D).func_225583_a_((float)this.x1 / scale, (float)(this.y0 + (int)this.yo) / scale).func_225586_a_(32, 32, 32, 255).endVertex();
      buffer.func_225582_a_((double)this.x0, (double)this.y0, 0.0D).func_225583_a_((float)this.x0 / scale, (float)(this.y0 + (int)this.yo) / scale).func_225586_a_(32, 32, 32, 255).endVertex();
