...
public class SoundSlider extends AbstractSlider {
   ...
   public SoundSlider(Minecraft p_i51127_1_, int p_i51127_2_, int p_i51127_3_, SoundCategory p_i51127_4_, int p_i51127_5_) {
      ...
      this.category = p_i51127_4_;
      this.updateMessage();
   }

   protected void updateMessage() {
      String lvt_1_1_ = (float)this.value == (float)this.getYImage(false) ? I18n.format("options.off") : (int)((float)this.value * 100.0F) + "%";
      this.setMessage(I18n.format("soundCategory." + this.category.getName()) + ": " + lvt_1_1_);
   }
