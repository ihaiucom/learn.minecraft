...
public abstract class Widget extends AbstractGui implements IRenderable, IGuiEventListener {
   ...
   public Widget(int p_i51142_1_, int p_i51142_2_, String p_i51142_3_) {
      this(p_i51142_1_, p_i51142_2_, 200, 20, p_i51142_3_);
   }

   public Widget(int p_i51143_1_, int p_i51143_2_, int p_i51143_3_, int p_i51143_4_, String p_i51143_5_) {
      this.active = true;
      this.visible = true;
      this.alpha = 1.0F;
      ...
      this.x = p_i51143_1_;
      this.y = p_i51143_2_;
      this.width = p_i51143_3_;
      this.height = p_i51143_4_;
      this.message = p_i51143_5_;
   }
   ...
   public void setHeight(int p_setHeight_1_) {
      this.height = p_setHeight_1_;
   }
   ...
   public void setFGColor(int p_setFGColor_1_) {
      this.packedFGColor = p_setFGColor_1_;
   }
