...
public abstract class AbstractList<E extends AbstractList.AbstractListEntry<E>> extends FocusableGui implements IRenderable {
   ...
   @Nullable
   public E getFocused() {
      return (AbstractList.AbstractListEntry)((AbstractList.AbstractListEntry)super.getFocused());
   }
   ...
   protected E getEntry(int p_getEntry_1_) {
      return (AbstractList.AbstractListEntry)this.children().get(p_getEntry_1_);
   }
   ...
   protected final E getEntryAtPosition(double p_getEntryAtPosition_1_, double p_getEntryAtPosition_3_) {
      ...
      return p_getEntryAtPosition_1_ < (double)this.getScrollbarPosition() && p_getEntryAtPosition_1_ >= (double)k && p_getEntryAtPosition_1_ <= (double)l && j1 >= 0 && i1 >= 0 && j1 < this.getItemCount() ? (AbstractList.AbstractListEntry)this.children().get(j1) : null;
   }
   ...
   protected void moveSelection(int p_moveSelection_1_) {
      if (!this.children().isEmpty()) {
         ...
         E e = (AbstractList.AbstractListEntry)this.children().get(j);
         this.setSelected(e);
      ...
      for(int j = 0; j < i; ++j) {
         ...
         if (l >= this.y0 && k <= this.y1) {
            ...
            if (this.renderSelection && this.isSelectedItem(j)) {
               j2 = this.x0 + this.width / 2 - k1 / 2;
               int i2 = this.x0 + this.width / 2 + k1 / 2;
               RenderSystem.disableTexture();
               float f = this.isFocused() ? 1.0F : 0.5F;
               RenderSystem.color4f(f, f, f, 1.0F);
               bufferbuilder.begin(7, DefaultVertexFormats.POSITION);
               bufferbuilder.func_225582_a_((double)j2, (double)(i1 + j1 + 2), 0.0D).endVertex();
               ...
               bufferbuilder.func_225582_a_((double)j2, (double)(i1 - 2), 0.0D).endVertex();
               tessellator.draw();
               RenderSystem.color4f(0.0F, 0.0F, 0.0F, 1.0F);
               bufferbuilder.begin(7, DefaultVertexFormats.POSITION);
               bufferbuilder.func_225582_a_((double)(j2 + 1), (double)(i1 + j1 + 1), 0.0D).endVertex();
               ...
               bufferbuilder.func_225582_a_((double)(j2 + 1), (double)(i1 - 1), 0.0D).endVertex();
               tessellator.draw();
               RenderSystem.enableTexture();
            }
   ...
   protected E remove(int p_remove_1_) {
      E e = (AbstractList.AbstractListEntry)this.children.get(p_remove_1_);
      return this.removeEntry((AbstractList.AbstractListEntry)this.children.get(p_remove_1_)) ? e : null;
   }
   ...
   protected boolean removeEntry(E p_removeEntry_1_) {
      ...
      if (flag && p_removeEntry_1_ == this.getSelected()) {
         this.setSelected((AbstractList.AbstractListEntry)null);
      }
   ...
   class SimpleArrayList extends java.util.AbstractList<E> {
      ...
      public E get(int p_get_1_) {
         return (AbstractList.AbstractListEntry)this.field_216871_b.get(p_get_1_);
      }
      ...
      public E set(int p_set_1_, E p_set_2_) {
         E e = (AbstractList.AbstractListEntry)this.field_216871_b.set(p_set_1_, p_set_2_);
      ...
      public E remove(int p_remove_1_) {
         return (AbstractList.AbstractListEntry)this.field_216871_b.remove(p_remove_1_);
      }

      // $FF: synthetic method
      SimpleArrayList(Object p_i51088_2_) {
         this();
      }
   }
