...
public abstract class AbstractSlider extends Widget {
   ...
   protected AbstractSlider(int p_i51144_1_, int p_i51144_2_, int p_i51144_3_, int p_i51144_4_, double p_i51144_5_) {
      this(Minecraft.getInstance().gameSettings, p_i51144_1_, p_i51144_2_, p_i51144_3_, p_i51144_4_, p_i51144_5_);
   }

   protected AbstractSlider(GameSettings p_i51145_1_, int p_i51145_2_, int p_i51145_3_, int p_i51145_4_, int p_i51145_5_, double p_i51145_6_) {
      super(p_i51145_2_, p_i51145_3_, p_i51145_4_, p_i51145_5_, "");
      this.options = p_i51145_1_;
      this.value = p_i51145_6_;
   }
   ...
   protected void renderBg(Minecraft p_renderBg_1_, int p_renderBg_2_, int p_renderBg_3_) {
      ...
      this.blit(this.x + (int)(this.value * (double)(this.width - 8)), this.y, 0, 46 + lvt_4_1_, 4, 20);
      this.blit(this.x + (int)(this.value * (double)(this.width - 8)) + 4, this.y, 196, 46 + lvt_4_1_, 4, 20);
   }
   ...
   public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
      boolean lvt_4_1_ = p_keyPressed_1_ == 263;
      if (lvt_4_1_ || p_keyPressed_1_ == 262) {
         float lvt_5_1_ = lvt_4_1_ ? -1.0F : 1.0F;
         this.setValue(this.value + (double)(lvt_5_1_ / (float)(this.width - 8)));
      }
