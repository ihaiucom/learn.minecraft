...
public class CheckboxButton extends AbstractButton {
   ...
   public void renderButton(int p_renderButton_1_, int p_renderButton_2_, float p_renderButton_3_) {
      ...
      lvt_4_1_.getTextureManager().bindTexture(field_212944_b);
      ...
      this.renderBg(lvt_4_1_, p_renderButton_1_, p_renderButton_2_);
      int lvt_6_1_ = 14737632;
      this.drawString(lvt_5_1_, this.getMessage(), this.x + 24, this.y + (this.height - 8) / 2, 14737632 | MathHelper.ceil(this.alpha * 255.0F) << 24);
   }
}
