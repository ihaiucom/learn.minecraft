...
public class LockIconButton extends Button {
   ...
   public void renderButton(int p_renderButton_1_, int p_renderButton_2_, float p_renderButton_3_) {
      ...
      LockIconButton.Icon lvt_4_3_;
      if (!this.active) {
         lvt_4_3_ = this.locked ? LockIconButton.Icon.LOCKED_DISABLED : LockIconButton.Icon.UNLOCKED_DISABLED;
      } else if (this.isHovered()) {
         lvt_4_3_ = this.locked ? LockIconButton.Icon.LOCKED_HOVER : LockIconButton.Icon.UNLOCKED_HOVER;
      } else {
         lvt_4_3_ = this.locked ? LockIconButton.Icon.LOCKED : LockIconButton.Icon.UNLOCKED;
      }

      this.blit(this.x, this.y, lvt_4_3_.getX(), lvt_4_3_.getY(), this.width, this.height);
   }
