...
public class BeeEntity extends AnimalEntity implements IFlyingAnimal {
   private static final DataParameter<Byte> field_226374_bw_;
   private static final DataParameter<Integer> field_226375_bx_;
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      if (this.func_226409_eA_()) {
         p_213281_1_.put("HivePos", NBTUtil.writeBlockPos(this.func_226410_eB_()));
      }

      if (this.func_226425_er_()) {
         p_213281_1_.put("FlowerPos", NBTUtil.writeBlockPos(this.func_226424_eq_()));
      }

      p_213281_1_.putBoolean("HasNectar", this.func_226411_eD_());
      p_213281_1_.putBoolean("HasStung", this.func_226412_eE_());
      p_213281_1_.putInt("TicksSincePollination", this.field_226363_bC_);
      p_213281_1_.putInt("CannotEnterHiveTicks", this.field_226364_bD_);
      p_213281_1_.putInt("CropsGrownSincePollination", this.field_226365_bE_);
      p_213281_1_.putInt("Anger", this.func_226418_eL_());
      if (this.field_226376_by_ != null) {
         p_213281_1_.putString("HurtBy", this.field_226376_by_.toString());
      } else {
   ...
   public void readAdditional(CompoundNBT p_70037_1_) {
      ...
      if (p_70037_1_.contains("HivePos")) {
         this.field_226369_bI_ = NBTUtil.readBlockPos(p_70037_1_.getCompound("HivePos"));
      }

      this.field_226368_bH_ = null;
      if (p_70037_1_.contains("FlowerPos")) {
         this.field_226368_bH_ = NBTUtil.readBlockPos(p_70037_1_.getCompound("FlowerPos"));
      }

      super.readAdditional(p_70037_1_);
      this.func_226447_r_(p_70037_1_.getBoolean("HasNectar"));
      this.func_226449_s_(p_70037_1_.getBoolean("HasStung"));
      this.func_226453_u_(p_70037_1_.getInt("Anger"));
      this.field_226363_bC_ = p_70037_1_.getInt("TicksSincePollination");
      this.field_226364_bD_ = p_70037_1_.getInt("CannotEnterHiveTicks");
      this.field_226365_bE_ = p_70037_1_.getInt("CropsGrownSincePollination");
      String lvt_2_1_ = p_70037_1_.getString("HurtBy");
      if (!lvt_2_1_.isEmpty()) {
         this.field_226376_by_ = UUID.fromString(lvt_2_1_);
         PlayerEntity lvt_3_1_ = this.world.getPlayerByUuid(this.field_226376_by_);
   ...
   public boolean attackEntityAsMob(Entity p_70652_1_) {
      boolean lvt_2_1_ = p_70652_1_.attackEntityFrom(DamageSource.func_226252_a_(this), (float)((int)this.getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).getValue()));
      if (lvt_2_1_) {
         this.applyEnchantments(this, p_70652_1_);
         if (p_70652_1_ instanceof LivingEntity) {
            ((LivingEntity)p_70652_1_).func_226300_q_(((LivingEntity)p_70652_1_).func_226297_df_() + 1);
            int lvt_3_1_ = 0;
            ...
            if (lvt_3_1_ > 0) {
               ((LivingEntity)p_70652_1_).addPotionEffect(new EffectInstance(Effects.POISON, lvt_3_1_ * 20, 0));
            }
         }
   ...
   public void tick() {
      ...
      if (this.func_226411_eD_() && this.func_226419_eM_() < 10 && this.rand.nextFloat() < 0.05F) {
         for(int lvt_1_1_ = 0; lvt_1_1_ < this.rand.nextInt(2) + 1; ++lvt_1_1_) {
            this.func_226397_a_(this.world, this.func_226277_ct_() - 0.30000001192092896D, this.func_226277_ct_() + 0.30000001192092896D, this.func_226281_cx_() - 0.30000001192092896D, this.func_226281_cx_() + 0.30000001192092896D, this.func_226283_e_(0.5D), ParticleTypes.field_229430_aj_);
         }
      }
   ...
   private void func_226433_h_(BlockPos p_226433_1_) {
      Vec3d lvt_2_1_ = new Vec3d(p_226433_1_);
      int lvt_3_1_ = 0;
      BlockPos lvt_4_1_ = new BlockPos(this);
      int lvt_5_1_ = (int)lvt_2_1_.y - lvt_4_1_.getY();
      if (lvt_5_1_ > 2) {
         lvt_3_1_ = 4;
      } else if (lvt_5_1_ < -2) {
         lvt_3_1_ = -4;
      ...
      int lvt_6_1_ = 6;
      int lvt_7_1_ = 8;
      int lvt_8_1_ = lvt_4_1_.manhattanDistance(p_226433_1_);
      if (lvt_8_1_ < 15) {
         lvt_6_1_ = lvt_8_1_ / 2;
         lvt_7_1_ = lvt_8_1_ / 2;
      }

      Vec3d lvt_9_1_ = RandomPositionGenerator.func_226344_b_(this, lvt_6_1_, lvt_7_1_, lvt_3_1_, lvt_2_1_, 0.3141592741012573D);
      if (lvt_9_1_ != null) {
         this.navigator.func_226335_a_(0.5F);
         this.navigator.tryMoveToXYZ(lvt_9_1_.x, lvt_9_1_.y, lvt_9_1_.z, 1.0D);
      }
   }
   ...
   private boolean func_226415_eI_() {
      if (this.field_226364_bD_ <= 0 && !this.field_226370_bJ_.func_226503_k_() && !this.func_226412_eE_()) {
         boolean lvt_1_1_ = this.func_226414_eH_() || this.world.isRaining() || this.world.func_226690_K_() || this.func_226411_eD_();
         return lvt_1_1_ && !this.func_226417_eK_();
      } else {
         return false;
      }
   }
   ...
   public void setRevengeTarget(@Nullable LivingEntity p_70604_1_) {
      ...
      if (p_70604_1_ != null) {
         this.field_226376_by_ = p_70604_1_.getUniqueID();
      }

   }

   protected void updateAITasks() {
      boolean lvt_1_1_ = this.func_226412_eE_();
      ...
      if (this.func_226427_ez_()) {
         int lvt_2_1_ = this.func_226418_eL_();
         this.func_226453_u_(lvt_2_1_ - 1);
         LivingEntity lvt_3_1_ = this.getAttackTarget();
         if (lvt_2_1_ == 0 && lvt_3_1_ != null) {
            this.func_226391_a_(lvt_3_1_);
         }
      }
   ...
   private boolean func_226417_eK_() {
      if (this.field_226369_bI_ == null) {
         ...
         TileEntity lvt_1_1_ = this.world.getTileEntity(this.field_226369_bI_);
         return lvt_1_1_ instanceof BeehiveTileEntity && ((BeehiveTileEntity)lvt_1_1_).func_226968_d_();
      }
   }
   ...
   private int func_226418_eL_() {
      return (Integer)this.dataManager.get(field_226375_bx_);
   }
   ...
   private boolean func_226435_i_(BlockPos p_226435_1_) {
      TileEntity lvt_2_1_ = this.world.getTileEntity(p_226435_1_);
      if (lvt_2_1_ instanceof BeehiveTileEntity) {
         return !((BeehiveTileEntity)lvt_2_1_).func_226970_h_();
      } else {
         return false;
      }
   }
   ...
   public void livingTick() {
      ...
      if (!this.world.isRemote) {
         ...
         boolean lvt_1_1_ = this.func_226427_ez_() && !this.func_226412_eE_() && this.getAttackTarget() != null && this.getAttackTarget().getDistanceSq(this) < 4.0D;
         this.func_226452_t_(lvt_1_1_);
   ...
   private boolean func_226422_eP_() {
      if (!this.func_226409_eA_()) {
         ...
         TileEntity lvt_1_1_ = this.world.getTileEntity(this.field_226369_bI_);
         return lvt_1_1_ != null && lvt_1_1_.getType() == TileEntityType.field_226985_G_;
      }
   }
   ...
   private void func_226404_d_(int p_226404_1_, boolean p_226404_2_) {
      if (p_226404_2_) {
         this.dataManager.set(field_226374_bw_, (byte)((Byte)this.dataManager.get(field_226374_bw_) | p_226404_1_));
      } else {
         this.dataManager.set(field_226374_bw_, (byte)((Byte)this.dataManager.get(field_226374_bw_) & ~p_226404_1_));
      }
   ...
   private boolean func_226456_v_(int p_226456_1_) {
      return ((Byte)this.dataManager.get(field_226374_bw_) & p_226456_1_) != 0;
   }
   ...
   protected PathNavigator createNavigator(World p_175447_1_) {
      FlyingPathNavigator lvt_2_1_ = new FlyingPathNavigator(this, p_175447_1_) {
      ...
      lvt_2_1_.setCanOpenDoors(false);
      lvt_2_1_.setCanSwim(false);
      lvt_2_1_.setCanEnterDoors(true);
      return lvt_2_1_;
   }

   public boolean isBreedingItem(ItemStack p_70877_1_) {
      return p_70877_1_.getItem().isIn(ItemTags.field_226159_I_);
   }
   ...
   public BeeEntity createChild(AgeableEntity p_90011_1_) {
      return (BeeEntity)EntityType.field_226289_e_.create(this.world);
   }
   ...
   public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_) {
      if (this.isInvulnerableTo(p_70097_1_)) {
         ...
         if (!this.world.isRemote && lvt_3_1_ instanceof PlayerEntity && !((PlayerEntity)lvt_3_1_).isCreative() && this.canEntityBeSeen(lvt_3_1_) && !this.isAIDisabled()) {
   ...
   static {
      field_226374_bw_ = EntityDataManager.createKey(BeeEntity.class, DataSerializers.BYTE);
      field_226375_bx_ = EntityDataManager.createKey(BeeEntity.class, DataSerializers.VARINT);
   }
   ...
   class EnterBeehiveGoal extends BeeEntity.PassiveGoal {
      ...
      public boolean func_225506_g_() {
         if (BeeEntity.this.func_226409_eA_() && BeeEntity.this.func_226415_eI_() && BeeEntity.this.field_226369_bI_.withinDistance(BeeEntity.this.getPositionVec(), 2.0D)) {
            TileEntity lvt_1_1_ = BeeEntity.this.world.getTileEntity(BeeEntity.this.field_226369_bI_);
            if (lvt_1_1_ instanceof BeehiveTileEntity) {
               BeehiveTileEntity lvt_2_1_ = (BeehiveTileEntity)lvt_1_1_;
               if (!lvt_2_1_.func_226970_h_()) {
                  return true;
               }
      ...
      public void startExecuting() {
         ...
         if (lvt_1_1_ instanceof BeehiveTileEntity) {
            BeehiveTileEntity lvt_2_1_ = (BeehiveTileEntity)lvt_1_1_;
            lvt_2_1_.func_226961_a_(BeeEntity.this, BeeEntity.this.func_226411_eD_());
         }

      }

      // $FF: synthetic method
      EnterBeehiveGoal(Object p_i225721_2_) {
         this();
      }
   }
   ...
   class FindPollinationTargetGoal extends BeeEntity.PassiveGoal {
      ...
      public void tick() {
         if (BeeEntity.this.rand.nextInt(30) == 0) {
            for(int lvt_1_1_ = 1; lvt_1_1_ <= 2; ++lvt_1_1_) {
               BlockPos lvt_2_1_ = (new BlockPos(BeeEntity.this)).down(lvt_1_1_);
               BlockState lvt_3_1_ = BeeEntity.this.world.getBlockState(lvt_2_1_);
               Block lvt_4_1_ = lvt_3_1_.getBlock();
               boolean lvt_5_1_ = false;
               IntegerProperty lvt_6_1_ = null;
               if (lvt_4_1_.isIn(BlockTags.field_226153_ac_)) {
                  if (lvt_4_1_ instanceof CropsBlock) {
                     CropsBlock lvt_7_1_ = (CropsBlock)lvt_4_1_;
                     if (!lvt_7_1_.isMaxAge(lvt_3_1_)) {
                        lvt_5_1_ = true;
                        lvt_6_1_ = lvt_7_1_.getAgeProperty();
                     }
                  } else {
                     int lvt_7_3_;
                     if (lvt_4_1_ instanceof StemBlock) {
                        lvt_7_3_ = (Integer)lvt_3_1_.get(StemBlock.AGE);
                        if (lvt_7_3_ < 7) {
                           lvt_5_1_ = true;
                           lvt_6_1_ = StemBlock.AGE;
                        }
                     } else if (lvt_4_1_ == Blocks.SWEET_BERRY_BUSH) {
                        lvt_7_3_ = (Integer)lvt_3_1_.get(SweetBerryBushBlock.AGE);
                        if (lvt_7_3_ < 3) {
                           lvt_5_1_ = true;
                           lvt_6_1_ = SweetBerryBushBlock.AGE;
                        }
                     }
                  }

                  if (lvt_5_1_) {
                     BeeEntity.this.world.playEvent(2005, lvt_2_1_, 0);
                     BeeEntity.this.world.setBlockState(lvt_2_1_, (BlockState)lvt_3_1_.with(lvt_6_1_, (Integer)lvt_3_1_.get(lvt_6_1_) + 1));
      ...
      // $FF: synthetic method
      FindPollinationTargetGoal(Object p_i225725_2_) {
         this();
      }
   }
   ...
   class UpdateBeehiveGoal extends BeeEntity.PassiveGoal {
      ...
      public void startExecuting() {
         ...
         List<BlockPos> lvt_1_1_ = this.func_226489_j_();
         if (!lvt_1_1_.isEmpty()) {
            ...
            do {
               if (!var2.hasNext()) {
                  ...
                  BeeEntity.this.field_226369_bI_ = (BlockPos)lvt_1_1_.get(0);
                  return;
               }

               lvt_3_1_ = (BlockPos)var2.next();
            } while(BeeEntity.this.field_226371_bK_.func_226473_b_(lvt_3_1_));

            BeeEntity.this.field_226369_bI_ = lvt_3_1_;
         }
      }

      private List<BlockPos> func_226489_j_() {
         BlockPos lvt_1_1_ = new BlockPos(BeeEntity.this);
         PointOfInterestManager lvt_2_1_ = ((ServerWorld)BeeEntity.this.world).func_217443_B();
         Stream<PointOfInterest> lvt_3_1_ = lvt_2_1_.func_219146_b((p_226486_0_) -> {
            return p_226486_0_ == PointOfInterestType.field_226356_s_ || p_226486_0_ == PointOfInterestType.field_226357_t_;
         }, lvt_1_1_, 20, PointOfInterestManager.Status.ANY);
         return (List)lvt_3_1_.map(PointOfInterest::getPos).filter((p_226487_1_) -> {
            return BeeEntity.this.func_226435_i_(p_226487_1_);
         }).sorted(Comparator.comparingDouble((p_226488_1_) -> {
            return p_226488_1_.distanceSq(lvt_1_1_);
         })).collect(Collectors.toList());
      }

      // $FF: synthetic method
      UpdateBeehiveGoal(Object p_i225728_2_) {
         this();
      }
   }
   ...
   class PollinateGoal extends BeeEntity.PassiveGoal {
      ...
      public boolean func_225506_g_() {
         if (BeeEntity.this.field_226367_bG_ > 0) {
            ...
            Optional<BlockPos> lvt_1_1_ = this.func_226507_o_();
            if (lvt_1_1_.isPresent()) {
               BeeEntity.this.field_226368_bH_ = (BlockPos)lvt_1_1_.get();
               BeeEntity.this.navigator.tryMoveToXYZ((double)BeeEntity.this.field_226368_bH_.getX() + 0.5D, (double)BeeEntity.this.field_226368_bH_.getY() + 0.5D, (double)BeeEntity.this.field_226368_bH_.getZ() + 0.5D, 1.2000000476837158D);
               return true;
            } else {
               return false;
            }
      ...
      public void tick() {
         ...
         if (this.field_226497_h_ > 600) {
            ...
            Vec3d lvt_1_1_ = (new Vec3d(BeeEntity.this.field_226368_bH_)).add(0.5D, 0.6000000238418579D, 0.5D);
            if (lvt_1_1_.distanceTo(BeeEntity.this.getPositionVec()) > 1.0D) {
               this.field_226496_g_ = lvt_1_1_;
               this.func_226505_m_();
            } else {
               ...
               boolean lvt_2_1_ = BeeEntity.this.getPositionVec().distanceTo(this.field_226496_g_) <= 0.1D;
               boolean lvt_3_1_ = true;
               if (!lvt_2_1_ && this.field_226497_h_ > 600) {
                  BeeEntity.this.field_226368_bH_ = null;
               } else {
                  if (lvt_2_1_) {
                     boolean lvt_4_1_ = BeeEntity.this.rand.nextInt(100) == 0;
                     if (lvt_4_1_) {
                        this.field_226496_g_ = new Vec3d(lvt_1_1_.getX() + (double)this.func_226506_n_(), lvt_1_1_.getY(), lvt_1_1_.getZ() + (double)this.func_226506_n_());
                        BeeEntity.this.navigator.clearPath();
                     } else {
                        lvt_3_1_ = false;
                     }

                     BeeEntity.this.getLookController().func_220679_a(lvt_1_1_.getX(), lvt_1_1_.getY(), lvt_1_1_.getZ());
                  }
      ...
      private void func_226505_m_() {
         BeeEntity.this.getMoveHelper().setMoveTo(this.field_226496_g_.getX(), this.field_226496_g_.getY(), this.field_226496_g_.getZ(), 0.3499999940395355D);
      }
      ...
      private Optional<BlockPos> func_226500_a_(Predicate<BlockState> p_226500_1_, double p_226500_2_) {
         BlockPos lvt_4_1_ = new BlockPos(BeeEntity.this);
         BlockPos.Mutable lvt_5_1_ = new BlockPos.Mutable();

         for(int lvt_6_1_ = 0; (double)lvt_6_1_ <= p_226500_2_; lvt_6_1_ = lvt_6_1_ > 0 ? -lvt_6_1_ : 1 - lvt_6_1_) {
            for(int lvt_7_1_ = 0; (double)lvt_7_1_ < p_226500_2_; ++lvt_7_1_) {
               for(int lvt_8_1_ = 0; lvt_8_1_ <= lvt_7_1_; lvt_8_1_ = lvt_8_1_ > 0 ? -lvt_8_1_ : 1 - lvt_8_1_) {
                  for(int lvt_9_1_ = lvt_8_1_ < lvt_7_1_ && lvt_8_1_ > -lvt_7_1_ ? lvt_7_1_ : 0; lvt_9_1_ <= lvt_7_1_; lvt_9_1_ = lvt_9_1_ > 0 ? -lvt_9_1_ : 1 - lvt_9_1_) {
                     lvt_5_1_.setPos((Vec3i)lvt_4_1_).move(lvt_8_1_, lvt_6_1_ - 1, lvt_9_1_);
                     if (lvt_4_1_.withinDistance(lvt_5_1_, p_226500_2_) && p_226500_1_.test(BeeEntity.this.world.getBlockState(lvt_5_1_))) {
                        return Optional.of(lvt_5_1_);
                     }
                  }
               }
            }
   ...
   public class FindFlowerGoal extends BeeEntity.PassiveGoal {
      ...
      FindFlowerGoal() {
         super(null);
         this.field_226481_c_ = BeeEntity.this.world.rand.nextInt(10);
         this.setMutexFlags(EnumSet.of(Goal.Flag.MOVE));
      }
   ...
   public class FindBeehiveGoal extends BeeEntity.PassiveGoal {
      ...
      FindBeehiveGoal() {
         super(null);
         this.field_226468_c_ = BeeEntity.this.world.rand.nextInt(10);
         ...
         if (BeeEntity.this.field_226369_bI_ != null) {
            ...
            if (this.field_226468_c_ > 600) {
               ...
               if (!BeeEntity.this.func_226401_b_(BeeEntity.this.field_226369_bI_, 16)) {
                  ...
                  boolean lvt_1_1_ = this.func_226472_a_(BeeEntity.this.field_226369_bI_);
                  if (!lvt_1_1_) {
                     this.func_226478_k_();
      ...
      private boolean func_226476_d_(BlockPos p_226476_1_) {
         if (BeeEntity.this.func_226401_b_(p_226476_1_, 2)) {
            ...
            Path lvt_2_1_ = BeeEntity.this.navigator.getPath();
            return lvt_2_1_ != null && lvt_2_1_.func_224770_k().equals(p_226476_1_) && lvt_2_1_.func_224771_h() && lvt_2_1_.isFinished();
         }
      }
   }
   ...
   class WanderGoal extends Goal {
      ...
      public void startExecuting() {
         Vec3d lvt_1_1_ = this.func_226509_g_();
         if (lvt_1_1_ != null) {
            BeeEntity.this.navigator.setPath(BeeEntity.this.navigator.getPathToPos(new BlockPos(lvt_1_1_), 1), 1.0D);
         }
      ...
      private Vec3d func_226509_g_() {
         ...
         if (BeeEntity.this.func_226422_eP_() && !BeeEntity.this.func_226401_b_(BeeEntity.this.field_226369_bI_, 40)) {
            Vec3d lvt_2_1_ = new Vec3d(BeeEntity.this.field_226369_bI_);
            lvt_1_2_ = lvt_2_1_.subtract(BeeEntity.this.getPositionVec()).normalize();
         } else {
            lvt_1_2_ = BeeEntity.this.getLook(0.0F);
         }

         int lvt_2_2_ = true;
         Vec3d lvt_3_1_ = RandomPositionGenerator.func_226340_a_(BeeEntity.this, 8, 7, lvt_1_2_, 1.5707964F, 2, 1);
         return lvt_3_1_ != null ? lvt_3_1_ : RandomPositionGenerator.func_226338_a_(BeeEntity.this, 8, 4, -2, lvt_1_2_, 1.5707963705062866D);
      }
   }
   ...
   abstract class PassiveGoal extends Goal {
      ...
      // $FF: synthetic method
      PassiveGoal(Object p_i225717_2_) {
         this();
      }
   }
   ...
   static class AttackPlayerGoal extends NearestAttackableTargetGoal<PlayerEntity> {
      ...
      public boolean shouldContinueExecuting() {
         boolean lvt_1_1_ = this.func_226465_h_();
         if (lvt_1_1_ && this.goalOwner.getAttackTarget() != null) {
      ...
      private boolean func_226465_h_() {
         BeeEntity lvt_1_1_ = (BeeEntity)this.goalOwner;
         return lvt_1_1_.func_226427_ez_() && !lvt_1_1_.func_226412_eE_();
      }
   }
   ...
   class AngerGoal extends HurtByTargetGoal {
      ...
      protected void setAttackTarget(MobEntity p_220793_1_, LivingEntity p_220793_2_) {
         if (p_220793_1_ instanceof BeeEntity && this.goalOwner.canEntityBeSeen(p_220793_2_) && ((BeeEntity)p_220793_1_).func_226391_a_(p_220793_2_)) {
