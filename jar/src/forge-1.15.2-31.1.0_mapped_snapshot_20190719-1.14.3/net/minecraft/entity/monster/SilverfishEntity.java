...
public class SilverfishEntity extends MonsterEntity {
   ...
   public float getBlockPathWeight(BlockPos p_205022_1_, IWorldReader p_205022_2_) {
      return SilverfishBlock.canContainSilverfish(p_205022_2_.getBlockState(p_205022_1_.down())) ? 10.0F : super.getBlockPathWeight(p_205022_1_, p_205022_2_);
   }
                  ...
                  for(int k = 0; k <= 10 && k >= -10; k = (k <= 0 ? 1 : 0) - k) {
                     ...
                     if (block instanceof SilverfishBlock) {
                        if (ForgeEventFactory.getMobGriefingEvent(world, this.silverfish)) {
                           world.func_225521_a_(blockpos1, true, this.silverfish);
                        } else {
      ...
      public boolean shouldExecute() {
         if (this.creature.getAttackTarget() != null) {
            ...
            if (ForgeEventFactory.getMobGriefingEvent(this.creature.world, this.creature) && random.nextInt(10) == 0) {
               ...
               BlockPos blockpos = (new BlockPos(this.creature.func_226277_ct_(), this.creature.func_226278_cu_() + 0.5D, this.creature.func_226281_cx_())).offset(this.facing);
