...
public class WorkTask extends Task<CreatureEntity> {
   ...
   protected boolean shouldExecute(ServerWorld p_212832_1_, CreatureEntity p_212832_2_) {
      Optional<GlobalPos> lvt_3_1_ = p_212832_2_.getBrain().getMemory(this.field_220565_a);
      return lvt_3_1_.isPresent() && Objects.equals(p_212832_1_.getDimension().getType(), ((GlobalPos)lvt_3_1_.get()).getDimension()) && ((GlobalPos)lvt_3_1_.get()).getPos().withinDistance(p_212832_2_.getPositionVec(), (double)this.field_220567_c);
   }
   ...
   protected void startExecuting(ServerWorld p_212831_1_, CreatureEntity p_212831_2_, long p_212831_3_) {
      if (p_212831_3_ > this.field_220566_b) {
         Optional<Vec3d> lvt_5_1_ = Optional.ofNullable(RandomPositionGenerator.getLandPos(p_212831_2_, 8, 6));
         p_212831_2_.getBrain().setMemory(MemoryModuleType.WALK_TARGET, lvt_5_1_.map((p_220564_0_) -> {
