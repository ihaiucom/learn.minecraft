...
public class JumpOnBedTask extends Task<MobEntity> {
   ...
   protected boolean shouldExecute(ServerWorld p_212832_1_, MobEntity p_212832_2_) {
      return p_212832_2_.isChild() && this.func_220469_b(p_212832_1_, p_212832_2_);
   }
   ...
   private void func_220467_a(MobEntity p_220467_1_, BlockPos p_220467_2_) {
      p_220467_1_.getBrain().setMemory(MemoryModuleType.WALK_TARGET, (Object)(new WalkTarget(p_220467_2_, this.field_220470_a, 0)));
   }
   ...
   private boolean func_220468_c(ServerWorld p_220468_1_, MobEntity p_220468_2_) {
      BlockPos lvt_3_1_ = new BlockPos(p_220468_2_);
      BlockPos lvt_4_1_ = lvt_3_1_.down();
      return this.func_220466_a(p_220468_1_, lvt_3_1_) || this.func_220466_a(p_220468_1_, lvt_4_1_);
   }
