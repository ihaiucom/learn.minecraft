...
public class SensorType<U extends Sensor<?>> extends ForgeRegistryEntry<SensorType<?>> {
   ...
   public U func_220995_a() {
      return (Sensor)this.field_221006_j.get();
   }

   private static <U extends Sensor<?>> SensorType<U> register(String p_220996_0_, Supplier<U> p_220996_1_) {
      return (SensorType)Registry.register((Registry)Registry.SENSOR_TYPE, (ResourceLocation)(new ResourceLocation(p_220996_0_)), (Object)(new SensorType(p_220996_1_)));
   }
}
