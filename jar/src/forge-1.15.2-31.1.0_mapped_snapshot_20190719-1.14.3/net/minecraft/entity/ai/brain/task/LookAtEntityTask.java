...
public class LookAtEntityTask extends Task<LivingEntity> {
   ...
   protected boolean shouldExecute(ServerWorld p_212832_1_, LivingEntity p_212832_2_) {
      return ((List)p_212832_2_.getBrain().getMemory(MemoryModuleType.VISIBLE_MOBS).get()).stream().anyMatch(this.field_220519_a);
   }
   ...
   protected void startExecuting(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      lvt_5_1_.getMemory(MemoryModuleType.VISIBLE_MOBS).ifPresent((p_220515_3_) -> {
         p_220515_3_.stream().filter(this.field_220519_a).filter((p_220517_2_) -> {
            ...
            lvt_5_1_.setMemory(MemoryModuleType.LOOK_TARGET, (Object)(new EntityPosWrapper(p_220516_1_)));
         });
      });
   }
}
