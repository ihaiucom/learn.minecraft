...
public class MemoryModuleType<U> extends ForgeRegistryEntry<MemoryModuleType<?>> {
   ...
   private static <U extends IDynamicSerializable> MemoryModuleType<U> register(String p_220937_0_, Optional<Function<Dynamic<?>, U>> p_220937_1_) {
      return (MemoryModuleType)Registry.register((Registry)Registry.MEMORY_MODULE_TYPE, (ResourceLocation)(new ResourceLocation(p_220937_0_)), (Object)(new MemoryModuleType(p_220937_1_)));
   }

   private static <U> MemoryModuleType<U> register(String p_223541_0_) {
      return (MemoryModuleType)Registry.register((Registry)Registry.MEMORY_MODULE_TYPE, (ResourceLocation)(new ResourceLocation(p_223541_0_)), (Object)(new MemoryModuleType(Optional.empty())));
   }
}
