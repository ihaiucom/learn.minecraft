...
public class InteractWithEntityTask<E extends LivingEntity, T extends LivingEntity> extends Task<E> {
   ...
   protected boolean shouldExecute(ServerWorld p_212832_1_, E p_212832_2_) {
      return this.field_220451_f.test(p_212832_2_) && ((List)p_212832_2_.getBrain().getMemory(MemoryModuleType.VISIBLE_MOBS).get()).stream().anyMatch((p_220444_1_) -> {
         return this.field_220448_c.equals(p_220444_1_.getType()) && this.field_220450_e.test(p_220444_1_);
      });
   }

   protected void startExecuting(ServerWorld p_212831_1_, E p_212831_2_, long p_212831_3_) {
      Brain<?> lvt_5_1_ = p_212831_2_.getBrain();
      lvt_5_1_.getMemory(MemoryModuleType.VISIBLE_MOBS).ifPresent((p_220437_3_) -> {
         p_220437_3_.stream().filter((p_220440_1_) -> {
            ...
            lvt_5_1_.setMemory(this.field_220452_g, (Object)p_220438_2_);
            lvt_5_1_.setMemory(MemoryModuleType.LOOK_TARGET, (Object)(new EntityPosWrapper(p_220438_2_)));
            lvt_5_1_.setMemory(MemoryModuleType.WALK_TARGET, (Object)(new WalkTarget(new EntityPosWrapper(p_220438_2_), this.field_220447_b, this.field_220446_a)));
         });
      });
   }
}
