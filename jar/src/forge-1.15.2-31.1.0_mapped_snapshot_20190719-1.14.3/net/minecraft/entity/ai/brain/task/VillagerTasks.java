...
public class VillagerTasks {
   ...
   public static ImmutableList<Pair<Integer, ? extends Task<? super VillagerEntity>>> panic(VillagerProfession p_220636_0_, float p_220636_1_) {
      float lvt_2_1_ = p_220636_1_ * 1.5F;
      return ImmutableList.of(Pair.of(0, new ClearHurtTask()), Pair.of(1, new FleeTask(MemoryModuleType.NEAREST_HOSTILE, lvt_2_1_)), Pair.of(1, new FleeTask(MemoryModuleType.HURT_BY_ENTITY, lvt_2_1_)), Pair.of(3, new FindWalkTargetTask(lvt_2_1_, 2, 2)), func_220646_b());
   }
