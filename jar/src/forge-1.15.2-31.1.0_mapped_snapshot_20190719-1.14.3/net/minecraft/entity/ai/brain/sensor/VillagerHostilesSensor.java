...
public class VillagerHostilesSensor extends Sensor<LivingEntity> {
   ...
   private boolean func_220987_a(LivingEntity p_220987_1_, LivingEntity p_220987_2_) {
      float lvt_3_1_ = (Float)field_220991_b.get(p_220987_2_.getType());
      return p_220987_2_.getDistanceSq(p_220987_1_) <= (double)(lvt_3_1_ * lvt_3_1_);
   }
   ...
   static {
      field_220991_b = ImmutableMap.builder().put(EntityType.DROWNED, 8.0F).put(EntityType.EVOKER, 12.0F).put(EntityType.HUSK, 8.0F).put(EntityType.ILLUSIONER, 12.0F).put(EntityType.PILLAGER, 15.0F).put(EntityType.RAVAGER, 12.0F).put(EntityType.VEX, 8.0F).put(EntityType.VINDICATOR, 10.0F).put(EntityType.ZOMBIE, 8.0F).put(EntityType.ZOMBIE_VILLAGER, 8.0F).build();
   }
}
