...
public class FindInteractionAndLookTargetTask extends Task<LivingEntity> {
   ...
   public boolean shouldExecute(ServerWorld p_212832_1_, LivingEntity p_212832_2_) {
   ...
   public void startExecuting(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      lvt_5_1_.getMemory(MemoryModuleType.VISIBLE_MOBS).ifPresent((p_220526_3_) -> {
         p_220526_3_.stream().filter((p_220529_2_) -> {
            ...
            lvt_5_1_.setMemory(MemoryModuleType.INTERACTION_TARGET, (Object)p_220527_1_);
            lvt_5_1_.setMemory(MemoryModuleType.LOOK_TARGET, (Object)(new EntityPosWrapper(p_220527_1_)));
         });
      });
   }
   ...
   private List<LivingEntity> func_220530_b(LivingEntity p_220530_1_) {
      return (List)p_220530_1_.getBrain().getMemory(MemoryModuleType.VISIBLE_MOBS).get();
   }
}
