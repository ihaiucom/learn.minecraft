...
public class WalkToVillagerBabiesTask extends Task<CreatureEntity> {
   ...
   protected boolean shouldExecute(ServerWorld p_212832_1_, CreatureEntity p_212832_2_) {
      return p_212832_1_.getRandom().nextInt(10) == 0 && this.func_220501_e(p_212832_2_);
   }

   protected void startExecuting(ServerWorld p_212831_1_, CreatureEntity p_212831_2_, long p_212831_3_) {
      LivingEntity lvt_5_1_ = this.func_220500_b(p_212831_2_);
      if (lvt_5_1_ != null) {
         this.func_220508_a(p_212831_1_, p_212831_2_, lvt_5_1_);
      } else {
         Optional<LivingEntity> lvt_6_1_ = this.func_220497_b(p_212831_2_);
         if (lvt_6_1_.isPresent()) {
            func_220498_a(p_212831_2_, (LivingEntity)lvt_6_1_.get());
         } else {
   ...
   private void func_220508_a(ServerWorld p_220508_1_, CreatureEntity p_220508_2_, LivingEntity p_220508_3_) {
      for(int lvt_4_1_ = 0; lvt_4_1_ < 10; ++lvt_4_1_) {
         Vec3d lvt_5_1_ = RandomPositionGenerator.getLandPos(p_220508_2_, 20, 8);
         if (lvt_5_1_ != null && p_220508_1_.func_217483_b_(new BlockPos(lvt_5_1_))) {
            p_220508_2_.getBrain().setMemory(MemoryModuleType.WALK_TARGET, (Object)(new WalkTarget(lvt_5_1_, 0.6F, 0)));
            return;
         }
      }
   ...
   private static void func_220498_a(CreatureEntity p_220498_0_, LivingEntity p_220498_1_) {
      Brain<?> lvt_2_1_ = p_220498_0_.getBrain();
      lvt_2_1_.setMemory(MemoryModuleType.INTERACTION_TARGET, (Object)p_220498_1_);
      lvt_2_1_.setMemory(MemoryModuleType.LOOK_TARGET, (Object)(new EntityPosWrapper(p_220498_1_)));
      lvt_2_1_.setMemory(MemoryModuleType.WALK_TARGET, (Object)(new WalkTarget(new EntityPosWrapper(p_220498_1_), 0.6F, 1)));
   }
   ...
   private Optional<LivingEntity> func_220497_b(CreatureEntity p_220497_1_) {
      Map<LivingEntity, Integer> lvt_2_1_ = this.func_220505_c(p_220497_1_);
      return lvt_2_1_.entrySet().stream().sorted(Comparator.comparingInt(Entry::getValue)).filter((p_220504_0_) -> {
         return (Integer)p_220504_0_.getValue() > 0 && (Integer)p_220504_0_.getValue() <= 5;
      }).map(Entry::getKey).findFirst();
   }

   private Map<LivingEntity, Integer> func_220505_c(CreatureEntity p_220505_1_) {
      Map<LivingEntity, Integer> lvt_2_1_ = Maps.newHashMap();
      this.func_220503_d(p_220505_1_).stream().filter(this::func_220502_c).forEach((p_220509_2_) -> {
         Integer var10000 = (Integer)lvt_2_1_.compute(this.func_220495_a(p_220509_2_), (p_220511_0_, p_220511_1_) -> {
   ...
   private List<LivingEntity> func_220503_d(CreatureEntity p_220503_1_) {
      return (List)p_220503_1_.getBrain().getMemory(MemoryModuleType.VISIBLE_VILLAGER_BABIES).get();
   }

   private LivingEntity func_220495_a(LivingEntity p_220495_1_) {
      return (LivingEntity)p_220495_1_.getBrain().getMemory(MemoryModuleType.INTERACTION_TARGET).get();
   }

   @Nullable
   private LivingEntity func_220500_b(LivingEntity p_220500_1_) {
      return (LivingEntity)((List)p_220500_1_.getBrain().getMemory(MemoryModuleType.VISIBLE_VILLAGER_BABIES).get()).stream().filter((p_220507_2_) -> {
