...
public class VillagerBabiesSensor extends Sensor<LivingEntity> {
   ...
   protected void update(ServerWorld p_212872_1_, LivingEntity p_212872_2_) {
      p_212872_2_.getBrain().setMemory(MemoryModuleType.VISIBLE_VILLAGER_BABIES, (Object)this.func_220994_a(p_212872_2_));
   }

   private List<LivingEntity> func_220994_a(LivingEntity p_220994_1_) {
      return (List)this.func_220992_c(p_220994_1_).stream().filter(this::func_220993_b).collect(Collectors.toList());
   }
   ...
   private List<LivingEntity> func_220992_c(LivingEntity p_220992_1_) {
      return (List)p_220992_1_.getBrain().getMemory(MemoryModuleType.VISIBLE_MOBS).orElse(Lists.newArrayList());
   }
}
