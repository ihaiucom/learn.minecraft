...
public class PhaseType<T extends IPhase> {
   ...
   public IPhase createPhase(EnderDragonEntity p_188736_1_) {
      try {
         Constructor<? extends IPhase> lvt_2_1_ = this.getConstructor();
         return (IPhase)lvt_2_1_.newInstance(p_188736_1_);
   ...
   private static <T extends IPhase> PhaseType<T> create(Class<T> p_188735_0_, String p_188735_1_) {
      PhaseType<T> lvt_2_1_ = new PhaseType(phases.length, p_188735_0_, p_188735_1_);
      phases = (PhaseType[])Arrays.copyOf(phases, phases.length + 1);
      phases[lvt_2_1_.getId()] = lvt_2_1_;
      return lvt_2_1_;
   }
}
