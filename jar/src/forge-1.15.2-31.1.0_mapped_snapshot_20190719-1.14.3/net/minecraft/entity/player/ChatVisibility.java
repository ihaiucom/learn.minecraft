...
public enum ChatVisibility {
   ...
   private static final ChatVisibility[] field_221255_d = (ChatVisibility[])Arrays.stream(values()).sorted(Comparator.comparingInt(ChatVisibility::func_221254_a)).toArray((p_221253_0_) -> {
