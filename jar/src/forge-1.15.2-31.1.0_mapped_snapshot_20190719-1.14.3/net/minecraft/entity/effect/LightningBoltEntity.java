...
public class LightningBoltEntity extends Entity {
   ...
   public LightningBoltEntity(World p_i46780_1_, double p_i46780_2_, double p_i46780_4_, double p_i46780_6_, boolean p_i46780_8_) {
      ...
      Difficulty difficulty = p_i46780_1_.getDifficulty();
   ...
   public void tick() {
      ...
      if (this.lightningState == 2) {
         this.world.playSound((PlayerEntity)null, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), SoundEvents.ENTITY_LIGHTNING_BOLT_THUNDER, SoundCategory.WEATHER, 10000.0F, 0.8F + this.rand.nextFloat() * 0.2F);
         this.world.playSound((PlayerEntity)null, this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), SoundEvents.ENTITY_LIGHTNING_BOLT_IMPACT, SoundCategory.WEATHER, 2.0F, 0.5F + this.rand.nextFloat() * 0.2F);
      }
      ...
      if (this.lightningState >= 0) {
         if (this.world.isRemote) {
            ...
            double d0 = 3.0D;
            List<Entity> list = this.world.getEntitiesInAABBexcluding(this, new AxisAlignedBB(this.func_226277_ct_() - 3.0D, this.func_226278_cu_() - 3.0D, this.func_226281_cx_() - 3.0D, this.func_226277_ct_() + 3.0D, this.func_226278_cu_() + 6.0D + 3.0D, this.func_226281_cx_() + 3.0D), Entity::isAlive);
   ...
   private void igniteBlocks(int p_195053_1_) {
