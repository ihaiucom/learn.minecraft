...
public interface IVillagerType {
   ...
   Map<Biome, IVillagerType> BY_BIOME = (Map)Util.make(Maps.newHashMap(), (p_221172_0_) -> {
   ...
   static IVillagerType register(final String p_221171_0_) {
      return (IVillagerType)Registry.register((Registry)Registry.VILLAGER_TYPE, (ResourceLocation)(new ResourceLocation(p_221171_0_)), (Object)(new IVillagerType() {
   ...
   static IVillagerType byBiome(Biome p_221170_0_) {
      return (IVillagerType)BY_BIOME.getOrDefault(p_221170_0_, PLAINS);
   }
}
