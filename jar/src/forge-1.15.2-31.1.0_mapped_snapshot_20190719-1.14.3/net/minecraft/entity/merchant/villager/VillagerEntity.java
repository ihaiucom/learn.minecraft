...
public class VillagerEntity extends AbstractVillagerEntity implements IReputationTracking, IVillagerDataHolder {
   ...
   public static final Map<Item, Integer> field_213788_bA;
   private static final Set<Item> field_213776_bD;
   ...
   public static final Map<MemoryModuleType<GlobalPos>, BiPredicate<VillagerEntity, PointOfInterestType>> field_213774_bB;
   ...
   public boolean processInteract(PlayerEntity p_184645_1_, Hand p_184645_2_) {
      ...
      if (flag) {
         ...
         return true;
      } else if (itemstack.getItem() != Items.VILLAGER_SPAWN_EGG && this.isAlive() && !this.func_213716_dX() && !this.isSleeping() && !p_184645_1_.func_226563_dT_()) {
         if (this.isChild()) {
            this.shakeHead();
            ...
            if (flag1) {
               ...
               if (!this.world.isRemote && !this.offers.isEmpty()) {
                  this.func_213740_f(p_184645_1_);
               }
   ...
   private boolean func_223723_ev() {
      ...
      } while(!merchantoffer.func_226654_r_());
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      p_213281_1_.put("Gossips", (INBT)this.gossip.func_220914_a(NBTDynamicOps.INSTANCE).getValue());
      p_213281_1_.putInt("Xp", this.xp);
      p_213281_1_.putLong("LastRestock", this.lastRestock);
      p_213281_1_.putLong("LastGossipDecay", this.lastGossipDecay);
      p_213281_1_.putInt("RestocksToday", this.field_223725_bO);
   }
   ...
   public void readAdditional(CompoundNBT p_70037_1_) {
      ...
      if (p_70037_1_.contains("Xp", 3)) {
         this.xp = p_70037_1_.getInt("Xp");
      }

      this.lastRestock = p_70037_1_.getLong("LastRestock");
      this.lastGossipDecay = p_70037_1_.getLong("LastGossipDecay");
      this.setCanPickUpLoot(true);
      if (this.world instanceof ServerWorld) {
         this.resetBrain((ServerWorld)this.world);
      }

      this.field_223725_bO = p_70037_1_.getInt("RestocksToday");
   }
   ...
   public void setRevengeTarget(@Nullable LivingEntity p_70604_1_) {
      if (p_70604_1_ != null && this.world instanceof ServerWorld) {
         ((ServerWorld)this.world).func_217489_a(IReputationType.VILLAGER_HURT, p_70604_1_, this);
   ...
   private void func_223361_a(Entity p_223361_1_) {
      if (this.world instanceof ServerWorld) {
         ...
         if (optional.isPresent()) {
            ...
            ((List)optional.get()).stream().filter((p_lambda$func_223361_a$3_0_) -> {
               return p_lambda$func_223361_a$3_0_ instanceof IReputationTracking;
            }).forEach((p_lambda$func_223361_a$4_2_) -> {
               serverworld.func_217489_a(IReputationType.VILLAGER_KILLED, p_223361_1_, (IReputationTracking)p_lambda$func_223361_a$4_2_);
            });
         }
      }
   ...
   public void func_213742_a(MemoryModuleType<GlobalPos> p_213742_1_) {
      if (this.world instanceof ServerWorld) {
         ...
         this.brain.getMemory(p_213742_1_).ifPresent((p_lambda$func_213742_a$5_3_) -> {
            ServerWorld serverworld = minecraftserver.getWorld(p_lambda$func_213742_a$5_3_.getDimension());
            PointOfInterestManager pointofinterestmanager = serverworld.func_217443_B();
            Optional<PointOfInterestType> optional = pointofinterestmanager.func_219148_c(p_lambda$func_213742_a$5_3_.getPos());
            BiPredicate<VillagerEntity, PointOfInterestType> bipredicate = (BiPredicate)field_213774_bB.get(p_213742_1_);
            if (optional.isPresent() && bipredicate.test(this, optional.get())) {
               pointofinterestmanager.func_219142_b(p_lambda$func_213742_a$5_3_.getPos());
               DebugPacketSender.func_218801_c(serverworld, p_lambda$func_213742_a$5_3_.getPos());
            }
      ...
      if (this.func_223344_ex() && this.func_213751_ew() != 0) {
         for(int i = 0; i < this.func_213715_ed().getSizeInventory(); ++i) {
            ...
            if (!itemstack.isEmpty()) {
               Integer integer = (Integer)field_213788_bA.get(itemstack.getItem());
               if (integer != null) {
   ...
   public int func_223107_f(PlayerEntity p_223107_1_) {
      return this.gossip.func_220921_a(p_223107_1_.getUniqueID(), (p_lambda$func_223107_f$6_0_) -> {
         return true;
      });
   }
   ...
   protected ITextComponent func_225513_by_() {
      ...
      return new TranslationTextComponent(this.getType().getTranslationKey() + '.' + (!"minecraft".equals(profName.getNamespace()) ? profName.getNamespace() + '.' : "") + profName.getPath(), new Object[0]);
   }
   ...
   public ILivingEntityData onInitialSpawn(IWorld p_213386_1_, DifficultyInstance p_213386_2_, SpawnReason p_213386_3_, @Nullable ILivingEntityData p_213386_4_, @Nullable CompoundNBT p_213386_5_) {
      ...
      if (p_213386_3_ == SpawnReason.COMMAND || p_213386_3_ == SpawnReason.SPAWN_EGG || p_213386_3_ == SpawnReason.SPAWNER || p_213386_3_ == SpawnReason.DISPENSER) {
         this.setVillagerData(this.getVillagerData().withType(IVillagerType.byBiome(p_213386_1_.func_226691_t_(new BlockPos(this)))));
      }

      return super.onInitialSpawn(p_213386_1_, p_213386_2_, p_213386_3_, p_213386_4_, p_213386_5_);
   }

   public VillagerEntity createChild(AgeableEntity p_90011_1_) {
   ...
   public void onStruckByLightning(LightningBoltEntity p_70077_1_) {
      ...
      witchentity.setLocationAndAngles(this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_(), this.rotationYaw, this.rotationPitch);
   ...
   protected void updateEquipmentIfNeeded(ItemEntity p_175445_1_) {
      ...
      if (this.func_223717_b(item)) {
         ...
         itemstack2 = inventory.addItem(itemstack);
   ...
   private int func_213751_ew() {
      Inventory inventory = this.func_213715_ed();
      return field_213788_bA.entrySet().stream().mapToInt((p_lambda$func_213751_ew$7_1_) -> {
         return inventory.count((Item)p_lambda$func_213751_ew$7_1_.getKey()) * (Integer)p_lambda$func_213751_ew$7_1_.getValue();
      }).sum();
   }
   ...
   protected void populateTradeData() {
      VillagerData villagerdata = this.getVillagerData();
      Int2ObjectMap<VillagerTrades.ITrade[]> int2objectmap = (Int2ObjectMap)VillagerTrades.field_221239_a.get(villagerdata.getProfession());
      if (int2objectmap != null && !int2objectmap.isEmpty()) {
         VillagerTrades.ITrade[] avillagertrades$itrade = (VillagerTrades.ITrade[])int2objectmap.get(villagerdata.getLevel());
   ...
   public void func_223358_a(long p_223358_1_, int p_223358_3_) {
      if (this.func_223350_a(p_223358_1_)) {
         ...
         List<VillagerEntity> list1 = (List)list.stream().filter((p_lambda$func_223358_a$8_2_) -> {
            return p_lambda$func_223358_a$8_2_.func_223350_a(p_223358_1_);
         }).limit(5L).collect(Collectors.toList());
         if (list1.size() >= p_223358_3_) {
            IronGolemEntity irongolementity = this.func_213759_ey();
            if (irongolementity != null) {
               list.forEach((p_lambda$func_223358_a$9_2_) -> {
                  p_lambda$func_223358_a$9_2_.func_223347_b(p_223358_1_);
               });
            }
         }
      }
   ...
   private void func_223347_b(long p_223347_1_) {
      this.brain.setMemory(MemoryModuleType.GOLEM_LAST_SEEN_TIME, (Object)p_223347_1_);
   }
   ...
   private IronGolemEntity func_213759_ey() {
      ...
      for(int i = 0; i < 10; ++i) {
         ...
         IronGolemEntity irongolementity = (IronGolemEntity)EntityType.IRON_GOLEM.create(this.world, (CompoundNBT)null, (ITextComponent)null, (PlayerEntity)null, blockpos2, SpawnReason.MOB_SUMMONED, false, false);
         if (irongolementity != null) {
   ...
   public void startSleeping(BlockPos p_213342_1_) {
      ...
      this.brain.setMemory(MemoryModuleType.LAST_SLEPT, (Object)LongSerializable.of(this.world.getGameTime()));
   }

   public void wakeUp() {
      super.wakeUp();
      this.brain.setMemory(MemoryModuleType.field_226332_A_, (Object)LongSerializable.of(this.world.getGameTime()));
   }
   ...
   private boolean func_223352_d(long p_223352_1_) {
      ...
      if (optional.isPresent() && optional1.isPresent()) {
         return p_223352_1_ - ((LongSerializable)optional.get()).func_223461_a() < 24000L && p_223352_1_ - ((LongSerializable)optional1.get()).func_223461_a() < 36000L;
      } else {
         return false;
      }
   }
   ...
   static {
      ...
      field_213774_bB = ImmutableMap.of(MemoryModuleType.HOME, (p_lambda$static$0_0_, p_lambda$static$0_1_) -> {
         return p_lambda$static$0_1_ == PointOfInterestType.HOME;
      }, MemoryModuleType.JOB_SITE, (p_lambda$static$1_0_, p_lambda$static$1_1_) -> {
         return p_lambda$static$1_0_.getVillagerData().getProfession().getPointOfInterest() == p_lambda$static$1_1_;
      }, MemoryModuleType.MEETING_POINT, (p_lambda$static$2_0_, p_lambda$static$2_1_) -> {
         return p_lambda$static$2_1_ == PointOfInterestType.MEETING;
      });
   }
}
