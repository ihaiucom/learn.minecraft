...
public class VillagerData {
   ...
   public VillagerData(Dynamic<?> p_i50181_1_) {
      this((IVillagerType)Registry.VILLAGER_TYPE.getOrDefault(ResourceLocation.tryCreate(p_i50181_1_.get("type").asString(""))), (VillagerProfession)Registry.VILLAGER_PROFESSION.getOrDefault(ResourceLocation.tryCreate(p_i50181_1_.get("profession").asString(""))), p_i50181_1_.get("level").asInt(1));
   }
