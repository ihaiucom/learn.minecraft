...
public interface IRecipeType<T extends IRecipe<?>> {
   ...
   static <T extends IRecipe<?>> IRecipeType<T> register(final String p_222147_0_) {
      return (IRecipeType)Registry.register((Registry)Registry.RECIPE_TYPE, (ResourceLocation)(new ResourceLocation(p_222147_0_)), (Object)(new IRecipeType<T>() {
   ...
   default <C extends IInventory> Optional<T> matches(IRecipe<C> p_222148_1_, World p_222148_2_, C p_222148_3_) {
