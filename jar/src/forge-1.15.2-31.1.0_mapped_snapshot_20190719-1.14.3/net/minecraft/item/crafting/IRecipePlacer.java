...
public interface IRecipePlacer<T> {
   default void placeRecipe(int p_201501_1_, int p_201501_2_, int p_201501_3_, IRecipe<?> p_201501_4_, Iterator<T> p_201501_5_, int p_201501_6_) {
      int i = p_201501_1_;
      int j = p_201501_2_;
      if (p_201501_4_ instanceof IShapedRecipe) {
         IShapedRecipe shapedrecipe = (IShapedRecipe)p_201501_4_;
      ...
      for(int k = 0; k < p_201501_2_; ++k) {
         ...
         for(int i1 = 0; i1 < p_201501_1_; ++i1) {
            ...
            if (flag1) {
               this.setSlotContents(p_201501_5_, k1, p_201501_6_, k, i1);
            } else if (j1 == i1) {
               k1 += p_201501_1_ - i1;
               break;
            }
   ...
   void setSlotContents(Iterator<T> var1, int var2, int var3, int var4, int var5);
}
