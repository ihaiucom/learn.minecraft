...
public class ArrowItem extends Item {
   ...
   public boolean isInfinite(ItemStack p_isInfinite_1_, ItemStack p_isInfinite_2_, PlayerEntity p_isInfinite_3_) {
      int enchant = EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, p_isInfinite_2_);
