...
public class VillageSiege {
   ...
   private boolean trySetupSiege(ServerWorld p_75529_1_) {
      Iterator var2 = p_75529_1_.getPlayers().iterator();
      ...
      while(var2.hasNext()) {
         ...
         if (!playerentity.isSpectator()) {
            ...
            if (p_75529_1_.func_217483_b_(blockpos) && p_75529_1_.func_226691_t_(blockpos).getCategory() != Biome.Category.MUSHROOM) {
               for(int i = 0; i < 10; ++i) {
                  float f = p_75529_1_.rand.nextFloat() * 6.2831855F;
                  ...
                  if (siegeLocation != null) {
                     if (MinecraftForge.EVENT_BUS.post(new VillageSiegeEvent(this, p_75529_1_, playerentity, siegeLocation))) {
                        return false;
                     }
   ...
   private void spawnZombie(ServerWorld p_75530_1_) {
      ...
      if (vec3d != null) {
         ...
         try {
            zombieentity = (ZombieEntity)EntityType.ZOMBIE.create(p_75530_1_);
