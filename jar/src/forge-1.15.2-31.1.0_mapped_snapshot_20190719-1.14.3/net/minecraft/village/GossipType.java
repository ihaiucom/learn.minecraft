...
public enum GossipType {
   ...
   private static final Map<String, GossipType> field_220936_l = (Map)Stream.of(values()).collect(ImmutableMap.toImmutableMap((p_220930_0_) -> {
   ...
   public static GossipType func_220929_a(String p_220929_0_) {
      return (GossipType)field_220936_l.get(p_220929_0_);
   }
}
