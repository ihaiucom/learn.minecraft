...
public class PointOfInterestManager extends RegionSectionCache<PointOfInterestData> {
   ...
   public void func_219135_a(BlockPos p_219135_1_, PointOfInterestType p_219135_2_) {
      ((PointOfInterestData)this.func_219110_e(SectionPos.from(p_219135_1_).asLong())).func_218243_a(p_219135_1_, p_219135_2_);
   }

   public void func_219140_a(BlockPos p_219140_1_) {
      ((PointOfInterestData)this.func_219110_e(SectionPos.from(p_219140_1_).asLong())).remove(p_219140_1_);
   }
   ...
   public Stream<PointOfInterest> func_219146_b(Predicate<PointOfInterestType> p_219146_1_, BlockPos p_219146_2_, int p_219146_3_, PointOfInterestManager.Status p_219146_4_) {
      int lvt_5_1_ = p_219146_3_ * p_219146_3_;
      return this.func_226353_b_(p_219146_1_, p_219146_2_, p_219146_3_, p_219146_4_).filter((p_226349_2_) -> {
         return p_226349_2_.getPos().distanceSq(p_219146_2_) <= (double)lvt_5_1_;
      });
   }
   ...
   private Stream<PointOfInterest> func_219136_a(Predicate<PointOfInterestType> p_219136_1_, long p_219136_2_, PointOfInterestManager.Status p_219136_4_) {
      return (Stream)this.func_219113_d(p_219136_2_).map((p_219159_2_) -> {
   ...
   public Optional<BlockPos> func_219163_a(Predicate<PointOfInterestType> p_219163_1_, Predicate<BlockPos> p_219163_2_, PointOfInterestManager.Status p_219163_3_, BlockPos p_219163_4_, int p_219163_5_, Random p_219163_6_) {
      List<PointOfInterest> lvt_7_1_ = (List)this.func_219146_b(p_219163_1_, p_219163_4_, p_219163_5_, p_219163_3_).collect(Collectors.toList());
      Collections.shuffle(lvt_7_1_, p_219163_6_);
      return lvt_7_1_.stream().filter((p_219131_1_) -> {
   ...
   public boolean func_219142_b(BlockPos p_219142_1_) {
      return ((PointOfInterestData)this.func_219110_e(SectionPos.from(p_219142_1_).asLong())).func_218251_c(p_219142_1_);
   }

   public boolean func_219138_a(BlockPos p_219138_1_, Predicate<PointOfInterestType> p_219138_2_) {
      return (Boolean)this.func_219113_d(SectionPos.from(p_219138_1_).asLong()).map((p_219133_2_) -> {
   ...
   public Optional<PointOfInterestType> func_219148_c(BlockPos p_219148_1_) {
      PointOfInterestData lvt_2_1_ = (PointOfInterestData)this.func_219110_e(SectionPos.from(p_219148_1_).asLong());
      return lvt_2_1_.func_218244_d(p_219148_1_);
   }
   ...
   private boolean func_219154_f(long p_219154_1_) {
      Optional<PointOfInterestData> lvt_3_1_ = this.func_219106_c(p_219154_1_);
      return lvt_3_1_ == null ? false : (Boolean)lvt_3_1_.map((p_223144_0_) -> {
   ...
   public void func_219139_a(ChunkPos p_219139_1_, ChunkSection p_219139_2_) {
      SectionPos lvt_3_1_ = SectionPos.from(p_219139_1_, p_219139_2_.getYLocation() >> 4);
      Util.acceptOrElse(this.func_219113_d(lvt_3_1_.asLong()), (p_219130_3_) -> {
         p_219130_3_.func_218240_a((p_219141_3_) -> {
            if (hasAnyPOI(p_219139_2_)) {
               this.func_219132_a(p_219139_2_, lvt_3_1_, p_219141_3_);
            }

         });
      }, () -> {
         if (hasAnyPOI(p_219139_2_)) {
            PointOfInterestData lvt_3_1_x = (PointOfInterestData)this.func_219110_e(lvt_3_1_.asLong());
            this.func_219132_a(p_219139_2_, lvt_3_1_, lvt_3_1_x::func_218243_a);
         }
   ...
   private static boolean hasAnyPOI(ChunkSection p_219151_0_) {
      Stream var10000 = PointOfInterestType.getAllStates();
      p_219151_0_.getClass();
      return var10000.anyMatch(p_219151_0_::contains);
   }
   ...
   private void func_219132_a(ChunkSection p_219132_1_, SectionPos p_219132_2_, BiConsumer<BlockPos, PointOfInterestType> p_219132_3_) {
      p_219132_2_.allBlocksWithin().forEach((p_219143_2_) -> {
         BlockState lvt_3_1_ = p_219132_1_.getBlockState(SectionPos.mask(p_219143_2_.getX()), SectionPos.mask(p_219143_2_.getY()), SectionPos.mask(p_219143_2_.getZ()));
         PointOfInterestType.forState(lvt_3_1_).ifPresent((p_219161_2_) -> {
   ...
   public void func_226347_a_(IWorldReader p_226347_1_, BlockPos p_226347_2_, int p_226347_3_) {
      SectionPos.func_229421_b_(new ChunkPos(p_226347_2_), Math.floorDiv(p_226347_3_, 16)).map((p_226354_1_) -> {
         ...
         return !(Boolean)((Optional)p_226352_0_.getSecond()).map(PointOfInterestData::func_226355_a_).orElse(false);
      }).map((p_226348_0_) -> {
         return ((SectionPos)p_226348_0_.getFirst()).asChunkPos();
      }).filter((p_226351_1_) -> {
