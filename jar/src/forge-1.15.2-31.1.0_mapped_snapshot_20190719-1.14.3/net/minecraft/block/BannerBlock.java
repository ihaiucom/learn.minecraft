...
public class BannerBlock extends AbstractBannerBlock {
   ...
   private static final Map<DyeColor, Block> BANNERS_BY_COLOR;
   private static final VoxelShape SHAPE;

   public BannerBlock(DyeColor p_i48448_1_, Block.Properties p_i48448_2_) {
   ...
   public BlockState getStateForPlacement(BlockItemUseContext p_196258_1_) {
      return (BlockState)this.getDefaultState().with(ROTATION, MathHelper.floor((double)((180.0F + p_196258_1_.getPlacementYaw()) * 16.0F / 360.0F) + 0.5D) & 15);
   }
   ...
   public static Block forColor(DyeColor p_196287_0_) {
      return (Block)BANNERS_BY_COLOR.getOrDefault(p_196287_0_, Blocks.WHITE_BANNER);
   }

   static {
      ROTATION = BlockStateProperties.ROTATION_0_15;
      BANNERS_BY_COLOR = Maps.newHashMap();
