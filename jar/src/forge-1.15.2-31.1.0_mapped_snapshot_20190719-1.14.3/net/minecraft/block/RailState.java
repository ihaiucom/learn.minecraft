...
public class RailState {
   ...
   public RailState(World p_i47755_1_, BlockPos p_i47755_2_, BlockState p_i47755_3_) {
      ...
      RailShape railshape = this.block.getRailDirection(this.newState, p_i47755_1_, p_i47755_2_, (AbstractMinecartEntity)null);
      this.disableCorners = !this.block.isFlexibleRail(this.newState, p_i47755_1_, p_i47755_2_);
      this.canMakeSlopes = this.block.canMakeSlopes(this.newState, p_i47755_1_, p_i47755_2_);
