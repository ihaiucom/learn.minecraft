...
public class MushroomBlock extends BushBlock implements IGrowable {
   ...
   public MushroomBlock(Block.Properties p_i48363_1_) {
      super(p_i48363_1_);
   }
   ...
   public void func_225534_a_(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      if (p_225534_4_.nextInt(25) == 0) {
         int i = 5;
         int j = true;
         Iterator var7 = BlockPos.getAllInBoxMutable(p_225534_3_.add(-4, -1, -4), p_225534_3_.add(4, 1, 4)).iterator();
   ...
   public boolean isValidPosition(BlockState p_196260_1_, IWorldReader p_196260_2_, BlockPos p_196260_3_) {
      ...
      if (block != Blocks.MYCELIUM && block != Blocks.PODZOL) {
         return p_196260_2_.func_226659_b_(p_196260_3_, 0) < 13 && blockstate.canSustainPlant(p_196260_2_, blockpos, Direction.UP, this);
      } else {
         return true;
      }
   }
