...
public class FurnaceBlock extends AbstractFurnaceBlock {
   protected FurnaceBlock(Block.Properties p_i48393_1_) {
      super(p_i48393_1_);
   }
   ...
   public void animateTick(BlockState p_180655_1_, World p_180655_2_, BlockPos p_180655_3_, Random p_180655_4_) {
      if ((Boolean)p_180655_1_.get(LIT)) {
         ...
         if (p_180655_4_.nextDouble() < 0.1D) {
            p_180655_2_.playSound(lvt_5_1_, lvt_7_1_, lvt_9_1_, SoundEvents.BLOCK_FURNACE_FIRE_CRACKLE, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
         }
         ...
         double lvt_19_1_ = p_180655_4_.nextDouble() * 6.0D / 16.0D;
         ...
         p_180655_2_.addParticle(ParticleTypes.FLAME, lvt_5_1_ + lvt_17_1_, lvt_7_1_ + lvt_19_1_, lvt_9_1_ + lvt_21_1_, 0.0D, 0.0D, 0.0D);
      }
   }
}
