...
public class ItemTags {
   private static TagCollection<Item> collection = new TagCollection((p_lambda$static$0_0_) -> {
   ...
   public static final Tag<Item> field_226158_H_ = makeWrapperTag("tall_flowers");
   public static final Tag<Item> field_226159_I_ = makeWrapperTag("flowers");
   ...
   public static final Tag<Item> field_226160_P_ = makeWrapperTag("lectern_books");
   ...
   public static class Wrapper extends Tag<Item> {
      ...
      public boolean contains(Item p_199685_1_) {
