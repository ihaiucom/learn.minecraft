...
public class ServerPropertiesProvider {
   ...
   public ServerPropertiesProvider(Path p_i50718_1_) {
      this.propertiesPath = p_i50718_1_;
      this.properties = ServerProperties.create(p_i50718_1_);
   }
   ...
   public ServerPropertiesProvider func_219033_a(UnaryOperator<ServerProperties> p_219033_1_) {
      (this.properties = (ServerProperties)p_219033_1_.apply(this.properties)).save(this.propertiesPath);
      return this;
   }
}
