   ...
   public void run() {
      while(this.server.isServerRunning()) {
         ...
         if (k > this.maxTickTime) {
            ...
            Error error = new Error(String.format("ServerHangWatchdog detected that a single server tick took %.2f seconds (should be max 0.05)", (float)k / 1000.0F));
            ThreadInfo[] var11 = athreadinfo;
            int var12 = athreadinfo.length;
            ...
            crashreportcategory.addDetail("Threads", (Object)stringbuilder);
