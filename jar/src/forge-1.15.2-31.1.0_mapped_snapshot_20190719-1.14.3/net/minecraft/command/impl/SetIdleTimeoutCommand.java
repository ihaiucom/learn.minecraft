...
public class SetIdleTimeoutCommand {
   public static void register(CommandDispatcher<CommandSource> p_198690_0_) {
      p_198690_0_.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("setidletimeout").requires((p_198692_0_) -> {
   ...
   private static int setTimeout(CommandSource p_198693_0_, int p_198693_1_) {
      p_198693_0_.getServer().setPlayerIdleTimeout(p_198693_1_);
      p_198693_0_.sendFeedback(new TranslationTextComponent("commands.setidletimeout.success", new Object[]{p_198693_1_}), true);
      return p_198693_1_;
   }
}
