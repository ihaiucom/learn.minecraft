...
public class DimensionArgument implements ArgumentType<DimensionType> {
   ...
   public DimensionType parse(StringReader p_parse_1_) throws CommandSyntaxException {
      ...
      return (DimensionType)Registry.DIMENSION_TYPE.getValue(lvt_2_1_).orElseThrow(() -> {
         return field_212596_a.create(lvt_2_1_);
      });
   }
   ...
   public static DimensionType func_212592_a(CommandContext<CommandSource> p_212592_0_, String p_212592_1_) {
      return (DimensionType)p_212592_0_.getArgument(p_212592_1_, DimensionType.class);
   }
   ...
   static {
      EXAMPLES = (Collection)Stream.of(DimensionType.OVERWORLD, DimensionType.THE_NETHER).map((p_212593_0_) -> {
         return DimensionType.getKey(p_212593_0_).toString();
      }).collect(Collectors.toList());
      field_212596_a = new DynamicCommandExceptionType((p_212594_0_) -> {
         return new TranslationTextComponent("argument.dimension.invalid", new Object[]{p_212594_0_});
      });
   }
}
