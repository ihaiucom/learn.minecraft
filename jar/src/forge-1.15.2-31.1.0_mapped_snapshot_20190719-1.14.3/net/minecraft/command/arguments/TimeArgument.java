...
public class TimeArgument implements ArgumentType<Integer> {
   ...
   private static final SimpleCommandExceptionType field_218094_b = new SimpleCommandExceptionType(new TranslationTextComponent("argument.time.invalid_unit", new Object[0]));
   private static final DynamicCommandExceptionType field_218095_c = new DynamicCommandExceptionType((p_218092_0_) -> {
      return new TranslationTextComponent("argument.time.invalid_tick_count", new Object[]{p_218092_0_});
   });
   ...
   public Integer parse(StringReader p_parse_1_) throws CommandSyntaxException {
      float lvt_2_1_ = p_parse_1_.readFloat();
      String lvt_3_1_ = p_parse_1_.readUnquotedString();
      int lvt_4_1_ = field_218096_d.getOrDefault(lvt_3_1_, 0);
      if (lvt_4_1_ == 0) {
         throw field_218094_b.create();
      } else {
         int lvt_5_1_ = Math.round(lvt_2_1_ * (float)lvt_4_1_);
         if (lvt_5_1_ < 0) {
            throw field_218095_c.create(lvt_5_1_);
         } else {
            return lvt_5_1_;
         }
      }
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> p_listSuggestions_1_, SuggestionsBuilder p_listSuggestions_2_) {
      StringReader lvt_3_1_ = new StringReader(p_listSuggestions_2_.getRemaining());
      ...
      return ISuggestionProvider.suggest((Iterable)field_218096_d.keySet(), p_listSuggestions_2_.createOffset(p_listSuggestions_2_.getStart() + lvt_3_1_.getCursor()));
   }
