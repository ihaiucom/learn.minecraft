...
public class SuggestionProviders {
   ...
   public static SuggestionProvider<ISuggestionProvider> get(ResourceLocation p_197498_0_) {
      return (SuggestionProvider)REGISTRY.getOrDefault(p_197498_0_, ASK_SERVER);
   }
   ...
   public static SuggestionProvider<ISuggestionProvider> ensureKnown(SuggestionProvider<ISuggestionProvider> p_197496_0_) {
      return p_197496_0_ instanceof SuggestionProviders.Wrapper ? p_197496_0_ : ASK_SERVER;
   }

   static {
      ASK_SERVER = register(ASK_SERVER_ID, (p_197500_0_, p_197500_1_) -> {
         return ((ISuggestionProvider)p_197500_0_.getSource()).getSuggestionsFromServer(p_197500_0_, p_197500_1_);
      });
      ALL_RECIPES = register(new ResourceLocation("all_recipes"), (p_197501_0_, p_197501_1_) -> {
         return ISuggestionProvider.func_212476_a(((ISuggestionProvider)p_197501_0_.getSource()).getRecipeResourceLocations(), p_197501_1_);
      });
      AVAILABLE_SOUNDS = register(new ResourceLocation("available_sounds"), (p_197495_0_, p_197495_1_) -> {
         return ISuggestionProvider.suggestIterable(((ISuggestionProvider)p_197495_0_.getSource()).getSoundResourceLocations(), p_197495_1_);
      });
      SUMMONABLE_ENTITIES = register(new ResourceLocation("summonable_entities"), (p_201210_0_, p_201210_1_) -> {
         return ISuggestionProvider.func_201725_a(Registry.ENTITY_TYPE.stream().filter(EntityType::isSummonable), p_201210_1_, EntityType::getKey, (p_201209_0_) -> {
            return new TranslationTextComponent(Util.makeTranslationKey("entity", EntityType.getKey(p_201209_0_)), new Object[0]);
         });
      });
   }
