...
public class ItemParser {
   public static final SimpleCommandExceptionType ITEM_TAGS_NOT_ALLOWED = new SimpleCommandExceptionType(new TranslationTextComponent("argument.item.tag.disallowed", new Object[0]));
   public static final DynamicCommandExceptionType ITEM_BAD_ID = new DynamicCommandExceptionType((p_208696_0_) -> {
      return new TranslationTextComponent("argument.item.id.invalid", new Object[]{p_208696_0_});
   });
   ...
   public void readItem() throws CommandSyntaxException {
      ...
      ResourceLocation lvt_2_1_ = ResourceLocation.read(this.reader);
      this.item = (Item)Registry.ITEM.getValue(lvt_2_1_).orElseThrow(() -> {
         this.reader.setCursor(lvt_1_1_);
         return ITEM_BAD_ID.createWithContext(this.reader, lvt_2_1_.toString());
      });
   }
   ...
   public CompletableFuture<Suggestions> func_197329_a(SuggestionsBuilder p_197329_1_) {
      return (CompletableFuture)this.field_197339_g.apply(p_197329_1_.createOffset(this.reader.getCursor()));
   }
}
