...
public class RealmsSlotOptionsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      if (this.field_224647_j.equals(RealmsServer.ServerType.NORMAL)) {
         ...
         if (this.field_224647_j.equals(RealmsServer.ServerType.ADVENTUREMAP)) {
            lvt_1_3_ = getLocalizedString("mco.configure.world.edit.subscreen.adventuremap");
         } else if (this.field_224647_j.equals(RealmsServer.ServerType.INSPIRATION)) {
            lvt_1_3_ = getLocalizedString("mco.configure.world.edit.subscreen.inspiration");
         } else {
            lvt_1_3_ = getLocalizedString("mco.configure.world.edit.subscreen.experience");
         }

         this.field_224637_C = new RealmsLabel(lvt_1_3_, this.width() / 2, 26, 16711680);
   ...
   private String func_224625_b() {
      String lvt_1_1_ = getLocalizedString("options.difficulty");
      return lvt_1_1_ + ": " + this.field_224639_b[this.field_224649_l];
   }

   private String func_224610_c() {
      String lvt_1_1_ = getLocalizedString("selectWorld.gameMode");
      return lvt_1_1_ + ": " + this.field_224640_c[this.field_224650_m];
   }
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      String lvt_4_1_ = getLocalizedString("mco.configure.world.edit.slot.name");
      this.drawString(lvt_4_1_, this.field_224643_f + this.field_224644_g / 2 - this.fontWidth(lvt_4_1_) / 2, RealmsConstants.func_225109_a(0) - 5, 16777215);
