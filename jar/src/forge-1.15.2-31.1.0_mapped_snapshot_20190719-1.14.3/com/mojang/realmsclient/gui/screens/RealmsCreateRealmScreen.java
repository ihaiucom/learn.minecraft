...
public class RealmsCreateRealmScreen extends RealmsScreen {
   ...
   private void func_224132_a() {
      if (this.func_224133_b()) {
         RealmsResetWorldScreen lvt_1_1_ = new RealmsResetWorldScreen(this.field_224136_b, this.field_224135_a, this.field_224136_b.func_223942_f(), getLocalizedString("mco.selectServer.create"), getLocalizedString("mco.create.world.subtitle"), 10526880, getLocalizedString("mco.create.world.skip"));
         lvt_1_1_.func_224432_a(getLocalizedString("mco.create.world.reset.title"));
         RealmsTasks.WorldCreationTask lvt_2_1_ = new RealmsTasks.WorldCreationTask(this.field_224135_a.id, this.field_224137_c.getValue(), this.field_224138_d.getValue(), lvt_1_1_);
         RealmsLongRunningMcoTaskScreen lvt_3_1_ = new RealmsLongRunningMcoTaskScreen(this.field_224136_b, lvt_2_1_);
