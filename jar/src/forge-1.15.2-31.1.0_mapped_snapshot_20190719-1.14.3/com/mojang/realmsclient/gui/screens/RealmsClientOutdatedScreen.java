...
public class RealmsClientOutdatedScreen extends RealmsScreen {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      String lvt_4_1_ = getLocalizedString(this.field_224130_b ? "mco.client.outdated.title" : "mco.client.incompatible.title");
      this.drawCenteredString(lvt_4_1_, this.width() / 2, RealmsConstants.func_225109_a(3), 16711680);
      int lvt_5_1_ = this.field_224130_b ? 2 : 3;

      for(int lvt_6_1_ = 0; lvt_6_1_ < lvt_5_1_; ++lvt_6_1_) {
         String lvt_7_1_ = getLocalizedString((this.field_224130_b ? "mco.client.outdated.msg.line" : "mco.client.incompatible.msg.line") + (lvt_6_1_ + 1));
         this.drawCenteredString(lvt_7_1_, this.width() / 2, RealmsConstants.func_225109_a(5) + lvt_6_1_ * 12, 16777215);
      }
