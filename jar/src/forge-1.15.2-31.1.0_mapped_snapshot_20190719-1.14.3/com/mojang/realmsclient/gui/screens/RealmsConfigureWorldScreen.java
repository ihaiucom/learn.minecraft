...
public class RealmsConfigureWorldScreen extends RealmsScreenWithCallback<WorldTemplate> implements RealmsServerSlotButton.IHandler {
   ...
   public void init() {
      ...
      this.buttonsAdd(this.field_224428_p = new RealmsButton(8, this.func_224411_b(0), RealmsConstants.func_225109_a(13) - 5, 100, 20, getLocalizedString("mco.configure.world.buttons.switchminigame")) {
         public void onPress() {
            RealmsSelectWorldTemplateScreen lvt_1_1_ = new RealmsSelectWorldTemplateScreen(RealmsConfigureWorldScreen.this, RealmsServer.ServerType.MINIGAME);
            lvt_1_1_.func_224483_a(RealmsScreen.getLocalizedString("mco.template.title.minigame"));
      ...
      this.buttonsAdd(this.field_224425_m = new RealmsButton(5, this.func_224411_b(0), RealmsConstants.func_225109_a(13) - 5, 90, 20, getLocalizedString("mco.configure.world.buttons.options")) {
         public void onPress() {
            Realms.setScreen(new RealmsSlotOptionsScreen(RealmsConfigureWorldScreen.this, ((RealmsWorldOptions)RealmsConfigureWorldScreen.this.field_224416_d.slots.get(RealmsConfigureWorldScreen.this.field_224416_d.activeSlot)).clone(), RealmsConfigureWorldScreen.this.field_224416_d.worldType, RealmsConfigureWorldScreen.this.field_224416_d.activeSlot));
         }
      });
   ...
   private void func_224402_a(int p_224402_1_) {
      int lvt_2_1_ = this.func_224368_c(p_224402_1_);
      int lvt_3_1_ = RealmsConstants.func_225109_a(5) + 5;
      int lvt_4_1_ = 100 + p_224402_1_;
      RealmsServerSlotButton lvt_5_1_ = new RealmsServerSlotButton(lvt_2_1_, lvt_3_1_, 80, 80, () -> {
         return this.field_224416_d;
      }, (p_224391_1_) -> {
         this.field_224414_b = p_224391_1_;
      }, lvt_4_1_, p_224402_1_, this);
      this.getProxy().buttonsAdd(lvt_5_1_);
   }
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      if (this.field_224416_d == null) {
         ...
         String lvt_4_1_ = this.field_224416_d.getName();
         int lvt_5_1_ = this.fontWidth(lvt_4_1_);
         int lvt_6_1_ = this.field_224416_d.state == RealmsServer.Status.CLOSED ? 10526880 : 8388479;
         int lvt_7_1_ = this.fontWidth(getLocalizedString("mco.configure.world.title"));
         this.drawCenteredString(getLocalizedString("mco.configure.world.title"), this.width() / 2, 12, 16777215);
         this.drawCenteredString(lvt_4_1_, this.width() / 2, 24, lvt_6_1_);
         int lvt_8_1_ = Math.min(this.func_224374_a(2, 3) + 80 - 11, this.width() / 2 + lvt_5_1_ / 2 + lvt_7_1_ / 2 + 10);
         this.func_224379_a(lvt_8_1_, 7, p_render_1_, p_render_2_);
         if (this.func_224376_g()) {
   ...
   private void func_224387_a(long p_224387_1_) {
      (new Thread(() -> {
         ...
         try {
            this.field_224416_d = lvt_3_1_.func_224935_a(p_224387_1_);
            this.func_224400_e();
            if (this.func_224376_g()) {
               this.func_224375_k();
            } else {
            ...
            Realms.setScreen(new RealmsGenericErrorScreen(var5.getMessage(), this.field_224415_c));
   ...
   private void func_224401_f() {
      RealmsSelectWorldTemplateScreen lvt_1_1_ = new RealmsSelectWorldTemplateScreen(this, RealmsServer.ServerType.MINIGAME);
      lvt_1_1_.func_224483_a(getLocalizedString("mco.template.title.minigame"));
      lvt_1_1_.func_224492_b(getLocalizedString("mco.minigame.world.info.line1") + "\\n" + getLocalizedString("mco.minigame.world.info.line2"));
      Realms.setScreen(lvt_1_1_);
   }

   private void func_224403_a(int p_224403_1_, RealmsServer p_224403_2_) {
      String lvt_3_1_ = getLocalizedString("mco.configure.world.slot.switch.question.line1");
      String lvt_4_1_ = getLocalizedString("mco.configure.world.slot.switch.question.line2");
      ...
      }, RealmsLongConfirmationScreen.Type.Info, lvt_3_1_, lvt_4_1_, true, 9));
   }
   ...
   private void func_224388_b(int p_224388_1_, RealmsServer p_224388_2_) {
      ...
      Realms.setScreen(new RealmsLongConfirmationScreen((p_227970_3_, p_227970_4_) -> {
         if (p_227970_3_) {
            RealmsResetWorldScreen lvt_5_1_ = new RealmsResetWorldScreen(this, p_224388_2_, this.func_224407_b(), getLocalizedString("mco.configure.world.switch.slot"), getLocalizedString("mco.configure.world.switch.slot.subtitle"), 10526880, getLocalizedString("gui.cancel"));
            lvt_5_1_.func_224445_b(p_224388_1_);
            lvt_5_1_.func_224432_a(getLocalizedString("mco.create.world.reset.title"));
            Realms.setScreen(lvt_5_1_);
         } else {
            Realms.setScreen(this);
         }

      }, RealmsLongConfirmationScreen.Type.Info, lvt_3_1_, lvt_4_1_, true, 10));
   }

   protected void func_224394_a(String p_224394_1_, int p_224394_2_, int p_224394_3_) {
      if (p_224394_1_ != null) {
         int lvt_4_1_ = p_224394_2_ + 12;
         int lvt_5_1_ = p_224394_3_ - 12;
         int lvt_6_1_ = this.fontWidth(p_224394_1_);
         if (lvt_4_1_ + lvt_6_1_ + 3 > this.field_224419_g) {
            lvt_4_1_ = lvt_4_1_ - lvt_6_1_ - 20;
         }

         this.fillGradient(lvt_4_1_ - 3, lvt_5_1_ - 3, lvt_4_1_ + lvt_6_1_ + 3, lvt_5_1_ + 8 + 3, -1073741824, -1073741824);
         this.fontDrawShadow(p_224394_1_, lvt_4_1_, lvt_5_1_, 16777215);
      }
   }
   ...
   public void func_224386_a(RealmsWorldOptions p_224386_1_) {
      RealmsWorldOptions lvt_2_1_ = (RealmsWorldOptions)this.field_224416_d.slots.get(this.field_224416_d.activeSlot);
      p_224386_1_.templateId = lvt_2_1_.templateId;
      p_224386_1_.templateImage = lvt_2_1_.templateImage;
      RealmsClient lvt_3_1_ = RealmsClient.func_224911_a();

      try {
         lvt_3_1_.func_224925_a(this.field_224416_d.id, this.field_224416_d.activeSlot, p_224386_1_);
   ...
   public void func_224410_a(String p_224410_1_, String p_224410_2_) {
      String lvt_3_1_ = p_224410_2_ != null && !p_224410_2_.trim().isEmpty() ? p_224410_2_ : null;
      RealmsClient lvt_4_1_ = RealmsClient.func_224911_a();

      try {
         lvt_4_1_.func_224922_b(this.field_224416_d.id, p_224410_1_, lvt_3_1_);
         this.field_224416_d.setName(p_224410_1_);
         this.field_224416_d.setDescription(lvt_3_1_);
   ...
   public void func_224383_a(boolean p_224383_1_, RealmsScreen p_224383_2_) {
      RealmsTasks.OpenServerTask lvt_3_1_ = new RealmsTasks.OpenServerTask(this.field_224416_d, this, this.field_224415_c, p_224383_1_);
      RealmsLongRunningMcoTaskScreen lvt_4_1_ = new RealmsLongRunningMcoTaskScreen(p_224383_2_, lvt_3_1_);
      lvt_4_1_.func_224233_a();
      Realms.setScreen(lvt_4_1_);
   }

   public void func_224405_a(RealmsScreen p_224405_1_) {
      RealmsTasks.CloseServerTask lvt_2_1_ = new RealmsTasks.CloseServerTask(this.field_224416_d, this);
      RealmsLongRunningMcoTaskScreen lvt_3_1_ = new RealmsLongRunningMcoTaskScreen(p_224405_1_, lvt_2_1_);
   ...
   private void func_224406_a(long p_224406_1_, int p_224406_3_) {
      RealmsConfigureWorldScreen lvt_4_1_ = this.func_224407_b();
      RealmsTasks.SwitchSlotTask lvt_5_1_ = new RealmsTasks.SwitchSlotTask(p_224406_1_, p_224406_3_, (p_227971_1_, p_227971_2_) -> {
         Realms.setScreen(lvt_4_1_);
      }, 11);
      RealmsLongRunningMcoTaskScreen lvt_6_1_ = new RealmsLongRunningMcoTaskScreen(this.field_224415_c, lvt_5_1_);
      lvt_6_1_.func_224233_a();
      Realms.setScreen(lvt_6_1_);
   }

   private void func_224393_b(WorldTemplate p_224393_1_) {
      RealmsTasks.SwitchMinigameTask lvt_2_1_ = new RealmsTasks.SwitchMinigameTask(this.field_224416_d.id, p_224393_1_, this.func_224407_b());
      RealmsLongRunningMcoTaskScreen lvt_3_1_ = new RealmsLongRunningMcoTaskScreen(this.field_224415_c, lvt_2_1_);
      lvt_3_1_.func_224233_a();
      Realms.setScreen(lvt_3_1_);
   }
