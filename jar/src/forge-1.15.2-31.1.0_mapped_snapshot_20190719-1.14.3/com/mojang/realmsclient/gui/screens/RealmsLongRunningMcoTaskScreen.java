...
public class RealmsLongRunningMcoTaskScreen extends RealmsScreen {
   ...
   public void func_224233_a() {
      Thread lvt_1_1_ = new Thread(this.field_224242_f, "Realms-long-running-task");
      lvt_1_1_.setUncaughtExceptionHandler(new RealmsDefaultUncaughtExceptionHandler(field_224238_b));
      lvt_1_1_.start();
   }
