...
public class RealmsBackupInfoScreen extends RealmsScreen {
   ...
   public RealmsBackupInfoScreen(RealmsScreen p_i51778_1_, Backup p_i51778_2_) {
      ...
      if (p_i51778_2_.changeList != null) {
         Iterator var3 = p_i51778_2_.changeList.entrySet().iterator();

         while(var3.hasNext()) {
            Entry<String, String> lvt_4_1_ = (Entry)var3.next();
            this.field_224050_f.add(lvt_4_1_.getKey());
         }
      }
   ...
   private String func_224039_a(String p_224039_1_, String p_224039_2_) {
      String lvt_3_1_ = p_224039_1_.toLowerCase(Locale.ROOT);
      if (lvt_3_1_.contains("game") && lvt_3_1_.contains("mode")) {
         return this.func_224043_b(p_224039_2_);
      } else {
         return lvt_3_1_.contains("game") && lvt_3_1_.contains("difficulty") ? this.func_224042_a(p_224039_2_) : p_224039_2_;
      }
   }
   ...
   class BackupInfoList extends RealmsSimpleScrolledSelectionList {
      ...
      public void renderItem(int p_renderItem_1_, int p_renderItem_2_, int p_renderItem_3_, int p_renderItem_4_, Tezzelator p_renderItem_5_, int p_renderItem_6_, int p_renderItem_7_) {
         String lvt_8_1_ = (String)RealmsBackupInfoScreen.this.field_224050_f.get(p_renderItem_1_);
         RealmsBackupInfoScreen.this.drawString(lvt_8_1_, this.width() / 2 - 40, p_renderItem_3_, 10526880);
         String lvt_9_1_ = (String)RealmsBackupInfoScreen.this.field_224049_e.changeList.get(lvt_8_1_);
         RealmsBackupInfoScreen.this.drawString(RealmsBackupInfoScreen.this.func_224039_a(lvt_8_1_, lvt_9_1_), this.width() / 2 - 40, p_renderItem_3_ + 12, 16777215);
      }
   }
}
