...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.buttonsAdd(this.field_224309_j = new RealmsButton(5, this.field_224307_h, RealmsConstants.func_225109_a(9), this.field_224306_g + 10, 20, getLocalizedString("mco.configure.world.invites.ops.tooltip")) {
         public void onPress() {
            if (((PlayerInfo)RealmsPlayerScreen.this.field_224303_d.players.get(RealmsPlayerScreen.this.field_224312_m)).isOperator()) {
      ...
      Iterator var1 = this.field_224303_d.players.iterator();

      while(var1.hasNext()) {
         PlayerInfo lvt_2_1_ = (PlayerInfo)var1.next();
         this.field_224304_e.func_223870_a(lvt_2_1_);
      }
   ...
   private void func_224289_b(int p_224289_1_) {
      ...
      String lvt_3_1_ = ((PlayerInfo)this.field_224303_d.players.get(p_224289_1_)).getUuid();

      try {
         this.func_224283_a(lvt_2_1_.func_224906_e(this.field_224303_d.id, lvt_3_1_));
   ...
   private void func_224279_c(int p_224279_1_) {
      this.func_224280_a();
      RealmsClient lvt_2_1_ = RealmsClient.func_224911_a();
      String lvt_3_1_ = ((PlayerInfo)this.field_224303_d.players.get(p_224279_1_)).getUuid();

      try {
         this.func_224283_a(lvt_2_1_.func_224929_f(this.field_224303_d.id, lvt_3_1_));
      } catch (RealmsServiceException var5) {
   ...
   private void func_224283_a(Ops p_224283_1_) {
      Iterator var2 = this.field_224303_d.players.iterator();

      while(var2.hasNext()) {
         PlayerInfo lvt_3_1_ = (PlayerInfo)var2.next();
         lvt_3_1_.setOperator(p_224283_1_.ops.contains(lvt_3_1_.getName()));
      }
   ...
   private void func_224274_d(int p_224274_1_) {
      ...
      if (p_224274_1_ >= 0 && p_224274_1_ < this.field_224303_d.players.size()) {
         PlayerInfo lvt_2_1_ = (PlayerInfo)this.field_224303_d.players.get(p_224274_1_);
         this.field_224311_l = lvt_2_1_.getUuid();
         this.field_224310_k = p_224274_1_;
         RealmsConfirmScreen lvt_3_1_ = new RealmsConfirmScreen(this, "Question", getLocalizedString("mco.configure.world.uninvite.question") + " '" + lvt_2_1_.getName() + "' ?", 2);
   ...
   public void confirmResult(boolean p_confirmResult_1_, int p_confirmResult_2_) {
      if (p_confirmResult_2_ == 2) {
         if (p_confirmResult_1_) {
            ...
            try {
               lvt_3_1_.func_224908_a(this.field_224303_d.id, this.field_224311_l);
            } catch (RealmsServiceException var5) {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      int lvt_4_1_ = RealmsConstants.func_225109_a(12) + 20;
      Tezzelator lvt_5_1_ = Tezzelator.instance;
      bind("textures/gui/options_background.png");
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      float lvt_6_1_ = 32.0F;
      lvt_5_1_.begin(7, RealmsDefaultVertexFormat.POSITION_TEX_COLOR);
      lvt_5_1_.vertex(0.0D, (double)this.height(), 0.0D).tex(0.0F, (float)(this.height() - lvt_4_1_) / 32.0F + 0.0F).color(64, 64, 64, 255).endVertex();
      lvt_5_1_.vertex((double)this.width(), (double)this.height(), 0.0D).tex((float)this.width() / 32.0F, (float)(this.height() - lvt_4_1_) / 32.0F + 0.0F).color(64, 64, 64, 255).endVertex();
      lvt_5_1_.vertex((double)this.width(), (double)lvt_4_1_, 0.0D).tex((float)this.width() / 32.0F, 0.0F).color(64, 64, 64, 255).endVertex();
      lvt_5_1_.vertex(0.0D, (double)lvt_4_1_, 0.0D).tex(0.0F, 0.0F).color(64, 64, 64, 255).endVertex();
      lvt_5_1_.end();
   ...
   protected void func_224277_a(String p_224277_1_, int p_224277_2_, int p_224277_3_) {
      if (p_224277_1_ != null) {
         int lvt_4_1_ = p_224277_2_ + 12;
         int lvt_5_1_ = p_224277_3_ - 12;
         int lvt_6_1_ = this.fontWidth(p_224277_1_);
         this.fillGradient(lvt_4_1_ - 3, lvt_5_1_ - 3, lvt_4_1_ + lvt_6_1_ + 3, lvt_5_1_ + 8 + 3, -1073741824, -1073741824);
         this.fontDrawShadow(p_224277_1_, lvt_4_1_, lvt_5_1_, 16777215);
      }
   }

   private void func_224291_a(int p_224291_1_, int p_224291_2_, int p_224291_3_, int p_224291_4_) {
      boolean lvt_5_1_ = p_224291_3_ >= p_224291_1_ && p_224291_3_ <= p_224291_1_ + 9 && p_224291_4_ >= p_224291_2_ && p_224291_4_ <= p_224291_2_ + 9 && p_224291_4_ < RealmsConstants.func_225109_a(12) + 20 && p_224291_4_ > RealmsConstants.func_225109_a(1);
      bind("realms:textures/gui/realms/cross_player_icon.png");
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      RenderSystem.pushMatrix();
      RealmsScreen.blit(p_224291_1_, p_224291_2_, 0.0F, lvt_5_1_ ? 7.0F : 0.0F, 8, 7, 8, 14);
   ...
   private void func_224295_b(int p_224295_1_, int p_224295_2_, int p_224295_3_, int p_224295_4_) {
      boolean lvt_5_1_ = p_224295_3_ >= p_224295_1_ && p_224295_3_ <= p_224295_1_ + 9 && p_224295_4_ >= p_224295_2_ && p_224295_4_ <= p_224295_2_ + 9 && p_224295_4_ < RealmsConstants.func_225109_a(12) + 20 && p_224295_4_ > RealmsConstants.func_225109_a(1);
      bind("realms:textures/gui/realms/op_icon.png");
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      RenderSystem.pushMatrix();
      RealmsScreen.blit(p_224295_1_, p_224295_2_, 0.0F, lvt_5_1_ ? 8.0F : 0.0F, 8, 8, 8, 16);
      RenderSystem.popMatrix();
      if (lvt_5_1_) {
   ...
   private void func_224294_c(int p_224294_1_, int p_224294_2_, int p_224294_3_, int p_224294_4_) {
      boolean lvt_5_1_ = p_224294_3_ >= p_224294_1_ && p_224294_3_ <= p_224294_1_ + 9 && p_224294_4_ >= p_224294_2_ && p_224294_4_ <= p_224294_2_ + 9 && p_224294_4_ < RealmsConstants.func_225109_a(12) + 20 && p_224294_4_ > RealmsConstants.func_225109_a(1);
      bind("realms:textures/gui/realms/user_icon.png");
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      RenderSystem.pushMatrix();
      RealmsScreen.blit(p_224294_1_, p_224294_2_, 0.0F, lvt_5_1_ ? 8.0F : 0.0F, 8, 8, 8, 16);
      RenderSystem.popMatrix();
      if (lvt_5_1_) {
   ...
   class InvitedEntry extends RealmListEntry {
      ...
      private void func_223745_a(PlayerInfo p_223745_1_, int p_223745_2_, int p_223745_3_, int p_223745_4_, int p_223745_5_) {
         ...
         RealmsPlayerScreen.this.drawString(p_223745_1_.getName(), RealmsPlayerScreen.this.field_224305_f + 3 + 12, p_223745_3_ + 1, lvt_6_3_);
   ...
   class InvitedList extends RealmsObjectSelectionList {
      ...
      public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
         if (p_mouseClicked_5_ == 0 && p_mouseClicked_1_ < (double)this.getScrollbarPosition() && p_mouseClicked_3_ >= (double)this.y0() && p_mouseClicked_3_ <= (double)this.y1()) {
            int lvt_6_1_ = RealmsPlayerScreen.this.field_224305_f;
            int lvt_7_1_ = RealmsPlayerScreen.this.field_224305_f + RealmsPlayerScreen.this.field_224306_g;
      ...
      public void itemClicked(int p_itemClicked_1_, int p_itemClicked_2_, double p_itemClicked_3_, double p_itemClicked_5_, int p_itemClicked_7_) {
         if (p_itemClicked_2_ >= 0 && p_itemClicked_2_ <= RealmsPlayerScreen.this.field_224303_d.players.size() && RealmsPlayerScreen.this.field_224301_b != null) {
            ...
            } else if (((PlayerInfo)RealmsPlayerScreen.this.field_224303_d.players.get(p_itemClicked_2_)).isOperator()) {
      ...
      public void selectItem(int p_selectItem_1_) {
         ...
         if (p_selectItem_1_ != -1) {
            Realms.narrateNow(RealmsScreen.getLocalizedString("narrator.select", ((PlayerInfo)RealmsPlayerScreen.this.field_224303_d.players.get(p_selectItem_1_)).getName()));
         }
