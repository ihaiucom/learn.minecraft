         ...
         if (!p_confirmResult_1_) {
            ...
            try {
               Realms.downloadResourcePack(this.field_224481_c.resourcePackUrl, this.field_224481_c.resourcePackHash).thenRun(() -> {
                  RealmsLongRunningMcoTaskScreen lvt_1_1_ = new RealmsLongRunningMcoTaskScreen(this.field_224480_b, new RealmsTasks.RealmsConnectTask(this.field_224480_b, this.field_224481_c));
                  lvt_1_1_.func_224233_a();
