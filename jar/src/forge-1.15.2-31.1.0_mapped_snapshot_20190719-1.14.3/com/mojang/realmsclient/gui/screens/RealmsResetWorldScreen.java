...
public class RealmsResetWorldScreen extends RealmsScreenWithCallback<WorldTemplate> {
   ...
   private final int field_224466_l;
   private final int field_224467_m;
   ...
   private RealmsResetWorldScreen.ResetType field_224472_r;
   ...
   public RealmsResetWorldScreen(RealmsScreen p_i51756_1_, RealmsServer p_i51756_2_, RealmsScreen p_i51756_3_) {
      ...
      this.field_224465_k = 16711680;
      this.field_224466_l = 0;
      this.field_224467_m = 100;
      this.field_224455_a = -1;
      this.field_224472_r = RealmsResetWorldScreen.ResetType.NONE;
   ...
   public void init() {
      ...
      (new Thread("Realms-reset-world-fetcher") {
         public void run() {
            ...
            try {
               WorldTemplatePaginatedList lvt_2_1_ = lvt_1_1_.func_224930_a(1, 10, RealmsServer.ServerType.NORMAL);
               WorldTemplatePaginatedList lvt_3_1_ = lvt_1_1_.func_224930_a(1, 10, RealmsServer.ServerType.ADVENTUREMAP);
               WorldTemplatePaginatedList lvt_4_1_ = lvt_1_1_.func_224930_a(1, 10, RealmsServer.ServerType.EXPERIENCE);
               WorldTemplatePaginatedList lvt_5_1_ = lvt_1_1_.func_224930_a(1, 10, RealmsServer.ServerType.INSPIRATION);
               Realms.execute(() -> {
                  RealmsResetWorldScreen.this.field_224468_n = lvt_2_1_;
                  RealmsResetWorldScreen.this.field_224469_o = lvt_3_1_;
                  RealmsResetWorldScreen.this.field_224470_p = lvt_4_1_;
                  RealmsResetWorldScreen.this.field_224471_q = lvt_5_1_;
               });
            } catch (RealmsServiceException var6) {
               RealmsResetWorldScreen.field_224456_b.error("Couldn't fetch templates in reset world", var6);
            }
      ...
      this.buttonsAdd(new RealmsResetWorldScreen.TexturedButton(this.func_224434_c(3), RealmsConstants.func_225109_a(0) + 10, getLocalizedString("mco.reset.world.template"), -1L, "realms:textures/gui/realms/survival_spawn.png", RealmsResetWorldScreen.ResetType.SURVIVAL_SPAWN) {
         public void onPress() {
            RealmsSelectWorldTemplateScreen lvt_1_1_ = new RealmsSelectWorldTemplateScreen(RealmsResetWorldScreen.this, RealmsServer.ServerType.NORMAL, RealmsResetWorldScreen.this.field_224468_n);
            lvt_1_1_.func_224483_a(RealmsScreen.getLocalizedString("mco.reset.world.template"));
      ...
      this.buttonsAdd(new RealmsResetWorldScreen.TexturedButton(this.func_224434_c(1), RealmsConstants.func_225109_a(6) + 20, getLocalizedString("mco.reset.world.adventure"), -1L, "realms:textures/gui/realms/adventure.png", RealmsResetWorldScreen.ResetType.ADVENTURE) {
         public void onPress() {
            RealmsSelectWorldTemplateScreen lvt_1_1_ = new RealmsSelectWorldTemplateScreen(RealmsResetWorldScreen.this, RealmsServer.ServerType.ADVENTUREMAP, RealmsResetWorldScreen.this.field_224469_o);
            lvt_1_1_.func_224483_a(RealmsScreen.getLocalizedString("mco.reset.world.adventure"));
            Realms.setScreen(lvt_1_1_);
         }
      });
      this.buttonsAdd(new RealmsResetWorldScreen.TexturedButton(this.func_224434_c(2), RealmsConstants.func_225109_a(6) + 20, getLocalizedString("mco.reset.world.experience"), -1L, "realms:textures/gui/realms/experience.png", RealmsResetWorldScreen.ResetType.EXPERIENCE) {
         public void onPress() {
            RealmsSelectWorldTemplateScreen lvt_1_1_ = new RealmsSelectWorldTemplateScreen(RealmsResetWorldScreen.this, RealmsServer.ServerType.EXPERIENCE, RealmsResetWorldScreen.this.field_224470_p);
            lvt_1_1_.func_224483_a(RealmsScreen.getLocalizedString("mco.reset.world.experience"));
            Realms.setScreen(lvt_1_1_);
         }
      });
      this.buttonsAdd(new RealmsResetWorldScreen.TexturedButton(this.func_224434_c(3), RealmsConstants.func_225109_a(6) + 20, getLocalizedString("mco.reset.world.inspiration"), -1L, "realms:textures/gui/realms/inspiration.png", RealmsResetWorldScreen.ResetType.INSPIRATION) {
         public void onPress() {
            RealmsSelectWorldTemplateScreen lvt_1_1_ = new RealmsSelectWorldTemplateScreen(RealmsResetWorldScreen.this, RealmsServer.ServerType.INSPIRATION, RealmsResetWorldScreen.this.field_224471_q);
            lvt_1_1_.func_224483_a(RealmsScreen.getLocalizedString("mco.reset.world.inspiration"));
            Realms.setScreen(lvt_1_1_);
         }
      });
      this.narrateLabels();
   ...
   public void func_224446_a(RealmsScreen p_224446_1_) {
      RealmsTasks.SwitchSlotTask lvt_2_1_ = new RealmsTasks.SwitchSlotTask(this.field_224458_d.id, this.field_224455_a, p_224446_1_, 100);
      RealmsLongRunningMcoTaskScreen lvt_3_1_ = new RealmsLongRunningMcoTaskScreen(this.field_224457_c, lvt_2_1_);
   ...
   public void func_224435_b(WorldTemplate p_224435_1_) {
      RealmsTasks.ResettingWorldTask lvt_2_1_ = new RealmsTasks.ResettingWorldTask(this.field_224458_d.id, this.field_224459_e, p_224435_1_);
      if (this.field_224475_u != null) {
         lvt_2_1_.func_225012_c(this.field_224475_u);
      }

      if (this.field_224476_v != -1) {
         lvt_2_1_.func_225011_a(this.field_224476_v);
      }
   ...
   private void func_224437_b(RealmsResetWorldScreen.ResetWorldInfo p_224437_1_) {
      RealmsTasks.ResettingWorldTask lvt_2_1_ = new RealmsTasks.ResettingWorldTask(this.field_224458_d.id, this.field_224459_e, p_224437_1_.field_225157_a, p_224437_1_.field_225158_b, p_224437_1_.field_225159_c);
      if (this.field_224475_u != null) {
         lvt_2_1_.func_225012_c(this.field_224475_u);
      }
