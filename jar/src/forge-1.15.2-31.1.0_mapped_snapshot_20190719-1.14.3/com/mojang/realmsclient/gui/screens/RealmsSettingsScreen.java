...
public class RealmsSettingsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      int lvt_1_1_ = this.width() / 2 - 106;
      this.buttonsAdd(this.field_224568_d = new RealmsButton(1, lvt_1_1_ - 2, RealmsConstants.func_225109_a(12), 106, 20, getLocalizedString("mco.configure.world.buttons.done")) {
         public void onPress() {
      ...
      this.buttonsAdd(new RealmsButton(5, this.width() / 2 - 53, RealmsConstants.func_225109_a(0), 106, 20, getLocalizedString(this.field_224566_b.state.equals(RealmsServer.Status.OPEN) ? "mco.configure.world.buttons.close" : "mco.configure.world.buttons.open")) {
         public void onPress() {
            if (RealmsSettingsScreen.this.field_224566_b.state.equals(RealmsServer.Status.OPEN)) {
               String lvt_1_1_ = RealmsScreen.getLocalizedString("mco.configure.world.close.question.line1");
               String lvt_2_1_ = RealmsScreen.getLocalizedString("mco.configure.world.close.question.line2");
               Realms.setScreen(new RealmsLongConfirmationScreen(RealmsSettingsScreen.this, RealmsLongConfirmationScreen.Type.Info, lvt_1_1_, lvt_2_1_, true, 5));
            } else {
      ...
      this.field_224570_f = this.newEditBox(2, lvt_1_1_, RealmsConstants.func_225109_a(4), 212, 20, getLocalizedString("mco.configure.world.name"));
      ...
      this.field_224569_e = this.newEditBox(3, lvt_1_1_, RealmsConstants.func_225109_a(8), 212, 20, getLocalizedString("mco.configure.world.description"));
