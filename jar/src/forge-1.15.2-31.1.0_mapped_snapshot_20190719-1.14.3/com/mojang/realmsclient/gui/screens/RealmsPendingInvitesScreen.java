...
public class RealmsPendingInvitesScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      (new Thread("Realms-pending-invitations-fetcher") {
         public void run() {
            ...
            try {
               List<PendingInvite> lvt_2_1_ = lvt_1_1_.func_224919_k().pendingInvites;
               List<RealmsPendingInvitesScreen.InvitationEntry> lvt_3_1_ = (List)lvt_2_1_.stream().map((p_225146_1_) -> {
                  return RealmsPendingInvitesScreen.this.new InvitationEntry(p_225146_1_);
               }).collect(Collectors.toList());
               Realms.execute(() -> {
                  RealmsPendingInvitesScreen.this.field_224337_e.replaceEntries(lvt_3_1_);
               });
      ...
      if (p_224321_1_ < this.field_224337_e.getItemCount()) {
         (new Thread("Realms-reject-invitation") {
            public void run() {
               try {
                  RealmsClient lvt_1_1_ = RealmsClient.func_224911_a();
                  lvt_1_1_.func_224913_b(((RealmsPendingInvitesScreen.InvitationEntry)RealmsPendingInvitesScreen.this.field_224337_e.children().get(p_224321_1_)).field_223750_a.invitationId);
                  Realms.execute(() -> {
      ...
      if (p_224329_1_ < this.field_224337_e.getItemCount()) {
         (new Thread("Realms-accept-invitation") {
            public void run() {
               try {
                  RealmsClient lvt_1_1_ = RealmsClient.func_224911_a();
                  lvt_1_1_.func_224901_a(((RealmsPendingInvitesScreen.InvitationEntry)RealmsPendingInvitesScreen.this.field_224337_e.children().get(p_224329_1_)).field_223750_a.invitationId);
                  Realms.execute(() -> {
   ...
   protected void func_224322_a(String p_224322_1_, int p_224322_2_, int p_224322_3_) {
      if (p_224322_1_ != null) {
         int lvt_4_1_ = p_224322_2_ + 12;
         int lvt_5_1_ = p_224322_3_ - 12;
         int lvt_6_1_ = this.fontWidth(p_224322_1_);
         this.fillGradient(lvt_4_1_ - 3, lvt_5_1_ - 3, lvt_4_1_ + lvt_6_1_ + 3, lvt_5_1_ + 8 + 3, -1073741824, -1073741824);
         this.fontDrawShadow(p_224322_1_, lvt_4_1_, lvt_5_1_, 16777215);
      }
   }
   ...
   class InvitationList extends RealmsObjectSelectionList<RealmsPendingInvitesScreen.InvitationEntry> {
      ...
      public void selectItem(int p_selectItem_1_) {
         ...
         if (p_selectItem_1_ != -1) {
            List<RealmsPendingInvitesScreen.InvitationEntry> lvt_2_1_ = RealmsPendingInvitesScreen.this.field_224337_e.children();
            PendingInvite lvt_3_1_ = ((RealmsPendingInvitesScreen.InvitationEntry)lvt_2_1_.get(p_selectItem_1_)).field_223750_a;
            String lvt_4_1_ = RealmsScreen.getLocalizedString("narrator.select.list.position", p_selectItem_1_ + 1, lvt_2_1_.size());
            String lvt_5_1_ = Realms.joinNarrations(Arrays.asList(lvt_3_1_.worldName, lvt_3_1_.worldOwnerName, RealmsPendingInvitesScreen.func_224330_a(lvt_3_1_), lvt_4_1_));
            Realms.narrateNow(RealmsScreen.getLocalizedString("narrator.select", lvt_5_1_));
         }
