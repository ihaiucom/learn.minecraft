...
public enum ChatFormatting {
   ...
   private static final Map<Character, ChatFormatting> field_225044_w = (Map)Arrays.stream(values()).collect(Collectors.toMap(ChatFormatting::func_225041_a, (p_225039_0_) -> {
      return p_225039_0_;
   }));
   private static final Map<String, ChatFormatting> field_225045_x = (Map)Arrays.stream(values()).collect(Collectors.toMap(ChatFormatting::func_225038_b, (p_225040_0_) -> {
      return p_225040_0_;
   }));
