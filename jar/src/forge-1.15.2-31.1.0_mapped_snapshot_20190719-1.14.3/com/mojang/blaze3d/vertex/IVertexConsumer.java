...
public interface IVertexConsumer extends IVertexBuilder {
   ...
   void func_225589_a_(int var1, byte var2);

   void func_225591_a_(int var1, short var2);

   void func_225590_a_(int var1, float var2);
   ...
   default IVertexBuilder func_225586_a_(int p_225586_1_, int p_225586_2_, int p_225586_3_, int p_225586_4_) {
      VertexFormatElement lvt_5_1_ = this.func_225592_i_();
      if (lvt_5_1_.getUsage() != VertexFormatElement.Usage.COLOR) {
         return this;
      } else if (lvt_5_1_.getType() != VertexFormatElement.Type.UBYTE) {
         throw new IllegalStateException();
      } else {
   ...
   default IVertexBuilder func_225583_a_(float p_225583_1_, float p_225583_2_) {
      VertexFormatElement lvt_3_1_ = this.func_225592_i_();
      if (lvt_3_1_.getUsage() == VertexFormatElement.Usage.UV && lvt_3_1_.getIndex() == 0) {
         if (lvt_3_1_.getType() != VertexFormatElement.Type.FLOAT) {
            throw new IllegalStateException();
         } else {
   ...
   default IVertexBuilder func_227847_a_(short p_227847_1_, short p_227847_2_, int p_227847_3_) {
      VertexFormatElement lvt_4_1_ = this.func_225592_i_();
      if (lvt_4_1_.getUsage() == VertexFormatElement.Usage.UV && lvt_4_1_.getIndex() == p_227847_3_) {
         if (lvt_4_1_.getType() != VertexFormatElement.Type.SHORT) {
            throw new IllegalStateException();
         } else {
   ...
   default IVertexBuilder func_225584_a_(float p_225584_1_, float p_225584_2_, float p_225584_3_) {
      VertexFormatElement lvt_4_1_ = this.func_225592_i_();
      if (lvt_4_1_.getUsage() != VertexFormatElement.Usage.NORMAL) {
         return this;
      } else if (lvt_4_1_.getType() != VertexFormatElement.Type.BYTE) {
         throw new IllegalStateException();
      } else {
