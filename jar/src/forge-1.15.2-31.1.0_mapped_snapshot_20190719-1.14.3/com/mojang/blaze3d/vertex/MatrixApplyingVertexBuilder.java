...
public class MatrixApplyingVertexBuilder extends DefaultColorVertexBuilder {
   ...
   public void endVertex() {
      Vector3f lvt_1_1_ = new Vector3f(this.field_227817_p_, this.field_227818_q_, this.field_227819_r_);
      lvt_1_1_.func_229188_a_(this.field_227810_i_);
      Direction lvt_2_1_ = Direction.getFacingFromVector(lvt_1_1_.getX(), lvt_1_1_.getY(), lvt_1_1_.getZ());
      Vector4f lvt_3_1_ = new Vector4f(this.field_227811_j_, this.field_227812_k_, this.field_227813_l_, 1.0F);
      lvt_3_1_.func_229372_a_(this.field_227809_h_);
      lvt_3_1_.func_195912_a(Vector3f.field_229181_d_.func_229187_a_(180.0F));
      lvt_3_1_.func_195912_a(Vector3f.field_229179_b_.func_229187_a_(-90.0F));
      lvt_3_1_.func_195912_a(lvt_2_1_.func_229384_a_());
      float lvt_4_1_ = -lvt_3_1_.getX();
      float lvt_5_1_ = -lvt_3_1_.getY();
      this.field_227808_g_.func_225582_a_((double)this.field_227811_j_, (double)this.field_227812_k_, (double)this.field_227813_l_).func_227885_a_(1.0F, 1.0F, 1.0F, 1.0F).func_225583_a_(lvt_4_1_, lvt_5_1_).func_225585_a_(this.field_227814_m_, this.field_227815_n_).func_227886_a_(this.field_227816_o_).func_225584_a_(this.field_227817_p_, this.field_227818_q_, this.field_227819_r_).endVertex();
      this.func_227820_b_();
   }
