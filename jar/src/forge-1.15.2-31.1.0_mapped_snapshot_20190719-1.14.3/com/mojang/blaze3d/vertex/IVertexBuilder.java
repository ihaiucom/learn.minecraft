...
public interface IVertexBuilder extends IForgeVertexBuilder {
   ...
   IVertexBuilder func_225582_a_(double var1, double var3, double var5);

   IVertexBuilder func_225586_a_(int var1, int var2, int var3, int var4);

   IVertexBuilder func_225583_a_(float var1, float var2);

   IVertexBuilder func_225585_a_(int var1, int var2);

   IVertexBuilder func_225587_b_(int var1, int var2);

   IVertexBuilder func_225584_a_(float var1, float var2, float var3);
      ...
      try {
         ...
         for(int k = 0; k < j; ++k) {
            ...
            if (p_227890_9_) {
               ...
               f4 = f9 * p_227890_3_[k] * p_227890_5_;
               f5 = f10 * p_227890_3_[k] * p_227890_6_;
            } else {
            ...
            this.applyBakedNormals(vector3f, bytebuffer, p_227890_1_.func_227872_b_());
